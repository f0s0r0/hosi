...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
   ...
   <tr>
    ...
    <td width="99%" valign="top"><table width="105%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
        <td width="860">
              <form name="cbform1" method="post" action="triagelist1_test.php">
                <table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                   <tr bgcolor="#011E6A">
              <td colspan="3" bgcolor="#CCCCCC" class="bodytext3"><strong> Search Patient to Triage </strong></td>
  ...
  <form name="form1" id="form1" method="post" action="triagelist1_test.php">	
  <tr>
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			echo "<br>".$visitcode = $res1['visitcode'];
           ...
           $query123 = "select * from master_visitentry where patientfullname like '%$searchpatient%' and locationcode='$locationcode' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and locationcode='$locationcode' and  paymentstatus = '' and consultationdate between '$fromdate' and '$todate'  order by auto_number desc";
			...
			echo "<br>".$query65="select * from master_triage where patientcode = '$patientcode' and visitcode = '$visitcode' and triagestatus = 'completed' and closesvisits = ''";
			...
			$query1 = "select * from master_visitentry where overallpayment <> 'completed' and complaint <> '0' and billtype <> 'PAY NOW' and 
		...
		//	$query5 = "select * from master_employeedepartment AS me LEFT JOIN master_employeelocation AS ml ON me.employeecode = ml.employeecode  where me.department = '$res1department' and me.username='$username' and ml.locationcode = '".$locationcode."' ";
			$query5 = "select employeecode from master_employeedepartment  where department = '$res1department' and username='$username'";
			
			$exec5 = mysql_query($query5) or die ("Error in Query2".mysql_error());
			$num5 = mysql_num_rows($exec5);
			while($employeedep=mysql_fetch_array($exec5))
			{
				$employeecodedep=$employeedep['employeecode'];
				
			
			$queryml = "select auto_number from  master_employeelocation   where employeecode = '".$employeecodedep."' and locationcode = '".$locationcode."' ";
			$execml = mysql_query($queryml) or die ("Error in Queryml".mysql_error());
			$numml = mysql_num_rows($execml);
			}
            ...
            <tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left"><div align="left"><?php echo $sno = $sno + 1; ?></div></td>
			   <td class="bodytext31" valign="center"  align="left">
				...
				<input type="hidden" name="visit[]" id="visit" value="<?php echo $visitcode; ?>"></div></td>
              <td class="bodytext31" valign="center"  align="left">
			  <div class="bodytext31"><?php echo $patientfirstname.' '.$patientmiddlename.' '.$patientlastname; ?>test</div></td>
              <td class="bodytext31" valign="center"  align="left">
			    <div align="left"><?php echo $age;?></div></td>
				 <td class="bodytext31" valign="center"  align="left">
			    <div align="left"><?php echo strtoupper($gender);?></div></td>
