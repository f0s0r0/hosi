...
if ($frmflag1 == 'frmflag1')
{
	...
	$locationname=$_REQUEST["hiddenlocation"];
	...
	if ($length<=100)
	{
	$query2 = "select * from master_ward where auto_number = '$wardanum'";
	$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
	$res2 = mysql_num_rows($exec2);
	if ($res2 != 0)
	{
		$query1 = "update master_ward set locationname='$selectedlocation',locationcode='$selectedlocationcode', ward = '$ward',ipaddress = '$ipaddress',recorddate = '$updatedatetime' where auto_number = '$wardanum'";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		$errmsg = "Success. New ward Updated.";
		//$bgcolorcode = 'success';
		header ("location:addward.php?bgcolorcode=success&&st=edit&&anum=$wardanum");
	}
	//exit();
	else
	{
		...
		//$bgcolorcode = 'failed';
		//header ("location:editward.php?bgcolorcode=failed&&st=edit&&anum=$wardanum");
	}
	}
	else
	{
...
if ($st == 'edit' && $anum != '')
{
    $query1 = "select * from master_ward where auto_number = '$anum'";
	$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
	$res1 = mysql_fetch_array($exec1);
	$res1autonumber = $res1['auto_number'];
	$res1ward = $res1['ward'];
			  $res2location = $res1['locationname'];
			  $res31locationcode = $res1['locationcode'];
}
...
function funcDeleteward1(varwardAutoNumber)
{
	 ...
	 var fRet;
	fRet = confirm('Are you sure want to delete this Consultation Type '+varwardAutoNumber+'?');
	//alert(fRet);
	if (fRet == true)
	{
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="editward.php" onSubmit="return addward1process1()">
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Ward Master - Add New </strong></td>
                      </tr>
					  <tr>
                ...
                <select name="location" id="location" onChange="return funclocationChange1();"  style="border: 1px solid #001E6A;">
                  ...
                  <?php
                      ...
                      <tr>
						...
						<input name="ward" id="ward" value="<?php echo $res1ward ?>" style="border: 1px solid #001E6A;" size="40" /></td>
                      </tr>
                      <tr>
						...
						<input type="hidden" name="frmflag" value="addnew" />
							...
							<input type="hidden" name="wardanum" id="wardanum" value="<?php echo $res1autonumber; ?>">
