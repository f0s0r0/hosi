    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<form name="form1" id="form1" method="post" action="theaterreport.php">	
          ...
          <td width="206" align="left" valign="center"  bgcolor="#ffffff" class="bodytext31"><input name="ADate1" id="ADate1" value="<?php echo $transactiondatefrom; ?>"  size="10"  readonly="readonly" onKeyDown="return disableEnterKey()" />
			<img src="images2/cal.gif" onClick="javascript:NewCssCal('ADate1')" style="cursor:pointer"/>			</td>
          <td width="175" align="left" valign="center"  bgcolor="#FFFFFF" class="style1"><span class="bodytext31"><strong> Date To </strong></span></td>
          <td width="237" align="left" valign="center"  bgcolor="#ffffff"><span class="bodytext31">
            <input name="ADate2" id="ADate2" value="<?php echo $transactiondateto; ?>"  size="10"  readonly="readonly" onKeyDown="return disableEnterKey()" />
			<img src="images2/cal.gif" onClick="javascript:NewCssCal('ADate2')" style="cursor:pointer"/>
		  </span></td>
          </tr>
		  <tr>
  			  <td width="150" height="28" align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3">Location</td>
...
if ($cbfrmflag1 == 'cbfrmflag1')
{
	...
	//$transactiondateto = $_REQUEST['ADate2'];
			...
			$querynw1 = "select * from ip_otrequest where locationcode='$locationcode1'";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
...
?>
		...
		$query1 = "select * from ip_otrequest where locationcode='$locationcode1' ";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		...
		if($opadmissiondoctor == '')
		{
			...
			$query6 = "select * from master_doctor where locationcode='$locationcode1' and auto_number = '$consultingdoctor' ";
			$exec6 = mysql_query($query6) or die ("Error in Query6".mysql_error());
			$res6 = mysql_fetch_array($exec6);
			$opadmissiondoctor = $res6['doctorname'];
		}
		
		$query5 = "select * from master_ippackage where locationcode='$locationcode1' and auto_number='$package'";
		...
		{
			$query4 = "select * from ip_discharge where locationcode='$locationcode1' and patientcode='$patientcode' and visitcode='$visitcode' ";
