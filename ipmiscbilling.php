...
<body>
<form name="form1" id="frmsales" method="post" action="ipmiscbilling.php" onKeyDown="return disableEnterKey(event)" onSubmit="return validcheck()">
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
				        ...
				        <tr>
				   <td colspan="11" align="left" valign="middle"  bgcolor="#CCCCCC" class="bodytext3"><span class="bodytext32"><strong>IP Misc Billing </strong> </span></td>
		        </tr>
				<tr id="reffid">
				   ...
				   <input name="searchaccountnamess" type="hidden" id="searchaccountnamess" size="30">
