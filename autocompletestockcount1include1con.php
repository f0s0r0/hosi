...
$query1 = "select sum(quantity) as sumsales from pharmacysales_details where itemcode = '$res1itemcode' and  recordstatus <> 'DELETED' and companyanum = '$companyanum'";
$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
$res1 = mysql_fetch_array($exec1);
$totalsales = $res1['sumsales'];

$query1 = "select sum(quantity) as sumsalesreturn from pharmacysalesreturn_details where itemcode = '$res1itemcode' and  recordstatus <> 'DELETED' and companyanum = '$companyanum'";
$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
$res1 = mysql_fetch_array($exec1);
...
$query1 = "select sum(allpackagetotalquantity) as sumpurchase from purchase_details where itemcode = '$res1itemcode' and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
$res1 = mysql_fetch_array($exec1);

$totalpurchase = $res1['sumpurchase'];

$query1 = "select sum(quantity) as sumpurchasereturn from purchasereturn_details where itemcode = '$res1itemcode' and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
$res1 = mysql_fetch_array($exec1);
...
$query2 = "select sum(transferquantity) as sumtransferadd from master_stock_transfer where itemcode = '$res1itemcode' and companyanum = '$companyanum'";
$exec2 = mysql_query($query2) or die(mysql_error());
$res2 = mysql_fetch_array($exec2);
$totalsumtransferadd = $res2['sumtransferadd'];

$query21 = "select sum(transferquantity) as sumtransferminus from master_stock_transfer where itemcode = '$res1itemcode' and companyanum = '$companyanum'";
