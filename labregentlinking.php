    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="labregentlinking.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
		   <tr>
              <td colspan="8" bgcolor="#CCCCCC" class="bodytext3"><strong> Lab Regent Linking </strong></td>
              </tr>
            <tr>
			
              <td colspan="8" class="bodytext3"><strong> Select Item </strong>
			  <input type="hidden" name="serialnumber" id="serialnumber" value="1">
					  <input type="hidden" name="medicinecode" id="medicinecode" value="">
                        <input name="medicinename" type="text" id="medicinename" size="69" autocomplete="off" onKeyDown="return StateSuggestionspharm4()" onKeyUp="return funcCustomerDropDownSearch4()">
	  ...
	  <tr id="pressid">
				   ...
				   <table id="presid" width="500" border="0" cellspacing="1" cellpadding="1">
                     <tr>
                       <td width="211" class="bodytext3">Lab</td>
			 ...
			 <tr bgcolor="#011E6A">
                      ...
                      <tr>
                        ...
                        <td width="48%" align="left" valign="top" bgcolor="#CCCCCC"  class="bodytext3"><strong>Lab </strong></td>
                        <td width="9%" align="left" valign="top" bgcolor="#CCCCCC"  class="bodytext3"><strong>Edit</strong></td>
                      </tr>
                      <?php
					  $colorloopcount = '';
	    $query1 = "select * from master_labregentlinking where recordstatus <> 'deleted' group by itemcode";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		while ($res1 = mysql_fetch_array($exec1))
		{
		$labcode = $res1['itemcode'];
		$labname = $res1["itemname"];
		...
		?>
                      <tr <?php echo $colorcode; ?>>
						...
						<a href="editlabregentlinking.php?st=edit&&code=<?php echo $labcode; ?>" style="text-decoration:none">Edit</a>						</td>
                      </tr>
                      <?php
		}
		?>
