    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="patientwiseradiologybillsuser.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="3" bgcolor="#CCCCCC" class="bodytext3"><strong>Patient Wise Radiology Bills</strong></td>
...
&nbsp;				<input  value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />-->
		  ...
		  { 
		  $query31 = "select * from billing_paylaterradiology where patientname = '$res21patientfullname' and patientvisitcode = '$res21visitcode' and patientcode = '$res21patientcode'";
		  }
		  else if($res21billtype == 'PAY NOW')
		  {
		  $query31 = "select * from billing_paynowradiology where patientname = '$res21patientfullname' and patientvisitcode = '$res21visitcode' and patientcode = '$res21patientcode'";
		  }
		  $exec31 = mysql_query($query31) or die ("Error in Query31". mysql_error());
		  
		  if($res21billtype == 'PAY LATER')
		  {
		  $query44 = "select * from billing_paylaterradiology where patientname = '$res21patientfullname' and patientvisitcode = '$res21visitcode'";
		  }
		  else if($res21billtype == 'PAY NOW')
		  {
		   $query44 = "select * from billing_paynowradiology where patientname = '$res21patientfullname' and patientvisitcode = '$res21visitcode'";
		  }
