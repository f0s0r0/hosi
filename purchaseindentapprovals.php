...
if ($frm1submit1 == 'frm1submit1')
{
	...
	$remarks = $_REQUEST['remarks'];
		...
		{	
			...
			if ($medicinename != "")// && $dose != "" && $frequency != "" && $days != "" && $quantity != "" && $instructions != "" && $rate != "" && $amount != "")
			{
		       $query43="insert into purchase_indent(date,docno,medicinename,medicinecode,quantity,packagequantity,rate,amount,username,status,remarks,companyanum,location)values
		                 ('$dateonly','$docno','$medicinename','$medicinecode','$reqqty','$pkgqty','$rate','$amount','$username','$status','$remarks','$companyanum','$location')";
				$exec43 = mysql_query($query43) or die(mysql_error());		 
			
				}
				}
				header("location:purchaseindent.php");
				exit;
...
<form name="form1" id="frmsales" method="post" action="purchaseindentapproval.php" onKeyDown="return disableEnterKey(event)">
