...
if (isset($_SESSION["accountnameano"])) { $accountnameano = $_SESSION["accountnameano"]; } else { $accountnameano = ""; }
...
$query6 = "select docno,transactionamount from master_transactionpaylater where accountnameano = '$res21accountnameano' and transactiondate < '$ADate1'  and transactiontype = 'paylatercredit' and patientname='' order by transactiondate desc";
	...
	$openingbalance = $totaldebit -$credit3 -$credit4;	
				...
				?>
            <tr>
            <td colspan="7"  align="left" valign="center" class="bodytext31"><strong>Opening Balance</strong></td>
            <td colspan="1"  align="left" valign="center" class="bodytext31"><strong><?= number_format($openingbalance,2,'.',','); ?></strong></td>
            <td colspan="7"  align="left" valign="center" class="bodytext31"><strong><?= number_format($openingbalance,2,'.',','); ?></strong></td>
            </tr> 
            <?php
