...
if($num3 >0)
{
	...
	$query24 = "select * from purchaseorder_details order by auto_number desc limit 0, 1";
...
<body>
<form method="post" name="form1" action="consolidateindents1.php">
<?php 
$query34="select * from purchase_indent where approvalstatus='approved' and pogeneration='' group by docno";
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <td class="bodytext31" valign="center"  align="center">
	   ...
	   <input type="hidden" name="doccno" value="<?php echo $billnumbercode; ?>">
	    <input type="submit" name="submit" value="Generate PO"></td>
	  </tr>
    </table>
</table>
</form>
