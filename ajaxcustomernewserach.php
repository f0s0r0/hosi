...
$query1 = "select customercode,customerfullname,nationalidnumber,mobilenumber,accountname,dateofbirth,area from master_customer where (customercode like '%$customer%' or customerfullname like '%$customer%' or nationalidnumber like '%$customer%') and status <> 'Deleted'  order by auto_number limit 0, 20";

$query1 = "select customercode,customerfullname,nationalidnumber,mobilenumber,accountname,dateofbirth,area from master_customer where $customersearch and status <> 'Deleted'  order by auto_number limit 0, 20";
