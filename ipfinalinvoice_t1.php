...
echo '<br>shelf:'.$totalshelfamount;
echo '<br>op'.$totalop;
echo '<br>bed'.$totalbedtransferamount;
echo '<br>bedtr'.$totalbedallocationamount;
echo '<br>lab'.$totallab;
echo '<br>ph'.$totalpharm;
echo '<br>rad'.$totalrad;
echo '<br>ser'.$totalser;
echo '<br>pkg'.$packageamount;
echo '<br>ot'.$totalotbillingamount;
echo '<br>dr'.$totalprivatedoctoramount;
echo '<br>amb'.$totalambulanceamount;

echo '<br>hom'.$totaliphomecareamount;
echo '<br>mis'.$totalmiscbillingamount;
echo '<br>dep'.$totaldepositamount;
echo '<br>nhif'.$totalnhifamount;
echo '<br>depref'.$totaldepositrefundamount;
echo '<br>disc'.$totaldiscountamount;
echo '<br>adv'.-$totaladvancedepositamount;
	...
	<tr>
	  <td colspan="3" class="bodytext31" align="right"><strong> Grand Total&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php 
 echo number_format($overalltotal,2,'.',','); //+$copaytotalbed+$totalcopay ?></strong></td>
