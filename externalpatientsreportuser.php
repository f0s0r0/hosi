    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="externalpatientsreportuser.php">
		<table width="634" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="3" bgcolor="#CCCCCC" class="bodytext3"><strong>External patients Report</strong></td>
...
&nbsp;				<input  value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />-->
		  ...
		  $query2 = "select * from billing_external where billdate between '$ADate1' and '$ADate2' order by billdate desc";
		  ...
		  $query3 = "select sum(labitemrate) as labitemrate1 from billing_externallab where patientname = '$res2patientname' and billnumber = '$res2billno'";
		  ...
		  $query4 = "select sum(amount) as amount1 from billing_externalpharmacy where patientname = '$res2patientname' and billnumber = '$res2billno'";
		  ...
		  $query5 = "select sum(radiologyitemrate) as radiologyitemrate1 from billing_externalradiology where patientname = '$res2patientname' and billnumber = '$res2billno'";
		  ...
		  $query6 = "select sum(servicesitemrate) as servicesitemrate1 from billing_externalservices where patientname = '$res2patientname' and billnumber = '$res2billno'";
           ...
           <tr <?php echo $colorcode; ?>>
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="right" 
				...
				<?php if($total6 != 0.00) { ?>
				 <td align="left" valign="center" bgcolor="#E0E0E0" class="bodytext31"><div align="right"><a target="_blank" href="print_externalpatientsreport.php?cbfrmflag1=cbfrmflag1&&ADate1=<?php echo $transactiondatefrom; ?>&&ADate2=<?php echo $transactiondateto; ?>&&user=<?php echo $res21username; ?>"><img src="images/excel-xls-icon.png" width="30" height="30"></a></div></td>
				<?php } ?>
				</tr>
          </tbody>
        </table></td>
