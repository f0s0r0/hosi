    ...
    <td colspan="2" valign="top"><table width="99%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td colspan="2" width="46%">
              ...
              <form name="cbform1" method="post" action="trialbalance1.php">
             ...
             <tr>
                ...
                bgcolor="#FFFFFF" class="bodytext31"> As at Date </td>
                      <td width="54%" align="left" valign="center"  bgcolor="#FFFFFF"><span class="bodytext31">
					    <input type="" name="ADate1" id="ADate1" style="border: 1px solid #001E6A" value="<?php echo $ADate1; ?>"  size="10"  onKeyDown="return disableEnterKey()" />
                        <input name="ADate2" id="ADate2" style="border: 1px solid #001E6A" value="<?php echo $ADate2; ?>"  size="10"  onKeyDown="return disableEnterKey()" />
...
function ledgervalue($parentid,$ADate1,$ADate2,$tbinclude)
{
	...
	{
		/*if($tbinclude == 'tb_accountbank.php' || $tbinclude == 'tb_accountincome.php' || $tbinclude == 'tb_accountar.php' || $tbinclude == 'tb_accountdeposit.php' 
		|| $tbinclude == 'tb_accountdiscount.php')
		{*/
