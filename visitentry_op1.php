...
$location = $_REQUEST['location'];
	...
	$referredfrom = $_REQUEST["referredfrom"];
	...
	$admitid = $_REQUEST["admitid"];
		...
		if($billtype == 'PAY NOW')
	{
		$query3 = "select * from master_visitentry where patientcode = '$patientcode' and  consultationdate = '$consultationdate' and billtype = 'PAY NOW'";
		$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
		$rowcount3 = mysql_num_rows($exec3);
		if ($rowcount3 != 0)
		{
			header ("location:visitentry_op1.php?errorcode=errorcode2failed");
			exit();
		}	
	}
	/*else
	...
	{
	$query211 = "select * from master_visitentry where patientcode = '$patientcode' and billtype = 'PAY LATER' order by auto_number desc limit 0,1";
...
else
{
	...
	$execed = mysql_query($query_edition) or die ("Error in Query2".mysql_error());
	$resed = mysql_num_rows($execed);
	if($resed > 0)
	{
	...
	if ($res2 == 0)
	{
		...
		visitcount,department,consultationdate,consultationtime,consultationfees,patientspent,planfixedamount,planpercentage,patientfullname,paymentstatus,triagestatus,doctorconsultation,age,gender,accountfullname,departmentname,username,consultationrefund,complaint,locationname,locationcode,admitid,smartbenefitno)values('$patientcode','$visitcode','$patientfirstname','$patientmiddlename','$patientlastname','$consultationtype','$consultingdoctor','$consultingdoctorcode','$accountname','$accountexpirydate','$paymenttype','$subtype','$planname','$planexpirydate','$visitlimit','$overalllimit','$availablelimit','$billtype',
		'$visitcount','$department','$consultationdate','$consultationtime','$consultationfees','$patientspent','$planfixedamount','$planpercentageamount','$patientfullname','','completed','completed','$age','$gender','$accname','$departmentname','$username','torefund','$triag','$locationname1','$location','$admitid','$smartbenefitno')";
	...
	else if(($planfixedamount =='0.00' && $planpercentageamount =='0.00') && ($consultationfees =='0'))
	{
	$query2 = "select * from master_visitentry where visitcode = '$visitcode'";
	$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
	$res2 = mysql_num_rows($exec2);
	...
	{
		$query56="insert into master_visitentry(patientcode, visitcode, patientfirstname,patientmiddlename, patientlastname,consultationtype,consultingdoctor,consultingdoctorcode,accountname,accountexpirydate,paymenttype,subtype,planname,planexpirydate,visitlimit,overalllimit,availablelimit,billtype,
		visitcount,department,consultationdate,consultationtime,consultationfees,patientspent,planfixedamount,planpercentage,patientfullname,paymentstatus,triagestatus,age,gender,accountfullname,departmentname,username,complaint,consultationrefund,locationname1,locationcode,admitid,smartbenefitno,referalconsultation)values('$patientcode','$visitcode','$patientfirstname','$patientmiddlename','$patientlastname','$consultationtype','$consultingdoctor','$consultingdoctorcode','$accountname','$accountexpirydate','$paymenttype','$subtype','$planname','$planexpirydate','$visitlimit','$overalllimit','$availablelimit','$billtype',
		'$visitcount','$department','$consultationdate','$consultationtime','$consultationfees','$patientspent','$planfixedamount','$planpercentageamount','$patientfullname','completed','','$age','$gender','$accname','$departmentname','$username','$triag','torefund','$locationname','$location','$admitid','$smartbenefitno','$referredfrom')"; 
		$exec56=mysql_query($query56) or die(mysql_error());
	...
	{
	$query56="insert into master_visitentry(patientcode, visitcode, patientfirstname,patientmiddlename, patientlastname,consultationtype,consultingdoctor,consultingdoctorcode,accountname,accountexpirydate,paymenttype,subtype,planname,planexpirydate,visitlimit,overalllimit,availablelimit,billtype,
		visitcount,department,consultationdate,consultationtime,consultationfees,patientspent,planfixedamount,planpercentage,patientfullname,paymentstatus,triagestatus,age,gender,accountfullname,departmentname,username,complaint,consultationrefund,locationname,locationcode,admitid,smartbenefitno)values('$patientcode','$visitcode','$patientfirstname','$patientmiddlename','$patientlastname','$consultationtype','$consultingdoctor','$consultingdoctorcode','$accountname','$accountexpirydate','$paymenttype','$subtype','$planname','$planexpirydate','$visitlimit','$overalllimit','$availablelimit','$billtype','$visitcount','$department','$consultationdate','$consultationtime','$consultationfees','$patientspent','$planfixedamount','$planpercentageamount','$patientfullname','completed','pendng','$age','$gender','$accname','$departmentname','$username','$triag','torefund','$locationname1','$location','$admitid','$smartbenefitno')";
		$exec56=mysql_query($query56) or die(mysql_error());
		header("location:visitentry_op1.php");
	exit();
	}
	...
	$query56="insert into master_visitentry(patientcode, visitcode, patientfirstname,patientmiddlename, patientlastname,consultationtype,consultingdoctor,consultingdoctorcode,accountname,accountexpirydate,paymenttype,subtype,planname,planexpirydate,visitlimit,overalllimit,availablelimit,billtype,
		visitcount,department,consultationdate,consultationtime,consultationfees,patientspent,planfixedamount,planpercentage,patientfullname,paymentstatus,triagestatus,age,gender,accountfullname,departmentname,username,complaint,consultationrefund,locationname,locationcode,admitid,smartbenefitno)values('$patientcode','$visitcode','$patientfirstname','$patientmiddlename','$patientlastname','$consultationtype','$consultingdoctor','$consultingdoctorcode','$accountname','$accountexpirydate','$paymenttype','$subtype','$planname','$planexpirydate','$visitlimit','$overalllimit','$availablelimit','$billtype',
		'$visitcount','$department','$consultationdate','$consultationtime','$consultationfees','$patientspent','$planfixedamount','$planpercentageamount','$patientfullname','completed','pending','$age','$gender','$accname','$departmentname','$username','$triag','torefund','$locationname1','$location','$admitid','$smartbenefitno')";
		$exec56=mysql_query($query56) or die(mysql_error());
		header("location:visitentry_op1.php");
	exit();
	}
	...
	if ($res2 == 0)
	{
		$query56="insert into master_visitentry(patientcode, visitcode, patientfirstname,patientmiddlename, patientlastname,consultationtype,consultingdoctor,consultingdoctorcode,accountname,accountexpirydate,paymenttype,subtype,planname,planexpirydate,visitlimit,overalllimit,availablelimit,billtype,
		visitcount,department,consultationdate,consultationtime,consultationfees,patientspent,planfixedamount,planpercentage,patientfullname,paymentstatus,triagestatus,age,gender,accountfullname,departmentname,username,consultationrefund,complaint,locationname,locationcode,admitid,smartbenefitno)values('$patientcode','$visitcode','$patientfirstname','$patientmiddlename','$patientlastname','$consultationtype','$consultingdoctor','$consultingdoctorcode','$accountname','$accountexpirydate','$paymenttype','$subtype','$planname','$planexpirydate','$visitlimit','$overalllimit','$availablelimit','$billtype',
		'$visitcount','$department','$consultationdate','$consultationtime','$consultationfees','$patientspent','$planfixedamount','$planpercentageamount','$patientfullname','','','$age','$gender','$accname','$departmentname','$username','torefund','$triag','$locationname1','$location','$admitid','$smartbenefitno')";
		$exec56=mysql_query($query56) or die(mysql_error());
		header("location:visitentry_op1.php");
	exit();
		}
	...
	if ($res2 == 0)
	{
		...
		department,paymenttype,subtype,billtype,accountname,accountexpirydate,planname,planexpirydate,consultationdate,consultationtime,consultationtype,consultationfees,referredby,consultationremarks,complaint,registrationdate,visittype,visitlimit,overalllimit,availablelimit,visitcount,patientspent,planpercentage,planfixedamount,age,gender,accountfullname,itemrefund,departmentname,username,consultationrefund,locationname,locationcode,admitid,smartbenefitno) 
...
{
	$errmsg = 'Patient Already Has Unfinalized Visit. Cannot Proceed With Visit Entry. Save Not Completed.';	
}
if ($errorcode == 'errorcode2failed')
{
	$errmsg = 'Patient Already Has CASH Visit for Today. Cannot Proceed With Visit Entry. Save Not Completed.';	
}
...
function funcDepartmentChange()
{
	...
	?>
		...
		{
		if(document.getElementById("subtype").value == "<?php echo $res43subanum; ?>")
		{
		<?php 
		$loopcount=0;
		?>
		combo.options[<?php echo $loopcount;?>] = new Option ("Select Consultation Type", ""); 
		<?php
		$query10 = "select * from master_consultationtype where department = '$res11departmentanum' and locationcode = '$res4loccode' and subtype = '$res43subanum' AND recordstatus!= 'deleted' and subtype <> '' order by auto_number";
            ...
            <tbody>
              <tr bgcolor="#011E6A">
                ...
                <!--<td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><?php echo $errmgs; ?>&nbsp;</td>-->
                 ...
                 <td colspan="5" bgcolor="#CCCCCC" class="bodytext3" id="ajaxlocation"><strong> Location </strong>
             ...
             <tr>
              ...
              <select name="location" id="location" onChange="locationform(form1,this.value); ajaxlocationfunction(this.value);"  style="border: 1px solid #001E6A;">
                ...
                <input type="hidden" name="locationcodenew" value="<?php echo $res1locationanum; ?>">
				  ...
				  <td width="26%" rowspan="6" align="center" valign="middle"  bgcolor="#E0E0E0"><img width="150" height="150" id="patientimage" src="">
				  <br/> <input type="button" name="imgbtn" id="imgbtn" value="Show Image" onClick="return ShowImage('<?php echo $patientcode; ?>',this.value);"><br/>
				  <div id="fetchbtn" style="display:<?php if($smartap == 1){ echo ""; } else { echo "none"; } ?>">
				  <input name="fetch" type="button"  value="FETCH" <?php if($smartap == 1){ echo ""; } else { echo "disabled"; } ?> class="button" id="fetch" onClick="return funcCustomerSmartSearch()" style="background-color:#FF9900;color:#FFFFFF; font-weight:bold; height:50px; width:100px; cursor:pointer;" /></div></td>
				  </tr>
				<tr>
...
-->
				...
				?>
				  ...
				  <td align="left" valign="middle"  bgcolor="#E0E0E0"><strong>
			<input name="consultingdoctor" id="consultingdoctor" value="OP DOCTOR" />
            <input type="hidden" name="consultingdoctorcode" id="consultingdoctorcode" value="08-8000" />
			<input name="consultingdoctorsearch" id="consultingdoctorsearch" value="" type="hidden" />
				  ...
				  $query52="select * from master_consultationtype where locationcode = '$resultlocationanum' and subtype = '$subtypeanum' and subtype <> '' and recordstatus = ''";
              ...
              <?php  
                ...
                <td align="left" valign="middle"  bgcolor="#E0E0E0"><input name="consultationfees" id="consultationfees" value="" onFocus="return funcVisitEntryPatientCodeValidation1()" size="20" readonly/></td>
                ...
                <td align="left" valign="middle"  bgcolor="#E0E0E0">&nbsp;</td>
				 ...
				 <tr>
				   ...
				   <td align="left" valign="middle"  bgcolor="#E0E0E0"> <input type="text" name="visitlimit" id="visitlimit"  value="<?php echo $visitlimit;?>"></td>
				   <td align="left" valign="middle"  bgcolor="#E0E0E0">&nbsp;</td>
				   <td align="left" valign="middle"  bgcolor="#E0E0E0">&nbsp;</td>
				   <td align="left" valign="middle"  bgcolor="#E0E0E0">&nbsp;</td>
				 </tr>
			 ...
			 <tr id="enabtriag">
				   ...
				   <td colspan="5" align="left" valign="middle"  bgcolor="#E0E0E0"><input type="checkbox" name="triag" id="triag"></td>
			      </tr>
			 
				 
                 <tr>
                 <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><span class="bodytext32">Smart Benefit No </span></td>
				   <td align="left" valign="middle"  bgcolor="#E0E0E0"><input name="smartbenefitno" id="smartbenefitno" value="" size="20"  readonly/></td>
				   <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><span class="bodytext32"><label onClick="return enabtriage();">Admit ID </label></span></td>
				   <td align="left" valign="middle"  bgcolor="#E0E0E0"><input name="admitid" id="admitid" value="" size="20" readonly/></td>
				  <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><span class="bodytext32">Referred From </span></td>
				   <td align="left" valign="middle"  bgcolor="#E0E0E0"><input type="text" name="referredfrom" id="referredfrom" /></td>
				   </tr>
				   <tr>
				   <td colspan="5" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"></td>
                <td align="middle"  bgcolor="#E0E0E0"><div align="left"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
                  <input type="hidden" name="frmflag1" value="frmflag1" />
                  <input type="hidden" name="loopcount" value="<?php echo $i - 1; ?>" />
                  <input name="Submit222" type="submit"  value="Save Visit Entry (Alt+S)" accesskey="s" class="button" id="submit" onClick="return expirydatewarning()"/>
