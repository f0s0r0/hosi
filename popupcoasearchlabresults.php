...
<script type="text/javascript" src="js/autocoasearchlabresults.js"></script>
...
function escapekeypressed(e)
{
	...
	if(key == '13') //up arrow key press
	{
		...
		if (!isNaN(varActiveElementNumber)) //to prevent losing focus to submit2.
		{
			...
			//alert (varCustomerNameCatch);
			window.opener.document.getElementById("result"+i+"").value = varCoaCatch;
							window.opener.document.getElementById("result"+i+"").focus();
...
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
    <tbody>
      <tr bgcolor="#011E6A">
        <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Search Values </strong></td>
      </tr>
      <tr>
