		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
           <tr bgcolor="#011E6A">
			...
			$querycop = "select lab_copay,radiology_copay,service_copay,pharmacy_copay,bed_copay,nursing_copay,rmo_copay,package_copay,misc_copay,ambulance_copay,mortuary_copay,admission_copay from master_copayaccount where accountnameano='$accountnum' and recordstatus <>'DELETED'";
			...
			$copayyes = $lab_copay+$radiology_copay+$service_copay+$pharmacy_copay+$bed_copay+$nursing_copay+$rmo_copay+$package_copay+$misc_copay+$ambulance_copay+$mortuary_copay+$admission_copay;
...
$consultationfee_less = $consultationfee - $admissionratecopay;
		?>
			  <tr <?php echo $colorcode; ?>>
			 ...
			 <td class="bodytext31" valign="center"  align="left"><div align="left"><?php echo 'Admission Charge'; ?></div></td>
			     <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo '1'; ?></div></td>
				  	 <input type="hidden" name="admissionchargerate[]" id="admissionchargerate" value="<?php echo $consultationfee_less; ?>">
			 <input type="hidden" name="admissionchargeamount[]" id="admissionchargeamount" value="<?php echo $consultationfee_less; ?>">
			
	
                <td class="bodytext31" valign="center"  align="left"><div align="right"><?php echo number_format($consultationfee_less,2,'.',','); ?></div></td>
				 <td class="bodytext31" valign="center"  align="left"><div align="right"><?php echo number_format($consultationfee_less,2,'.',','); ?></div></td>
           	</tr>
 ...
 <?php if($bcopay > 0) { ?>
		   <tr <?php echo $colorcode; ?>>
									...
									<td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $consultationdate; ?></div></td>
									<td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $refno; ?></div></td>
									<td class="bodytext31" valign="center"  align="left"><div align="left"><?php echo 'Admission Charge'; ?> Copay</div></td>
									<td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo '1'?></div></td>
									<td class="bodytext31" valign="center"  align="left"><div align="right"><?php echo number_format($admissionratecopay,2,'.',','); ?></div></td>
									<td class="bodytext31" valign="center"  align="left"><div align="right"><?php echo number_format($admissionratecopay,2,'.',','); ?></div></td>
								</tr>   
					   <?php
					   }
...
$consultationfee_less = $consultationfee - $admissionratecopay;
			...
			?>
			 ...
			 <input type="hidden" name="admissionchargeamount[]" id="admissionchargeamount" value="<?php echo $consultationfee_less; ?>">
                ...
                <td class="bodytext31" valign="center"  align="left"><div align="right"><?php echo number_format($consultationfee_less,2,'.',','); ?></div></td>
				 <td class="bodytext31" valign="center"  align="left"><div align="right"><?php echo $consultationfee_less; ?></div></td>
           	</tr>
...
$deposit_total=abs($totaldepositamount)-abs($totaldepositrefundamount)+abs($totaladvancedepositamount);
 ...
 $total_copay=(abs($copaytotalbed+$totalcopay+$totaldepositamount-$totaladvancedepositamount)<0.5)?0:abs($copaytotalbed+$totalcopay+$totaldepositamount-$totaladvancedepositamount);
	...
	<tr>
	  <td colspan="3" class="bodytext31" align="right"><strong> Grand Total &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo number_format($grandtotal,2,'.',','); ?></strong></td>
	...
	<tr>
	  <td colspan="3" class="bodytext31" align="right"><strong> Deposit Total &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo number_format($deposit_total,2,'.',','); ?></strong></td>
	     <td class="bodytext31" align="center">&nbsp;</td>
	     <td class="bodytext31" align="center">&nbsp;</td>
		 <td class="bodytext31" align="center">&nbsp;
		 </td>
	...
	<tr>
	  <td colspan="3" class="bodytext31" align="right"><strong> Net Payable&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo number_format($grandtotal-$deposit_total-$overalltotal,2,'.',','); ?></strong></td>
	     <td class="bodytext31" align="center">&nbsp;</td>
	     <td class="bodytext31" align="center">&nbsp;</td>
		 <td class="bodytext31" align="center">&nbsp;
		 <input type="hidden" name="totalcopay" id="totalcopay" value="<?php echo number_format($total_copay,2,'.',''); ?>">
		...
		if($totalcopay > 0) { ?>
		<tr>
	  <td colspan="3" class="bodytext31" align="right"><strong> Copay&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo number_format($total_copay,2,'.',','); ?></strong></td>
	     <td class="bodytext31" align="center">&nbsp;</td>
	     <td class="bodytext31" align="center">&nbsp;</td>
		 <td class="bodytext31" align="center">&nbsp;</td>
		</tr>
