...
while ($res2 = mysql_fetch_array($exec2))
{
	...
	$visitdays = floor($datediff/(60*60*24));
	 ...
	 $query66 = "select * from master_consultationtype where locationcode = '$location' and department = '1'  and recordstatus = ''";
