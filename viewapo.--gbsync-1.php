...
if($medicinename != '')
{
			...
			$query45 = "select * from master_itemtosupplier where itemcode='$medicinecode'";
			...
			if ($medicinename != "")
			{
		       $query43="insert into purchaseorder_details(billdate,billnumber,itemname,itemcode,quantity,packagequantity,rate,totalamount,username,recordstatus,companyanum,suppliername,suppliercode)values
		                 ('$currentdate','$pono','$medicinename','$medicinecode','$reqqty','$pkgqty','$rate','$amount','$username','autogenerated','$companyanum','$suppliername','$suppliercode')";
			...
			?>
              ...
              <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $sno = $sno + 1; ?></div></td>
			   <td class="bodytext31" valign="center"  align="left">
				...
				<td class="bodytext31" valign="center"  align="left"> <div align="center"><input type="text" size="6" name="amount" id="amount<?php echo $sno ;?>" value="<?php echo $amount?>" class="bal" readonly="readonly"></div></td>
