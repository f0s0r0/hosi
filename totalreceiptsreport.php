...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
	    <tr>
	 <td width="860">
              <form name="cbform1" method="post" action="totalreceiptsreport.php">
                <table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                    <tr>
              <td colspan="4" bgcolor="#cccccc" class="bodytext31">
                <div align="left"><strong>Total Receipts List </strong></div></td>
			    </tr>
					<tr>
	  ...
	  <tr><form action="totalreceiptsreport.php" name="checklist" method="post">
        <td><table width="600" height="80" border="0" 
          ...
          <tbody>
			...
			$sno = '';
			$totalamount = '0.00';
			$query1 = "select * from master_transactionpaylater where transactiondate between '$ADate1' and '$ADate2' and transactionmodule = 'PAYMENT' and recordstatus <> 'deallocated' group by docno";
			$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
			
			while ($res1 = mysql_fetch_array($exec1))
			{
			$accountname = strtoupper($res1['accountname']);
			$docno = $res1['docno'];
			$transactiondate =$res1['transactiondate'];
			
			$query2 = "select sum(transactionamount) as transactionamount from master_transactionpaylater where transactiondate between '$ADate1' and '$ADate2' and docno = '$docno' and transactionmodule = 'PAYMENT' and recordstatus <> 'deallocated'";
			...
			$query3 = "select * from receiptsub_details where transactiondate between '$ADate1' and '$ADate2' and transactionmodule = 'EXPENSE' group by docnumber";
			$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
			
			while ($res3 = mysql_fetch_array($exec3))
			{
			$accountcode = strtoupper($res3['receiptcoa']);
			$docno = $res3['docnumber'];			
			$transactiondate =$res3['transactiondate'];	
								
			$query4 = "select sum(transactionamount) as transactionamount from receiptsub_details where transactiondate between '$ADate1' and '$ADate2' and docnumber = '$docno' and transactionmodule = 'EXPENSE'";
