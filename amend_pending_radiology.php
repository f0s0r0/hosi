...
<body>
<?php $querynw1 = "select * from consultation_radiology where resultentry='pending' and paymentstatus = 'pending' group by patientvisitcode order by consultationdate DESC";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
		  <form name="cbform1" method="post" action="amend_pending_radiology.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong>Amend Pending Radiology</strong></td>
			</tr>
			<tr>
          ...
          <tbody>
		   ...
		   $patientaccountname=$res1['accountname'];
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left"><a href="amendradiology.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>"><strong>Amend</strong></a>			  </td>
              </tr>
			<?php
			}    
			?>
			 <?php
			 $query11 = "select * from consultation_radiology where patientcode like '%$patientcode1' and patientvisitcode like '%$visitcode1%' and patientname like '%$patientname1%' and resultentry='pending' and consultationdate between '$ADate1' and '$ADate2' and paymentstatus = 'completed' and billtype = 'PAY LATER' and locationcode = '$location' group by patientvisitcode order by consultationdate DESC";
