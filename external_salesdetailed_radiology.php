...
<tr>
  ...
  $newamount=0;
		  ...
		  $querypaynow="select radiologyitemrate as amount,patientcode,patientvisitcode,patientname,billdate,radiologyitemname from  billing_externalradiology where billdate between '$ADate1' and '$ADate2' and locationcode='$locationcode1' and  patientvisitcode ='walkinvis' ";
