  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <tr>
        	<td colspan="2">
            	<form name="cbform1" method="post" action="pharmacyitemsbylocation.php" onSubmit="return checkfunction()">
                <table width="436" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                   <tr bgcolor="#011E6A">
              <td width="183" colspan="1" bgcolor="#CCCCCC" class="bodytext3"><strong> Search Pharmacy Item By Location</strong></td>
            ...
            <tr>
              <td>
                ...
                <table width="1300" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><span class="bodytext32"><strong>Pharmacy Item Master - Existing List - Latest 100 Pharmacy Items </strong></span></td>
						...
						if($searchflag1 != 'searchflag1'){
							...
							*/
						//	$location = $locationcode.'_rateperunit';
					$query111 = "select * from master_medicine where   status <> 'deleted' group by itemcode order by auto_number desc"; 
			 ...
			 { 
			  ?>	 
				 <td align="left" valign="center" bgcolor="#E0E0E0" class="bodytext31" ><a target="_blank" href="print_pharmacyitemsbylocation.php?cbfrmflag1=cbfrmflag1&&locationcode=<?php echo $locationcode; ?>"><img src="images/excel-xls-icon.png" width="30" height="30"></a></td>
              <?php
		      }
		   ?>
                      </tr>
                      ...
                      <tr bgcolor="#011E6A">
                        ...
                        <td width="27%" bgcolor="#CCCCCC" class="bodytext3"><strong>Itemname</strong></td>
                       <!-- <td width="4%" bgcolor="#CCCCCC" class="bodytext3"><strong>Unit</strong></td>-->
                        <td width="9%" bgcolor="#CCCCCC" class="bodytext3"><strong>Purchase Price</strong></td>
                       ...
                       <!-- <td width="9%" bgcolor="#CCCCCC" class="bodytext3"><div align="center"><strong>Tax%</strong></div></td>-->
                          ...
                          <td width="10%" bgcolor="#CCCCCC" class="bodytext3"><div align="center"><strong>Selling Price</strong></div></td>
                           <td width="10%" bgcolor="#CCCCCC" class="bodytext3"><div align="center"><strong>ROL</strong></div></td>
 	 ...
 	 $query1 = "select * from master_medicine where itemname like '%$search1%' or categoryname like '%$search1%' and status <> 'deleted' group by itemcode order by auto_number desc LIMIT 100";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
	...
	$query1 = "select * from master_medicine where  status <> 'deleted' group by itemcode order by auto_number desc LIMIT $start , $limit";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
