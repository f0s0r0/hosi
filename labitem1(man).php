...
/*function locationratefun(frm,lcount)
{
	//alert(lcount);
	var ifcount=0;
	var lcheck='lcheck';
...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
 ...
 <tr>
      ...
      <tr>
	   <td width="9%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">&nbsp;</td>
        <td width="10px" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3" ><input type="checkbox" name="lcheck<?php echo $incr;?>" id="lcheck<?php echo $incr;?>" style="float:left" value="<?php echo $incr;?>"><input type="hidden" name="checklocval" value=<?php echo $locationcode;?>"">
        &nbsp;<span style="width:100px;float:left;line-height:20px"><?php echo $locationname;?></span>&nbsp;<input type="text" style="width:90px;"></td>
	  </tr> 
      <?php }?><input type="text" name="locationcount" value="<?php echo  $incr;?>">
					 <tr>
