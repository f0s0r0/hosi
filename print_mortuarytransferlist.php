...
<tr></tr>
   ...
   <table width="654" height="768" align="center" cellpadding="0" cellspacing="0"bborder="1" >
   <tr>
   
			  <td colspan="4" align="center" valign="center"  class="bodytext3" ><b><u>TRANSFER FORM</u></b></td>
			  
			  </tr>
			  <tr>
			  <td align="left" valign="middle" class="bodytext3" ><strong>Place of Transfer :</strong></td>
              
			  <td><?php echo $placeoftransfer;?></td>
              </tr>
			  <tr>
			 ...
			 <td colspan="1" align="left" valign="middle" class="bodytext3"  width="158"><strong>Other Comments:</strong></td>
			  ...
			  <tr>
			  <td width="150" height="24" colspan="">Shirt/tshirt</td>
              ...
              <tr>
			  <td height="24" colspan="1" align="left">Trousers/short</td>
			  ...
			  <td height="26" colspan="" align="left">Socks</td>
              ...
              <tr>
			  <td height="24" align="left">Blouse</td>
			  ...
			  <tr>
			  <td height="23" colspan="4" align="left" valign="middle" class="bodytext3" ><strong>Jewellery:</strong></td>
			  </tr>
			  <tr>
			  <td height="24" >Rings</td>
              ...
              <tr>
			  <td height="25"  align="left">Necklace</td>
			  ...
			  <tr>
			  <td colspan="4" align="left" valign="middle" class="bodytext3" ><strong>Wallet:</strong></td>
			  </tr>
			  ...
			  <tr>
			  <td height="25" >DrivingLicense</td>
              ...
              <tr>
              <td height="23" colspan="" align="left">Cash</td>
             ...
             >&nbsp;</td>
               ...
               >&nbsp;</td>
                ...
                <tr>
				<td  width="158" height="25"  align="left" valign="middle" class="bodytext3"><strong>Relationship:</strong></td>
				...
				<tr>
				<td height="26"  align="left" valign="left" class="bodytext3"><strong>Witness Telephone:</strong></td>
