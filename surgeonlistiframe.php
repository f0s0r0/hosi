...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
		<form name="cbform1" method="post" action="surgeonlistiframe.php">
		<table width="637" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong>Surgeon List</strong></td>
            </tr>
            <tr>
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="644" 
            align="left" border="0">
          <tbody>
          <tr>
			...
			if($num11 > 0)
		{
            ...
            <tr <?php echo $colorcode; ?>>
				  <td class="bodytext31" valign="center"  align="left">
					   <div>
						   <a class="linking" target="_parent" href="surgeonconsultationform.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>">
			...
			{
			$query12 = "select * from consultation_departmentreferal where patientvisitcode='$visitcode1' and referalcode = '5' and consultation = '' and paymentstatus = 'completed'";
		...
		if($num12 > 0)
		{
			...
			?>
             <tr <?php echo $colorcode; ?>>
				  <td class="bodytext31" valign="center"  align="left">
					   <div>
						   <a class="linking" target="_parent" href="surgeonconsultationform.php?patientcode=<?php echo $patientcode1; ?>&&visitcode=<?php echo $visitcode1; ?>">
			...
			if($referalbill == '')
			{
			$query12 = "select * from consultation_departmentreferal where patientvisitcode='$visitcode1' and referalcode = '5' and consultation = ''";
			$exec12 = mysql_query($query12) or die(mysql_error());
			$num12 = mysql_num_rows($exec12);
