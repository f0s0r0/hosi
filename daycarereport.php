...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><form name="cbform1" method="post" action="daycarereport.php">
          <table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong>Day Care Report </strong></td>
              </tr>
	  ...
	  <tr>
        <td>
	<form name="form1" id="form1" method="post" action="daycarereport.php">	
...
$querynw1 = "select * from master_triage where daycare='1' and registrationdate between '$fromdate' and '$todate' order by auto_number desc";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
			$execnw1 = mysql_query($querynw1) or die ("Error in Querynw1".mysql_error());
			$resnw1=mysql_num_rows($execnw1);
	
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="1077" 
            align="left" border="0">
          <tbody>
             <tr>
			 <td colspan="7" bgcolor="#cccccc" class="bodytext31"><div align="left"><strong>Day Care Report </strong><label class="number"><<<?php echo $resnw1;?>>></label></div></td>
			 </tr>
            <tr>
              <td width="3%"  align="left" valign="center" 
                ...
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Admitted By</strong></div></td>
				<td width="19%"  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Discharged By</strong></div></td>
             </tr>
           <?php
		
		$query1 = "select * from master_triage where daycare='1' and registrationdate between '$fromdate' and '$todate' order by auto_number desc";
	    ...
	    $admittedby=$res1['user'];
		
		$query61 = "select * from dc_discharge where visitcode='$visitcode'";
		$exec61 = mysql_query($query61) or die(mysql_query());
		$res61 = mysql_fetch_array($exec61);
		$dischargedby = $res61['username'];
		...
		$colorloopcount = $colorloopcount + 1;
			...
			<td class="bodytext31" valign="center"  align="left"><div align="left"><?php echo strtoupper($admittedby); ?></div>                  </td>
			<td class="bodytext31" valign="center"  align="left"><div align="left"><?php echo strtoupper($dischargedby); ?></div>                  </td>
			</tr>
		   <?php 
		   } 
