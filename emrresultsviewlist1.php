    ...
    <td width="97%" valign="top"><table width="80%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
      	  ...
      	  <form name="form1" id="form1" method="post" action="emrresultsviewlist1.php" onKeyDown="return disableEnterKey(event)" onSubmit="return process1()">
      <table width="69%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="860"><table width="800" height="213" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
              ...
              <tr>
                ...
                <td width="15%" align="left" valign="center"  bgcolor="#ffffff" class="bodytext3"><input name="ADate1" id="ADate1" style="border: 1px solid #001E6A" value="<?php echo $transactiondatefrom; ?>"  size="10"  readonly="readonly" onKeyDown="return disableEnterKey()" />
              ...
              <tr>
                <td height="32" align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext3">&nbsp;</td>
                <td colspan="3" align="left" valign="center"  bgcolor="#ffffff" class="bodytext3">&nbsp;</td>
              </tr>
              <tr>
                <td height="32" colspan="4" align="left" valign="center"  
...
<?php				
			...
			?>
				<table width="736" border="1">
                  ...
                  <tr>
                    <td width="275">Visit Code </td>
                    <td width="445">Date</td>
                  </tr>
				  <?php
				  $query1 = "select * from master_visitentry where patientcode = '$searchpatientcode'";
                  ...
                  <tr>
                    ...
                    <td><a href="labresultsview.php?patientcode=<?php echo $searchpatientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&docnumber=<?php echo $labdocnumber; ?>" target="_blank">View</a>&nbsp;</td>
                  </tr>
				  <?php
				  }
				  ?>
				  <?php
				  $query2 = "select * from resultentry_radiology where patientvisitcode = '$visitcode' group by itemname";
				  $exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
				  while ($res2 = mysql_fetch_array($exec2))
				  {
				  ...
				  ?>
                  <tr>
                    <td><?php echo $radiologytestname; ?>&nbsp;</td>
                    <td><a href="labresultsview.php?patientcode=<?php echo $searchpatientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&docnumber=<?php echo $radiologydocnumber; ?>" target="_blank">Download</a></td>
                  </tr>
				  <?php
				  }
				  ?>
