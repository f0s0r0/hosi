...
$query8="select * from master_employee where username = '$orderedby' ";
...
<?php //include('a4pdfheader.php'); ?>
  <table width="520" cellspacing="0" cellpadding="1" border="0">
	     <tr>
			...
			<img src="logofiles/<?php echo $companyanum;?>.jpg" width="65" height="100" />
    ...
    <table width="519" border="0" cellpadding="1" cellspacing="2">
	  ...
	  <?php
	  $pendingtest = '';
	  $query68 = "select labitemname from ipconsultation_lab where patientcode = '$patientcode' and patientcode <> 'walkin' and patientvisitcode = '$visitcode' and resultentry <> 'completed' and labitemcode not in (select itemcode from ipresultentry_lab where patientcode = '$patientcode' and patientcode <> 'walkin' and patientvisitcode = '$visitcode')  order by labitemname";
	...
	$refcomments = str_replace('border="1"','border="0"',$refcomments);		
	 ...
	 <tr>
      ...
      <tr>
        ...
        <td width="172">&nbsp;<?php echo strtoupper($res41jobdescription); ?></td>
