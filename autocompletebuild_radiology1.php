...
$stringbuild1 = "";
$query1 = "select * from master_radiology where status <> 'Deleted' AND locationcode = '".$locationcode."' AND rateperunit <> 0 order by itemname";
...
$filefolder = 'js';
$filename = 'autocomplete_radiology1.'.'js';
