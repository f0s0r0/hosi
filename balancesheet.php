...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
          ...
          <tbody>
            <tr bgcolor="#011E6A">
             ...
             <tr>
                ...
                bgcolor="#FFFFFF" class="bodytext31"> As at Date </td>
                      <td width="54%" align="left" valign="center"  bgcolor="#FFFFFF"><span class="bodytext31">
					    <input type="hidden" name="ADate1" id="ADate1" style="border: 1px solid #001E6A" value="<?php echo $ADate1; ?>"  size="10"  readonly="readonly" onKeyDown="return disableEnterKey()" />
 ...
 <td width="54%" valign="top"><table width="600" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
			...
			//echo $ADate2;
			  ...
			  $snocount = "";
			$query1 = "select accountsmain,auto_number,section from master_accountsmain where recordstatus <> 'deleted' and section IN ('L') order by accountsmain desc";
			$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
			while($res1 = mysql_fetch_array($exec1))
			{  
			$accountsmain = $res1['accountsmain'];
			...
			<tr bgcolor="#999999">
			<td width="695" align="left" class="bodytext3" style="color:#000000"><strong>Total :</strong></td>
			<td width="100" align="right" class="bodytext3" style="color:#000000"><strong><?php $groupright12 = groupright(0); $groupright12 = $groupright12+$netpandl; echo number_format($groupright12,2,'.',','); ?></strong>&nbsp;&nbsp;</td>
			</tr>
			<?php
			if (isset($_REQUEST["cbfrmflag1"])) { $cbfrmflag1 = $_REQUEST["cbfrmflag1"]; } else { $cbfrmflag1 = ""; }
			//$cbfrmflag1 = $_REQUEST['cbfrmflag1'];
			...
			?>
			<tr>
			<td colspan="2" align="right"><a href="balancesheetxl.php?ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2; ?>" target="_blank"><img  width="40" height="40" src="images/excel-xls-icon.png" style="cursor:pointer;"></a></td>
			</tr>
			<?php
			}
			?>
