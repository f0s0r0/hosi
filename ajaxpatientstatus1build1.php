...
$stringbuild1 = "";
$query1 = "select * from master_visitentry where patientfullname like '%$searchsuppliername1%' and recordstatus = '' group by visitcode order by auto_number desc limit 0,10";// order by subtype limit 0, 15";
