    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="882" 
            align="left" border="0">
          <tbody>
		  <tr>
          	<td colspan="12">
            	<form name="cbform1" method="post" action="expenseentryreport.php" >
		  ...
		  <!--<tr bgcolor="red">
            ...
            <tr bgcolor="#011E6A">
              <td colspan="3" bgcolor="#CCCCCC" class="bodytext3"><strong> Expense Entry </strong></td>
		 ...
		 <tr>
			  ...
			  <div align="left"><strong>Expense Entry</strong></div></td>
              </tr>			
            <tr>
		...
		$query34="select * from expensesub_details where transactiondate between '$ADate1' and '$ADate2' group by docnumber order by auto_number";
		$exec34=mysql_query($query34) or die(mysql_error());
		while($res34=mysql_fetch_array($exec34))
			{
			$date=$res34['transactiondate'];
			$user=$res34['username'];
			$pono=$res34['docnumber'];
			$remarks=$res34['remarks'];
			$payee=$res34['payee'];
			$totalamount=$res34['transactionamount'];
			...
			?>
              ...
              <td class="bodytext31" valign="center"  align="left"><div align="left"><?php echo $sno = $sno + 1; ?></div></td>
			   <td class="bodytext31" valign="center"  align="left">
			    <div align="left"><?php echo $date; ?></div></td>
				<td class="bodytext31" valign="center"  align="left">
			    <div align="left"><?php echo $pono; ?></div></td>
				<td class="bodytext31" valign="center"  align="left">
			    <div align="left"><?php echo $remarks.' - '.$payee; ?></div></td>
		        <td class="bodytext31" valign="center"  align="right">
			  <div class="bodytext31" align="right"><?php echo $totalamount; ?></div></td>
				<td class="bodytext31" valign="center"  align="right">
			  <div class="bodytext31" align="center"><a href="print_expense_receipt1.php?receiptanum=<?php echo $anum; ?>" target="_blank"><strong>Print</strong></a></div></td>
                </tr>
			  <?php
			}
			?>
