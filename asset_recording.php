            ...
            <tr>
              <td><form name="form1" id="form1" method="post" action="asset_recording.php" onSubmit="return addward1process1()">
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="" bgcolor="#CCCCCC" class="bodytext3"><strong>Asset Recording </strong></td>
				...
				?>
					  ...
					  <tr>
						...
						<?php if($asset_department != '') { ?>
						<option value="<?php echo $asset_department; ?>"><?php echo $asset_department; ?></option>
						<?php } ?>
					  ...
					  <tr>
					   ...
					   <tr>
						...
						<option value="<?php echo $dep_percent.'||'.$asset_category; ?>"><?php echo $asset_category; ?></option>
						<?php } ?>
						<option value="">Select</option>
						<?php 
