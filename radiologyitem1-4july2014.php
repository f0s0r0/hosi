...
if ($frmflag1 == 'frmflag1')
{
	...
	if ($length1<25 && $length2<255)
	{
		...
		$query2 = "select * from master_radiology where itemcode = '$itemcode'";// or itemname = '$itemname'";
		$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
		$res2 = mysql_num_rows($exec2);
		if ($res2 == 0)
		{
			$query1 = "insert into master_radiology (itemcode, itemname, categoryname, itemname_abbreviation, rateperunit, expiryperiod, taxanum, taxname, ipaddress, updatetime, description, purchaseprice, referencevalue,ipmarkup,location,rate2) 
			values ('$itemcode', '$itemname', '$categoryname', '$itemname_abbreviation', '$rateperunit', '$expiryperiod', '$taxanum', '$res4taxname', '$ipaddress', '$updatedatetime','$description', '$purchaseprice', '$referencevalue','$ipmarkup','$location','$rate2')";
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td><form name="form1" id="form1" method="post" action="radiologyitem1.php" onSubmit="return additem1process1()">
                ...
                <table width="900" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="10" bgcolor="#CCCCCC" class="bodytext3"><span class="bodytext32"><strong>Radiology Item Master - Existing List - Latest 100 radiology Items </strong></span></td>
                      </tr>
                      <tr bgcolor="#011E6A">
                      ...
                      <tr bgcolor="#011E6A">
                        ...
                        <td width="13%" bgcolor="#CCCCCC" class="bodytext3"><strong>Unit</strong>                          <div align="center"><strong><!--Purchase--></strong></div></td>
						...
						<td width="11%" bgcolor="#CCCCCC" class="bodytext3"><div><strong>IP Markup</strong></div></td>
	  ...
	  if ($searchflag1 == 'searchflag1')
	  {
	    ...
	    $query1 = "select * from master_radiology where itemname like '%$search1%' or categoryname like '%$search1%' and status <> 'deleted' order by auto_number desc LIMIT 100";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		while ($res1 = mysql_fetch_array($exec1))
		{
	...
	$query1 = "select * from master_radiology where status <> 'deleted' order by auto_number desc LIMIT 100";
		...
		?>
                ...
                <table width="900" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="10" bgcolor="#CCCCCC" class="bodytext3"><strong>Radiology Item Master - Deleted </strong></td>
                      </tr>
                      <tr bgcolor="#011E6A">
