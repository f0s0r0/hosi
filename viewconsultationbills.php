    ...
    <td width="99%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="791" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Consultation Bills Report </strong></td>
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			if ( $visitcode1 == 10)
			{
			$query2 = "select * from master_billing where  patientfullname like '%$patientfirstname%' and visitcode like '%$visitcode%'and billingdatetime between '$transactiondatefrom' and '$transactiondateto' and  locationcode='$locationcode1'  order by billnumber desc";
