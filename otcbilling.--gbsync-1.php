...
foreach($_POST['medicinename'] as $key=>$value)
		...
		$query53 = "update master_consultationpharm set pharmacybill='completed',paymentstatus='completed',billtype = 'PAY NOW',accountname = 'CASH' where billnumber = '$pharmbillnumber'";
		$exec53 = mysql_query($query53) or die(mysql_error());
		
		$query54 = "update master_consultationpharmissue set paymentstatus='completed',billtype = 'PAY NOW',accountname = 'CASH' where billnumber = '$pharmbillnumber'";
		...
		'$billnumber',  '$billanum', '$ipaddress', '$updatedate', '$balanceamount', '$companyanum', '$companyname', '$remarks', 
		'$transactionmodule','$patientname','walkin','walkinvis','paid','$financialyear','$username','$timeonly','$cashgivenbycustomer','$cashgiventocustomer')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		
		$query37 = "insert into paymentmodedebit(patientname,patientcode,patientvisitcode,billnumber,billdate,ipaddress,username,cash,cashcoa,source)values('$patientname','walkin','walkinvis','$billnumber','$billdate','$ipaddress','$username','$cashamount','$cashcoa','externalbilling')";
        $exec37 = mysql_query($query37) or die(mysql_error());
		
			mysql_query("insert into billing_external(billno,patientname,patientcode,visitcode,totalamount,billdate,age,gender,username,billstatus)values('$billnumber','$patientname','walkin','walkinvis','$totalamount','$dateonly','$age','$gender','$username','otc')") or die(mysql_error());
		...
		'$billnumber',  '$billanum', '$ipaddress', '$updatedate', '$balanceamount', '$companyanum', '$companyname', '$remarks', 
		'$transactionmodule','$patientname','walkin','walkinvis','paid','$financialyear','$username','$timeonly')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		...
		'$remarks', '$transactionmodule','$patientname','walkin','walkinvis','paid','$financialyear','$username','$timeonly')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
	...
	$transactiontype = 'PAYMENT';
		...
		transactionmodule,patientname,patientcode,visitcode,billstatus,financialyear,username,transactiontime,creditcardname) 
		values ('$billdate', '$particulars', 
		'$transactionmode', '$transactiontype', '$totalamount',
		'$cardamount','$cardnumber',  '$billnumber',  '$billanum', 
		 '$bankname', '$ipaddress', '$updatedate', '$balanceamount', '$companyanum', '$companyname', 
		'$remarks', '$transactionmodule','$patientname','walkin','walkinvis','paid','$financialyear','$username','$timeonly','$cardname')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
	   ...
	   $query9 = "insert into master_transactionexternal (transactiondate, particulars, 
		...
		'$chequenumber', '$transactionmodule','$patientname','walkin','walkinvis','paid','$financialyear','$username','$timeonly','$cashgivenbycustomer','$cashgiventocustomer')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		
		$query37 = "insert into paymentmodedebit(patientname,patientcode,patientvisitcode,billnumber,billdate,ipaddress,username,card,cardcoa,cash,cashcoa,cheque,chequecoa,online,onlinecoa,mpesa,mpesacoa,source)values('$patientname','walkin','walkinvis','$billnumber','$billdate','$ipaddress','$username','$cardamount','$cardcoa','$cashamount','$cashcoa','$chequeamount','$chequecoa','$onlineamount','$onlinecoa','$creditamount','$mpesacoa','externalbilling')";
        $exec37 = mysql_query($query37) or die(mysql_error());
...
$execlab=mysql_fetch_array($Querylab);
 ...
 $locationname=$execlab['locationname'];
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
                <tr bgcolor="#011E6A">
                <td colspan="4" bgcolor="#CCCCCC" class="bodytext32"><strong>OTC Billing </strong></td>
                <td colspan="3" bgcolor="#CCCCCC" class="bodytext32"><strong>Location </strong><?php echo $locationname;?></td>
