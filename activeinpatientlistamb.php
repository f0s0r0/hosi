    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
     ...
     <tr>   
		<td width="860">
              ...
              <form name="cbform1" method="post" action="activeinpatientlistamb.php">
	  ...
	  <form name="form1" id="form1" method="post" action="activeinpatientlistamb.php">	
	  <tr>
        <td>
...
?>
	    ...
	    $query59 = "select * from ip_bedallocation where ward='$wardnum' and bed='$bedanum' and locationcode='$searchlocation' and patientname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and recordstatus<>'discharged' order by auto_number desc limit 0, 1";
		...
		$query10 = "select * from master_ipvisitentry where patientcode='$patientcode'  and locationcode='$searchlocation' and discharge<>'discharge' ";
		$exec10 = mysql_query($query10) or die(mysql_error());
		$res10 = mysql_fetch_array($exec10);
		$res10age = $res10['age'];
		$res10gender = $res10['gender'];
	
		$query67 = "select * from ip_bedtransfer where ward='$wardnum' and bed='$bedanum'  and locationcode='$searchlocation' and recordstatus NOT IN ('discharge','transfered') order by auto_number desc limit 0, 1";
		...
		{
		$query592 = "select * from ip_bedtransfer where ward='$wardnum' and bed='$bedanum'  and locationcode='$searchlocation' and patientname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and recordstatus NOT IN ('discharge','transfered') order by auto_number desc limit 0, 1";
			...
			if($num69 > 0)
		{
		   ...
		   $query82 = "select * from master_ipvisitentry where patientcode='$patientcode'  and locationcode='$searchlocation' and visitcode='$visitcode' and discharge<>'discharge'";
