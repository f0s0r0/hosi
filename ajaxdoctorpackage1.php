...
$stringbuild1 = "";
 ...
 $query1 = "SELECT doctorcode,doctorname,pridoc_charge,consultationfees FROM master_doctor WHERE pridoc_charge >0 AND doctorname LIKE '%$doctor%' AND locationcode='".$location."'";
$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
while ($res1 = mysql_fetch_array($exec1))
{
	$doctorcode = $res1['doctorcode'];
	$doctorname = $res1['doctorname'];
	$resdoc_charge = $res1['pridoc_charge'];
