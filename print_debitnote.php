...
$billnumber = $_REQUEST["billno"];
	...
	$query4 = "SELECT * FROM ip_debitnote WHERE patientcode = '$patientcode' AND visitcode = '$visitcode' AND billno = '$billnumber'";
...
<table align="center">
	<tr>
    	<td class="bodyhead" colspan="5">IP DEBIT NOTE</td>
    </tr>
    <tr>
    ...
    <tr>
    	<td class="bodytextbold">Narration:</td>
        <td class="bodytext"><?php // echo $patientaccount1; ?></td>
        <td class="bodytext">&nbsp;</td>
        <td class="bodytext">&nbsp;</td>
        <td class="bodytext"></td>
...
<?php
	$sno = '';
	$query5 = "SELECT * FROM ip_debitnotebrief WHERE patientcode = '$patientcode' AND patientvisitcode = '$visitcode' AND docno = '$billnumber'";
...
//      $html2pdf->setModeDebug();
        ...
        $html2pdf->Output('printdebitnote.pdf');
    }
