    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="servicerevenuereport.php">
                <table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                    <tr bgcolor="#011E6A">
                      <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Services Revenue</strong></td>
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
		  ...
		  <?php
			...
			?>
            <tr>
              <td width="108"  align="left" colspan="2" valign="center" 
...
//IP Discount for services 
		  ...
		  $snocount = $snocount + 1;
           ...
           <tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left"><a href="opsalesdetailed_services.php?locationcode=<?php echo $locationcode1;?>&&adate1=<?php echo $ADate1;?>&&adate2=<?php echo $ADate2;?>&&category=<?= $scategory?>" /><strong>OP Sales</strong></td>
			...
			?>
			<tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left"><a href="ipsalesdetailed_services.php?locationcode=<?php echo $locationcode1;?>&&adate1=<?php echo $ADate1;?>&&adate2=<?php echo $ADate2;?>&&category=<?= $scategory?>" /><strong>IP Sales</strong></td>
               <td class="bodytext31" valign="center"  align="right">
		   ...
		   <?php
			...
			?>
			<tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left"><a href="external_salesdetailed_services.php?locationcode=<?php echo $locationcode1;?>&&adate1=<?php echo $ADate1;?>&&adate2=<?php echo $ADate2;?>&&category=<?= $scategory?>" /><strong>External Sales</strong></td>
               <td class="bodytext31" valign="center"  align="right">
			...
			?>
			<tr <?php echo $colorcode; ?>>
              <td  align="left" valign="center" class="bodytext31"><a href="opreturns_services.php?locationcode=<?php echo $locationcode1;?>&&adate1=<?php echo $ADate1;?>&&adate2=<?php echo $ADate2;?>" /><strong>OP Returns</strong></td>
               <td class="bodytext31" valign="center"  align="right">
          ...
          <?php
			...
			?>
			<tr <?php echo $colorcode; ?>>
              <td  align="left" valign="center" class="bodytext31"><a href="externalreturns_services.php?locationcode=<?php echo $locationcode1;?>&&adate1=<?php echo $ADate1;?>&&adate2=<?php echo $ADate2;?>" /><strong>Ext Returns</strong></td>
               <td class="bodytext31" valign="center"  align="right">
			...
			<tr <?php echo $colorcode; ?>>
              ...
              <td rowspan="2" align="right" valign="center" 
			   bgcolor="#e0e0e0" class="bodytext31"><div align="left"><a target="_blank" href="print_servicesrevenue.php?locationcode=<?php echo $locationcode1; ?>&&ADate1=<?php echo $transactiondatefrom; ?>&&ADate2=<?php echo $transactiondateto; ?>&&category=<?= $scategory?>"><img src="images/excel-xls-icon.png" width="30" height="30"></a></div></td>
               <?php } ?>
