...
$times=$_REQUEST['times'];
	...
	$smear = $_REQUEST['smear'];
	$cpt =  isset($_REQUEST['cpt'])? 'Yes' : 'No';
	$xtratb =  isset($_REQUEST['xtratb'])? 'Yes' : 'No';
	$defaulter =  isset($_REQUEST['defaulter'])? 'Yes' : 'No';
	$hiv = $_REQUEST['hiv'];
	$notreat = $_REQUEST['notreat']? 'Yes' : 'No';
...
$updatedatetime = date('Y-m-d H:i:s');
	...
	if ($res2 == 0)
	{
		...
		if($pairvar111 != "")
		{
		$query69 = "select * from consultation_icd where patientcode='$patientcode' and patientvisitcode='$visitcode' and consultationid='$consultationid' and consultationtime = '$timestamp' and disease = '$pairvar111'";
		$exec69 = mysql_query($query69) or die(mysql_error());
		$num69 = mysql_num_rows($exec69);
		if($num69 == 0)
		{
		$icdquery1 = "insert into consultation_icd(consultationid,patientcode,patientname,patientvisitcode,disease,icdcode,accountname,consultationdate,consultationtime)
		values('$consultationid','$patientcode','$patientfullname','$visitcode','$pairvar111','$pairvar112','$accountname','$currentdate','$timestamp')";
...
$maxanum = $labrefcode;
	...
	$categorylabquery1=mysql_query("insert into consultation_lab(consultationid,patientcode,patientname,patientvisitcode,labitemname,labitemrate,billtype,accountname,consultationdate,paymentstatus,refno,labsamplecoll,resultentry,labrefund)values('$consultationid','$patientcode','$patientfullname','$visitcode','$categorylabname','$categorylabrate','$billingtype','$accountname','$currentdate','$status','$labrefcode','pending','pending','norefund')") or die(mysql_error());
		...
		$labquery1=mysql_query("insert into consultation_lab(consultationid,patientcode,patientname,patientvisitcode,labitemcode,labitemname,labitemrate,billtype,accountname,consultationdate,paymentstatus,refno,labsamplecoll,resultentry,labrefund,urgentstatus,consultationtime)values('$consultationid','$patientcode','$patientfullname','$visitcode','$labcode','$labname','$labrate','$billingtype','$accountname','$currentdate','$status','$labrefcode','pending','pending','norefund','$urgentstatus','$timestamp')") or die(mysql_error());
			}
			}
		}
		...
		if($visitcode!='')
		{
		$query100 = "insert into tbtemplate(consultationid,patientname,patientcode,patientvisitcode,age,gender,smear,cpt,extrapulmonarytb,defaulter,hiv,nooftreatcomp,department,account,subtype,username,recorddate,recordtime,ipaddress)values('$consultationid','$patientfullname','$patientcode','$visitcode','$age','$gender','$smear','$cpt','$xtratb','$defaulter','$hiv','$notreat','$department','$accountname','$subtype','$username','$curdate','$currenttime','$ipaddress')";
		$exec100 = mysql_query($query100) or die(mysql_error());
		}
	    ...
	    $amount = '';
		$consultationstatus = '';
		if($frompage == 'iframetblist')
		{
		header("location:iframetblist.php");
		}
		else
		{
...
$viscode=$_REQUEST['visitcode'];
 ...
 $query67 = "update master_triage set consultation='Inprogress' where patientcode='$patientcode' and visitcode='$viscode'";
 $exec67 = mysql_query($query67) or die(mysql_error());
...
function funcShowView()
{
  if (document.getElementById("disease") != null) 
	...
	if (document.getElementById("disease2") != null) 
	  {
	  document.getElementById("disease2").style.display = '';
	 }
}
...
{		
 ...
 document.getElementById("disease1").style.display = 'none';
	...
	if (document.getElementById("disease2") != null) 
	 {
	document.getElementById("disease2").style.display = 'none';
	}
}
...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top">
     <form name="form1" id="form1" method="post" action="tbconsultationform.php" onKeyDown="return disableEnterKey(event)" onSubmit="return process1();">
          ...
          <td width="103%"><table   border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              ...
              <!--<tr>
				...
				<tr>
				  <td align="left" valign="middle"  bgcolor="#E0E0E0"><span class="bodytext3"><strong>Type</strong></span></td>
				  <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><lable><?php echo $res121paymenttype; ?></label>
				  ...
				  <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><lable><?php echo $res131subtype; ?></lable>
...
-->
				...
				<td colspan="6" align="left" valign="middle"  bgcolor="<?php if ($errmsg == '') { echo ''; } else { echo '#AAFF00'; } ?>" class="bodytext3"><?php echo $errmsg;?>&nbsp;</td>
				 ...
				 <tr bgcolor="">
				  ...
				  <strong>Medical History</strong>
				   ...
				   <td align="left" valign="middle"  bgcolor=""><label class="bodytext32">
				    ...
				    <td align="left" valign="middle"  bgcolor="" class="bodytext3"><span class="bodytext32"><strong>Family History</strong></span></td>
				     <td colspan="3" align="left" valign="middle"  bgcolor="" class="bodytext3"><span class="bodytext32">
				 ...
				 <tr id="consltid">
				  ...
				  <tr id="disease2">
					 ...
					 <td width="89" class="bodytext3"><strong>SMEAR</strong></td>
					 <td width="139" class="bodytext3"><select name="smear" id="smear" >
					 <option value="">Select</option>
					 <option value="positive">Positive</option>
					 <option value="negative">Negative</option>
					 </select>
					 </td>
					 <td width="47" class="bodytext3"><strong>CPT</strong></td>
					 <td width="31" class="bodytext3"><input type="checkbox" name="cpt" value="cpt" id="cpt"></td>
					 <td width="156" class="bodytext3"><strong>EXTRA PULMONARY TB</strong></td>
					 <td width="88" class="bodytext3" align="left"><input type="checkbox" name="xtratb" value="xtratb" id="xtratb"></td>
					 <td width="75" class="bodytext3"><strong>Defaulter</strong></td>
					 <td width="119" class="bodytext3" align="left"><input type="checkbox" name="defaulter" value="defaulter" id="defaulter"></td>
					 
					 </tr>
					 <tr>
					 <td width="89" class="bodytext3"><strong>HIV+</strong></td>
					 <td width="139" class="bodytext3" align="left"><select name="hiv" id="hiv" >
					 <option value="">Select</option>
					 <option value="positive">Positive</option>
					 <option value="negative">Negative</option>
					 </select></td>
					 <td colspan="4" class="bodytext3" align="left"><strong>Treatments completed</strong>&nbsp;&nbsp;&nbsp;
					 <input type="checkbox" name="notreat" value="1" id="notreat"></td>
					 </tr>
					 </table>
					</td>
				  </tr>
		        ...
		        <tr>
				   <td colspan="8" align="right" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><span class="style2"></span><input type="hidden" id="totalr" readonly size="7"></td></tr>
                ...
                <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><input type="checkbox" name="ipadmit" id="ipadmit"></td>
				<td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext32"><div align="center">Notes</div></td>
