...
<body>
<?php $querynw1 = "select * from master_visitentry where paymentstatus = '' order by auto_number desc";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            <tr>
              ...
              <td colspan="7" bgcolor="#cccccc" class="bodytext31"><script language="javascript">
                ...
                <div align="left"><strong>Consultation Billing</strong><label class="number"><<<?php echo $resnw1;?>>></label></div></td>
              </tr>
           ...
           <!-- <tr>
			...
			$colorloopcount = '';
			$sno = '';
			$query1 = "select * from master_visitentry where paymentstatus = '' order by auto_number desc";
			...
			$query2 = "select * from master_doctor where auto_number = '$consultingdoctor'";
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left">
			  <div class="bodytext31" align="center"><?php echo $patientfirstname.' '.$patientmiddlename.' '.$patientlastname; ?></div></td>
              <td class="bodytext31" valign="center"  align="left">
			    <div align="center">
			      <?php echo $consultingdoctorname; ?>			      </div></td>
                <td class="bodytext31" valign="center"  align="left">
			    <div align="center">
			      <?php echo $patientaccountname; ?>			      </div></td>
                  
              
              <td class="bodytext31" valign="center"  align="left"><a href="consultationbilling.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>"><strong>BillNow</strong></a>			  </td>
              </tr>
			<?php
			}    
			?>
