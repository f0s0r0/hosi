...
*/	
	...
	{		
		...
		{ 
			mysql_query("update master_consultationpharmissue set approvalstatus='$pharamapprovalstatus',paymentstatus='completed'  where auto_number='$pharamcheck' and patientvisitcode='$visitcode'");
			mysql_query("update master_consultationpharm set approvalstatus='$pharamapprovalstatus', paymentstatus='completed',pharmacybill='$status'  where auto_number='$pharamcheck' and patientvisitcode='$visitcode'");
			$counter=$counter + 1;
		}
