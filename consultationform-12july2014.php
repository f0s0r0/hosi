...
function process1()
{
	...
	{
	alert("Please Add any Request or Click Back to Exit");
	return false;
	}
...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top">
     <form name="form1" id="form1" method="post" action="consultationform.php" onKeyDown="return disableEnterKey(event)" onSubmit="return process1();">
            ...
            <tbody>
              ...
              <!--<tr>
				...
				<tr>
				  ...
				  <td colspan="2" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><lable><?php echo $res131subtype; ?></lable>
...
-->
				...
				<td colspan="6" align="left" valign="middle"  bgcolor="<?php if ($errmsg == '') { echo ''; } else { echo '#AAFF00'; } ?>" class="bodytext3"><?php echo $errmsg;?>&nbsp;</td>
				 ...
				 <tr id="consltid">
				   <td colspan="4" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><textarea name="consultation"  id="consultation" cols="75"></textarea></td>
			       <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">&nbsp;</td>
			       <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">&nbsp;</td>
				   ...
				   $query667 = "select * from master_consultationlist where patientcode = '$patientcode' and visitcode = '$visitcodenum'";
					$exec667 = mysql_query($query667) or die(mysql_error());
					while($res667 = mysql_fetch_array($exec667))
					{
					$consultationnotes = $res667['consultation'];
					$comconsultationdoctor = $res667['username'];

				 echo $consultationnotes."-".$comconsultationdoctor; 
				 echo "<br />\n";
				 }?>
				   </td>
			       <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">&nbsp;</td>
					...
					<tr>
					 <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">Department</td>
					  <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><span class="bodytext32">
					    <select name="departmentreferal" id="departmentreferal">
