...
if ($frmflag1 == 'frmflag1')
{
	...
	$query4 = "select * from master_tax where auto_number = '$taxanum'";// and cstid='$custid' and cstname='$custname'";
		...
		$res4manufacturername = $res54["manufacturername"];*/
			...
			$query1 = "update master_medicine set itemcode='$itemcode', itemname='$itemname', categoryname='$categoryname', unitname_abbreviation='$res4packagename', packagename='$res4packagename',rateperunit='$rateperunit', expiryperiod='$expiryperiod',
			 ...
			 minimumstock='$minimumstock',maximumstock='$maximumstock',rol='$rol',roq='$roq',ipmarkup='$ipmarkup',spmarkup='$spmarkup',formula='$formula',disease='$disease',pkg='".$pkg."', transfertype = '$transfertype', type = '$medtype' where itemcode='$itemcode'";
	...
	header("location:pharmacyitem1inv.php");
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="editpharmacyiteminv.php" onSubmit="return additem1process1()">
