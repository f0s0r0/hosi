...
else
{
	...
	$patientcodeprefix = isset($_REQUEST["patientcodeprefix"]);
          ...
          <td width="860"><table width="800" height="282" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              ...
              <tr>
                ...
                <td align="left" valign="middle"  bgcolor="#E0E0E0"><input name="patientcodeprefix" id="patientcodeprefix" value="<?php echo $currencydecimalname; ?>" style="border: 1px solid #001E6A;"  size="10" />
			...
			&nbsp;</td>
              ...
              <tr>
                <td align="middle"  bgcolor="#E0E0E0"><span class="bodytext32">Show Logo </span></td>
