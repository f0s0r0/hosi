    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="791" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong> Shiftwise Report By Users</strong></td>
...
//				$ADate2 = date('Y-m-d', strtotime($ADate2 . ' + 1 day'));

//			$query33 = "select * from shift_tracking as st LEFT JOIN master_employeelocation as mel ON st.username = mel.username where mel.locationcode='$locationcode1' and st.username = '$res5username' and st.lastupdate between '$ADate1' and '$ADate2' GROUP BY st.auto_number order by st.auto_number desc";
			$query33 = "select * from shift_tracking as st LEFT JOIN master_employeelocation as mel ON st.username = mel.username where mel.locationcode='$locationcode1' and st.username = '$res5username' and (date(st.shiftstarttime) BETWEEN '$ADate1' AND '$ADate2' or date(shiftouttime) BETWEEN '$ADate1' AND '$ADate2') GROUP BY st.auto_number order by st.auto_number desc";
...
//			$query31 = "select *,st.auto_number as me_auto_number from shift_tracking as st LEFT JOIN master_employeelocation as mel ON st.username = mel.username where mel.locationcode='$locationcode1' and st.username = '$res5username' and st.lastupdate between '$ADate1' and '$ADate2' GROUP BY st.auto_number order by st.auto_number desc";
			$query31 = "select *,st.auto_number as me_auto_number from shift_tracking as st LEFT JOIN master_employeelocation as mel ON st.username = mel.username where mel.locationcode='$locationcode1' and st.username = '$res5username' and (date(st.shiftstarttime) BETWEEN '$ADate1' AND '$ADate2' or date(shiftouttime) BETWEEN '$ADate1' AND '$ADate2') GROUP BY st.auto_number order by st.auto_number desc";
			...
			{
			$res31anum = $res31["me_auto_number"];
			$shiftstarttime = $res31["shiftstarttime"];
			$shiftouttime = $res31["shiftouttime"];
			$res31username = $res31["username"];
			
			$queryamount = "SELECT (sum(`cash`)+sum(`cheque`)+sum(`mpesa`)+sum(`online`)+sum(`card`)) as amount FROM `paymentmodedebit` where username='$res31username' and billdatetime between '$shiftstarttime' and '$shiftouttime'";
			$exeamount = mysql_query($queryamount) or die("Error in queryamount".mysql_error());
			if($resamount = mysql_fetch_array($exeamount))
			{
...
//			if($shiftouttime != "0000-00-00 00:00:00")
            ...
            <tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left" style="font-size:14px;font-weight:bold;color:black;"><?php echo $res31anum; ?></td>
              <td class="bodytext31" valign="center"  align="left">
                <div class="bodytext31"><?php echo $res31username; ?></div>              </td>
              <td class="bodytext31" valign="center"  align="left">
			  <div class="bodytext31"><?php echo $shiftstarttime; ?></div></td>
              <?php  if($shiftouttime != "0000-00-00 00:00:00"){ ?>
              <td class="bodytext31" valign="center"  align="left">
                <div class="bodytext31"><?php echo $shiftouttime; ?></div>              </td>
             
              <td class="bodytext31" valign="center"  align="right">
                <div class="bodytext31"><?php echo number_format($amount,2); ?></div>              </td>
              <td class="bodytext31" valign="center"  align="left">
			    <div align="center">		
					
				  <a href="shiftwisereportdetailed.php?locationcode=<?php echo $locationcode1; ?>&&anum=<?php echo $res31anum; ?>"><span class="bodytext3" >View</span></a>
			...
			$query52 = "select * from master_employee as me LEFT JOIN master_employeelocation as mel ON me.username = mel.username where mel.locationcode='$locationcode1' and me.username = '$searchemployeename' and me.status = 'Active' GROUP BY me.auto_number";
...
//			$query31 = "select st.auto_number,st.shiftstarttime,st.shiftouttime,st.username from shift_tracking as st LEFT JOIN master_employeelocation as mel ON st.username = mel.username where mel.locationcode='$locationcode1' and st.username = '$searchemployeename' and st.lastupdate between '$ADate1' and '$ADate2' GROUP BY st.auto_number order by st.auto_number desc";
			$query31 = "select st.auto_number,st.shiftstarttime,st.shiftouttime,st.username from shift_tracking as st LEFT JOIN master_employeelocation as mel ON st.username = mel.username where mel.locationcode='$locationcode1' and st.username = '$searchemployeename' and (date(st.shiftstarttime)  BETWEEN '$ADate1' AND '$ADate2' or date(shiftouttime) BETWEEN '$ADate1' AND '$ADate2') GROUP BY st.auto_number order by st.auto_number desc";
			$exe31 = mysql_query($query31) or die("Error in Query31".mysql_error());
			$num1 = mysql_num_rows($exe31);
			while($res31 = mysql_fetch_array($exe31))
			{
			...
			?>
            <tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left" tyle="font-size:14px;font-weight:bold;color:black;"><?php echo $res31anum; ?></td>
              <td class="bodytext31" valign="center"  align="left">
                <div class="bodytext31"><?php echo $res31username; ?></div>              </td>
              <td class="bodytext31" valign="center"  align="left">
			  <div class="bodytext31"><?php echo $shiftstarttime; ?></div></td>
