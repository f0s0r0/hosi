...
{
    $bloodgroupanum = $_REQUEST['bloodgroupanum'];
	...
	if ($length<=100)
	{
	$query2 = "select * from master_bloodgroup where auto_number = '$bloodgroupanum'";
	$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
	$res2 = mysql_num_rows($exec2);
	if ($res2 != 0)
	{
	    $query1 = "update master_bloodgroup set bloodgroup = '$bloodgroup', recorddate = '$updatedatetime' 
		where auto_number = '$bloodgroupanum'";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		$errmsg = "Success. New bloodgroup Updated.";
		//$bgcolorcode = 'success';
		header ("location:editbloodgroup.php?bgcolorcode=success&&st=edit&&anum=$bloodgroupanum");
	}
	else
	{
		$errmsg = "Failed. bloodgroup Already Exists.";
		//$bgcolorcode = 'failed';
		header ("location:editbloodgroup.php?bgcolorcode=failed&&st=edit&&anum=$bloodgroupanum");
	}
	}
	else
	{
...
if ($st == 'edit' && $anum != '')
{
    ...
    $query1 = "select * from master_bloodgroup where auto_number = '$anum'";
	$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
	$res1 = mysql_fetch_array($exec1);
    $res1autonumber = $res1['auto_number'];
    $res1bloodgroup = $res1['bloodgroup'];
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="editbloodgroup.php" onSubmit="return addbloodgroup1process1()">
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      ...
                      <tr>
						...
						<input name="bloodgroup" id="bloodgroup" value="<?php echo $res1bloodgroup ?>" style="border: 1px solid #001E6A;" size="40" /></td>
                      </tr>
                      ...
                      <tr>
					   ...
					   <input type="hidden" name="bloodgroupanum" id="bloodgroupanum" value="<?php echo $res1autonumber; ?>">
