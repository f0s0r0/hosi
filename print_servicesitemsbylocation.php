...
header('Content-Disposition: attachment;filename="servicesitems.xls"');
...
.text{
  mso-number-format:"\@";/*force text*/
          ...
          <tbody>
			...
			<?php
			$sno=0;
			$query1 = "select * from master_services where  locationcode = '".$locationcode."' and status <> 'deleted' group by itemcode order by auto_number desc ";
