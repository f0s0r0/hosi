...
if ($frm1submit1 == 'frm1submit1')
{
	...
	$query23 = "select * from consultation_referal where patientcode='$patientcode' and patientvisitcode='$visitcode' order by auto_number desc limit 0, 1";
	...
	foreach($_POST['referal'] as $key=>$value)
		...
		if($pairvar2!="")
		{
		$referalquery1=mysql_query("insert into consultation_referal(consultationid,patientcode,patientname,patientvisitcode,referalcode,referalname,referalrate,billtype,accountname,consultationdate,paymentstatus,refno)values('$consultationid','$patientcode','$patientname','$visitcode','$referalcode','$pairvar2','$pairvar3','$billtype','$accountname','$consultationdate','pending','$refrefnonumber')") or die(mysql_error());
		$referalquery2=mysql_query("update master_visitentry set referalbill='pending' where visitcode='$visitcode'") or die(mysql_error());
		}
		}
		
		header("location:amend_pending_referal.php");
...
mysql_query("delete from consultation_referal where referalname='$referalname' and patientvisitcode='$visit'");
}
...
function btnDeleteClick11(delID4,vrate4)
{
...
<script type="text/javascript" src="js/insertnewitem9.js"></script>
<style type="text/css">
...
<form name="form1" id="frmsales" method="post" action="amendreferal.php" onKeyDown="return disableEnterKey(event)">
...
-->
  <tr>
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
            ...
            <tbody>
			  ...
			  <tr>
			   ...
			   <tr>
				...
				<input type="hidden" name="patientage" id="patientage" value="<?php echo $patientage; ?>" style="border: 1px solid #001E6A;text-transform: uppercase;"  size="5" readonly="readonly"><?php echo $patientage; ?>
				&
				...
				<input type="hidden" name="address1" id="address1" value="<?php echo $res41address1; ?>" style="border: 1px solid #001E6A;text-transform: uppercase;" size="30" /><?php echo $res41address1; ?>
                ...
                <td colspan="3" align="left" valign="middle" class="bodytext3">
				<input name="account" id="account" type="hidden" value="<?php echo $patientaccount1; ?>" style="border: 1px solid #001E6A" size="18" rsize="20" readonly="readonly"/><?php echo $patientaccount1; ?>
			...
			?>
			 ...
			 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $paharmitemname; ?></div></td>
			    <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $pharmitemrate; ?></div></td>
				 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $pharmitemrate; ?></div></td>
				 <td class="bodytext31" valign="center"  align="left"><div align="center"><a onClick="return deletevalid()" href="amendreferal.php?delete=<?php echo $paharmitemname; ?>&&patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>">Delete</a></div></td>
      ...
      <tr>
	   <td width="9%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><strong>Add Referal</strong></td>
     ...
     <tr id="reffid">
				   ...
				   <td width="30"><input name="referal[]" type="text" id="referal" size="69"></td>
				    <td width="30"><input name="rate4[]" type="text" id="rate4" readonly size="8"></td>
					   <td><label>
                       <input type="button" name="Add4" id="Add4" value="Add" onClick="return insertitem9()" class="button">
                       </label></td>
					   </tr>
					    </table></td> 
						</tr>
