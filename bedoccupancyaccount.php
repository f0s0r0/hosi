...
$searchaccountname=isset($_REQUEST['searchaccountname'])?$_REQUEST['searchaccountname']:'';
...
$('#searchaccountname').autocomplete({
	...
	source:'ajax_bedoccupancyacc.php', 
	//alert(source);
	minLength:1,
	delay: 0,
html: true, 
...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><form name="cbform1" method="post" action="bedoccupancyaccount.php">
          <table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Bed Occupancy Account Detailed</strong></td>
           ...
           <tr>
              ...
              <td width="299" align="left" valign="top"  bgcolor="#FFFFFF"><span class="bodytext3">
			 ...
			 <select name="ward" id="ward"  >
               ...
               <tr>
  			  <td width="165" align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><strong>Account </strong></td>
              <td width="299" align="left" valign="top"  bgcolor="#FFFFFF">
              <input type="text" name="searchaccountname" id="searchaccountname" value="<?php echo $searchaccountname;?>"  style="width:290"/>
              </td>
			   <td align="left" colspan="2" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"></td>
			  </tr>
				<tr>
          ...
          <td width="299" align="left" valign="center"  bgcolor="#ffffff" class="bodytext31"><input name="ADate1" id="ADate1" value="<?php echo $ADate1; ?>"  size="10"  readonly="readonly" onKeyDown="return disableEnterKey()" />
			<img src="images2/cal.gif" onClick="javascript:NewCssCal('ADate1')" style="cursor:pointer"/>			</td>
          <td width="54" align="left" valign="center"  bgcolor="#FFFFFF" class="style1"><span class="bodytext31"><strong> Date To </strong></span></td>
          <td width="250" align="left" valign="center"  bgcolor="#ffffff"><span class="bodytext31">
	  ...
	  <tr>
        <td>
	<form name="form1" id="form1" method="post" action="bedoccupancyaccount.php">	
...
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse; float:none" 
          ...
          <tbody>
             <tr>
			 <td colspan="13" bgcolor="#cccccc" class="bodytext31"><div align="left"><strong>Bed Occupancy Account Detailed</strong>
            ...
            <tr>
              <td width="17"  align="left" valign="center" 
                ...
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong> AccountName </strong></div></td>
...
<?php	
			...
			$totalbeddays = 0;
			if($ward == ''){
  			$querynw1 = "select visitcode,patientcode,recorddate,accountname from ip_bedallocation where locationcode='$locationcode1' and recordstatus <> 'transfered' and accountname like '%$searchaccountname%' and recorddate between '$fromdate' and '$todate'";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
			} else {
			$querynw1 = "select visitcode,patientcode,recorddate,accountname from ip_bedallocation where locationcode='$locationcode1' and recordstatus <> 'transfered' and ward = '$ward' and accountname like '%$searchaccountname%' and recorddate between '$fromdate' and '$todate'";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
			}
			...
			{ 
				...
				$accountfullname=$getmw['accountname'];
		...
		$dob = $res751['dateofbirth'];
          ...
          <tr <?php echo $colorcode; ?>>
		   ...
		   <?php 
			...
			if($ward == ''){
  			$querynw1 = "select visitcode,patientcode,recorddate,accountname from ip_bedtransfer where locationcode='$locationcode1' and recordstatus <> 'transfered' and accountname like '%$searchaccountname%' and  recorddate between '$fromdate' and '$todate'";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
			} else {
			$querynw1 = "select visitcode,patientcode,recorddate,accountname from ip_bedtransfer where locationcode='$locationcode1' and recordstatus <> 'transfered' and accountname like '%$searchaccountname%' and ward = '$ward' and recorddate between '$fromdate' and '$todate'";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
			}
			$execnw1 = mysql_query($querynw1) or die ("Error in Querynw1".mysql_error());
			$resnw1=mysql_num_rows($execnw1);
		...
		$dob = $res751['dateofbirth'];
          ...
          <tr <?php echo $colorcode; ?>>
	       ...
	       if($ward == ''){
  			$querynw2 = "select visitcode,patientcode,recorddate,accountname from ip_bedallocation where locationcode='$locationcode1' and recordstatus <> 'transfered' and accountname like '%$searchaccountname%' and recorddate < '$fromdate' and visitcode IN (select visitcode from ip_discharge where recorddate between '$fromdate' and '$todate' and req_status = 'discharge')";
			} else {
			$querynw2 = "select visitcode,patientcode,recorddate,accountname from ip_bedallocation where locationcode='$locationcode1' and recordstatus <> 'transfered' and accountname like '%$searchaccountname%' and ward = '$ward' and recorddate < '$fromdate' and visitcode IN (select visitcode from ip_discharge where recorddate between '$fromdate' and '$todate' and req_status = 'discharge')";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
			}
			...
			{ 
				...
				$accountfullname=$getmw2['accountname'];
		...
		$dob = $res752['dateofbirth'];
          ...
          <tr <?php echo $colorcode; ?>>
		   ...
		   <?php 
			...
			if($ward == ''){
  			$querynw2 = "select visitcode,patientcode,recorddate,accountname from ip_bedtransfer where locationcode='$locationcode1' and recordstatus <> 'transfered' and accountname like '%$searchaccountname%' and recorddate < '$fromdate' and visitcode IN (select visitcode from ip_discharge where recorddate between '$fromdate' and '$todate' and req_status = 'discharge')";
			} else {
			$querynw2 = "select visitcode,patientcode,recorddate,accountname from ip_bedtransfer where locationcode='$locationcode1' and recordstatus <> 'transfered' and accountname like '%$searchaccountname%' and ward = '$ward' and recorddate < '$fromdate' and visitcode IN (select visitcode from ip_discharge where recorddate between '$fromdate' and '$todate' and req_status = 'discharge')";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
			}
			$execnw2 = mysql_query($querynw2) or die ("Error in Querynw2".mysql_error());
			$resnw2=mysql_num_rows($execnw2);
		...
		$dob = $res752['dateofbirth'];
          ...
          <tr <?php echo $colorcode; ?>>
		   ...
		   <?php 
			...
			if($ward == ''){
  			$querynw8 = "select visitcode,patientcode,recorddate,accountname from ip_bedallocation where locationcode='$locationcode1' and recordstatus <> 'transfered' and accountname like '%$searchaccountname%' and recorddate < '$fromdate' and visitcode IN (select visitcode from ip_discharge where recorddate > '$todate' and req_status = 'discharge')";
			} else {
			...
			{ 
				...
				$accountfullname=$getmw8['accountname'];
		...
		$dob = $res758['dateofbirth'];
          ...
          <tr <?php echo $colorcode; ?>>
		   ...
		   <?php 
			...
			if($ward == ''){
  			$querynw3 = "select visitcode,patientcode,recorddate,accountname from ip_bedallocation where locationcode='$locationcode1' and recordstatus <> 'transfered' and accountname like '%$searchaccountname%' and recorddate < '$fromdate' and visitcode NOT IN (select visitcode from ip_discharge where req_status = 'discharge')";
			} else {
			$querynw3 = "select visitcode,patientcode,recorddate,accountname from ip_bedallocation where locationcode='$locationcode1' and recordstatus <> 'transfered' and accountname like '%$searchaccountname%' and ward = '$ward' and recorddate < '$fromdate' and visitcode NOT IN (select visitcode from ip_discharge where req_status = 'discharge')";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
			}
			...
			while($getmw3=mysql_fetch_array($execnw3))
			{
				...
				$accountfullname=$getmw3['accountname'];
		...
		$dob = $res753['dateofbirth'];
          ...
          <tr <?php echo $colorcode; ?>>
		   ...
		   <?php 
			...
			if($ward == ''){
  			$querynw3 = "select visitcode,patientcode,recorddate,accountname from ip_bedtransfer where locationcode='$locationcode1' and recordstatus <> 'transfered' and accountname like '%$searchaccountname%' and recorddate < '$fromdate' and visitcode NOT IN (select visitcode from ip_discharge where req_status = 'discharge')";
			} else {
			$querynw3 = "select visitcode,patientcode,recorddate,accountname from ip_bedtransfer where locationcode='$locationcode1' and recordstatus <> 'transfered' and accountname like '%$searchaccountname%' and ward = '$ward' and recorddate < '$fromdate' and visitcode NOT IN (select visitcode from ip_discharge where req_status = 'discharge')";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
			}
			$execnw3 = mysql_query($querynw3) or die ("Error in Querynw3".mysql_error());
			$resnw3=mysql_num_rows($execnw3);
         ...
         <tr>
             <?php if($sno > 0) { $avgstay= $totalbedday/$sno ; } else { $avgstay = '0.00'; } ?>
			  ...
			  <div class="bodytext31" align="left"><strong></strong></div></td>
               <td width="142"  align="left" valign="center" class="bodytext31"><div align="left"><strong>Total Patients:</strong></div></td>
               <td width="78"  align="left" valign="center" class="bodytext31"><div align="left"><?php echo $sno ?></div></td>
			  <td width="80"  align="left" valign="center" class="bodytext31">
			    <div align="left"><strong>Total Days</strong></div></td>
                 <td width="60"  align="left" valign="center" class="bodytext31"><div align="left"><?php echo $totalday ?></div></td>
				  <td width="74"  align="left" valign="center" class="bodytext31">
			    <div align="left"><strong>Total Bed Days</strong></div></td>
                 <td width="137"  align="left" valign="center" class="bodytext31"><div align="left"><?php echo $totalbedday ?></div></td>
				 <td width="91"  align="left" valign="center" class="bodytext31">
			    <div align="left"><strong>Average Length of Stay</strong></div></td>
				 <td width="91"  align="left" valign="center" class="bodytext31"><div align="left"><?php echo number_format($avgstay); ?></div></td>
                <td width="91" align="left" valign="center" bgcolor="#E0E0E0" class="bodytext31"><div align="left"><a target="_blank" href="print_bedoccupancyaccount.php?&&location=<?php echo $location; ?>&&ward=<?= $ward ?>&&searchaccountname=<?= $searchaccountname ?>&&ADate1=<?= $fromdate ?>&&ADate2=<?= $todate ?>&&cbfrmflag1=cbfrmflag1"><img src="images/excel-xls-icon.png" width="30" height="30"></a></div></td>
      </tr> 
