  ...
  <tr>
   ...
   <tr>
    ...
    <td width="99%" valign="top"><table width="105%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
        <td width="860">
              <form name="cbform1" method="post" action="adddaycare.php" onSubmit="return searchcheck()">
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			$query1pay = "select * from master_visitentry where overallpayment='completed' and patientcode like '%$patientcode%' and visitcode like '%$visitcode%' and billtype <> 'PAY NOW' order by auto_number desc";
			...
			$query1 = "select * from master_visitentry where overallpayment <> 'completed' and billtype <> 'PAY NOW' and consultationfees <> '0' and patientfullname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and planfixedamount='0.00' and planpercentage='0.00' order by auto_number desc";
			...
			$query1 = "select * from master_visitentry where overallpayment <> 'completed' and patientfullname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and consultationfees='0' order by auto_number desc";
