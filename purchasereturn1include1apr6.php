...
echo	$query3 = "insert into master_purchasereturn (companyanum, billnumber, billdate, suppliertype, subtotal, suppliercode, suppliername, 
	...
	$exec19 = mysql_query($query19) or die(mysql_num_rows());
	...
	$accountssubid = $res11['id'];
		...
		echo	$query4 = "insert into purchasereturn_details (bill_autonumber, companyanum, 
			...
			batchnumber, expirydate,typeofreturn,location,store,grtcoa, suppliercode, suppliername,accountssubcode) 
			...
			'$batchnumber', '$expirydate','Manual','$location1','$store1','$coa','$suppliercode','$suppliername','$accountssubid')";exit; 
			...
			companyanum, companyname,typeofreturn,location,store)  
			...
			'$companyanum', '$companyname','Manual','$location1','$store1')";
	...
	updatedate, balanceamount, companyanum, companyname, transactionmodule,typeofreturn) 
	...
	'$ipaddress', '$updatedate', '$balanceamount', '$companyanum', '$companyname', '$transactionmodule1','Manual')";
