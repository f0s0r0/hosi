	   ...
	   <table width="105%" border="0" cellspacing="0" cellpadding="0"><!--2ndtablestarthere  -->
		  ...
		  <tr><!--2ndtable-1strow start here  -->
				<td width="860"><!--2ndtable-1sttd start here  -->
					<form name="cbform1" method="post" action="approvedlistreport.php">
<!--3rd table start here --><table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
						<tbody><!--3rd table tbody start here -->
							<tr><!--3rd table 1st row start here -->
								<td align="left" bgcolor="#CCCCCC" class="bodytext3" colspan="2"><strong>Approved  List </strong></td>
											...
											<tbody><!--4rth table tbody  start here  -->
													<tr><!--4rth table 1st tr  start here  -->
															<td colspan="7" bgcolor="#cccccc" class="bodytext31">
																...
																<div align="left"><strong> Approved List</strong><label class="number">&nbsp;</label>
																</div>
															</td>
													  </tr>
													  ...
													  <td width="4%"  align="left" valign="center" 
													    ...
													    <td width="21%"  align="left" valign="center" 
															  ...
															  <td width="18%"  align="left" valign="center" 
																bgcolor="#ffffff" class="bodytext31"><strong>Approved By</strong></td>				
												        ...
												        $i=1;
														$sql1 = "select * from approvalstatus where patientname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and recorddate between '$fromdate' and '$todate' order by auto_number desc ";
														$result = mysql_query($sql1);
														while ($row = mysql_fetch_array($result))
														{
															$patientcode=$row['patientcode'];
															$patientvisitcode=$row['visitcode'];
														...
														<tr <?php echo $colorcode; ?>><!--4rth table 3rd tr  start here  -->
															 <td class="bodytext31" valign="center"  align="left"><div align="left"><?php echo  $i;?></div></td>
															  <td class="bodytext31" valign="center"  align="left"><div align="left"><?php echo $row['docno'] ;?></div></td>
															  <td class="bodytext31" valign="center"  align="left"><div align="left"><?php echo $row['patientcode'] ;?></div></td>
															  <td class="bodytext31" valign="center"  align="left"><div align="left"><?php echo $row['visitcode'] ;?></div></td>
															  <td class="bodytext31" valign="center"  align="left"><div align="left"><?php echo $row['patientname'];?></div></td>
															  <td class="bodytext31" valign="center"  align="left"><div align="left"><?php echo $row['recorddate'].' '.$row['recordtime'] ;?></div></td>
															  <td class="bodytext31" valign="center"  align="left"><div align="left"><?php echo $row['username']; ?></div></td>
														</tr>
														<?php
														$i++;
														}
