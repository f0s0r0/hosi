...
$patientcodeprefix = $res3['patientcodeprefix'];
...
if ($res2customercode == '')
{
	...
	$customercode = $patientcodeprefix.'1';
	$openingbalance = '0.00';
}
else
{
	...
	$customercode = substr($res2customercode,$patientcodeprefix1,9);
...
//echo $customercode;
	...
	$customercode = $patientcodeprefix.$maxanum;
	$openingbalance = '0.00';
	//echo $companycode;
}
	...
	if ($res2 == 0)
	{
		...
		if ($_FILES['browse1']['name'] != '')
		{
			if(move_uploaded_file($_FILES['browse1']['tmp_name'], $target_path)) 
			{
				...
				maintype, billtype,accountexpirydate, planexpirydate, overalllimit, planfixedamount, planpercentage, mrdno, promotion,username) 
		...
		else
		{
				...
				planvaliditystart, accountname, customermiddlename,visitlimit, 
				maintype, accountexpirydate, planexpirydate, overalllimit, planfixedamount, planpercentage, mrdno, promotion,username) 
				values('$customercode','$customername','$typeofcustomer','$address1','$address2','$area','$city',
				'$state','$country','$pincode','$phonenumber1','$phonenumber2','$faxnumber','$mobilenumber','$emailid1',
				'$emailid2','$remarks','$status', '$tinnumber', '$cstnumber', '$openingbalance', '$insuranceid', 
				'$gender','$mothername', '$age', '$nameofrelative', '$dateofbirth', '$maritalstatus', '$occupation', '$nationalidnumber', 
	...
	{
	header("location:addpatient1.php?savedpatientcode=$previouscustomercode");
		}
...
function funcVistLimit()
{
	...
	?>
		...
		if( varPlanName == "<?php echo $res11plannameanum; ?>")
		{
			...
			document.getElementById("overalllimit").value = "<?php echo $res11overalllimit; ?>";
...
function funcAccountNameChange1()
{
	<?php
	...
	?>
		if(document.getElementById("accountname").value=="<?php echo $res11accountnameanum; ?>")
		{
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="860"><table width="1316" height="282" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td bgcolor="#CCCCCC" class="bodytext3" colspan="8"><strong> New Patient Registration </strong></td>
              ...
              <!--<tr>
				...
				<tr>
				  ...
				  <select name="paymenttype" id="paymenttype" onChange="return funcPaymentTypeChange1();"  style="width: 150px;">
				...
				?>
				  ...
				  <select name="subtype" id="subtype" onChange="return funcSubTypeChange1()" >
...
-->				  
				  ...
				  <td width="15%" align="left" valign="middle"  bgcolor="#E0E0E0"><strong>
						<select name="accountname" id="accountname" onChange="return funcAccountNameChange1()">
...
-->				
				  ...
				  <td width="30%" align="left" valign="middle"  bgcolor="#E0E0E0"><input type="text" name="accountexpirydate" id="accountexpirydate" value="<?php echo $accountexpirydate; ?>" readonly="readonly"  ></td>
				</tr>
				<tr>
				<td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><span class="bodytext32">Plan </span></td>
				  <td align="left" valign="middle"  bgcolor="#E0E0E0">
				  <input type="hidden" name="planvaliditystart" id="planvaliditystart" value="<?php echo $registrationdate; ?>" readonly="readonly"  >
				  ...
				  <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><input type="text" name="planfixedamount" id="planfixedamount" readonly="readonly" value=""  ></td>
...
-->
				  <input type="text" name="billtype" id="billtype" readonly="readonly"  >
				  </strong></td>
				  ...
				  <input type="text" name="overalllimit" id="overalllimit" readonly="readonly"  >
				  <input type="hidden" name="planpercentage" id="planpercentage" readonly="readonly"  >
				  <input type="hidden" name="visitlimit" id="visitlimit" value="" readonly="readonly"  >				  </td>
				  </tr>
				
				<tr>
				<td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">Salutation</td>
				  <td align="left" valign="middle"  bgcolor="#E0E0E0"><strong>
				    <select name="salutation" id="salutation" style="width: 150px;">
                      <?php
				if ($salutation == '')
				{
...
<td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">DOB </td>
			      <td align="left" valign="middle"  bgcolor="#E0E0E0">
				  <input type="text" name="dateofbirth" id="dateofbirth" value="" onChange="return GetDifference1()" style="background-color:#E0E0E0;" readonly="readonly">
			      ...
			      <td align="left" valign="middle" bgcolor="#E0E0E0"><input name="age" type="text" id="age" value="" size="5" onKeyUp="return dobcalc();" onBlur="return idhide();">
			        <!--				  
				  <select name="age">
...
-->
                      <input name="ageduration" id="ageduration" value="" size="5" readonly="readonly">
					  <input type="hidden" name="planexpirydate" id="planexpirydate" value="<?php //echo $registrationdate; ?>" readonly="readonly"  >
                      <!--					 
...
-->                  </td>
                ...
                <td align="left" valign="middle"  bgcolor="#E0E0E0">
				<input name="customername" id="customername" value="<?php echo $customername; ?>" style="text-transform:uppercase;" size="20">
				...
				<td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">
				<input name="customermiddlename" id="customermiddlename" value="<?php echo $customermiddlename; ?>" style=" text-transform:uppercase;" size="20"></td>
				<td width="7%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><span class="bodytext32"> Last Name   </span></td> 
				<td align="left" valign="middle"  bgcolor="#E0E0E0">
				<input name="customerlastname" id="customerlastname" value="<?php echo $customerlastname; ?>" style="text-transform:uppercase;" size="20"></td>
				
<td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">National ID 				   </td>
				   <td align="left" valign="middle"  bgcolor="#E0E0E0">
				   <input name="nationalidnumber" id="nationalidnumber" value=""  onBlur="return funcNationalIDValidation1()" style="text-transform:uppercase;" size="20"/>				   </td>
				</tr>
				<tr>
...
<td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><span class="bodytext31"><span class="bodytext32">County </span></span></td>
			...
			?>
			 ...
			 <tr>
			  ...
			  <select name="settingsvalue" id="settingsvalue" style="width: 150px;">
            <?php
			...
			?>
				 ...
				 <td width="6%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">Reg  Code </td>
				  <td width="13%" align="left" valign="middle"  bgcolor="#E0E0E0"><strong><span class="bodytext312">
                    ...
                    <input  name="customercode" id="customercode" value="<?php echo $customercode; ?>" readonly="readonly" style=" background-color:#E0E0E0;" size="20">
                  </span></strong></td>
				   <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">Reg Date </td>
				   <td align="left" valign="middle"  bgcolor="#E0E0E0"><input type="text" name="registrationdate" id="registrationdate" value="<?php echo $registrationdate; ?>" readonly="readonly"   style="background-color:#E0E0E0;" size="16">
                ...
                <td colspan="7" align="middle"  bgcolor="#E0E0E0"><div align="right"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
				  ...
				  {
				  ?>
                  <input name="Submit222" type="submit" id="submit" value="Save Registration (Alt+S)" accesskey="s" class="button" onClick="return funcRegistrationLabel()"/>
                  <?php
				  }
				  ?>
				  <?php 
				  ...
				  {
				  ?>
				  <input name="Submit222" type="submit"  id="submit1" value="Save & Go OP Visit (Alt+O)" accesskey="o" class="button" onClick="return funcRegistrationOPLabel()"/>
                  <?php
				  }
				  ?>
				  <?php 
				  ...
				  <input name="Submit2222" type="submit" id="submit2" value="Save & Go IP Visit (Alt+I)" accesskey="i" class="button" onClick="return funcRegistrationIPLabel()"/>
				  </font></font></font></font>
				  <?php
				  }
				  ?>
                   <input name="Submit222" type="reset"  value="Reset (Alt+R)" accesskey="r" class="button"/>
