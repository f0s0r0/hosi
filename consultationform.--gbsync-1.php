...
$updatedatetime = date('Y-m-d H:i:s');
	...
	if ($res2 == 0)
	{
		...
		$query88 = "insert into master_consultation(consultation_id,patientcode,patientauto_number,patientname,patientvisitauto_number,patientvisitcode,recordstatus,recorddate,ipaddress,consultingdoctor,billtype,accountname,paymentstatus,sys,dia,pulse,temp,complaint,drugallergy,foodallergy,consultationtime,locationname,locationcode) 
				values('$consultationid','$patientcode','$patientauto_number','$patientfullname','$patientvisit','$visitcode','completed','$currentdate','$ipaddress','$consultingdoctor','$billingtype','$accountname','pending','$bpsystolic','$bpdiastolic','$pulse','$celsius','$complaint','$drugallergy','$foodallergy','$timestamp','$locationnameget','$locationcodeget')";
...
function sertotal()
{
	...
	if(parseInt(varserSlab)==1)
	{
		...
		if (parseInt(varquantityser) > parseInt(varserBaseunit))
		{
			...
			document.getElementById("serviceamount").value=(parseInt(varserRates)+parseInt(resultfinal)).toFixed(2);
		}
	}
...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top">
     <form name="form1" id="form1" method="post" action="consultationform.php" onSubmit="return process1();">
...
-->
				...
				?>
				 ...
				 <tr id="reffid">
				  ...
				  <tr>
				   <td colspan="11" align="left" valign="middle"  bgcolor="#CCCCCC" class="bodytext3"><span class="bodytext32"><span class="style2">External Referral <img src="images/plus1.gif" width="13" height="13"  onDblClick="return  funcExRefferalHideView()" onClick="return funcExRefferalShowView()"> </span></span></td>
		        </tr>
				<tr id="exreffid">
                ...
                <td colspan="6" align="middle"  bgcolor="#E0E0E0"><div align="right" > <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
                  ...
                  <input name="Submit222" type="submit"  value="Save Consultation (Alt+S)" accesskey="s" class="button"/>
