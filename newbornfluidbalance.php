...
else
{
	...
	$openingbalance = '0.00';
		...
		$stool = $_REQUEST['stool'];
		$ngast = $_REQUEST['ngast'];
		$others = $_REQUEST['others'];
		$urine = $_REQUEST['urine'];
	  	
		$referalquery1=mysql_query("insert into fluidbalance(docno,patientcode,patientname,visitcode,billtype,accountname,recorddate,recordtime,username,ipaddress,iv,ivdescription,alimentary,alimentarydesc,intravenoustype,alimentarytype,bottle,amount,infused,vomitus,stool,ngast,others,urine,locationname,locationcode)values('$billnumbercode','$patientcode','$patientfullname','$visitcode','$billtype','$account','$dateonly','$timeonly','$username','$ipaddress','$iv','$ivdescription','$alimentary','$alimentarydesc','$intravenoustype','$alimentarytype','$bottle','$amount','$infused','$vomitus','$stool','$ngast','$others','$urine','$locationname','$locationcode')") or die(mysql_error());
...
<body>
<form name="form1" id="frmsales" method="post" action="newbornfluidbalance.php" onKeyDown="return disableEnterKey(event)" onSubmit="return validcheck()">
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
				 ...
				 <td width="9%" align="center" valign="middle" class="bodytext3">Type</td>
				  ...
				  <td width="5%" align="left" valign="middle" class="bodytext3">Type</td>
				  <td width="11%" align="left" valign="middle" class="bodytext3"><input name="alimentarytype" type="text" id="alimentarytype"  size="20"></td>
				  <td align="left" valign="middle" class="bodytext3">&nbsp;</td>
				  <td align="center" valign="middle" class="bodytext3">Vomit</td>
				...
				<tr>
				 <td align="center" valign="middle" class="bodytext3">Bottle</td>
				  ...
				  <td align="left" valign="middle" class="bodytext3">&nbsp;</td>
				  <td align="center" valign="middle" class="bodytext3">Stool</td>
				  <td colspan="2" align="left" valign="middle" class="bodytext3"><input type="text" name="stool" id="stool" value="" size="8" onKeyPress="return isNumber(event)"></td>
				</tr>
				<tr>
				 <td align="center" valign="middle" class="bodytext3">Infused</td>
				  ...
				  <td align="left" valign="middle" class="bodytext3">&nbsp;</td>
				  <td align="left" valign="middle" class="bodytext3">&nbsp;</td>
				  <td align="center" valign="middle" class="bodytext3">N/Gast</td>
