...
$store = $res751['store'];
	...
	$query57 = "select sum(batch_quantity) as currentstock from transaction_stock where locationcode='".$locationcode."' AND itemcode = '$itemcode' and batch_stockstatus='1'";
