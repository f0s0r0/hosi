      ...
      <tr>
       ...
       <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
		 ...
		 $totalassets = $noncurrentassets + $grandtot;
		 ...
		 $commonstock = "0.00";
		 $capital = "0.00";
		 $totalliabilities = $currentliabilities + $longtermliabilities + $commonstock + $capital + $netincome + $patientdeposts + $ipfinalprivatedoctoramount - $totalreturnamount;
		 ...
		 $newtotalbalanceamount = $totalbalanceamount - $totalpaylaterpharmrefundamount + $paylaterrefundamount;
		  ...
		  <tr bgcolor="#D3EEB7">
              <td class="bodytext31" valign="center"  align="left"><strong>Non Current Assets</strong></td>
              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($noncurrentassets,2,'.',','); ?> </td>
           </tr>
			<tr bgcolor="#CBDBFA">
		   ...
		   <tr bgcolor="#D3EEB7">
		    ...
		    <tr bgcolor="#CBDBFA">
              <td class="bodytext31" valign="center"  align="left"><strong>Common Stock</strong></td>
              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($commonstock,2,'.',','); ?> </td>
           </tr>
		   <tr bgcolor="#D3EEB7">
              <td class="bodytext31" valign="center"  align="left"><strong>Additional Paid up Capital</strong></td>
