...
<body>
<form name="form1" id="frmsales" method="post" action="vitalio.php" onKeyDown="return disableEnterKey(event)" onSubmit="return validcheck()">
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
				 ...
				 <td align="left" valign="middle" class="bodytext3">Time&nbsp;&nbsp;&nbsp;
				  ...
				  <td align="left" valign="middle" class="bodytext3"><p><a target="_blank" href="viewvitalinputs.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&docnumber=<?php echo $billnumber; ?>"><strong>View Vitals </strong></a></p>
				  ...
				  <td align="left" valign="middle" class="bodytext3">		Date	&nbsp;&nbsp;&nbsp;		  
				    ...
				    <td width="13%" align="left" valign="middle" class="bodytext3"><p><a target="_blank" href="viewvitalinputoutput.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&docnumber=<?php echo $billnumber; ?>"><strong>View I/O </strong></a></p>
