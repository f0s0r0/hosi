    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="serviceslinking.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
		   <tr>
              <td colspan="8" bgcolor="#CCCCCC" class="bodytext3"><strong> Services Linking </strong></td>
              </tr>
            <tr>
              <td colspan="8" class="bodytext3"><strong> Select Service </strong>
				...
				<input type="hidden" name="fromstore" id="fromstore" value="<?php echo $storecode; ?>">
				</td>
			   </tr>
	  ...
	  <tr id="pressid">
			 ...
			 <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Services Linking - Existing List </strong></td>
                      </tr>
                      <tr>
                      ...
                      <?php
					  $colorloopcount = '';
	    $query1 = "select * from master_serviceslinking where recordstatus <> 'deleted' group by servicecode";
		...
		?>
                      <tr <?php echo $colorcode; ?>>
						...
						<a href="editserviceslinking.php?st=edit&&code=<?php echo $servicecode; ?>" style="text-decoration:none">Edit</a>						</td>
                      </tr>
                      <?php
		}
		?>
