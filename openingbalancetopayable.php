...
else
{
	...
	totalamount, billdate,patientname,billstatus,subtype,locationcode,locationname) 
	values ('$docnumber', '$accountname', '$amount', '$entrydate','Opening Balance','unpaid','$subtypename','$locationcode','$locationname')";
	$exec91 = mysql_query($query91) or die ("Error in Query9".mysql_error());
	
	$query92 = "insert into master_transactionpaylater (billnumber, accountname,  
	transactionamount, transactiondate, transactiontime, remarks, username, ipaddress, companyname, companyanum,patientname,paymenttype,subtype,transactiontype,locationcode,locationname,accountnameid,accountnameano,subtypeano) 
	values ('$docnumber', '$accountname', '$amount', '$entrydate',  
	'$entrytime', '$remarks', '$username', '$ipaddress', '$companyname', '$companyanum','Opening Balance','$paymenttypename','$subtypename','finalize','$locationcode','$locationname','$accountcode','$accountnameano','$subtype')";
	$exec92 = mysql_query($query92) or die ("Error in Query9".mysql_error());


	
	header ("location:openingbalancetopayable.php?st=1");
}
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td >
				...
				<form name="form1" id="form1" method="post" action="openingbalancetopayable.php" onSubmit="return paymententry1process1()">
			  <table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                <tbody>
                  <tr bgcolor="#011E6A">
                    <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Opening Balance Account Entry - Details </strong></td>
