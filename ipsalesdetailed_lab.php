...
<tr>
  ...
  $newamount=0;
		  ...
		  $querypaynow="select labitemrate as amount,patientcode,patientvisitcode,patientname,billdate,accountname,labitemname from  billing_iplab where billdate between '$ADate1' and '$ADate2' and locationcode='$locationcode1'  ";
  ...
  <tr <?php echo $colorcode; ?> class="bodytext31">
    ...
    <td width="154"><?php echo $labitemname; ?></td>
...
<tr>
  ...
  <?php
     $querypaylater="select labitemrate as amount,patientcode,patientvisitcode,patientname,billdate,accountname,labitemname from  billing_iplab where billdate between '$ADate1' and '$ADate2' and locationcode='$locationcode1' "; 
