...
foreach($_POST['lab'] as $key => $value)
   ...
   '$visitcode','$dateonly','$timeonly','$itemcode','$labname','$resultvalue','$referencevalue','$unit','$docnumber','$refname','$accountname','$locationcode','$locationname')";
   $exec26=mysql_query($query26) or die(mysql_error());
   
 
   $query29=mysql_query("update ipconsultation_lab set resultentry='$status1' where labitemcode='$itemcode' and patientvisitcode='$visitcode' and iptestdocno='$samplecollectiondocnumber'");
		}
	  ...
	  <td colspan="5" align="left" valign="middle"  bgcolor="#CCCCCC" class="bodytext365">
			...
			<td width="4%"  align="left" valign="center" 
                ...
                bgcolor="#ffffff" class="bodytext366"><div align="center"><strong>Acknowledge</strong></div></td>
				  ...
				  <?php
	  $query31="select * from ipconsultation_lab where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and labsamplecoll='completed' and resultentry='pending' and iptestdocno='$docnumber' and labrefund <> 'refund' group by labitemname";
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            align="left" border="0">
              <tbody>
			   ...
			   <?php 
			   $subTRsno = 0;
			  $query52="select * from master_labreference where itemcode='$labitemcode'";
