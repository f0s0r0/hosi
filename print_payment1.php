...
if (isset($_REQUEST["billnumber"])) { $billnumber = $_REQUEST["billnumber"]; } else { $billnumber = ""; }
	...
	$query12 = "select * from master_transactionpharmacy where docno = '$billnumber' ";
...
<table width="530" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
   ...
   <?php
			...
			$query11 = "select * from master_transactionpharmacy where docno = '$billnumber' and recordstatus = 'allocated'";
