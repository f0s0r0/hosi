...
if ($frmflag1 == 'frmflag1')
{
	...
	if ($len1<=25 && $len2<=10)
	{
	$query2 = "select * from master_lab where itemname = '$itemname' and itemname_abbreviation = '$itemname_abbreviation'";
	$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
	$res2 = mysql_num_rows($exec2);
	if ($res2 == 0)
	{
		$query1 = "insert into master_lab (itemname, ipaddress, updatetime, itemname_abbreviation) 
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="labunitname1.php" onSubmit="return addunit1labprocess1()">
                ...
                <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      ...
                      <?php
	    $query1 = "select * from master_lab where status <> 'deleted' order by itemname ";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
        ...
        <tr <?php echo $colorcode; ?>>
						...
						<a href="labunitname1.php?st=del&&anum=<?php echo $auto_number; ?>"><img src="images/b_drop.png" width="16" height="16" border="0" /></a></div></td>
        ...
        <tr <?php echo $colorcode; ?>>
						...
						<a href="labunitname1.php?st=activate&&anum=<?php echo $auto_number; ?>" class="bodytext3">
