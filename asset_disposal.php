...
if ($frmflag1 == 'frmflag1')
{
	...
	$disposalledger = $_REQUEST['disposalledger'];
	$disposalledgercode = $_REQUEST['disposalledgercode'];
	$disposalvalue = $_REQUEST['disposalvalue'];
	$disposalvalue = str_replace(',','',$disposalvalue);
	...
	if($row33 > 0)
	{ 
		$query88 = "INSERT INTO `assets_disposal`(`companyanum`, `itemcode`, `itemname`, `rate`, `quantity`, `subtotal`, `totalamount`, `recordstatus`, `assetledger`, `assetledgercode`, `assetledgeranum`, `fxamount`, 
		...
		$query78 = "UPDATE assets_disposal SET disposalvalue = '$disposalvalue', disposalledgercode = '$disposalledgercode', disposalledger = '$disposalledger', entrydate = '$updatedatetime', username = '$username', ipaddress = '$ipaddress' WHERE auto_number = '$insertid'";
...
function addward1process1()
{
	...
	if (document.form1.disposalledgercode.value == "")
	{
		alert ("Please Select Ledger");
		document.form1.disposalledger.focus();
		return false;
	}
	if (document.form1.disposalvalue.value == "")
	{
		alert ("Please Enter Amount");
		document.form1.disposalvalue.focus();
		return false;
	}
	if (document.form1.disposalvalue.value == '0')
	{
		alert ("Please Enter Amount");
		document.form1.disposalvalue.focus();
		return false;
...
$(function() {
$('#disposalledger').autocomplete({
	source:'autoassetledgersearch.php?requestfrm=disposal&', 
	select: function(event,ui){
			var code = ui.item.id;
			var anum = ui.item.anum;
			$('#disposalledgercode').val(code);
			},
	html: true
    });
});
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="asset_disposal.php" onSubmit="return addward1process1()">
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="" bgcolor="#CCCCCC" class="bodytext3"><strong>Asset Disposal </strong></td>
                  ...
                  <?php
					  ...
					  <tr>
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Disposal Ledger </div></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
						<input name="disposalledger" id="disposalledger" value="<?php //echo $accdepreciationledger; ?>" style="border: 1px solid #001E6A; text-transform:uppercase" size="40"/>
						<input type="hidden" name="disposalledgercode" id="disposalledgercode" value="<?php //echo $accdepreciationledgercode; ?>"></td>
                      </tr>
					  <tr>
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Disposal Value </div></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
						<input name="disposalvalue" id="disposalvalue" value="<?php //echo $totalamount; ?>" style="border: 1px solid #001E6A; text-transform:uppercase" size="40"/></td>
                      </tr>
                      <tr>
