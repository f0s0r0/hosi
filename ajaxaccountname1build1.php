...
$stringbuild1 = "";
$query2 = "select auto_number, accountname, expirydate from master_accountname where accountname like '%$searchsuppliername%' and subtype = '".$searchsubtypeanum1."' and recordstatus <> 'Deleted'";// order by accountname limit 0, 15";
