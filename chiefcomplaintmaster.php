...
if ($frmflag1 == 'frmflag1')
{
	...
	if ($length<=100)
	{
	$query2 = "select * from master_chiefcomplaint where chiefcomplaint = '$chiefcomplaint'";
	$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
	$res2 = mysql_num_rows($exec2);
	if ($res2 == 0)
	{
		$query1 = "insert into master_chiefcomplaint (chiefcomplaint, ipaddress, recorddate, username) 
		values ('$chiefcomplaint', '$ipaddress', '$updatedatetime', '$username')";
...
{
	$errmsg = "Please Add Chief Complaint Type To Proceed For Billing.";
	$bgcolorcode = 'failed';
}
...
function addward1process1()
{
	...
	{
		alert ("Pleae Enter Chief Complaint mode Name.");
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="chiefcomplaintmaster.php" onSubmit="return addward1process1()">
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      ...
                      <tr>
						...
						<input name="chiefcomplaint" id="chiefcomplaint" style="border: 1px solid #001E6A; text-transform:uppercase" size="40" /></td>
                      </tr>
                      <tr>
                ...
                <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong> Chief Complaint Master - Existing List </strong></td>
                        <td bgcolor="#CCCCCC" class="bodytext3"><strong>Edit</strong></td>
                      </tr>
                      <?php
	    $query1 = "select * from master_chiefcomplaint where recordstatus <> 'deleted' order by chiefcomplaint ";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		while ($res1 = mysql_fetch_array($exec1))
		{
		$chiefcomplaint = $res1["chiefcomplaint"];
        ...
        <tr <?php echo $colorcode; ?>>
						...
						<div align="center">	
					<a href="chiefcomplaintmaster.php?st=del&&anum=<?php echo $auto_number; ?>" onClick="return funcDeletechiefcomplaint('<?php echo $chiefcomplaint;?>')">
						<img src="images/b_drop.png" width="16" height="16" border="0" /></a></div></td>
                        <td width="85%" align="left" valign="top"  class="bodytext3"><?php echo $chiefcomplaint; ?> </td>
                        <td width="9%" align="left" valign="top"  class="bodytext3">
						<a href="editchiefcomplaintmaster.php?st=edit&&anum=<?php echo $auto_number; ?>" style="text-decoration:none">Edit</a>						</td>
                      </tr>
                      <?php
		}
		?>
                ...
                <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong> Chief Complaint Master - Deleted </strong></td>
                      </tr>
                      <?php
        ...
        <tr <?php echo $colorcode; ?>>
						...
						<a href="chiefcomplaintmaster.php?st=activate&&anum=<?php echo $auto_number; ?>" class="bodytext3">
                          <div align="center" class="bodytext3">Activate</div>
                        </a></td>
                        <td align="left" valign="top"  class="bodytext3"><?php echo $chiefcomplaint; ?></td>
                        </tr>
        <?php
		}
		?>
