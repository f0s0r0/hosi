...
{
	$paynowbillprefix = 'OTB-';
$paynowbillprefix1=strlen($paynowbillprefix);
$query2 = "select * from ip_otbilling order by auto_number desc limit 0, 1";
...
else
{
	...
	$paymentmode = $_REQUEST['billtype'];
		...
		if($pairvar!="")
		{
		$referalquery1=mysql_query("insert into ip_otbilling(docno,patientcode,patientname,patientvisitcode,surgeryname,rate,billtype,accountname,consultationdate,paymentstatus,consultationtime,username,ipaddress,locationcode)values('$billnumbercode','$patientcode','$patientfullname','$visitcode','$pairvar','$pairvar1','$billtype','$account','$dateonly','pending','$timeonly','$username','$ipaddress','$locationcode')") or die(mysql_error());
...
<?php include ("autocompletebuild_surgery.php"); ?>
<?php include ("js/dropdownlistotbilling.php"); ?>
<script type="text/javascript" src="js/autocomplete_surgery.js"></script>
<script type="text/javascript" src="js/autosuggestotbilling.js"></script>
...
<form name="form1" id="frmsales" method="post" action="ipotbilling.php" onKeyDown="return disableEnterKey(event)">
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<tr>
                ...
                <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">
				<input type="hidden" name="patienttype" id="patienttype" value="<?php echo $patienttype1; ?>">
