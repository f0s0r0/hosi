...
$query11 = "select sum(servicesitemrate * serviceqty) as servicesitemrate1 from billing_paylaterservices where billnumber = '$res2billnumber' and patientvisitcode = '$res2visitcode'";
...
<!--<page_footer>
 ...
 <table width="800" border="" cellpadding="0" cellspacing="0" align="center" >
  ...
  <tr>
    ...
    <td align="left" colspan="3" style="word-wrap: normal;"><?php echo $resmemberno; ?></td> 
  </tr>
...
$serviceitemcode199b=array();
		$query199b = mysql_query("select a.auto_number,b.itemcode as itemcode from consultation_services as a JOIN master_services as b ON a.servicesitemcode=b.itemcode where a.patientvisitcode = '$res2visitcode'");
/*  		$query199b = mysql_query("select a.auto_number,b.itemcode as itemcode from consultation_services as a JOIN master_services as b ON a.servicesitemcode=b.itemcode where b.pkg='Yes' limit 0,50");
 ...
 $serviceitemcode=implode("','",$serviceitemcode199b);
		...
		$query199a = mysql_query("select auto_number from master_serviceslinking where servicecode IN('$serviceitemcode') and itemcode = '$res19medicinecode' and recordstatus<>'deleted'");
...
$query199 = "select refno from master_consultationpharm where patientvisitcode='$res2visitcode' and patientcode='$res2patientcode' and medicinecode = '".$res19medicinecode."'";
...
$copaypharm = (($res19rate*$res19quantity)/100)*$res17planpercentage;
...
<td align="right" valign="left" 
	 bgcolor="#ffffff" class="bodytext31">
	 <?php echo number_format($res5amount,2);	 
	 //echo number_format($res19amount1=$res19amount1-$totalcopaypharm,2,'.',','); ?></td>
</tr>
<?php
}
?>
...
<td align="center" valign="left" 
	 bgcolor="#ffffff" class="bodytext31"  colspan="2"  width="32%">  <b> </b> 
      <br />
      <br />
