...
if ($frmflag2 == 'frmflag2')
{
	...
	if ($paymentmode == 'CASH')
		...
		transactionmodule,accountname,docno,recordstatus,receivableamount,paylaterdocno,transactionamount,cashamount,transactionstatus,paymenttype,subtype) 
		values ('$transactiondate', '$particulars', 
		'$transactionmode', '$transactiontype','$ipaddress', '$updatedate','$companyanum', '$companyname', '$remarks', 
		'$transactionmodule','$accname','$docno','','$paymentamount','$docno','$paymentamount','$paymentamount','onaccount','$patienttype11','$patientsubtype11')";
		...
		$query9 = "insert into master_transactionpaylater (transactiondate, particulars, 
		transactionmode, transactiontype,ipaddress, updatedate, companyanum, companyname, remarks, 
		transactionmodule,accountname,docno,recordstatus,receivableamount,paylaterdocno,transactionamount,onlineamount,transactionstatus,chequenumber,paymenttype,subtype) 
		values ('$transactiondate', '$particulars', 
		'$transactionmode', '$transactiontype','$ipaddress', '$updatedate','$companyanum', '$companyname', '$remarks', 
		'$transactionmodule','$accname','$docno','','$paymentamount','$docno','$paymentamount','$paymentamount','onaccount','$chequenumber','$patienttype11','$patientsubtype11')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
	    ...
	    $query9 = "insert into master_transactionpaylater (transactiondate, particulars, 
		transactionmode, transactiontype,ipaddress, updatedate, companyanum, companyname, remarks, 
		transactionmodule,accountname,docno,recordstatus,receivableamount,paylaterdocno,transactionamount,chequeamount,chequenumber,chequedate,bankname,transactionstatus,paymenttype,subtype) 
		values ('$transactiondate', '$particulars', 
		'$transactionmode', '$transactiontype','$ipaddress', '$updatedate','$companyanum', '$companyname', '$remarks', 
		'$transactionmodule','$accname','$docno','','$paymentamount','$docno','$paymentamount','$paymentamount','$chequenumber','$chequedate','$bankname','onaccount','$patienttype11','$patientsubtype11')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		...
		$query9 = "insert into master_transactionpaylater (transactiondate, particulars, 
		transactionmode, transactiontype,ipaddress, updatedate, companyanum, companyname, remarks, 
		transactionmodule,accountname,docno,recordstatus,receivableamount,paylaterdocno,transactionamount,writeoffamount,transactionstatus,paymenttype,subtype) 
		values ('$transactiondate', '$particulars', 
		'$transactionmode', '$transactiontype','$ipaddress', '$updatedate','$companyanum', '$companyname', '$remarks', 
		'$transactionmodule','$accname','$docno','','$paymentamount','$docno','$paymentamount','$paymentamount','onaccount','$patienttype11','$patientsubtype11')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		...
		transactionmodule,patientname,patientcode,visitcode,accountname,doctorname,billstatus,docno,billbalanceamount,recordstatus,receivableamount,paylaterdocno,paymenttype,subtype,username) 
		values ('$transactiondate', '$particulars', 
		...
		'$transactionmodule','$name','$patientcode','$visitcode','$accountname','$doctorname','$billstatus','$docno','$balamount','allocated','$paymentamount','$docno','$paymenttype','$subtype','$username')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		
		$query37 = "insert into paymentmodedebit(patientname,patientcode,patientvisitcode,accountname,billnumber,billdate,ipaddress,username,cash,cashcoa,source)values('$name','$patientcode','$visitcode','$accountname','$docno','$transactiondate','$ipaddress','$username','$adjamount','$cashcoa','accountreceivable')";
        $exec37 = mysql_query($query37) or die(mysql_error());
		...
		billnumber, billanum, ipaddress, updatedate, balanceamount, companyanum, companyname, remarks, 
		transactionmodule,patientname,patientcode,visitcode,accountname,doctorname,billstatus,docno,billbalanceamount,recordstatus,receivableamount,paylaterdocno,paymenttype,subtype,chequenumber,username) 
		values ('$transactiondate','$particulars', 
		'$transactionmode', '$transactiontype', '$adjamount', '$adjamount', 
		'$billnum3',  '$billanum', '$ipaddress', '$updatedate', '$balanceamount', '$companyanum', '$companyname', '$remarks', 
		'$transactionmodule','$name1','$patientcode','$visitcode','$accountname','$doctorname','$billstatus','$docno','$balamount','allocated','$paymentamount','$docno','$paymenttype','$subtype','$chequenumber','$username')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		
		$query37 = "insert into paymentmodedebit(patientname,patientcode,patientvisitcode,accountname,billnumber,billdate,ipaddress,username,online,onlinecoa,source)values('$name1','$patientcode','$visitcode','$accountname','$docno','$transactiondate','$ipaddress','$username','$adjamount','$onlinecoa','accountreceivable')";
        $exec37 = mysql_query($query37) or die(mysql_error());
		...
		'$adjamount','$chequenumber',  '$billnum1',  '$billanum', 
		'$chequedate', '$bankname', '$bankbranch','$ipaddress', '$updatedate', '$balanceamount', '$companyanum', '$companyname', 
		'$remarks', '$transactionmodule','$name2','$patientcode','$visitcode','$accountname','$doctorname','$billstatus','$docno','$balamount','allocated','$paymentamount','$docno','$paymenttype','$subtype','$username')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		
		$query37 = "insert into paymentmodedebit(patientname,patientcode,patientvisitcode,accountname,billnumber,billdate,ipaddress,username,cheque,chequecoa,source)values('$name2','$patientcode','$visitcode','$accountname','$docno','$transactiondate','$ipaddress','$username','$adjamount','$chequecoa','accountreceivable')";
        $exec37 = mysql_query($query37) or die(mysql_error());
		...
		'$transactionmodule','$name3','$patientcode','$visitcode','$accountname','$doctorname','$billstatus','$docno','$balamount','allocated','$paymentamount','$docno','$paymenttype','$subtype','$username')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
	}
		}
		}
...
$query765 = "select * from master_financialintegration where field='cashaccountreceivable'";
...
$query766 = "select * from master_financialintegration where field='chequeaccountreceivable'";
...
$query767 = "select * from master_financialintegration where field='mpesaaccountreceivable'";
$exec767 = mysql_query($query767) or die(mysql_error());
$res767 = mysql_fetch_array($exec767);

$mpesacoa = $res767['code'];

$query768 = "select * from master_financialintegration where field='cardaccountreceivable'";
$exec768 = mysql_query($query768) or die(mysql_error());
$res768 = mysql_fetch_array($exec768);

$cardcoa = $res768['code'];

$query769 = "select * from master_financialintegration where field='onlineaccountreceivable'";
...
$query2 = "select * from master_transactionpaylater where transactiontype='PAYMENT' and paylaterdocno <>'' order by auto_number desc limit 0, 1";
$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
$res2 = mysql_fetch_array($exec2);
		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            ...
            <tr>
			  ...
			  <input value="<?php echo $cbsuppliername; ?>" name="cbsuppliername" type="text" id="cbsuppliername" readonly="readonly" onKeyDown="return disableEnterKey()" size="50" ></td>
              </tr>
            <tr>
...
*/
			...
			$query2 = "select * from master_transactionpaylater where accountname = '$suppliername' and recordstatus = '' group by accountname";// and approvalstatus =  'APPROVED' and cstid='$custid' and cstname='$custname'";//  order by transactiondate desc";
			$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
			while ($res2 = mysql_fetch_array($exec2))
			{
			
			$res2suppliername = $res2['accountname'];
			
			$query3 = "select * from master_transactionpaylater where transactiontype = 'finalize' and accountname = '$res2suppliername'  and recordstatus = ''";// and approvalstatus =  'APPROVED' and cstid='$custid' and cstname='$custname'";
			$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
			...
			$query3 = "select * from master_transactionpaylater where transactiontype = 'PAYMENT' and accountname = '$res2suppliername' and recordstatus <> 'deallocated'";// and approvalstatus =  'APPROVED' and cstid='$custid' and cstname='$custname'";
			$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
			while ($res3 = mysql_fetch_array($exec3))
			{
...
*/
			...
			$query2 = "select * from master_transactionpaylater where accountname = '$suppliername' and recordstatus = '' group by accountname";// and cstid='$custid' and cstname='$custname'";//  order by transactiondate desc";
			$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
			while ($res2 = mysql_fetch_array($exec2))
			{
			...
			if ($supplieranum != 0)
			{
			$query3 = "select * from master_transactionpaylater where transactiontype = 'PURCHASE RETURN' and transactionmodule = 'PURCHASE RETURN' and accountname = '$res2suppliername' and recordstatus = ''";// and cstid='$custid' and cstname='$custname'";
			$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
			while ($res3 = mysql_fetch_array($exec3))
			{
				$transactionamount = $res3['transactionamount'];
			...
			$query3 = "select * from master_transactionpaylater where transactiontype = 'COLLECTION' and transactionmodule = 'PURCHASE RETURN' and accountname = '$res2suppliername' and recordstatus = ''";// and cstid='$custid' and cstname='$custname'";
			$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
			while ($res3 = mysql_fetch_array($exec3))
			{
				$cashamount1 = $res3['cashamount'];
...
?>
		...
		$totalrefundedamount=0;
			...
			$query3 = "select * from master_transactionpaylater where billnumber = '$billnumber' and companyanum='$companyanum' and transactionmodule = 'PAYMENT' and recordstatus <>'deallocated' order by auto_number desc";
			$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
			$res3 = mysql_fetch_array($exec3);
		...
		$totalrefundedamount=0;
			...
			$queryipf3 = "select * from master_transactionpaylater where billnumber = '$billnumber' and companyanum='$companyanum' and transactionmodule = 'PAYMENT' and recordstatus <>'deallocated' order by auto_number desc";
		...
		$totalrefundedamount=0;
			...
			while ($resipfc2 = mysql_fetch_array($execipfc2))
			{
				...
				$patienttype=$resipfc67['maintype'];
					...
					$exectype=mysql_fetch_array($querytype);
					$patienttype1=$exectype['paymenttype'];
					$patientsubtype=$resipfc67['subtype'];
					$querysubtype=mysql_query("select * from master_subtype where auto_number='$patientsubtype'");
					$execsubtype=mysql_fetch_array($querysubtype);
					$patientsubtype1=$execsubtype['subtype'];
			...
			$queryipfc3 = "select * from master_transactionpaylater where billnumber = '$billnumber' and companyanum='$companyanum' and transactionmodule = 'PAYMENT' and recordstatus <>'deallocated' order by auto_number desc";
		...
		$totalrefundedamount=0;
			...
			$queryipfcdebit3 = "select * from master_transactionpaylater where billnumber = '$billnumber' and companyanum='$companyanum' and transactionmodule = 'PAYMENT' and recordstatus <>'deallocated' order by auto_number desc";
			...
			$queryaop = "select * from openingbalanceaccount where accountname like '%$suppliername%'";
			//$query2 = "select * from master_transaction where transactiontype = 'PAYMENT' and transactionmode <> 'CREDIT' and transactionmodule = 'SALES' and billnumber = '$billnumber' and companyanum='$companyanum' and recordstatus = ''";
			$execaop = mysql_query($queryaop) or die ("Error in queryaop".mysql_error());
			$rowcountaop = mysql_num_rows($execaop);
			
			while ($resaop = mysql_fetch_array($execaop))
			{
				$billnumber = $resaop['docno'];
				$billtotalamount = $resaop['openbalanceamount'];
				$suppliername = $resaop['accountname'];
				$accountcode = $resaop['accountcode'];
				$billdate = $resaop['entrydate'];
				...
				$patientsubtype1 = '';
				$doctorname = '';
				$queryaop1 = "select * from master_transactionpaylater where billnumber = '$billnumber' and companyanum='$companyanum' and recordstatus <>'deallocated'";
				$execaop1 = mysql_query($queryaop1) or die ("Error in Queryaop1".mysql_error());
				$numbraop1 = mysql_num_rows($execaop1);
				//echo $numbr;
				while ($resaop1 = mysql_fetch_array($execaop1))
				{
					//echo $res3['auto_number'];
				    $cashamount1 = $resaop1['cashamount'];
					$onlineamount1 = $resaop1['onlineamount'];
					$chequeamount1 = $resaop1['chequeamount'];
					$cardamount1 = $resaop1['cardamount'];
					$tdsamount1 = $resaop1['tdsamount'];
					$writeoffamount1 = $resaop1['writeoffamount'];
					//echo $cashamount1;
					$cashamount21 = $cashamount21 + $cashamount1;
			...
			$queryaop2 = "select * from master_transactionpaylater where billnumber = '$billnumber' and companyanum='$companyanum' and transactionmodule = 'PAYMENT' and recordstatus <>'deallocated' order by auto_number desc";
			$execaop2 = mysql_query($queryaop2) or die ("Error in queryaop2".mysql_error());
			$resaop2 = mysql_fetch_array($execaop2);
			 $numbaop2=mysql_num_rows($execaop2);
			 $totalnumbaop2=$totalnumbaop2+$numbaop2;
			 
			$lastpaymentdate = $resaop2['transactiondate'];
			$lastpaymentdate = substr($lastpaymentdate, 0, 10);
            ...
            <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left">
			  <input type="checkbox" name="ack[]" id="acknow<?php echo $sno; ?>" value="<?php echo $billnumber; ?>" onClick="updatebox('<?php echo $sno; ?>','<?php echo $balanceamount; ?>','<?php echo $number; ?>')"></td>
              <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left"><div class="bodytext311"><?php echo $name; ?></div></td>
			  <input type="hidden" name="patientcode[]" id="patientcode" value="<?php echo $patientcode; ?>">
			  <input type="hidden" name="visitcode[]" id="visitcode" value="<?php echo $visitcode; ?>">
			  <input type="hidden" name="accountname[]" id="accountname" value="<?php echo $suppliername; ?>">
			  <input type="hidden" name="paymenttype[]" value="<?php echo $patienttype1; ?>">
