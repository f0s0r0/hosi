   ...
   $customercode = $_REQUEST['customercode'];
	...
	if ($_FILES['uploadedfile']['name'] != '')
		...
		else
		{
				$query1 = "update master_customer set customername='$customername',typeofcustomer='$typeofcustomer',address1='$address1',address2='$address2',
				area='$area',city='$city',state='$state',country='$country',pincode='$pincode',phonenumber1='$phonenumber1',phonenumber2='$phonenumber2',faxnumber='$faxnumber',mobilenumber='$mobilenumber',emailid1='$emailid1', emailid2='$emailid2',
				remarks='$remarks', status='$status', tinnumber='$tinnumber', cstnumber='$cstnumber', openingbalance='$openingbalance', insuranceid='$insuranceid', mrdno = '$mrdno',
		...
		header("location:searchpatient.php?patientcode=$customercode");
...
include ("autocompletebuild_paymenttype_edit.php");
...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top">
      	  ...
      	  <form name="form1" id="form1" method="post" onKeyDown="return disableEnterKey()" enctype="multipart/form-data" action="editpatient.php" onSubmit="return process1()">
            ...
            <tbody>
              ...
              <!--<tr>
				...
				<tr>
				  ...
				  <input type="hidden" name="searchpaymentcode" id="searchpaymentcode" value="<?php echo $res3paymentanum; ?>">
				...
				?>
				  ...
				  <input type="hidden" name="searchsubcode" id="searchsubcode" value="<?php echo $res4subanum; ?>">
...
-->				  
			  ...
			  <input name="searchaccountcode" id="searchaccountcode" value="<?php echo $res5accountanum; ?>" type="hidden">
