...
decoration:underline;"><strong>Laboratory Report</strong> </td>
	...
	$query616 = "select * from consultation_lab where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and labitemcode = '$labitemcode34' order by auto_number desc";
