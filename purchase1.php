...
$query2 = "select * from master_purchase where companyanum = '$companyanum' and typeofpurchase='Manual' order by auto_number desc";
...
<?php include ("js/dropdownlist2scripting21.php"); ?>
...
-->
  <tr>
    <td width="1%">&nbsp;</td>
    <td width="99%" valign="top"><table width="1000" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="100%"><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
		  <tr bgcolor="#011E6A">
		  <td bgcolor="#CCCCCC" class="bodytext3" colspan="5"><strong>Purchase Bill  </strong></td>
          <td colspan="5" align="center" bgcolor="#CCCCCC" class="bodytext3" id="ajaxlocation"><strong> Location </strong>
            ...
            <tr>
              ...
              <td width="4%" class="bodytext3"><strong>Bill Date </strong></td>
              <td width="11%" class="bodytext3"><span class="bodytext312">
              ...
              <td class="bodytext3"><div align="left"><strong>Location</strong></div></td>
              <td align="left" class="bodytext3"><select name="location" id="location" onChange=" funcSelectStore(); ajaxlocationfunction(this.value);">
			  ...
			  ?>
			  <option value="<?php echo $res7locationcode; ?>"><?php echo $res7locationname; ?></option>
			  <?php
			  }
			  ?>
			  </select>
...
*/            <?php
            ...
            <tr>
              ...
              <td width="14%" align="left" valign="top" ><span class="bodytext3"><span class="style6"><span class="bodytext312"><a href="javascript:displayDatePicker('ADate1', false, 'ymd', '-');"></a></span></span></span><span class="bodytext311">
                  <?php
                ...
                <input name="supplierbillnumber" id="supplierbillnumber" value="<?php echo $supplierbillnumber; ?>" size="10"  />
                  ...
                  </span>&nbsp;&nbsp;<span class="bodytext3"><strong>Store</strong></span></td>
             <td colspan="2" width="17%" ><span class="bodytext312">
		...
		<table id="newtable" style="BORDER-COLLAPSE: collapse" 
            ...
            <tbody id="tblrowinsert">
              <tr>
                ...
                bgcolor="#CCCCCC" class="bodytext31"><strong>Price/PK</strong></td>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
            ...
            <tr>
              ...
              <td align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31"><strong>Price/PK</strong></td>
            ...
            <tr>
			  ...
			  <input name="itemname" id="itemname" autocomplete="off" style="text-align:left" value="" size="30" />
              ...
              <td width="7%" align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31">
			  <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemquantity" value="1" id="itemquantity" style="text-align:right" size="2" /></td>
              <td width="7%" align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31"><span class="bodytext311">
                <input name="itemfreequantity" id="itemfreequantity" style="text-align:right" onBlur="return itemtotalamountupdate1()" onKeyDown="return itemquantitykeypress1(event)" value="0" size="1" />
              </span></td>
              ...
              <td width="3%" align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31"><span class="bodytext311">
				<select name="packagename" id="packagename">
				  <option value="1S" selected="selected">1S</option>
				  <?php
			  ...
			  <td width="7%" align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31"><span class="bodytext311">
                <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemtotalquantity" value="1" readonly id="itemtotalquantity" style="text-align:right" size="2" />
              </span></td>
