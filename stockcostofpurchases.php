  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <?php if (isset($_REQUEST["cbfrmflag1"])) { $cbfrmflag1 = $_REQUEST["cbfrmflag1"]; } else { $cbfrmflag1 = ""; }
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			$query1 = "SELECT * FROM purchase_details WHERE entrydate BETWEEN '".$ADate1."' AND '".$ADate2."' AND typeofpurchase='Process' AND locationcode = '".$locationcode."' AND store = '".$store."' GROUP BY billnumber";
			$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());	
			...
			?>
             <td colspan="6" bgcolor="#cccccc" class="bodytext31">
                ...
                <strong><?php echo $grnno; ?></strong></td>
              </tr>
              <tr>
              <td class="bodytext31" valign="center"  align="left" width="20%"
				...
				<td width="10%" align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Bonus</strong></div></td>
				<td width="10%" align="left" valign="center" 
     ...
     <?php
			...
			$totalamount = 0;
			$temp = 0;
			$query11 = "select * from purchase_details where billnumber = '$grnno' ";
    ...
    <tr <?php echo $colorcode;?>>
        <td class="bodytext3 border" width="20%" align="left"><?php echo $res11itemname; ?></td>
        <td class="bodytext3 border" align="center"><?php echo $res11itemcode; ?></td>
    ...
    <tr>
    	<td class="bodytext3 border" bgcolor="#ffffff" align="right" colspan="5"><strong>Net Amount:</strong></td>
