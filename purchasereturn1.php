...
<script type="text/javascript" src="js/batchselectionscript_111.js"></script>
...
<script type="text/javascript" src="js/autosuggestrequestmedicine_111.js"></script> <!-- For searching customer -->
<script type="text/javascript" src="js/autocomplete_requestmedicine.js"></script>
<script type="text/javascript" src="js/autosuggestbatch111.js"></script>
<script type="text/javascript" src="js/insertnewitemrequestmedicine_111.js"></script>
...
function suppliernamelostfocus()
{
	...
	var varSupplierName = document.getElementById("supplier").value;
	//alert (varSupplierName);
	var arrSupplierName = varSupplierName.split('#'); 
	var varSupplierName = arrSupplierName[0];
	...
	if (varSupplierCode != undefined)
	{
		...
		document.getElementById("suppliercode").value = varSupplierCode;
		//alert (varSupplierCode);
...
function funcSelectToStore()
{
	...
	$res12locationcode = $res12["locationcode"];
	?>
	if(document.getElementById("tolocation").value=="<?php echo $res12locationcode; ?>")
	{
		document.getElementById("tostore").options.length=null; 
		var combo = document.getElementById('tostore'); 	
		<?php 
		$loopcount=0;
		?>
		combo.options[<?php echo $loopcount;?>] = new Option ("Select Store", ""); 
...
{
	if(document.getElementById("tostore").value=='')
	{
...
<form name="frmpurchase" id="frmpurchase" method="post" action="purchasereturn1.php" onKeyDown="return disableEnterKey(event)" onSubmit="return validcheck();">
    ...
    <td width="99%" valign="top"><table width="950" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="100%"><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
		  <td bgcolor="#CCCCCC" class="bodytext3" colspan="5"><strong>Purchase Return  </strong></td>
		  ...
		  <tr>
              ...
              <td width="13%" class="bodytext3"><span class="bodytext312">
                ...
                <img src="images2/cal.gif" onClick="javascript:NewCssCal('ADate')" style="cursor:pointer"/> </span> </td>
                 ...
                 <td align="left" class="bodytext3"><strong> Location</strong></td>
					  <td align="left" class="bodytext3"><select name="location" id="location" onChange=" funcSelectFromStore(this.value); ajaxlocationfunction(this.value);"  style="border: 1px solid #001E6A;">
              ...
              <td width="2%" colspan="3" class="bodytext3">
            ...
            <tr>
              ...
              <td align="left" valign="top" ><span class="bodytext3">
               ...
               <td width="77" align="left" valign="middle" class="bodytext32"><strong>Store</strong></td>
			 ...
			 <td align="left" class="bodytext3"><strong></strong></td>
              ...
              <td width="25%" align="left" valign="top" ><span class="bodytext3"><span class="style6"><span class="bodytext312"><a href="javascript:displayDatePicker('ADate1', false, 'ymd', '-');"></a></span></span></span>
		...
		<table id="newtable" style="BORDER-COLLAPSE: collapse" 
            ...
            <tbody id="tblrowinsert">
              <tr>
                ...
                <td width="5%" align="center" valign="center"  
                bgcolor="#CBDBFA" class="bodytext31"><strong>Tax% </strong></td>
                <td width="9%" align="center" valign="center"  
                bgcolor="#CBDBFA" class="bodytext31"><span class="bodytext311"><strong>Rate</strong></span></td>
...
<!--
            <tr>
              ...
              <td align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31">&nbsp;</td>
              <td align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31">&nbsp;</td>
              <td align="center" valign="center"  bgcolor="#CBDBFA" class="bodytext31"><strong>Batch</strong></td>
              <td align="center" valign="center"  bgcolor="#CBDBFA" class="bodytext31"><strong>Expiry</strong></td>
              <td align="center" valign="center"  bgcolor="#CBDBFA" class="bodytext31"><strong>Qty</strong></td>
              <td align="center" valign="center"  bgcolor="#CBDBFA" class="bodytext31"><strong>Cost</strong></td>
              <td align="center" valign="center"  bgcolor="#CBDBFA" class="bodytext31"><strong>Tax</strong></td>
            ...
            <tr>
              ...
              <td width="7%" align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31">
              	 <input type="" name="medicinecode" id="medicinecode" value="" style=" text-align:left;text-transform: uppercase;" size="8" >
...
-->              <td width="26%" align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31">
			  <input name="itemname" id="itemname" type="hidden" autocomplete="off" style=" text-align:left" value="" size="40" />
              
                <input type="hidden" name="serialnumberinc" id="serialnumberinc"	var locationcode=document.getElementById("location").value ;
 value="1">
			  ...
			  <input name="searchmedicineanum1" id="searchmedicineanum1" value="" type="hidden">
                      ...
                      onChange="return funcbatchselection(this.value)" onkeyup="return amountcalc();">
                          <option value="" selected="selected">Select Batch</option>
                      </select></td>
                      <td align="left" valign="center"><input type="text" name="expirydate[]" id="expirydate" class="bal" size="10" readonly></td>
                      <td width="14%" align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31"><span class="bodytext311">
                <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemquantity" value="" id="itemquantity" style=" text-align:right" size="2" />
              </span></td>

 <td width="3%" align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31">
			  <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemmrp" value="" id="itemmrp" style=" text-align:right" size="4" /></td>

					  <input type="hidden" name="availablestock[]" id="availablestock" class="bal" size="10" >
                      <input type="hidden" name="reqquantity[]" id="reqquantity" class="bal" size="10" readonly>
                   <td width="3%" align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31"><span class="bodytext311">
              <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemtaxpercent" value="0.00" id="itemtaxpercent"  style=" text-align:right" size="2" />
                     </td>
                     <!-- <td align="left" valign="left" class="bodytext32"><input type="text" id="costprice" name="cost[]" size="10" class="bal" value="" readonly></td>-->
                      <td align="left" valign="left"><input type="text" name="itemtotalamount[]" id="itemtotalamount" class="bal" size="10" readonly></td>
			  ...
			  <input type="hidden" name="itemsearch2" value="Alt+S" accesskey="s" >
             <!-- <td width="3%" align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31">
...
-->              <!--<td width="3%" align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31"><span class="bodytext311">
            ...
            <!--  <td width="4%" align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31">
			  ...
			  <input name="Submit22222" type="button" value="Add" onClick="return insertitem10()" class="button" /></td>
