        ...
        <td width="860">
              ...
              <form name="cbform1" method="post" action="pharmacyrevenue.php">
                <table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                    <tr bgcolor="#011E6A">
                      <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Pharmacy Revenue</strong></td>
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
		  ...
		  <?php
		   ...
		   $query661=  "select sum(amount) as sumamount from billing_paynowpharmacy where   billdate between '$ADate1' and '$ADate2'";
		  ...
		  $snocount = $snocount + 1;
           ...
           <tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left">
              <a href="opsalesdetailed.php?locationcode=<?php echo $locationcode1;?>&&adate1=<?php echo $ADate1;?>&&adate2=<?php echo $ADate2;?>">
              <strong>OP Sales</strong></a></td>
			...
			?>
			<tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left"><a href="ipsalesdetailed.php?locationcode=<?php echo $locationcode1;?>&&adate1=<?php echo $ADate1;?>&&adate2=<?php echo $ADate2;?>"><strong>IP Sales</strong></td>
               <td class="bodytext31" valign="center"  align="right">
		   ...
		   <?php
			...
			?>
			<tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left"><a href="externalsales_detailed.php?locationcode=<?php echo $locationcode1;?>&&adate1=<?php echo $ADate1;?>&&adate2=<?php echo $ADate2;?>"><strong>External Sales</strong></a></td>
               <td class="bodytext31" valign="center"  align="right">
			...
			?>
			<tr <?php echo $colorcode; ?>>
              <td  align="left" valign="center" class="bodytext31"><a href="opreturns_detailed.php?locationcode=<?php echo $locationcode1;?>&&adate1=<?php echo $ADate1;?>&&adate2=<?php echo $ADate2;?>"><strong>OP Returns</strong></td>
               <td class="bodytext31" valign="center"  align="right">
                <div class="bodytext31"><strong><?php echo number_format($totallsumtransactionamount,2,'.',','); ?></strong></div></td>  
          ...
          <?php
			...
			?>
			<tr <?php echo $colorcode; ?>>
              <td  align="left" valign="center" class="bodytext31"><a href="extreturns_detailed.php?locationcode=<?php echo $locationcode1;?>&&adate1=<?php echo $ADate1;?>&&adate2=<?php echo $ADate2;?>"><strong>Ext Returns</strong></td>
               <td class="bodytext31" valign="center"  align="right">
			...
			<tr <?php echo $colorcode; ?>>
              ...
              <td rowspan="2" align="right" valign="center" 
			   bgcolor="#e0e0e0" class="bodytext31"><div align="left"><a target="_blank" href="print_pharmacyrevenue.php?locationcode=<?php echo $locationcode1; ?>&&ADate1=<?php echo $transactiondatefrom; ?>&&ADate2=<?php echo $transactiondateto; ?>"><img src="images/excel-xls-icon.png" width="30" height="30"></a></div></td>
               <?php } ?>
