  ...
  <tr>
    ...
    <td valign="top"><table width="99%" border="0" cellspacing="0" cellpadding="0">
      <tr>
       ...
       <tr>
        <td valign="top"><table width="1149" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            <?php
				...
				<tbody>
				<tr>
				<td colspan="9" bgcolor="#FFFFFF" class="bodytext3" align="left"><strong><?php echo $accountsmain2.' - '.'From '.date('d-M-Y',strtotime($ADate1)).' '.'to '.date('d-M-Y',strtotime($ADate2)); ?></strong></td>
				</tr>
				<tr bgcolor="#CCC">
				<td width="37" align="left" class="bodytext3"><strong><?php echo 'S.No'; ?></strong></td>
				<td width="70" align="left" class="bodytext3"><strong><?php echo 'Date'; ?></strong></td>
				<td width="95" align="left" class="bodytext3"><strong><?php echo 'Docno'; ?></strong></td>
				<td width="70" align="left" class="bodytext3"><strong><?php echo 'Cheque No'; ?></strong></td>
				<td width="73" align="left" class="bodytext3"><strong><?php echo 'Code'; ?></strong></td>
				<td width="334" align="left" class="bodytext3"><strong><?php echo 'Description'; ?></strong></td>
				<td width="85" align="right" class="bodytext3"><strong><?php echo 'Debit'; ?></strong></td>
				<td width="59" align="right" class="bodytext3"><strong><?php echo 'Credit'; ?></strong></td>
				<td width="83" align="right" class="bodytext3"><strong><?php echo 'Balance'; ?></strong></td>
				</tr>
				<?php
				$colorloopcount = '';
				$orderid1 = '';
				...
				{  
					...
					$querydr1 = "SELECT (`cashamount`) as bankamount, billdate as td2, billnumber as td3, patientcode as td4, patientname as td5 FROM `billing_consultation` WHERE (`cashcode` = '$id') AND `billdate` BETWEEN '$ADate1' AND '$ADate2'
									...
									UNION ALL SELECT (`cashamount`) as bankamount, transactiondate as td2, docno as td3, patientcode as td4, patientname as td5 FROM `master_mortuaryexternaldeposit` WHERE `cashcode` = '$id' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactionmodule` = 'PAYMENT'
									UNION ALL SELECT (`creditamount`) as bankamount, transactiondate as td2, docno as td3, patientcode as td4, patientname as td5 FROM `master_mortuaryexternaldeposit` WHERE `mpesacode` = '$id' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactionmodule` = 'PAYMENT'
									UNION ALL SELECT (`chequeamount`) as bankamount, transactiondate as td2, docno as td3, patientcode as td4, patientname as td5 FROM `master_mortuaryexternaldeposit` WHERE `bankcode` = '$id' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactionmodule` = 'PAYMENT'
									UNION ALL SELECT (`onlineamount`) as bankamount, transactiondate as td2, docno as td3, patientcode as td4, patientname as td5 FROM `master_mortuaryexternaldeposit` WHERE `bankcode` = '$id' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactionmodule` = 'PAYMENT'
									UNION ALL SELECT (`cardamount`) as bankamount, transactiondate as td2, docno as td3, patientcode as td4, patientname as td5 FROM `master_mortuaryexternaldeposit` WHERE `bankcode` = '$id' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactionmodule` = 'PAYMENT'
									...
									UNION ALL SELECT (`returnbalance`) as bankamount, transactiondate as td2, billnumber as td3, patientcode as td4, patientname as td5 FROM `master_transactionip` WHERE `bankcode` = '$id' AND billtype = 'PAY NOW' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2'
									UNION ALL SELECT (`returnbalance`) as bankamount, transactiondate as td2, billnumber as td3, patientcode as td4, patientname as td5 FROM `master_transactionip` WHERE `mpesacode` = '$id' AND billtype = 'PAY NOW' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2'
									...
									UNION ALL SELECT (-1*transactionamount) as bankamount, transactiondate as td2, docno as td3, patientcode as td4, patientname as td5 FROM `master_transactionpaylater` WHERE accountnameid = '$id' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactiontype` = 'pharmacycredit'
									
									UNION ALL SELECT (-1*`cashamount`) as bankamount, transactiondate as td2, docnumber as td3, expensecoa as td4, CONCAT(`payee`,' - ',`remarks`) as td5 FROM `expensesub_details` WHERE (`cashcode` = '$id') AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2'
									UNION ALL SELECT (-1*`creditamount`) as bankamount, transactiondate as td2, docnumber as td3, expensecoa as td4, CONCAT(`payee`,' - ',`remarks`) as td5 FROM `expensesub_details` WHERE (`mpesacode` = '$id') AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2'
									UNION ALL SELECT (-1*`cardamount`) as bankamount, transactiondate as td2, docnumber as td3, expensecoa as td4, CONCAT(`payee`,' - ',`remarks`) as td5 FROM `expensesub_details` WHERE (`bankcode` = '$id') AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2'
									UNION ALL SELECT (-1*`onlineamount`) as bankamount, transactiondate as td2, docnumber as td3, expensecoa as td4, CONCAT(`payee`,' - ',`remarks`) as td5 FROM `expensesub_details` WHERE (`bankcode` = '$id') AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2'
									UNION ALL SELECT (-1*`chequeamount`) as bankamount, transactiondate as td2, docnumber as td3, expensecoa as td4, CONCAT(`payee`,' - ',`remarks`) as td5 FROM `expensesub_details` WHERE (`bankcode` = '$id') AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2'
					...
					<?php } else { ?>
					<td align="left" class="bodytext3">&nbsp;</td>
					<td width="64" align="right" class="bodytext3"><?php echo number_format(abs($amount),2,'.',','); ?></td>
					<?php } ?>
					<td width="91" align="right" class="bodytext3"><?php echo number_format($sumbalance,2,'.',','); ?></td>
					</tr>
					<?php
					}
					}
					...
					<?php 
					$urlpath = "cbfrmflag1=cbfrmflag1&&ADate1=$ADate1&&ADate2=$ADate2&&id=$id";
					?>
             		<a href="detail_accountbankxl.php?<?php echo $urlpath; ?>"><img  width="40" height="40" src="images/excel-xls-icon.png" style="cursor:pointer;"></a></td>
					</tr>
</tbody>				
</table>
</td>
