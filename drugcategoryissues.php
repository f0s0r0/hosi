...
<table width="110%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
	...
	<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
      ...
      <tbody id="foo">
        <tr>
          <td colspan="6" bgcolor="#cccccc" class="bodytext31"><strong>Drug Category Issues</strong></td>
          </tr>
        <tr>
...
function disableEnterKey()
{
	...
	else
	{
        ...
        <tr>
          <td class="bodytext31" valign="center"  align="left" bgcolor="#ffffff"><input type="hidden" name="medicinecode" id="medicinecode" style="border: 1px solid #001E6A; text-align:left" onKeyDown="return disableEnterKey()" value="<?php echo $medicinecode; ?>" size="10" readonly="readonly" /></td>
          <td colspan="3" align="left" valign="center"  bgcolor="#ffffff" class="bodytext31">
		  <strong><!--Item Code :--> <?php //echo $medicinecode; ?></strong></td>
          <td colspan="2" align="left" valign="center"  bgcolor="#ffffff" class="bodytext31"><div align="right">
...
$query7 = "select * from pharmacysales_details where categoryname like '%$categoryname%' and entrydate between '$ADate1' and '$ADate2' order by entrydate desc";
...
?>
			<tr> <td align="left" valign="center"  
                class="bodytext31" colspan="5"><strong><?php echo $categoryname; ?></strong></td></tr>
			<tr>
              <td align="left" valign="center"  
...
$total=$total+$quantity6;
	...
	$colorloopcount = $colorloopcount + 1;
              ...
              <td align="left" valign="center"  
				...
				?>
				 <tr> <td align="left" valign="center"  
                class="bodytext31" width="5%"><strong><?php echo $categoryname; ?></strong></td></tr>
			 <tr>
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Sno</strong></div></td>
              <td align="left" valign="center"  
