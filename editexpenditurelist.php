...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
              <form name="cbform1" method="post" action="editexpenditurelist.php">
                <table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                    <tr bgcolor="#011E6A">
                      <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Edit Expenditure</strong></td>
...
-->				 <td class="bodytext31" valign="center"  align="left" 
        ...
        <?php      
          ...
          <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="1136" 
            align="left" border="0">
          <tbody>
            <tr>
             
              <td colspan="12" bgcolor="#cccccc" class="bodytext31">
                <div align="left"><strong>Edit Expenditure</strong></div>
              ...
              <td class="bodytext31" valign="left" width="25"  align="left"><div align="center"><?php echo $colorloopcount; ?></div></td>
			   ...
			   <td class="bodytext31"  valign="center"  align="left">
			    <?php echo $coordination; ?></td>
	  		      ...
	  		      <td class="bodytext31" valign="center"  width="64" align="left">
			  <div class="bodytext31" align="left"><a href="ambulanceexpenditure.php?docno=<?php echo $docno; ?>">Edit </a></div></td>
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                ...
                bgcolor="#cccccc">&nbsp;</td>
				 <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#cccccc">&nbsp;</td>
              <td class="bodytext31" colspan="6" valign="center"  align="left" 
                bgcolor="#cccccc">&nbsp;</td>
              <td align="right" valign="center" bgcolor="#E0E0E0" class="bodytext31"><a target="_blank" href="print_expenditurexl.php?cbfrmflag1=cbfrmflag1&&ADate1=<?php echo $transactiondatefrom; ?>&&ADate2=<?php echo $transactiondateto; ?>"><img src="images/excel-xls-icon.png" width="30" height="30"></a></td>
            </tr>
                <?php 
				}
