...
<?php 
$query1 = "select * from materialreceiptnote_nmdetails where typeofpurchase='Process' and itemstatus='' group by billnumber";
      ...
      <tr>
          ...
          <tbody>
            <tr>
              ...
              <td colspan="7" bgcolor="#cccccc" class="bodytext31">
                ...
                <div align="left"><strong>View NM MRN</strong><label class="number"><<<?php echo $resnw1;?>>></label></div></td>
              </tr>
             <tr>
              ...
              <td width="23%" align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>MRN No</strong></div></td>
		...
		while($res1=mysql_fetch_array($exec1))
            ...
            <tr <?php echo $colorcode; ?>>
			  ...
			  <div class="bodytext31" align="center"><?php echo $mrnno; ?></div></td>
			      <td  align="left" valign="center" class="bodytext31"><div class="bodytext31" align="center"><a href="editmaterialreceiptnotenm.php?ponumber=<?php echo $pono; ?>&&mrnnumber=<?php echo $mrnno; ?>">Edit</a></div></td>
			      <td class="bodytext31" valign="center" align="left" >
			  <div class="bodytext31" align="center"><a target="_blank" href="print_mrnnm_dmp4inch1.php?billautonumber=<?php echo $mrnno; ?>&&billnum=<?php echo $pono; ?>">Print</a></div></td>
                </tr>
			  <?php
			}
			?>
