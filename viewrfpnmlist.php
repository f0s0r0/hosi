...
<body>
<?php
$query1 = "select * from purchasenm_rfqrequest where approvalstatus='' group by docno";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left">
			    <div align="left"><?php echo $status; ?></div></td>
                 <td class="bodytext31" valign="center" align="left">
			    <div align="left"><a href="rfpapprovalnm.php?docno=<?php echo $docno; ?>"><strong>VIEW</strong></a></div></td>
              </tr>
			<?php
			}    
			?>
