...
<body>	
<form name="form1" id="frmsales" method="post" action="newbornvitals.php" onKeyDown="return disableEnterKey(event)" onSubmit="return validcheck()">
		...
		<tr>
				...
				<td colspan="3" class="bodytext3"><input type="hidden" name="billdate" id="billdate" value="<?php echo $dateonly; ?>" style="border: 1px solid #001E6A" size="18" rsize="20" readonly/>
                  <?php echo $dateonly; ?> </td>
                  	     	 ...
                  	     	 <tr>
							 <td align="left" valign="middle" class="bodytext3"><strong> Department</strong></td>
				<td class="bodytext3"><input type="hidden" name="department" id="departmant" value="<?php echo $department; ?>" style="border: 1px solid #001E6A" size="18" rsize="20" readonly/>
                <input type="hidden" name="departmentanum" id="departmantanum" value="<?php echo $departmentanum; ?>"/>
                
				<?php echo $department; ?>				</td></tr>				
