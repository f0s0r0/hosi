		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
				 ...
				 <td colspan="14"  bgcolor="#CCCCCC" class="bodytext31">
				      <?php //error_reporting(0);
							...
							*/
							...
							$query111 = "select customerfullname from master_customer where customerfullname like '%$searchpatient%' and customercode like '%$searchpatientcode%' and nationalidnumber like '%$searchnationalid%' and accountname = '$searchaccountcode'";
							}
           ...
           <tr>
			  ...
			  <?php 
			  if($searchaccountcode == '') {
            $query2 = "select * from master_customer where customerfullname like '%$searchpatient%' and customercode like '%$searchpatientcode%' and nationalidnumber like '%$searchnationalid%' LIMIT $start , $limit";
			} else {
			$query2 = "select * from master_customer where customerfullname like '%$searchpatient%' and customercode like '%$searchpatientcode%' and nationalidnumber like '%$searchnationalid%' and accountname = '$searchaccountcode' LIMIT $start , $limit";
			}
