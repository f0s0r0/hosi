...
<table width="48%">
  <tr>
    <td width="99%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="1145"><form name="cbform1" method="post" action="publishedorthopediclistiframe.php">
          <table width="623" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              ...
              <tr>
                ...
                <td width="309" align="left" valign="top"  bgcolor="#FFFFFF"><span class="bodytext3">
          ...
          <td width="309" align="left" valign="center"  bgcolor="#ffffff"><span class="bodytext31">
      ...
      <tr>
		...
		$gender = $res43['gender'];
            ...
            <tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left"><div align="left"> <a target="_parent" href="orthopedicresultscheck.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>"> <strong><?php echo $res1patientname; ?> (<?php echo $patientcode; ?>,<?php echo $visitcode; ?>),<?php echo $gender; ?>,<?php echo $age; ?></strong> </a> </div></td>
