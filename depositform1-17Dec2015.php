...
//get ends here
		...
		transactionmodule,patientname,patientcode,visitcode,accountname,docno,username,transactiontime,coa,locationname,locationcode,comments) 
		...
		'$transactionmodule','$patientname','$patientcode','$visitcode','$accname','$billnumbercode','$username','$updatetime','$ipdepositscoa','".$locationnameget."','".$locationcodeget."','".$comments."')";
		...
		transactionmodule,accountname,docno,transactionamount,onlineamount,chequenumber,bankname,username,transactiontime,coa,locationname,locationcode,comments) 
		...
		'$transactionmodule','$accname','$billnumbercode','$onlineamount','$onlineamount','$onlinenumber','$bankname','$username','$updatetime','$ipdepositscoa','".$locationnameget."','".$locationcodeget."','".$comments."')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		...
		$query9 = "insert into master_transactionipdeposit (patientname,patientcode,visitcode,transactiondate, particulars, 
		transactionmode, transactiontype,ipaddress, updatedate, companyanum, companyname, remarks, 
		transactionmodule,accountname,docno,transactionamount,creditamount,chequenumber,bankname,username,transactiontime,coa,locationname,locationcode,comments) 
		values ('$patientname','$patientcode','$visitcode','$updatedatetime', '$particulars', 
		'$transactionmode', '$transactiontype','$ipaddress', '$updatedatetime','$companyanum', '$companyname', '$remarks', 
		'$transactionmodule','$accname','$billnumbercode','$creditamount','$creditamount','$mpesanumber','$bankname','$username','$updatetime','$ipdepositscoa','".$locationnameget."','".$locationcodeget."','".$comments."')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
	    ...
	    $query9 = "insert into master_transactionipdeposit (patientname,patientcode,visitcode,transactiondate, particulars, 
		transactionmode, transactiontype,ipaddress, updatedate, companyanum, companyname, remarks, 
		transactionmodule,accountname,docno,transactionamount,chequeamount,chequenumber,chequedate,bankname,username,transactiontime,coa,locationname,locationcode,comments) 
		values ('$patientname','$patientcode','$visitcode','$updatedatetime', '$particulars', 
		'$transactionmode', '$transactiontype','$ipaddress', '$updatedatetime','$companyanum', '$companyname', '$remarks', 
		'$transactionmodule','$accname','$billnumbercode','$chequeamount','$chequeamount','$chequenumber','$chequedate','$chequebank','$username','$updatetime','$ipdepositscoa','".$locationnameget."','".$locationcodeget."','".$comments."')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
	    ...
	    $query9 = "insert into master_transactionipdeposit (patientname,patientcode,visitcode,transactiondate, particulars, 
		transactionmode, transactiontype,ipaddress, updatedate, companyanum, companyname, remarks, 
		transactionmodule,accountname,docno,transactionamount,cardamount,chequenumber,chequedate,bankname,username,transactiontime,coa,locationname,locationcode,comments) 
		values ('$patientname','$patientcode','$visitcode','$updatedatetime', '$particulars', 
		'$transactionmode', '$transactiontype','$ipaddress', '$updatedatetime','$companyanum', '$companyname', '$remarks', 
		'$transactionmodule','$accname','$billnumbercode','$cardamount','$cardamount','$cardnumber','$chequedate','$bankname1','$username','$updatetime','$ipdepositscoa','".$locationnameget."','".$locationcodeget."','".$comments."')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		...
		'$remarks', '$transactionmodule','$patientname','$patientcode','$visitcode','$accountname','$doctorname','paid','$financialyear','$username','$card','$cardnumber','$bankname1','CASH','CASH','".date('h:i:s')."','$cashamount','$onlineamount','$chequeamount','$chequenumber','$creditamount','$onlinenumber','$mpesanumber','".$locationnameget."','".$locationcodeget."','$billnumbercode')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		...
		'$ipaddress', '$updatedatetime','$companyanum', '$companyname', '$remarks', 
		'Adjustment','$accname','$docno','$cashamount','$username','$updatetime','".$locationnameget."','".$locationcodeget."')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
