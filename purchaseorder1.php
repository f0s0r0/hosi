...
<script type="text/javascript" src="js/purchaseorderinsertitem.js"></script>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
            ...
            <tr>
			  ...
			  <input name="itemcode" id="itemcode" style="border: 1px solid #001E6A; text-align:left;text-transform: uppercase;" value="" size="10" /></td>
			  ...
			  <input type="button" name="itemsearch2" value="Alt+S" accesskey="s" style="border: 1px solid #001E6A"></td>
              <td width="6%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <input onBlur="return itemtotalamountupdate1()" name="itemmrp" value="0.00" id="itemmrp" style="border: 1px solid #001E6A; text-align:right" size="6" /></td>
              <td width="4%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <input onBlur="return itemtotalamountupdate1()" name="itemquantity" value="1" id="itemquantity" style="border: 1px solid #001E6A; text-align:right" size="4" /></td>
              <td width="6%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <input onBlur="return itemtotalamountupdate1()" name="itemdiscountpercent" value="0.00" id="itemdiscountpercent" style="border: 1px solid #001E6A; text-align:right" size="2" /></td>
              <td width="6%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <input onBlur="return itemtotalamountupdate1()" name="itemdiscountrupees" value="0.00" id="itemdiscountrupees" style="border: 1px solid #001E6A; text-align:right" size="3" /></td>
              <td width="6%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311">
              <input onBlur="return itemtotalamountupdate1()" name="itemtaxpercent" value="0.00" id="itemtaxpercent" readonly="readonly" style="border: 1px solid #001E6A; text-align:right" size="2" />
			  ...
			  <input name="Submit22222" type="button" value="Add" onClick="return insertitem1()" onDblClick="return rest()"class="button" style="border: 1px solid #001E6A"/></td>
              <td width="18%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311">
                <input name="itemreversetax" value="0.00" id="itemreversetax" onBlur="return funcTaxReverseCalc2()" style="border: 1px solid #001E6A; text-align:right" size="8" />
              </span></td>
            </tr>
            <tr>
