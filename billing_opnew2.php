...
$query21=mysql_query("update master_visitentry set radiologybill='completed' where visitcode='$visitcode'");
header("location:billing_pending_opradiology.php");
...
<form name="frmsales" id="frmsales" method="post" action="billing_opnew2.php" onKeyDown="return disableEnterKey(event)">
        ...
        <td><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
               ...
               <td bgcolor="#CCCCCC" class="bodytext3"><strong>Radiology Bill No. </strong></td>
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
			...
			$sno = '';
			$totalamount=0;
			$query17 = "select * from consultation_radiology where patientvisitcode='$visitcode' and patientcode='$patientcode' and paymentstatus='pending'";
