...
<?php 
$query34="select * from master_rfqpurchaseorder where recordstatus='generated' and goodsstatus ='' group by billnumber";
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		$query34="select * from master_rfqpurchaseorder where recordstatus='generated' and goodsstatus ='' group by billnumber order by auto_number desc";
		$exec34=mysql_query($query34) or die(mysql_error());
              ...
              <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $sno = $sno + 1; ?></div></td>
			   <td class="bodytext31" valign="center"  align="left">
			    ...
			    <div align="center"><?php echo $suppliername; ?></div></td>
		  		      <td class="bodytext31" valign="center"  align="left">
			  <div class="bodytext31" align="center"><a href="viewrfqpo.php?billnumber=<?php echo $pono; ?>">View</a></div></td>
			    </tr>
			  <?php
			}
			?>
