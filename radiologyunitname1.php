...
if ($frmflag1 == 'frmflag1')
{
	...
	if ($len1<=25 && $len2<=10)
	{
	$query2 = "select * from master_radiology where itemname = '$itemname' and itemname_abbreviation = '$itemname_abbreviation'";
	$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
	$res2 = mysql_num_rows($exec2);
	if ($res2 == 0)
	{
		$query1 = "insert into master_radiology (itemname, ipaddress, updatetime, itemname_abbreviation) 
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="radiologyunitname1.php" onSubmit="return radiologyunitname1process1()">
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Radiology Units Master - Add New </strong></td>
                      </tr>
                      <tr>
                ...
                <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="3" bgcolor="#CCCCCC" class="bodytext3"><strong>Radiology Units Master - Existing List </strong></td>
                      </tr>
                      <tr bgcolor="#011E6A">
                      ...
                      <?php
	    $query1 = "select * from master_radiology where status <> 'deleted' order by itemname ";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
        ...
        <tr <?php echo $colorcode; ?>>
						...
						<a href="radiologyunitname1.php?st=del&&anum=<?php echo $auto_number; ?>"><img src="images/b_drop.png" width="16" height="16" border="0" /></a></div></td>
		...
		?>
                ...
                <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="3" bgcolor="#CCCCCC" class="bodytext3"><strong>Radiology Units Master - Deleted </strong></td>
                      </tr>
                      <tr bgcolor="#011E6A">
        ...
        <tr <?php echo $colorcode; ?>>
						...
						<a href="radiologyunitname1.php?st=activate&&anum=<?php echo $auto_number; ?>" class="bodytext3">
