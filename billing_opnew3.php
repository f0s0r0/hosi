...
if ($frm1submit1 == 'frm1submit1')
{
	...
	$query21=mysql_query("update master_visitentry set servicebill='completed' where visitcode='$visitcode'");
header("location:billing_pending_opservice.php");
...
$servicesprefix = $res3['serviceprefix'];

$query2 = "select * from billing_services order by auto_number desc limit 0, 1";
$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
$res2 = mysql_fetch_array($exec2);
$billnumber = $res2["billnumber"];
if ($billnumber == '')
{
	$billnumbercode =$servicesprefix.'00000001';
	$openingbalance = '0.00';
}
else
{
	...
	$billnumbercode = $servicesprefix .$maxanum1;
	$openingbalance = '0.00';
	//echo $companycode;
}
?>
...
<form name="frmsales" id="frmsales" method="post" action="billing_opnew3.php" onKeyDown="return disableEnterKey(event)">
        ...
        <td><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
               ...
               <td bgcolor="#CCCCCC" class="bodytext3"><strong>Service Bill No. </strong></td>
	 <td bgcolor="#CCCCCC" class="bodytext3"> <input name="billnumber" id="billnumber" value="<?php echo $billnumbercode; ?>" <?php echo $billnumbertextboxvalidation; ?> style="border: 1px solid #001E6A; text-align:right" size="8" readonly="readonly"/> </td>
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
			...
			$sno = '';
			$totalamount=0;
			$query17 = "select * from consultation_services where patientvisitcode='$visitcode' and patientcode='$patientcode' and paymentstatus='pending' group by servicesitemname";
