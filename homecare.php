...
//get ends here
	$paynowbillprefix = 'HOM-';
$paynowbillprefix1=strlen($paynowbillprefix);
$query2 = "select * from homecare order by auto_number desc limit 0, 1";
...
<table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                   <tr bgcolor="#011E6A">
              <td colspan="5" bgcolor="#CCCCCC" class="bodytext3"><strong> Search Patient to Homecare </strong></td>
              <?php
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="792">
        <form name="form1" id="frmsales" method="post" action="homecare.php" onKeyDown="return disableEnterKey(event)">
