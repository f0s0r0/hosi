...
header('Content-Disposition: attachment;filename="Radtemplate.xls"');
	...
	font-size:11px;
          ...
          <tbody>
              <tr >
                        ...
                        <td width="9%"  class="bodytext3"><strong>ID / Code </strong></td>
                        <td width="12%"  class="bodytext3"><strong>Category</strong></td>
                        <td width="28%"  class="bodytext3"><strong>Radiology Item</strong></td>
                        <td width="13%"  class="bodytext3"><strong>Unit</strong>                          <div align="center"><strong><!--Purchase--></strong></div></td>
                        <td width="9%"  class="bodytext3"><div><strong>Charges</strong></div></td>
						...
						<td width="11%"  class="bodytext3"><div><strong>IP Markup</strong></div></td>
						<td width="13%"  class="bodytext3"><div><strong>Location</strong></div></td>
