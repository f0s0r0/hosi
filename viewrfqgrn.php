...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><form name="cbform1" method="post" action="viewrfqgrn.php">
          <table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong>View GRN </strong></td>
              </tr>
...
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
           ...
           <?php
		$query1 = "select * from purchase_details where itemstatus <> 'deleted' and entrydate between '$fromdate' and '$todate' group by billnumber order by auto_number desc ";
		...
		$colorloopcount = $colorloopcount + 1;
		 ...
		 <tr <?php echo $colorcode; ?>>
			 ...
			 <td class="bodytext31" valign="center"  align="left"><?php echo $res1entrydate; ?></td>
			 <td class="bodytext31" valign="center"  align="left"><?php echo $res1store; ?></td>
			 <td class="bodytext31" valign="center"  align="left"><?php echo $res1location; ?></td>
             <td class="bodytext31" valign="center"  align="left"><?php echo strtoupper($res1username); ?></td>
			 <td class="bodytext31" valign="center"  align="center"><a href="viewrfqgrn1.php?cbfrmflag1=cbfrmflag1&&grnno=<?php echo $res1billnumber; ?>&&mrnno=<?php echo $res1ponumber; ?>&&ADate1=<?php echo $fromdate; ?>&&ADate2=<?php echo $todate; ?>" target="_blank"><strong>View</strong></a></td>
	      </tr>		 
         <?php } ?>
		  </tbody>
        </table>
