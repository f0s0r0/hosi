...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><form name="cbform1" method="post" action="ipotbillingreport.php">
          <table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong>OT Billing Report </strong></td>
              </tr>
            <!--
            <tr>
...
$querynw1 = "select * from ip_otbilling where consultationdate between '$fromdate' and '$todate' order by auto_number desc";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
...
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
             <tr>
			 <td colspan="6" bgcolor="#cccccc" class="bodytext31"><div align="left"><strong>OT Billing Report </strong><label class="number"><<<?php echo $resnw1;?>>></label></div></td>
			 </tr>
            <tr>
		...
		$query1 = "select * from ip_otbilling where consultationdate between '$fromdate' and '$todate' order by auto_number desc";
