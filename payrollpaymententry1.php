...
include ("autocompletebuild_payroll1.php");
...
$query2 = "select * from master_transactionpayroll where transactiontype='PAYMENT' and transactionmodule ='PAYMENT' order by auto_number desc limit 0, 1";
...
else
{
	...
	//echo $companycode;
		...
		$componentanum = $_REQUEST['componentanum'][$key];
		$componentname = $_REQUEST['componentname'][$key];
		$typecode = $_REQUEST['typecode'][$key];
		...
		if($acknow==$billnum)
		{
		$billnumsplit = explode('|',$billnum);
		$billnum = $billnumsplit[0];
		...
		$query9 = "insert into master_transactionpayroll (transactiondate, particulars, `componentanum`, `componentname`, `typecode`, `accountname`,
		transactionmode, transactiontype, transactionamount, cashamount,taxamount,
		paymonth, billanum, ipaddress, updatedate, balanceamount, companyanum, companyname, remarks, 
		transactionmodule,docno,accountcode,recordstatus,bankcode,locationcode,locationname) 
		values ('$transactiondate', '$particulars', '$componentanum', '$componentname', '$typecode', '$suppliername', 
		...
		'$transactionmodule','$billnumbercode','$suppliercode','allocated','$cashcode','$locationcode','$locationname')";
		$exec9 = mysql_query($query9) or die ("Error in Query10".mysql_error());
		
		$query37 = "insert into paymentmodecredit(billnumber,billdate,ipaddress,username,cash,cashcoa,source,transactionamount)values('$billnumbercode','$transactiondate','$ipaddress','$username','$adjamount','$cashcoa','payrollpaymententry','$adjamount')";
		...
		'$transactionmode', '$transactiontype', '$adjamount', '$adjamount', '$taxamount',
		'$billnum',  '$billanum', '$ipaddress', '$updatedate', '$balamount', '$companyanum', '$companyname', '$remarks', 
		'$transactionmodule','$billnumbercode','$suppliercode','allocated','$bankcode','$locationcode','$locationname')";
		$exec9 = mysql_query($query9) or die ("Error in Query10".mysql_error());
		
		$query37 = "insert into paymentmodecredit(billnumber,billdate,ipaddress,username,online,onlinecoa,source,transactionamount)values('$billnumbercode','$transactiondate','$ipaddress','$username','$adjamount','$onlinecoa','payrollpaymententry','$adjamount')";
        $exec37 = mysql_query($query37) or die(mysql_error());
		...
		if($acknow==$billnum1)
		{
		$billnumsplit = explode('|',$billnum1);
		$billnum = $billnumsplit[0];
		$query9 = "insert into master_transactionpayroll (transactiondate, particulars, `componentanum`, `componentname`, `typecode`, `accountname`,
		transactionmode, transactiontype, transactionamount, chequeamount,taxamount,
		paymonth, billanum, ipaddress, updatedate, balanceamount, companyanum, companyname, remarks, 
		transactionmodule,docno,accountcode,recordstatus,bankcode,locationcode,locationname,chequenumber, chequedate,bankname) 
		values ('$transactiondate', '$particulars', '$componentanum', '$componentname', '$typecode', '$suppliername', 
		'$transactionmode', '$transactiontype', '$adjamount', '$adjamount', '$taxamount',
		'$billnum',  '$billanum', '$ipaddress', '$updatedate', '$balamount', '$companyanum', '$companyname', '$remarks', 
		'$transactionmodule','$billnumbercode','$suppliercode','allocated','$bankcode','$locationcode','$locationname','$chequenumber','$chequedate','$bankname')";
		$exec9 = mysql_query($query9) or die ("Error in Query10".mysql_error());
		
		$query37 = "insert into paymentmodecredit(billnumber,billdate,ipaddress,username,cheque,chequecoa,source,transactionamount)values('$billnumbercode','$transactiondate','$ipaddress','$username','$adjamount','$chequecoa','payrollpaymententry','$adjamount')";
        $exec37 = mysql_query($query37) or die(mysql_error());
		...
		'$transactionmode', '$transactiontype', '$adjamount', '$adjamount', '$taxamount',
		'$billnum',  '$billanum', '$ipaddress', '$updatedate', '$balamount', '$companyanum', '$companyname', '$remarks', 
		'$transactionmodule','$billnumbercode','$suppliercode','allocated','','$locationcode','$locationname')";
		$exec9 = mysql_query($query9) or die ("Error in Query10".mysql_error());
		}
		}
		}
		...
		header ("location:payrollpaymententry1.php?st=success&&billnumber=$billnumbercode");
	    exit;
...
?>
<script>
window.open("print_paymentpayroll1.php?billnumber=<?php echo $billnumber; ?>", "OriginalWindow", 'width=522,height=650,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
</script>
<?php
}
//$st = $_REQUEST['st'];
...
<script type="text/javascript" src="js/autocomplete_payroll12.js"></script>
<script type="text/javascript" src="js/autosuggest2payroll1.js"></script>
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="payrollpaymententry1.php">
      ...
      <tr>
        <td>
				...
				<form name="form1" id="form1" method="post" action="payrollpaymententry1.php?cbfrmflag1=<?php echo $cbfrmflag1; ?>" onSubmit="return paymententry1process1()">
			  <table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                 <tbody>
				...
				<input type="hidden" name="suppliercode" value="<?php echo $suppliercode; ?>">
					...
					<input name="paymententrydate" id="paymententrydate" style="border: 1px solid #001E6A" value="<?php echo $updatedatetime; ?>"  readonly="readonly" onKeyDown="return disableEnterKey()" size="20" /><strong><span class="bodytext312"> <img src="images2/cal.gif" onClick="javascript:NewCssCal('paymententrydate')" style="cursor:pointer"/> </span></strong></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td align="left" valign="top"  bgcolor="#FFFFFF"><input type="checkbox" name="onaccount" id="onaccount" disabled="disabled" onClick="return checkvalid('<?php echo $number; ?>');"></td>
...
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            <tr>
              <td colspan="4" bgcolor="#cccccc" class="bodytext311"><strong><?php echo $suppliername; ?></strong></td>
          ...
          <td width="8%" bgcolor="#cccccc" class="bodytext311">&nbsp;</td>
            ...
            <tr>
              ...
              <td width="7%" align="left" valign="center" bordercolor="#f3f3f3" 
                bgcolor="#ffffff" class="bodytext311"><div align="left"><strong>Month </strong></div></td>
				<td width="12%" align="left" valign="center" bordercolor="#f3f3f3" 
                bgcolor="#ffffff" class="bodytext311"><div align="left"><strong>Description </strong></div></td>
              ...
              <td class="bodytext31" valign="center" bordercolor="#f3f3f3" align="left" 
                bgcolor="#ffffff"><div align="right"><strong> After Process </strong></div></td>
              <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left" 
			...
			$query2 = "select * from master_transactionpayroll where accountcode = '$suppliercode' and transactiontype = 'PROCESS' and recordstatus <> 'deleted'";
			$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
			...
			while ($res2 = mysql_fetch_array($exec2))
			{
				...
				$typecode = $res2['typecode'];
					
				$query3 = "select * from master_transactionpayroll where transactiontype = 'PAYMENT' and transactionmode <> 'CREDIT' and paymonth = '$billnumber' and componentanum = '$componentanum' and companyanum='$companyanum' and recordstatus = 'allocated'";
				$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
			...
			$query3 = "select * from master_transactionpayroll where transactiontype = 'PAYMENT' and transactionmode <> 'CREDIT' and paymonth = '$billnumber' and componentanum = '$componentanum' and companyanum='$companyanum' and recordstatus = 'allocated' order by auto_number desc";
			$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
			$res3 = mysql_fetch_array($exec3);
            ...
            <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left">
			  <input type="checkbox" name="ack[]" id="acknow<?php echo $sno; ?>" value="<?php echo $billnumber.'|'.$componentanum; ?>" onClick="updatebox('<?php echo $sno; ?>','<?php echo $balanceamount; ?>','<?php echo $number; ?>')"></td>
			  <input type="hidden" name="supplierbillnumber[]" value="<?php echo $supplierbillnumber; ?>">
			  <input type="hidden" name="componentanum[]" value="<?php echo $componentanum; ?>">
			  <input type="hidden" name="componentname[]" value="<?php echo $componentname; ?>">
			  <input type="hidden" name="typecode[]" value="<?php echo $typecode; ?>">
			  ...
			  <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left"><div align="left"><?php echo $componentname; ?></div></td>
              <input type="hidden" name="billnum[]" value="<?php echo $billnumber.'|'.$componentanum; ?>">
            ...
            <tr>
             ...
             <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left" 
                bgcolor="#cccccc"><input type="hidden" name="totcount" id="totcount" value="<?= $sno; ?>">
				<input type="text" readonly="readonly" name="totaladjamt" id="totaladjamt" size="7" class="bal"></td>
             <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left" 
                bgcolor="#cccccc">&nbsp;</td>
			</tr>
          </tbody>
