...
if ($frmflag1 == 'frmflag1')
{
	...
	if ($length<=100)
	{
	$query2 = "select * from master_accountssub where accountssub = '$accountssub'";
	$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
	$res2 = mysql_num_rows($exec2);
	if ($res2 == 0)
	{
		$query1 = "insert into master_accountssub (accountsmain, accountssub, ipaddress, recorddate, username, id) 
		values ('$accountsmain', '$accountssub', '$ipaddress', '$updatedatetime', '$username', '$id')";
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="addaccountssub.php" onSubmit="return addward1process1()">
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Accounts Sub Type Master - Add New </strong></td>
                      </tr>
					  <tr>
                      ...
                      <tr>
						...
						<select name="accountsmain" id="accountsmain" >
				...
				?>
                      ...
                      <tr>
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Add New Accounts Sub</div></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
						<input name="accountssub" id="accountssub" style="text-transform:uppercase" size="40" /></td>
                      </tr>
                      <tr>
                ...
                <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="5" bgcolor="#CCCCCC" class="bodytext3"><strong>Accounts Sub  Type Master - Existing List </strong></td>
                      </tr>
                      <tr>
                        <td align="left" valign="top" bgcolor="#CCCCCC"  class="bodytext3">&nbsp;</td>
                        <td width="22%" align="left" valign="top" bgcolor="#CCCCCC"  class="bodytext3"><strong>Main Type </strong></td>
                      ...
                      <?php
	    $query1 = "select * from master_accountssub where recordstatus <> 'deleted' order by accountsmain ";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		while ($res1 = mysql_fetch_array($exec1))
		{
		$accountsmainanum = $res1['accountsmain'];
		...
		?>
                      <tr <?php echo $colorcode; ?>>
					    ...
					    <a href="addaccountssub.php?st=del&&anum=<?php echo $auto_number; ?>" onClick="return funcDeleteSubType('<?php echo $accountssub;?>')">
						<img src="images/b_drop.png" width="16" height="16" border="0" /></a></div></td>
                        <td align="left" valign="top"  class="bodytext3"><?php echo $accountsmain; ?> </td>
                        <td align="left" valign="top"  class="bodytext3"><?php echo $id; ?></td>
                        <td align="left" valign="top"  class="bodytext3"><?php echo $accountssub; ?> </td>
                        <td align="left" valign="top"  class="bodytext3">
						<a href="editaccountssub.php?st=edit&&anum=<?php echo $auto_number; ?>" style="text-decoration:none">Edit</a>						</td>
                      </tr>
                      <?php
		}
		?>
                ...
                <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Accounts Sub Type Master - Deleted </strong></td>
        ...
        <tr <?php echo $colorcode; ?>>
						...
						<a href="addaccountssub1.php?st=activate&&anum=<?php echo $auto_number; ?>" class="bodytext3">
                          <div align="center" class="bodytext3">Activate</div>
                        </a></td>
                        <td width="37%" align="left" valign="top"  class="bodytext3"><?php echo $accountsmain; ?></td>
                        <td width="52%" align="left" valign="top"  class="bodytext3"><?php echo $accountssub; ?></td>
        </tr>
                      <?php
		}
		?>
