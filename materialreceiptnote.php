...
$query2 = "select * from materialreceiptnote_details where typeofpurchase='Process' order by auto_number desc limit 0, 1";
...
$itemstatus = '';
			...
			{		
				...
				values ('$fifo_code','purchase_details','$itemcode', '$itemname', '$dateonly','1', 'Purchase', 
				'$batchnumber', '$allpackagetotalquantity', '$allpackagetotalquantity', 
				'$allpackagetotalquantity', ";
				$billnumbercode =  $billnumbercode;
			$stockquery2 .= "	'$billnumbercode', 'New Batch','1','1', '$locationcode','','$storecode', '', '$username', '$ipaddress','$dateonly','$timeonly','$updatedatetime','$salesprice','$totalamount')";
			...
			$query4 = "insert into materialreceiptnote_details (companyanum, 
			billnumber, itemcode, itemname, rate, quantity, 
			...
			values ('$companyanum', '$billnumbercode', '$itemcode', '$itemname', '$rate', '$quantity', 
...
while ($res5 = mysql_fetch_array($exec5))
{
	...
	$billdatestr = strtotime($billdate);
	$mrndate = strtotime($dateonly);
...
$tele=$tele.','.$telephone1;
  ...
  $diffstr =  $mrndate - $billdatestr;
 
if($diffstr > 2592000)
	{
	
	echo "<script>alert('Validity Date of PO is expired');</script>";
}
...
{
var popWin; 
popWin = window.open("print_mrn_dmp4inch1.php?billautonumber=<?php echo $billnumbercode; ?>&&billnum=<?php echo $billnum; ?>");
}
...
-->
  <tr>
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
		 <form name="cbform1" method="post" action="materialreceiptnote.php"> 
	  ...
	  <td>&nbsp;	  </td>
			...
			<tr>
              <td bgcolor="#CCCCCC" class="bodytext3" colspan="8"><strong>Material Receipt Note</strong></td>
		</tr>
			  ...
			  <tr>
                ...
                <td colspan="3" align="left" valign="top" ><input name="po" id="po" value="<?php echo $billnum; ?>" style="border: 1px solid #001E6A" size="10" rsize="20" autocomplete="off"/></td>
      ...
      <tr>
        <td>
		<form action="materialreceiptnote.php" method="post" name="form">
...
?>
  <tr>
		...
		<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" name="balqty[]" id="balqty<?php echo $sno; ?>" value="<?php echo $balanceqty; ?>" class="bal" readonly size="10"></div></td>
		...
		<input type="hidden" name="spmarkup" id="spmarkup<?php echo $sno; ?>" value="<?php echo $spmarkup; ?>"><input type="hidden" name="saleprice[]" id="saleprice<?php echo $sno; ?>" size="6" class="bodytext21" readonly></div></td>
		...
		<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" name="totalamount[]" id="totalamount<?php echo $sno; ?>" size="6" class="bodytext21" readonly></div></td>
		<input type="hidden" name="costprice[]" id="costprice<?php echo $sno; ?>" size="6" class="bodytext21" readonly>
						</tr>
			<?php 
