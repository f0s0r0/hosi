...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><form name="cbform1" method="post" action="bedoccupancysummary.php">
          <table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Bed Occupancy Summary</strong></td>
	  ...
	  <tr>
        <td>
	<form name="form1" id="form1" method="post" action="bedoccupancysummary.php">	
...
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse; float:none" 
          ...
          <tbody>
             <tr>
			 <td colspan="4" bgcolor="#cccccc" class="bodytext31"><div align="left"><strong>Bed Occupancy Summary</strong></div></td>
			 </tr>
            <tr>
         ...
         <tr>
             <?php if($totalpatients > 0) { $avgstay= $totalbedday/$totalpatients ; } else { $avgstay = '0.00'; } ?>
			  ...
			  <td width="143"  align="left" valign="center" class="bodytext31">
                ...
                <td width="4%" align="left" valign="center" bgcolor="#E0E0E0" class="bodytext31"><div align="left"><a target="_blank" href="print_bedoccupancysum.php?&&location=<?php echo $location; ?>&&ward=<?= $searchward ?>&&ADate1=<?= $fromdate ?>&&ADate2=<?= $todate ?>&&cbfrmflag1=cbfrmflag1"><img src="images/excel-xls-icon.png" width="30" height="30"></a></div></td>
      </tr> 
