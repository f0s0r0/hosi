...
$maxanum = $labrefcode;
	...
	$categorylabquery1=mysql_query("insert into consultation_lab(patientcode,patientname,patientvisitcode,labitemname,labitemrate,consultationdate,paymentstatus,labsamplecoll,resultentry,labrefund,refno)values('walkin','$patientfullname','walkinvis','$categorylabname','$categorylabrate','$currentdate','paid','pending','pending','norefund','$labrefcode')") or die(mysql_error());
		...
		$query491 = "insert into master_triagebilling(patientcode,patientname,patientvisitcode,billtype,accountname,consultationdate,username,docnumber)values('$patientcode','$patientname','$visitcode','$billingtype','$accountname','$currentdate','$username','$consultationcode')";
...
if(consult > 0)
{
alert("Patient is Already Consulted By Doctor . Please Use Consultation to Add More Requests");
return false;
}
}
...
<form name="form1" id="frmsales" method="post" action="dcbilling.php" onKeyDown="return disableEnterKey(event)" onSubmit="return processcheck()">
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<?php if($num765 > '0') {?>
        <td bgcolor="#FA5858" class="bodytext311" align="left" colspan="3">Patient is Already Consulted By Doctor, Please Use Consultation to Requests More</td>
		<?php }else {?>
		<td>&nbsp;</td>
		<?php } ?>
		</tr>
				  ...
				  <tr id="labid">
				   <td colspan="11" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">
                     ...
                     <tr>
					   ...
					   <td colspan="2" width="30" class="bodytext3">&nbsp;</td>
                     </tr>
					  <tr>
