...
<tr>
  ...
  $newamount=0;
		  ...
		  $querypaynow="select labitemrate as amount,patientcode,patientvisitcode,patientname,billdate,accountname,labitemname from  billing_paynowlab where billdate between '$ADate1' and '$ADate2' and locationcode='$locationcode1' ";
...
<tr>
 ...
 <?php
     $querypaylater="select labitemrate as amount,patientcode,patientvisitcode,patientname,billdate,accountname,labitemname from  billing_paylaterlab where billdate between '$ADate1' and '$ADate2' and locationcode='$locationcode1' ";
		  ...
		  while($respaylater = mysql_fetch_array($execpaylater))
		  {
		   ...
		   $accountname= $respaylater['accountname'];
   		   $labitemname=$respaylater['labitemname'];
