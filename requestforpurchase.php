...
{
   $paynowbillprefix = 'REQ-';
$paynowbillprefix1=strlen($paynowbillprefix);
$query2 = "select * from purchase_rfqrequest where rfqstatus='original' order by auto_number desc limit 0, 1";
...
else
{
	...
	$remarks = $_REQUEST['remarks'];
		...
		{	
			...
			//echo '<br>'.
		    $medicinename = mysql_real_escape_string($_REQUEST['medicinename'.$p]);
			...
			{
		       $query43="insert into purchase_rfqrequest(date,docno,medicinename,medicinecode,quantity,packagequantity,rate,amount,username,status,remarks,companyanum,location,rfqstatus,locationname,locationcode)values
		                 ('$dateonly','$billnumbercode','$medicinename','$medicinecode','$reqqty','$pkgqty','$rate','$amount','$username','$status','$remarks','$companyanum','$location','original','$locationname','$locationcode')";
...
var packvalue=packsize.replace ( /[^\d.]/g, '' );
...
<form name="form1" id="frmsales" method="post" action="requestforpurchase.php" onKeyDown="return disableEnterKey(event)">
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellpadding="0" cellspacing="0" bgcolor="#E0E0E0">
	  ...
	  <td>&nbsp;
			...
			<tr>
              <td bgcolor="#CCCCCC" class="bodytext3" colspan="8"><strong>Prepare RFQ</strong></td>
