...
//get ends here
	$paynowbillprefix = 'AMB-';
$paynowbillprefix1=strlen($paynowbillprefix);
$query2 = "select * from ip_ambulance order by auto_number desc limit 0, 1";
...
else
{
	...
	$paymentmode = $_REQUEST['billtype'];
		...
		if($pairvar!="")
		{
		$referalquery1=mysql_query("insert into ip_ambulance(docno,units,amount,patientcode,patientname,patientvisitcode,description,rate,billtype,accountname,consultationdate,paymentstatus,consultationtime,remarks,username,ipaddress,locationname,locationcode)values('$billnumbercode','$units','$amount','$patientcode','$patientfullname','$visitcode','$pairvar','$pairvar1','$billtype','$account','$dateonly','pending','$timeonly','$remarks','$username','$ipaddress','".$locationnameget."','".$locationcodeget."')") or die(mysql_error());
...
<form name="form1" id="frmsales" method="post" action="ipambulancedirect.php" onKeyDown="return disableEnterKey(event)">
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<tr>
                ...
                <input type="hidden" value="<?php echo $from ?>" name="formfrom" id="formfrom">				</tr>       
