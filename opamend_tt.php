...
*/	
	...
	mysql_query("update master_consultation set approvalstatus='completed' where patientcode='$patientcode' and patientvisitcode='$visitcode' ");
	...
	{		
	    ...
	    echo $pharamapprovalstatus = isset($_POST['pharamcheck'][$i])?'1':'0';
		echo $pharamapprovalstatus = isset($_POST['pharamlatertonow'][$i])?'2':$pharamapprovalstatus; 
		...
		{ echo "update master_consultationpharmissue set approvalstatus='$pharamapprovalstatus',paymentstatus='pending'  where auto_number='$pharamcheck' and patientvisitcode='$visitcode'";
			...
			mysql_query("update master_consultationpharm set approvalstatus='$pharamapprovalstatus', paymentstatus='pending', pharmacybill='pending'  where auto_number='$pharamcheck' and patientvisitcode='$visitcode'");
			$counter=$counter + 1;
		}
		...
		{ 
echo 'hi';
			echo ("update master_consultationpharmissue set approvalstatus='$pharamapprovalstatus',paymentstatus='completed'  where auto_number='$pharamcheck' and patientvisitcode='$visitcode'");
			echo ("update master_consultationpharm set approvalstatus='$pharamapprovalstatus', paymentstatus='completed',pharmacybill='$status'  where auto_number='$pharamcheck' and patientvisitcode='$visitcode'");
			$counter=$counter + 1;
		}
...
<form name="form1" id="frmsales" method="post" action="opamend_tt.php">
      ...
      <tr>
		...
		if((($excludestatus == '')&&($excludebill == ''))||(($excludestatus == 'excluded')&&($excludebill == '')))
			...
			?>
			  ...
			  <input type="" name="pharamanum[<?php echo $sno; ?>]" id="pharamanum<?php echo $sno; ?>"  value="<?php echo $medanum; ?>">
			  </div></td>
			  <?php } ?>
