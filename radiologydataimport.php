...
if ($frmflag1 == 'frmflag1')
{
	...
	if ($fileformat == 'txt') // || $fileformat == 'peg') // || $fileformat == 'gif')
	{
		...
		{
			header ("location:radiologydataimport1.php?upload=success&&location=$location");
		}
		else
		{
			header ("location:radiologydataimport.php?upload=failed");
		}
...
function dataimport1verify()
{
	...
	{
		alert ("Please Select Add Location");
...
function deletelocationdata()
{
	...
	if (document.form1.dellocation.value == "")
	{
		alert ("Please Select Delete  Location");
		document.form1.dellocation.focus();
		return false;
	}
	
	var dellocation=document.getElementById("dellocation").value;	
	//alert(dellocation);
	if (confirm("Do You Want To Delete The Record?")==false){return false;}
	
	window.location.href = "radiologydataimport1.php?dellocation="+dellocation;
}
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form action="radiologydataimport.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onSubmit="return dataimport1verify()">
                  <table width="800" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      ...
                      <tr>
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><a href="tab_file_dump/Radiology_Sample_File.xlsx" class="bodytext3"><span class="bodytext3"><strong>Sample Download File Click Here...</strong></span></a></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF">&nbsp;</td>
                      </tr>
                       <tr>
                        <td align="right" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><strong>Delete for Location</strong></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF"><span class="bodytext3"><strong><select name="dellocation" id="dellocation"  style="border: 1px solid #001E6A;">
                  		<option value="" >Select Location </option>
				  <?php
						
						$query1 = "select * from master_location where status <> 'deleted'  group by locationname order by locationname";
                       ...
                       <tr>
						...
						<input type="hidden" name="frmflag2" value="addnew" />
                            <input type="hidden" name="frmflag12" value="frmflag12" />
                          <input type="button" name="Submit" id="delete" value="Delete" onClick="return deletelocationdata()" style="border: 1px solid #001E6A" />                        </td>
                      </tr> 
                     
                      <tr>
                        <td align="right" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><strong>Add for Location</strong></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF"><span class="bodytext3"><strong><select name="location" id="location"  style="border: 1px solid #001E6A;">
                 	<option value="" >Select Location </option>
                 	 <?php
