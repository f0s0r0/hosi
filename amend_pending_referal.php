...
<body>
<?php $querynw1 = "select * from master_visitentry where referalbill='pending' order by consultationdate DESC";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
          ...
          <tbody>
            <tr>
              ...
              <td colspan="6" bgcolor="#cccccc" class="bodytext31"><script language="javascript">
                ...
                <div align="left"><strong>Amend Referal</strong><label class="number"><<<?php echo $resnw1;?>>></label></div></td>
              </tr>
			...
			$colorloopcount = '';
			$sno = '';
			$query1 = "select * from master_visitentry where referalbill='pending' order by consultationdate DESC";
		   ...
		   $query56="select * from master_accountname where auto_number='$patientaccountname'";
		   $exec56=mysql_query( $query56) or die(mysql_error());
		   $res56=mysql_fetch_array($exec56);
		   $accname=$res56['accountname'];
            ...
            <tr <?php echo $colorcode; ?>>
			  ...
			  <div class="bodytext31" align="center"><?php echo $patientname; ?></div></td>
               <td class="bodytext31" valign="center"  align="left">
			  <div class="bodytext31" align="center"><?php echo $accname; ?></div></td>
              
              <td class="bodytext31" valign="center"  align="left"><a href="amendreferal.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>"><strong>Amend</strong></a>			  </td>
              </tr>
			<?php
			}    
			?>
