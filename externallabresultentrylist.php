          ...
          <tbody>
            <tr>
              ...
              <td colspan="4" bgcolor="#cccccc" class="bodytext31">
                ...
                <div align="left"><strong>Lab Result Entry</strong></div></td>
              </tr>
            <tr>
			...
			$query1 = "select * from consultation_lab where labsamplecoll='completed' and resultentry='pending' and patientcode='walkin' group by sampleid order by consultationdate desc";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center" align="left">
			    <div align="left"><a href="externallabresultentry.php?billnumber=<?php echo $billnumber; ?>&&sampleid=<?php echo $sampleid; ?>"><strong>Enter</strong></a></div></td>
              </tr>
			<?php
			}    
			?>
