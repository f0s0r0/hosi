...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><form name="cbform1" method="post" action="inpatientpackage.php">
          <table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Package Inpatient </strong></td>
...
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
             <tr>
			 <td colspan="6" bgcolor="#cccccc" class="bodytext31"><div align="left"><strong>Package Inpatient </strong><label class="number"></label></div></td>
			 </tr>
            <tr>
	       ...
	       $query1 = "select * from master_ipvisitentry where locationcode='$locationcode1' and consultationdate  between '$fromdate' and '$todate' and package <> 0 order by auto_number desc ";
		   ...
		   $package = $res1['package'];
		    ...
		    $query2 = "select * from master_ippackage where locationcode='$locationcode1' and status='' and auto_number = '$package' ";
          ...
          <tr <?php echo $colorcode; ?>>
			  ...
			  <div class="bodytext31" align="center"><?php echo $patientfullname; ?></div></td>
			  <td class="bodytext31" valign="center"  align="left">
