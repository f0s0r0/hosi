...
if ($frm1submit1 == 'frm1submit1')
{
	...
	$query21 = "select * from consultation_radiology where patientcode='$patientcode' and patientvisitcode='$visitcode' order by auto_number desc limit 0, 1";
	...
	$rad= $_POST['radiology'];
		...
		if(($pairvar!="")&&($pairvar1!=""))
		{
		$radiologyquery1="insert into consultation_radiology(consultationid,patientcode,patientname,patientvisitcode,radiologyitemcode,radiologyitemname,radiologyitemrate,billtype,accountname,consultationdate,paymentstatus,refno,resultentry,locationcode,locationname,username)values('$consultationid','$patientcode','$patientname','$visitcode','$radiologycode','$pairvar','$pairvar1','$patientpaymentmode','$accountname','$consultationdate','$status','$radrefnonumber','pending','$locationcode','$locationname','$username')";
		...
		header("location:amend_pending_radiology.php");
		exit;
...
$data=mysql_query("select auto_number,patientcode,patientvisitcode,patientname,refno,radiologyitemcode,radiologyitemname,radiologyitemrate from consultation_radiology where auto_number='$radiologyname'");
...
if($medicinecode<>'')
{
 $query="insert into amendment_details (patientcode,visitcode,patientname,refno,itemcode,itemname,rate,amenddate,amendtime,amendfrom,amendby,ipaddress) values ('$patientcode','$visitcode','$patientname','$refno','$medicinecode','$medicinename','$rate','$date','$time','radiology','$username','$ipaddress')";
mysql_query($query)or die("Error in query".mysql_error());
}

mysql_query("delete from consultation_radiology where auto_number='$radiologyname' and patientvisitcode='$visit'");
}
...
function funcOnLoadBodyFunctionCall()
{
	...
	funcCustomerDropDownSearch2(); //To handle ajax dropdown list.
...
<form name="form1" id="frmsales" method="post" action="amendradiology.php" onKeyDown="return disableEnterKey(event)" onSubmit="return validcheck()">
...
-->
  <tr>
            ...
            <tbody>
			  ...
			  <tr>
			   ...
			   <tr>
				...
				<input type="hidden" name="subtype" id="subtype"  value="<?php echo $res111subtype; ?>" >		</td>
				  </tr>
				  <tr>
	...
	$status='completed';
			...
			$query17 = "select * from consultation_radiology where patientvisitcode='$visitcode' and patientcode='$patientcode' and paymentstatus='$status' and resultentry='pending'";
			...
			?>
			 ...
			 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $paharmitemname; ?></div></td>
			    <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $pharmitemrate; ?></div></td>
				 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $pharmitemrate; ?></div></td>
				  <td class="bodytext31" valign="center"  align="left"><div align="center"><a onClick="return deletevalid()" href="amendradiology.php?delete=<?php echo $radanum; ?>&&patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>">Delete</a></div></td>
     ...
     <tr id="radid">
				 ...
				 <tr>
				   <td colspan="6" align="right" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><span class="style2">Total Amount</span><input type="text" id="total2" readonly size="7" value="<?php echo number_format($totalamount,2,'.',''); ?>"></td>
				   </tr>
