    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong>High Cost Visit</strong></td>
              </tr>
            <!--<tr>
...
&nbsp;				<input  value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />-->
	...
	<?php $urlpath = "ADate1=$ADate1&&ADate2=$ADate2&&accountname=$searchsuppliername&&amount=$amount&&range=$range";?>
		<td class="bodytext31" valign="top" bgcolor="#E0E0E0" align="left"> 
                 <a target="_blank" href="print_highcostvisit.php?<?php echo $urlpath;?>"><img src="images/pdfdownload.jpg" width="30" height="30"></a> 
                </td>  
            </tr>
            <tr>
              <td class="bodytext31" valign="center"  align="left" 
