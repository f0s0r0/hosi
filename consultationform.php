...
$username = $_SESSION["username"];
 ...
 $query6=mysql_query("select * from master_customer where customercode='$patientcode'");
...
$updatedatetime = date('Y-m-d H:i:s');
	...
	if ($res2 == 0)
	{
		...
		{
		$newquery1=mysql_query("update master_visitentry set doctorconsultation='' where visitcode='$visitcode'");
		}
		else
		{
...
else
{
	...
	//}
		...
		$queryref = "update consultation_referal set consultation='completed' where patientvisitcode='$visitcode'";
		$execref = mysql_query($queryref) or die(mysql_error());
		...
		$query93=mysql_query("update master_visitentry set overallpayment='',pharmacybill='',labbill='',servicebill='' where visitcode='$visitcode'") or die(mysql_error());
		//	
		//$patientcode = '';
		//$visitcode = '';
		$patientcode = '';
...
$viscode=$_REQUEST['visitcode'];
 ...
 $exec679 = mysql_query($query679) or die(mysql_error());
...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top">
     <form name="form1" id="form1" method="post" action="consultationform.php" onSubmit="return process1();"  onKeyDown="return disableEnterKey(event)">
