...
if ($frmflag1 == 'frmflag1')
{
	...
	if ($length<=100)
	{
	$query2 = "select * from master_accountname where accountname = '$accountname'";
	$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
	$res2 = mysql_num_rows($exec2);
	if ($res2 == 0)
	{
		$query1 = "insert into master_accountname (accountname,recordstatus, paymenttype, subtype, expirydate, ipaddress, recorddate, username,address,accountsmain,accountssub,openingbalancecredit,openingbalancedebit,id, contact) 
		values ('$accountname', '$recordstatus','$paymenttype', '$subtype', '$expirydate','$ipaddress', '$updatedatetime', '$username','$address','$accountsmaintype','$accountssub','$openingbalancecredit','$openingbalancedebit','$id','$contact')";
	...
	{
		$errmsg = "Failed. Account Name Already Exists.";
		$bgcolorcode = 'failed';
	}
	}
	else
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="addaccountname1.php">
                  <table width="956" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="right" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"></td>
                      ...
                      <tr>
                        ...
                        <td colspan="3" align="left" valign="top"  bgcolor="#FFFFFF">
                          <input type="text" name="expirydate" id="expirydate" value="<?php echo "2015-01-01"; ?>"   onFocus="return funcexpiry();" readonly="readonly"  >
                ...
                <table width="955" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    ...
                    <?php
	    $query1 = "select * from master_accountname where recordstatus <> 'deleted' order by accountssub ";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
