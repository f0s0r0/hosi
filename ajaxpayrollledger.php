...
global $a_json;
	...
	if($type == '10')
	{
	$query2 = "select * from master_accountname where accountname like '%$term%' and recordstatus <> 'deleted' and accountssub = '4' order by accountname limit 0, 10";
	}
	else if($type == '20')
	{
	$query2 = "select * from master_accountname where accountname like '%$term%' and recordstatus <> 'deleted' and accountssub = '30' order by accountname limit 0, 10";
	}
	else
	{
	$query2 = "select * from master_accountname where accountname like '%$term%' and recordstatus <> 'deleted' and accountssub IN ('4','30') order by accountname limit 0, 10";
	}
