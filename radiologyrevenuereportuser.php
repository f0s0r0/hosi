    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="radiologyrevenuereportuser.php">
                <table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                    <tr bgcolor="#011E6A">
                      <td colspan="3" bgcolor="#CCCCCC" class="bodytext3"><strong>Radiology Revenue Report </strong>&nbsp;&nbsp;&nbsp;<a href="#" onClick="viewReport();"><strong>W</strong></a></td>
...
&nbsp;				<input  value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />-->
            ...
            <tr>
              ...
              <td width="10%" align="right" valign="right"  
                bgcolor="#ffffff" class="style1">Rate</td>
		    ...
		    if (isset($_REQUEST["cbfrmflag1"])) { $cbfrmflag1 = $_REQUEST["cbfrmflag1"]; } else { $cbfrmflag1 = ""; }
				...
				if ($cbfrmflag1 == 'cbfrmflag1')
				{
		  $query2 = "select * from master_radiology group by itemname"; 
		  ...
		  $query3 = "select * from billing_externalradiology where radiologyitemname = '$res2itemname' and billdate between '$transactiondatefrom' and '$transactiondateto'";
		  $exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
		  $num1 = mysql_num_rows($exec3);
		  //echo $num1;
		  $res3 = mysql_fetch_array($exec3);
		  
		  $query4 = "select * from billing_paylaterradiology where radiologyitemname = '$res2itemname' and billdate between '$transactiondatefrom' and '$transactiondateto' ";
		  $exec4 = mysql_query($query4) or die ("Error in Query4".mysql_error());
		  $num2 = mysql_num_rows($exec4);
		  //echo $num2;
		  $res4 = mysql_fetch_array($exec4);
		  
		  $query5 = "select * from billing_paynowradiology where radiologyitemname = '$res2itemname' and billdate between '$transactiondatefrom' and '$transactiondateto' ";
		  $exec5 = mysql_query($query5) or die ("Error in Query5".mysql_error());
		  $num3 = mysql_num_rows($exec5);
		  //echo $num3;
		  $res5 = mysql_fetch_array($exec5);
		  
		  $query6 = "select * from billing_ipradiology where radiologyitemname = '$res2itemname' and billdate between '$transactiondatefrom' and '$transactiondateto' ";
		  ...
		  $total = $total + $amount;
           ...
           <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left">
                <div class="bodytext31"><?php echo $num4; ?></div>              </td>
              <td class="bodytext31" valign="center"  align="right">
			  <?php echo number_format($res2rate,2,'.',','); ?></td>
              <td class="bodytext31" valign="center"  align="right">
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="right" 
                bgcolor="#cccccc"><?php echo number_format($total,2); ?></td>
