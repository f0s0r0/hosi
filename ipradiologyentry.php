...
mysql_query("update ipconsultation_radiology set resultentry='$status',radiologyrefund='$status1',docnumber='$docnumber',locationcode = 
'".$locationcodeget."',locationname='".$locationnameget."' where patientvisitcode='$visitcode' and radiologyitemname='$radiologyname'");
...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
 ...
 <td colspan="8" align="left" valign="middle"  bgcolor="<?php if ($errmsg == '') { echo '#FFFFFF'; } else { echo '#AAFF00'; } ?>" class="bodytext3"><?php echo $errmsg;?>&nbsp;</td></tr>
	  ...
	  <td width="25%" align="left" valign="middle" bgcolor="#CCCCCC" class="bodytext3">
               ...
               <td width="3%" align="left" valign="middle"  bgcolor="#CCCCCC" class="bodytext3"><strong>Doc No</strong></td>
                <td width="15%" align="left" valign="middle" bgcolor="#CCCCCC" class="bodytext3">
  ...
  <tr>
	...
	<td class="bodytext31" valign="center"  align="left"><div align="center">
			<select name="Class[]" id="Class<?php echo $sno; ?>" onChange="if (this.value) window.open(this.value, '_blank'); disableafterclick(<?php echo $sno; ?>);" >
				...
				?>
                   <option value="ipappendto.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&tid=<?php echo $res5anum; ?>&&itemcode=<?php echo $itemcode; ?>&&docnum=<?php echo $billnumbercode; ?>"><?php echo $res5templatename; ?></option>
                    <?php
				}
				?>
