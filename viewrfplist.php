...
<body>
<?php
$query1 = "select * from purchase_rfqrequest where approvalstatus='' group by docno";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
          ...
          <tbody>
            <tr>
              <td colspan="6" bgcolor="#cccccc" class="bodytext31">
                ...
                <div align="center"><strong>RFPs</strong><label class="number"><<<?php echo $resnw3;?>>></label>
                </div></td>
              </tr>
            <tr>
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left">
			    <div align="left"><?php echo $status; ?></div></td>
                 <td class="bodytext31" valign="center" align="left">
			    <div align="left"><a href="rfpapproval.php?docno=<?php echo $docno; ?>"><strong>VIEW</strong></a></div></td>
              </tr>
			<?php
			}    
			?>
