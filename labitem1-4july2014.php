...
if ($frmflag1 == 'frmflag1')
{
	...
	if ($length1<25 && $length2<255)
	{
		if($reference != '')
	{
	$query1 = "insert into master_lab (itemcode, itemname, categoryname, itemname_abbreviation, rateperunit, expiryperiod, taxanum, taxname, ipaddress, updatetime, description, purchaseprice, referencevalue,ipmarkup,sampletype,location,referencename,referenceunit,referencerange,rate2) 
			values ('$itemcode', '$itemname', '$categoryname', '$itemname_abbreviation', '$rateperunit', '$expiryperiod', '$taxanum', '$res4taxname', '$ipaddress', '$updatedatetime','$description', '$purchaseprice', '$referencevalue','$ipmarkup','$sampletype','$location','$reference','$units','$range','$rate2')";
	...
	$query24 = "select * from master_lab where itemcode = '$itemcode'";// or itemname = '$itemname'";
		...
		if($res24 == 0)
	{
		$query1 = "insert into master_lab (itemcode, itemname, categoryname, itemname_abbreviation, rateperunit, expiryperiod, taxanum, taxname, ipaddress, updatetime, description, purchaseprice, referencevalue,ipmarkup,sampletype,location,rate2) 
			values ('$itemcode', '$itemname', '$categoryname', '$itemname_abbreviation', '$rateperunit', '$expiryperiod', '$taxanum', '$res4taxname', '$ipaddress', '$updatedatetime','$description', '$purchaseprice', '$referencevalue','$ipmarkup','$sampletype','$location','$rate2')";
			$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		}
                    ...
                    <tbody>
                      ...
                      <tr>
						...
						?>
                          ...
                          <a href="labcategory1.php"><font  class="bodytext32" color="#000000">(Click Here To Add New Category)</font></a>
                          </td>
                      ...
                      <tr>
					   ...
					   <tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#E0E0E0" class="bodytext3">Sample Type</td>
                        <td align="left" valign="top"  bgcolor="#E0E0E0"><input name="sampletype" id="sampletype" style="border: 1px solid #001E6A" value="" size="20" /></td></tr>
				    <tr>
	  ...
	  <tr id="pressid">
	   ...
	   <tr>
                ...
                <table width="1200" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="15" bgcolor="#CCCCCC" class="bodytext3"><span class="bodytext32"><strong>Lab Item Master - Existing List - Latest 100 Lab Items </strong></span></td>
                      </tr>
                      <tr bgcolor="#011E6A">
	...
	$rate2 = $res1['rate2'];
		...
		?>
                ...
                <table width="1200" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="14" bgcolor="#CCCCCC" class="bodytext3"><strong>lab Item Master - Deleted </strong></td>
                      </tr>
                      <tr bgcolor="#011E6A">
                        <td colspan="14" bgcolor="#FFFFFF" class="bodytext3"><span class="bodytext32">
