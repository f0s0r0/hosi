...
<tr>
  ...
  $newamount=0;
		  ...
		  $querypaynow="select radiologyitemrate as amount,patientcode,patientvisitcode,patientname,billdate,accountname,radiologyitemname from  billing_paynowradiology where billdate between '$ADate1' and '$ADate2' and locationcode='$locationcode1'  ";
  ...
  <tr <?php echo $colorcode; ?> class="bodytext31">
    ...
    <td width="139"><?php echo $radiologyitemname; ?></td>
...
<tr>
  ...
  <tr>
    ...
    <td width="148" bgcolor="#ffffff" class="bodytext31"><strong>Account</strong></td>
    <td width="139" bgcolor="#ffffff" class="bodytext31"><strong>Test Name</strong></td>
    <td width="148" bgcolor="#ffffff" class="bodytext31" align="right"><strong>Amount</strong></td>
 ...
 <?php
     $querypaylater="select radiologyitemrate as amount,patientcode,patientvisitcode,patientname,billdate,accountname,radiologyitemname from  billing_paylaterradiology where billdate between '$ADate1' and '$ADate2' and locationcode='$locationcode1'";
  ...
  <tr <?php echo $colorcode; ?> class="bodytext31">
    ...
    <td width="148"><?php echo $accountname; ?></td>
    <td width="139"><?php echo $radiologyitemname; ?></td>
    <td width="148" align="right"><?php echo number_format($amount1); ?></td>
