            ...
            <?php
				...
				{  
					...
					$querydr1 = "SELECT SUM(`totalamount`) as expenses FROM `expensepurchase_details` WHERE `expensecode` = '$id' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2' and recordstatus <> 'deleted'
								 ...
								 UNION ALL SELECT SUM(depreciation) as expenses FROM assets_depreciation WHERE depreciationledgercode = '$id' AND entrydate BETWEEN '$ADate1' AND '$ADate2'";
					...
					<a href="detail_accountexpense.php?id=<?= $id; ?>&&ADate1=<?= $ADate1; ?>&&ADate2=<?= $ADate2; ?>" target="_blank"><?php echo $colorloopcount; ?>. <?php echo $accountsmain2; ?></a></strong></td>
