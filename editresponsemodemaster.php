...
{
    $responsemodeanum = $_REQUEST['responsemodeanum'];
	...
	if ($length<=100)
	{
	$query2 = "select * from master_responsemode where auto_number = '$responsemodeanum'";
	$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
	$res2 = mysql_num_rows($exec2);
	if ($res2 != 0)
	{
		$query1 = "update master_responsemode set responsemode = '$responsemode' where auto_number = '$responsemodeanum'";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		$errmsg = "Success. New Response Type Updated.";
		//$bgcolorcode = 'success';
		header ("location:responsemodemaster.php?bgcolorcode=success&&st=edit&&anum=$responsemodeanum");
	}
	//exit();
	else
	{
		...
		//$bgcolorcode = 'failed';
		header ("location:responsemodemaster.php?bgcolorcode=failed&&st=edit&&anum=$responsemodeanum");
	}
	}
	else
	{
...
{
	$errmsg = "Please Add Response Mode To Proceed For Billing.";
	$bgcolorcode = 'failed';
}
...
if ($st == 'edit' && $anum != '')
{
	$query1 = "select * from master_responsemode where auto_number = '$anum'";
	$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
	$res1 = mysql_fetch_array($exec1);
	$res1autonumber = $res1['auto_number'];
	$res1responsemode = $res1['responsemode'];
...
function addward1process1()
{
	...
	{
		alert ("Pleae Enter Response Type Name.");
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="editresponsemodemaster.php" onSubmit="return addward1process1()">
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      ...
                      <tr>
						...
						<input name="responsemode" id="responsemode" value="<?php echo $res1responsemode;?>" style="border: 1px solid #001E6A; text-transform:uppercase" size="40" /></td>
                      </tr>
                      <tr>
						...
						<input type="hidden" name="frmflag" value="addnew" />
							...
							<input type="hidden" name="responsemodeanum" id="responsemodeanum" value="<?php echo $res1autonumber; ?>">
