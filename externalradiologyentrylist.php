...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
	...
	<tr>
        <td width="860">
              <form name="cbform1" method="post" action="externalradiologyentrylist.php">
          ...
          <tbody>
            <tr>
              ...
              <td colspan="4" bgcolor="#cccccc" class="bodytext31">
                ...
                <div align="left"><strong>Radiology Result Entry</strong></div></td>
              </tr>
            <tr>
			...
			$query1 = "select * from consultation_radiology where patientname like '%$searchpatient%' and patientcode='walkin' and resultentry='pending' and consultationdate between '$fromdate' and '$todate' group by billnumber order by consultationdate desc";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
