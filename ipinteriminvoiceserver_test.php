...
$deposit_total=abs($totaldepositamount)-abs($totaldepositrefundamount)+abs($totaladvancedepositamount);
 ...
 $total_copay=(abs($copaytotalbed+$totalcopay+$totaldepositamount-$totaladvancedepositamount)<0.5)?0:abs($copaytotalbed+$totalcopay+$totaldepositamount-$totaladvancedepositamount);
	...
	<tr>
	  <td colspan="4" class="bodytext31" align="right"><strong> Grand Total &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo number_format($grandtotal,2,'.',','); ?></strong></td>
	...
	<tr>
	  <td colspan="4" class="bodytext31" align="right"><strong> Deposit Total &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo number_format($deposit_total,2,'.',','); ?></strong></td>
	     <td class="bodytext31" align="center">&nbsp;</td>
	     <td class="bodytext31" align="center">&nbsp;</td>
		 <td class="bodytext31" align="center">&nbsp;
		 </td>
	...
	<tr>
	  <td colspan="4" class="bodytext31" align="right"><strong> Net Payable&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo number_format($grandtotal-$deposit_total-$overalltotal,2,'.',','); ?></strong></td>
	     <td class="bodytext31" align="center">&nbsp;</td>
	     <td class="bodytext31" align="center">&nbsp;</td>
		 <td class="bodytext31" align="center">&nbsp;
		...
		if($totalcopay > 0) { ?>
		<tr>
	  <td colspan="4" class="bodytext31" align="right"><strong> Copay&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo number_format($total_copay,2,'.',','); ?></strong></td>
	     <td class="bodytext31" align="center">&nbsp;</td>
	     <td class="bodytext31" align="center">&nbsp;</td>
		 <td class="bodytext31" align="center">&nbsp;</td>
		</tr>
