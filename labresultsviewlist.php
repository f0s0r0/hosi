...
$query24 = "select * from master_employee where username = '$orderedby'";
   ...
   $query44 = "update consultation_lab set publishstatus='completed',publishdatetime='".date('Y-m-d h:i:s')."' where resultdoc='$docno'";
		$exec44 = mysql_query($query44) or die(mysql_error());

   
		$query43 = "update resultentry_lab set publishstatus='completed',publishdatetime='".date('Y-m-d h:i:s')."' where docnumber='$docno'";
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="labresultsviewlist.php">
...
$querynw1 = "select * from resultentry_lab where locationcode = '".$locationcode."' and patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and patientcode <> 'walkin' and recorddate between '$fromdate' and '$todate' and docnumber like '%$docnumber%' and resultstatus='completed' and publishstatus = '' group by docnumber order by auto_number desc";
...
?>
		...
		<td width="11%"  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><strong>Entered By</strong></td>
	   ...
	   $query11="select * from resultentry_lab where patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and recorddate between '$fromdate' and '$todate' and docnumber like '%$docnumber%' and resultstatus='completed' and publishstatus = '' group by itemcode ";
		...
		<td class="bodytext31" valign="center"  align="left">
			    <div align="left"><?php echo $rusername; ?></div></td>
