  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="vehicle.php" onSubmit="return addward1process1()">
                ...
                <table width="844" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                     <tr>
                     <td colspan="10" align="center" class="bodytext3" bgcolor="#FFFFFF"><strong>MortuarySelfOccupied Details</strong></td>
                     </tr> 
                      <tr bgcolor="#011E6A">
                        <td  bgcolor="#CCCCCC" class="bodytext3"><strong>NO</strong>
                        <td bgcolor="#CCCCCC" class="bodytext3"><strong>Shelf number </strong> 
				       
						<td bgcolor="#CCCCCC" class="bodytext3"><strong>status</strong>  
						  <td bgcolor="#CCCCCC" class="bodytext3"><strong>Occupied By</strong>   
                                    </tr>
                     ...
                     <?php
		$sno=0;
		$query11 = "select * from mortuary_allocation ";
		...
		*/
	     ...
	     $query1 = "select * from master_shelf where recordstatus='' ";
		//$query1 = "select * from master_vehicle where recordstatus <> 'deleted' order by paymenttype ";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		while ($res1 = mysql_fetch_array($exec1))
		{
			$auto_number = $res1["auto_number"];
		    $shelfnumber =  $res1["shelf"];
			$status =  $res1["allocationstatus"];
			if($status!=''){
			$query2 = "select * from mortuary_allocation where shelve = '$shelfnumber' order by auto_number desc";
	        $exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
			$res2 = mysql_fetch_array($exec2);
			$patientname=$res2["patientname"];
			$patientcode=$res2['patientcode'];
			$visitcode=$res2['visitcode'];
		}else{$patientname=$patientcode=$visitcode='';}
	...
	*/
		...
		?>
          ...
          <td width="5%" align="left" valign="top"  class="bodytext3"><?php echo $sno = $sno + 1; ?></td>
          <td width="20%" align="left" valign="top"  class="bodytext3"><?php echo $shelfnumber; ?></td>
          <td width="18%" align="left" valign="top"  class="bodytext3"><?php echo $status; ?></td>
	       <td width="57%" align="left" valign="top"  class="bodytext3"><?php if($patientname!=''){echo $patientname.'/'.$patientcode.'/'.$visitcode; }?></td>
