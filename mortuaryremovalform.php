...
if ($frmflag1 == 'frmflag1')
{
	  ...
	  $placeofremoval= mysql_real_escape_string($_REQUEST['placeofremoval']);
	
		 $query10 = "select docno from mortuary_removaldetails where docno='$docno'";
		$exec10 = mysql_query($query10) or die ("Error in Query10".mysql_error());
		$num10=mysql_num_rows($exec10);
		$res10 = mysql_fetch_array($exec10);
	if($num10==0)
	{		 
 $query38="insert into mortuary_removaldetails(date,docno,disease,conditionofdecease,scarsmarkings,comments,shirt,belt,trousers,jacket,socks,tie,dress,skirt,blouse,clothingothers,rings,bracelet,necklace,earrings,watch,make,pens,jewelleryspecify,walletid,
keyy,passport,drivinglicense,creditcard,cash,amount,walletspecify,witnessedby,relationship,witnessid
,witnesstelephone,nextofkin,kinrelationship,nextofkintelephone,username,placeofremoval) values('$date','$docno','$disease','$conditionofdisease','$scars','$comments','$shirt','$belt','$trousers','$jacket','$socks','$tie','$dress','$skirt','$blouse','$anyothers','$rings','$bracelet','$necklace','$earrings','$watch','$make','$pens','$specify','$id','$keys','$passport','$drivinglicense','$creditcard','$cash','$amount','$othersspecify','$witnessedby','$relationship','$witnessid','$witnesstelephone','$nextofkin','$nextofkinrelationship','$nextofkinrelationshitelephone','$username','$placeofremoval')";
	}
	else
	{
	  $query38="update mortuary_removaldetails set conditionofdecease='$conditionofdisease',scarsmarkings='$scars',comments='$comments',shirt='$shirt',belt='$belt',trousers='$trousers',jacket='$jacket',socks='$socks',
	  ...
	  nextofkin='$nextofkin',kinrelationship='$nextofkinrelationship',nextofkintelephone='$nextofkinrelationshitelephone',placeofremoval='$placeofremoval' where docno='$docno'";
	}
...
var popWin; 
popWin = window.open("print_mortuaryremovelist.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&docno=<?php echo $docno; ?>","OriginalWindowA4",'width=600,height=700,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25'); 
 }
</script>
...
<body>
<form name="form1" id="form1" method="post" action="mortuaryremovalform.php" onSubmit="return validcheck()">	
  ...
  <tr>
	...
	$colorloopcount = $colorloopcount + 1;
          ...
          <tr <?php echo $colorcode; ?>>
			  ...
			  <tr>
			  <td colspan="30"align="center" valign="center" bgcolor="#E0E0E0" class="bodytext3" ><b><u>REMOVAL FORM</u></b></td>
			  
			  </tr>
			 
			  <tr>
			  <td colspan="2" align="left" valign="left" class="bodytext3" bgcolor="#E0E0E0"><strong>Place of Removal:</strong></td>
			  <td><textarea name="placeofremoval"><?php echo $placeofremoval;?></textarea></td>
...
<td width="96">&nbsp;</td>
      ...
      <input type="submit" name="update" value="Submit" style="border: 1px solid #001E6A" onClick="return funcvalidation()"/></td>
