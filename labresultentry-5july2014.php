...
foreach($_POST['lab'] as $key => $value)
	 ...
	 $labname=$_POST['lab'][$key];
		...
		{
		$status1='completed';
		$query26="insert into resultentry_lab(patientname,patientcode,patientvisitcode,recorddate,recordtime,itemcode,itemname,resultvalue,referencerange,referenceunit,docnumber,referencename,account,color,username)values('$patientname','$patientcode',
   '$visitcode','$dateonly','$timeonly','$itemcode','$labname','$resultvalue','$referencevalue','$unit','$docnumber','$refname','$accountname','$color','$username')";
   $exec26=mysql_query($query26) or die(mysql_error());
   
 
   $query29=mysql_query("update consultation_lab set resultentry='$status1' where labitemcode='$itemcode' and patientvisitcode='$visitcode' and docnumber='$samplecollectiondocnumber'");
	}
...
header("location:labresultentrylist.php?patientcode=$patientcode&&visitcode=$visitcode&&docnumber=$docnumber");
 exit();
...
$query2 = "select * from resultentry_lab where patientcode <> 'walkin' order by auto_number desc limit 0, 1";
...
<body>
<form name="frm" id="frmsales" method="post" action="labresultentry.php" onKeyDown="return disableEnterKey(event)">
	  ...
	  <td width="22%" align="left" valign="middle" class="bodytext3" bgcolor="#E0E0E0">
			...
			<input name="visitcode" id="visitcode" type="hidden" value="<?php echo $visitcode; ?>" style="border: 1px solid #001E6A" size="18" rsize="20" readonly/><?php echo $visitcode; ?>
			  ...
			  <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><span class="style4"></span><strong>Age &amp; Gender </strong></td>
				...
				<input type="hidden" name="samplecollectiondocno" id="docnum" value="<?php echo $docnumber; ?>">
				</td>
				  </tr>
				  <tr>
	  ...
	  <td colspan="5" align="left" valign="middle"  bgcolor="#CCCCCC" class="bodytext365">
			...
			<td width="4%"  align="left" valign="center" 
                ...
                bgcolor="#ffffff" class="bodytext366"><div align="center"><strong>Acknowledge</strong></div></td>
				  ...
				  <?php
	  $query31="select * from consultation_lab where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and labsamplecoll='completed' and resultentry='pending' and docnumber='$docnumber' group by labitemname";
            ...
            align="left" border="0">
			 ...
			 $itemcode2=$res52['itemcode'];
				...
				$labreferencerange1[1] = 1000000;
				  ...
				  <input type="text" name="result[]" id="result<?php echo $sn; ?>" size="8" onBlur="return funcrange('<?php echo $sn; ?>')"/>
               ...
               <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="center" width="358"><div align="left"> <?php if($labreferencerange == '')
			   {
