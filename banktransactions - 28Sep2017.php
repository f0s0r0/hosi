	  ...
	  <tr><form action="banktransactions.php" name="checklist" method="post">
        <td><table width="1049" height="80" border="0" 
          ...
          <tbody>
			...
			$query41 = "select * from bank_record where notes = 'accounts receivable' and status = 'Posted'";
		   ...
		   <?php
			...
			$query21 = "select * from bank_record where docno = '$apdocno' and instno = '$apchequeno' and status = 'Posted'";
			...
			$query42 = "select * from bank_record where notes = 'account payable' and status = 'Posted'";
		   ...
		   <?php
			...
			$query22 = "select * from bank_record where docno = '$ardocno' and instno = '$archequeno' and status = 'Posted'";
			...
			$query43 = "select * from bank_record where notes = 'expenses' and status = 'Posted'";
		   ...
		   <?php
			...
			$query23 = "select * from bank_record where docno = '$exdocno' and instno = '$exchequeno' and status = 'Posted'";
			...
			$query44 = "select * from bank_record where notes = 'receipts' and status = 'Posted'";
		   ...
		   <?php
			...
			$query24 = "select * from bank_record where docno = '$redocno' and instno = '$rechequeno' and status = 'Posted'";
			...
			$query45 = "select * from bank_record where notes = 'misc' and status = 'Posted'";
		   ...
		   <?php
			...
			$query25 = "select * from bank_record where docno = '$bkdocno' and status = 'Posted'";
