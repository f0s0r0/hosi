  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
          ...
          <tbody>
            ...
            <tr>
              <td class="bodytext31" valign="center"  align="left" 
				...
				<td width="14%" align="left" valign="center" bgcolor="#E0E0E0" class="bodytext31"><a target="_blank" href="viewrfqpoinexcel.php?billnumber=<?php echo $billnumber; ?>"><img src="images/excel-xls-icon.png" width="30" height="30" border="0"></a></td>
              </tr>
		...
		$query35="select * from master_rfq where ponumber='$billnumber' and status='generated' and medicinecode='$itemcode' and suppliercode='$suppliercode' order by auto_number desc";
			...
			?>
              ...
              <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $sno = $sno + 1; ?></div></td>
			   <td class="bodytext31" valign="center"  align="left">
				...
				<td class="bodytext31" valign="center"  align="left"> <div align="right"><?php echo number_format($amount,2,'.',','); ?><input type="hidden" size="6" name="amountval[]" id="amount<?php echo $sno ;?>" value="<?php echo $amount; ?>" class="bal" readonly></div></td>
				<td  align="left" valign="center" class="bodytext31"><input type="hidden" name="rate[]" id="rate<?php echo $sno; ?>" value="<?php echo $rate; ?>">
                    <div align="center"><a onClick="return deletevalid()" href="viewrfqpo.php?itemcode=<?php echo $itemcode; ?>&&billnumber=<?php echo $pono; ?>">Delete</a></div></td>
