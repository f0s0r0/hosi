...
if ($frm1submit1 == 'frm1submit1')
{
	...
	echo $query1="update ipconsultation_lab set freestatus='$alabfree' where patientcode='$patientcode' and patientvisitcode='$visitcode' and labitemcode='$aitemcode' and locationcode = '$locationcode' ";
	$exec1 = mysql_query($query1) or die(mysql_error()); 
	}
	$query2 = "select * from ipconsultation_lab where patientcode='$patientcode' and patientvisitcode='$visitcode' and locationcode = '$locationcode' order by auto_number desc limit 0, 1";
...
foreach($_POST['categorylab'] as $key=>$value)
	...
	if($categorylabname != "")
	{
	$categorylabquery1=mysql_query("insert into ipconsultation_lab(consultationid,patientcode,patientname,patientvisitcode,labitemname,labitemrate,billtype,accountname,consultationdate,paymentstatus,refno,labsamplecoll,resultentry,locationcode)values('$consultationid','$patientcode','$patientname','$visitcode','$categorylabname','$categorylabrate','$billtype','$accountname','$consultationdate','$status','$labrefnonumber','pending','pending','$locationcode')") or die(mysql_error());
	}	
	}
		...
		if(($labname!="")&&($labrate!=''))
		{
		$labquery1=mysql_query("insert into ipconsultation_lab(consultationid,patientcode,patientname,patientvisitcode,labitemcode,labitemname,labitemrate,billtype,accountname,consultationdate,paymentstatus,refno,labsamplecoll,resultentry,freestatus,locationcode)values('$consultationid','$patientcode','$patientname','$visitcode','$labcode','$labname','$labrate','$billtype','$accountname','$consultationdate','$status','$labrefnonumber','pending','pending','$labfree','$locationcode')") or die(mysql_error());
		}
		}
		header("location:ipamendlab_pending.php");
...
?>
<?php
$querylab1=mysql_query("select * from ipconsultation_lab where patientcode='$patientcode'");
...
<form name="form1" id="frmsales" method="post" action="ipamendlab.php" onKeyDown="return disableEnterKey(event)">
...
-->
  <tr>
			  ...
			  <tr>
			   ...
			   <tr>
				...
				<td width="9%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><strong>Location</strong></td>
				  <td colspan="3" align="left" valign="middle" class="bodytext3">
				  <input type="hidden" name="locationname" id="locationname" value="<?php echo $locationname; ?>" style="border: 1px solid #001E6A" size="18" rsize="20" readonly/><?php echo $locationname; ?>
				  <input type="" name="locationcode" id ="locationcode" value="<?php echo $locationcode; ?>"></td>
				  </tr>
            </tbody>
        </table></td>
      </tr>
	...
	$status='completed';
			...
			$query17 = "select * from ipconsultation_lab where patientvisitcode='$visitcode' and patientcode='$patientcode' and labsamplecoll='pending'";
			...
			?>
			 ...
			 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $paharmitemname; ?></div></td>
				...
				<td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $pharmitemrate; ?></div></td>
				 <td class="bodytext31" valign="center"  align="left"><div align="center"><select name="alabfree[]" id="alabfree">
				 ...
				 <td class="bodytext31" valign="center"  align="left"><div align="center"><a onClick="return deletevalid()" href="ipamendlab.php?delete=<?php echo $autonumber; ?>&&patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&locationcode=<?php echo $locationcode; ?>">Delete</a></div></td>
     ...
     <tr id="labid">
				 ...
				 <tr>
				   <td colspan="6" align="center" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><span class="style2">Total Amount</span>
				   <input type="text" id="total1" readonly size="7" value="<?php echo $totalamount; ?>">
				   <input type="hidden" id="total2" readonly size="7">
				   <input type="hidden" id="total3" readonly size="7">
