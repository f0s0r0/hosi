    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="reportsupplier212.php">
...
&nbsp;				<input  value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />-->
			...
			$arraysupplier = explode("#", $searchsuppliername);
			 ...
			 $arraysuppliercode =  end($arraysupplier);
	...
	*/
		  ...
		  $snocount = $snocount + 1;
           ...
           <tr <?php  echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="right">
			    ...
			    <div align="center"><?php echo $days_between;?></div></td>
               <td class="bodytext31" valign="center"  align="left">
			    <div align="right"><?php echo number_format($totalatret,2,'.',','); ?></div></td>
           </tr>
		   <?php
		   }  
		   ?>
        ...
        <td>&nbsp;</td>
           ...
           <td class="bodytext31" valign="center"  align="right" 
			...
			<tr>
               <td class="bodytext31" valign="center"  align="right" 
                bgcolor="#D3EEB7"><?php echo number_format($totalatret,2,'.',','); ?></td>
              <td class="bodytext31" valign="center"  align="right" 
            ...
            <td class="bodytext31" valign="center"  align="right" 
				...
				<td class="bodytext31" valign="center"  align="right">&nbsp;</td>
                <td class="bodytext31" valign="center"  align="right"> 
                 <a href="reportsupplier212.php?name=<?php echo $arraysuppliercode; ?>"> <img src="images/excel-xls-icon.png" width="22" height="22"></a>
            </tr>
