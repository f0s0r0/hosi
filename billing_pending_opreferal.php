          ...
          <tbody>
            <tr>
              ...
              <td colspan="6" bgcolor="#cccccc" class="bodytext31"><script language="javascript">
                ...
                <div align="left"><strong>Referal Billing</strong></div></td>
              </tr>
           ...
           <tr>
			...
			$colorloopcount = '';
			$sno = '';
			$query1 = "select * from master_visitentry where billtype='PAY NOW' and referalbill='pending' order by consultationdate desc";
		   ...
		   $accname=$res56['accountname'];
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left"><a href="billing_opnew4.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>"><strong>BillNow</strong></a>			  </td>
              </tr>
			<?php
			}    
			?>
