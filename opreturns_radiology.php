...
<tr>
  ...
  $newamount=0;
		  ...
		  $querypaynow="select radiologyitemrate as amount,patientcode,patientvisitcode,patientname,billdate,radiologyitemname from  refund_paynowradiology where patientvisitcode <>'walkinvis' and  billdate between '$ADate1' and '$ADate2' ";
		  ...
		  while($respaynow = mysql_fetch_array($execpaynow))
		  {
		   ...
		   $accountname= 'CASH COLLECTIONS';
   		   $labitemname=$respaynow['radiologyitemname'];
