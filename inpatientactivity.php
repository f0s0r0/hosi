    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="inpatientactivity.php" >
		<table width="604" border="1" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Inpatient Activity</strong></td>
              ...
              <td colspan="3" align="left" valign="top"  bgcolor="#FFFFFF"><span class="bodytext3">
                <input name="patient" type="text" id="searchpatient"  size="50" autocomplete="off">
              </span></td>
              </tr>
			    <tr>
              <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3">Patient Code</td>
              <td colspan="3" align="left" valign="top"  bgcolor="#FFFFFF"><span class="bodytext3">
                <input name="patientcode" type="text" id="searchpatientcode"  size="50" autocomplete="off">
              </span></td>
              </tr>
			   <tr>
              <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3">Visitcode</td>
              <td colspan="3" align="left" valign="top"  bgcolor="#FFFFFF"><span class="bodytext3">
                <input name="visitcode" type="text" id="searchvisitcode" size="50" autocomplete="off">
              </span></td>
              </tr>
          ...
          $res = mysql_fetch_array($exec);
	 		...
	 		$locationcode2 = $res["locationcode"];
			   ...
			   <tr >
              <td colspan="4" width="10%" align="center" bgcolor="#CCCCCC" class="bodytext3"  ><strong><input type="hidden" name="cbfrmflag1" value="cbfrmflag1">
...
if ($cbfrmflag1 == 'cbfrmflag1')
{
	...
	$query781 = "select * from master_ward where auto_number='$ward' and recordstatus='' and locationcode='$location'";
...
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <?php
            $query34 = "select * from master_ward where ward like '%$wardname%' and locationcode='$location'";
		 ...
		 $query50 = "select * from master_bed where ward='$wardnum' and locationcode='$location'";
		$exec50 = mysql_query($query50) or die(mysql_error());
		$exnu50 = mysql_num_rows($exec50);
		...
		$query69 = "select * from master_bed where auto_number='$bedanum' and ward='$wardnum' and locationcode='$location' and  recordstatus='occupied' order by auto_number desc limit 0, 1";
		$exec69 = mysql_query($query69) or die(mysql_error());
		$num69 = mysql_num_rows($exec69);
	
	    $query59 = "select * from ip_bedallocation where ward='$wardnum' and bed='$bedanum' and locationcode='$location' and patientname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and recordstatus NOT IN ('discharged','transfered') order by auto_number desc limit 0, 1";
	    ...
	    $query49 = "select * from master_ipvisitentry where patientcode='$patientcode'  and locationcode='$location' and visitcode='$visitcode' and discharge not in ('discharged','completed') order by auto_number desc limit 0, 1" ;
		...
		$query10 = "select * from master_ipvisitentry where patientcode='$patientcode'  and locationcode='$location' and discharge not in ('discharged','completed') ";
		$exec10 = mysql_query($query10) or die(mysql_error());
		$res10 = mysql_fetch_array($exec10);
		$res10age = $res10['age'];
		$res10gender = $res10['gender'];
	
		$query67 = "select * from ip_bedtransfer where ward='$wardnum' and bed='$bedanum'  and locationcode='$location' and recordstatus NOT IN ('discharged','transfered') order by auto_number desc limit 0, 1";
		...
		$query49 = "select * from master_ipvisitentry where patientcode='$patientcode'  and locationcode='$location' and visitcode='$visitcode' and discharge<>'discharge' order by auto_number desc limit 0, 1" ;
		$exec49 = mysql_query($query49) or die(mysql_error());
		$res49 = mysql_fetch_array($exec49);
		$date = $res49['consultationdate'];
		$accoutname = $res49['accountfullname'];
		...
		{
		$query592 = "select * from ip_bedtransfer where ward='$wardnum' and bed='$bedanum'  and locationcode='$location' and patientname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and recordstatus NOT IN ('discharged','transfered') order by auto_number desc limit 0, 1";
		...
		$res10age = $res10['age'];
		$res10gender = $res10['gender'];
		 $patientlocationcode = $res10['locationcode'];
		
		$query492 = "select * from master_ipvisitentry where patientcode='$patientcode'  and locationcode='$location' and visitcode='$visitcode' and patientfullname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and discharge<>'discharge' order by auto_number desc limit 0, 1" ;
		...
		$accoutname = $res492['accountfullname'];
		   ...
		   $query51 = "select * from master_bed where auto_number='$bed' and locationcode='$location' ";
		   $exec51 = mysql_query($query51) or die(mysql_error());
		   $res51 = mysql_fetch_array($exec51);
		   $bedname = $res51['bed'];
		
			$query7811 = "select * from master_ward where auto_number='$ward' and recordstatus='' and locationcode='$location' ";
			...
			if($num69 > 0)
		{
		   ...
		   $query82 = "select * from master_ipvisitentry where patientcode='$patientcode'  and locationcode='$location' and visitcode='$visitcode' and discharge not in ('discharged','completed')";
	...
	if (!function_exists('calculate_age')) {
			...
			$queryage="select dateofbirth from master_customer where customercode='$patientcode'";
			$execage=mysql_query($queryage) or die("Error in queryage".mysql_error());
			if($resage=mysql_fetch_array($execage)){
				$res10age=calculate_age($resage['dateofbirth']);
			}
          ...
          <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext31" valign="center"  align="left">
				...
				<option value="ipdrugchart.php?&&visitcode=<?php echo $visitcode; ?>&&patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode;?>&&locationcode=<?php echo $patientlocationcode;?>
             ">Drug Chart</option>
				<!--<option value="vitalio.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>">Vital I/O</option>-->
				<option value="vitals.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&locationcode=<?php echo $patientlocationcode;?>">Vitals</option>
				<option value="fluidbalance.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&locationcode=<?php echo $patientlocationcode;?>">Input / Output</option>
				<option value="ipprogressnotes.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&locationcode=<?php echo $patientlocationcode;?>">Nursing Cardex</option>
				<option value="ipdoctornotes.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&locationcode=<?php echo $patientlocationcode;?>">Doctors Notes</option>
				...
				<option value="ipicdentry.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&locationcode=<?php echo $patientlocationcode;?>">ICD</option>
			    <option value="ipclinicalrecords.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&locationcode=<?php echo $patientlocationcode;?>">Clinical Records</option>
				</select></td>
              </tr>
		   <?php 
		   }
