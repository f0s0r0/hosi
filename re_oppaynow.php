...
<tr>
<td colspan="12" align="center" valign="middle"><strong>OP Paynow Reconcile</strong></td>
</tr>
...
<?php 
$query8 = "SELECT visitcode,billnumber,transactionamount,cashamount,chequeamount,cardamount,onlineamount,creditamount,transactiondate,accountname,bankcode,cashcode,mpesacode FROM `master_transactionpaynow` WHERE `transactiondate` BETWEEN '$ADate1' AND '$ADate2' order by auto_number";
...
$i = 0;
$drresult = array();
$querydr1bnk = "SELECT SUM(`labitemrate`) as income FROM `billing_paynowlab` WHERE billnumber = '$docno'
UNION ALL SELECT SUM(`amount`) as income FROM `billing_paynowpharmacy` WHERE billnumber = '$docno'
UNION ALL SELECT SUM(`radiologyitemrate`) as income FROM `billing_paynowradiology` WHERE billnumber = '$docno'
UNION ALL SELECT SUM(`amount`) as income FROM `billing_paynowservices` WHERE billnumber = '$docno'
UNION ALL SELECT SUM(`referalrate`) as income FROM `billing_paynowreferal` WHERE billnumber = '$docno'
	...
	if($parentid != '')
	{
		if($parentid == '18' || $parentid == '19' || $parentid == '20')
		{
			...
			{  
				...
				$drresult = array();
				$querydr1bnk = "SELECT SUM(`creditamount`) as bankamount FROM `master_transactionpaynow` WHERE `mpesacode` = '$id' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2'
		...
		else if($parentid == '1')
		{
			$i = 0;
			$crresult = array();
			$querycr1bnk = "SELECT SUM(`labitemrate`) as income FROM `billing_paynowlab` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'
