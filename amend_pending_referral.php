...
<body>
<?php $querynw1 = "select * from consultation_departmentreferal where  consultation<>'completed' and paymentstatus = 'pending' group by patientvisitcode order by consultationdate DESC";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
		  <form name="cbform1" method="post" action="amend_pending_referral.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong>Amend Pending Referral</strong></td>
			</tr>
			<tr>
	   ...
	   <tr>
	     <td>	
          ...
          <!--  <tr>
			...
			$colorloopcount = '';
			$sno = '';
			$query1 = "select * from consultation_departmentreferal where patientcode like '%$patientcode1' and patientvisitcode like '%$visitcode1%' and patientname like '%$patientname1%' and consultation <>'completed' and consultationdate between '$ADate1' and '$ADate2' and paymentstatus = 'pending' and billtype = 'PAY NOW' and locationcode = '$location' group by patientvisitcode order by consultationdate DESC";
			$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left"><a href="amendreferral.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>"><strong>Amend</strong></a>			  </td>
              </tr>
			<?php
			}    
			?>
			<?php
				$query111 = "select * from consultation_departmentreferal where patientcode like '%$patientcode1' and patientvisitcode like '%$visitcode1%' and patientname like '%$patientname1%' and  consultation <>'completed' and consultationdate between '$ADate1' and '$ADate2' and referalrate = '0.00' and billtype = 'PAY NOW' and locationcode = '$location' group by patientvisitcode order by consultationdate DESC";
			...
			$visitcode = $res111['patientvisitcode'];
			
			$patientname = $res111['patientname'];
			  $patientaccountname=$res111['accountname']; 
			$consultationdate=$res111['consultationdate'];
			...
			?>
			 <?php
			 $query11 = "select * from consultation_departmentreferal where patientcode like '%$patientcode1' and patientvisitcode like '%$visitcode1%' and patientname like '%$patientname1%' and consultation <>'completed' and consultationdate between '$ADate1' and '$ADate2' and  paymentstatus = 'pending' and billtype = 'PAY LATER' and locationcode = '$location' group by patientvisitcode order by consultationdate DESC";
