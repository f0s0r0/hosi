...
$stringbuild1 = "";
$query1 = "select * from master_ipkitchen where recordstatus <> 'Deleted' AND locationcode = '".$patientlocationcode."'  order by typename";
$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
while ($res1 = mysql_fetch_array($exec1))
{
	//$res1autonumber = $res1['auto_number'];
	$res1itemcode=$res1['typecode'];
	$res1itemname = $res1['typename'];
...
$filefolder = 'js';
$filename = 'autocomplete_ipkitchen.'.'js';
