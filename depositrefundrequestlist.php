...
<body>
<?php $querynw1 = "select * from depositrefund_request where recordstatus = ''";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
          ...
          <tbody>
            <tr>
              ...
              <td colspan="8" bgcolor="#cccccc" class="bodytext31">
                ...
                <div align="left"><strong>Deposit Refund Request</strong><label class="number"></label></div></td>
              </tr>
            <tr>
			...
			$query1 = "select * from depositrefund_request where recordstatus = '' AND locationcode = '".$locationcode."' ";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center" align="left">
			    <div align="left"><a href="approvedepositrefund.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&docno=<?php echo $docno; ?>"><strong>Approve</strong></a></div></td>
              </tr>
			<?php
			}   
			}
