        ...
        <td valign="top"><table width="701" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            <?php
				...
				{ 
					...
					$query77 = mysql_fetch_array(mysql_query("select subtype from master_subtype where auto_number = '$subtype'"));
				...
				{  
					...
					$querycr1 = "SELECT SUM(transactionamount) as paylatercredit FROM `master_transactionpaylater` WHERE `accountnameid` = '$id' AND `docno` LIKE '%IPCr%' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactiontype` = 'paylatercredit'
								 ...
								 UNION ALL SELECT SUM(transactionamount) as paylatercredit FROM `master_transactionpaylater` WHERE accountnameid = '$id' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactiontype` = 'pharmacycredit'
					...
					$sumbalance1 = $sumbalance1 + $balance;
