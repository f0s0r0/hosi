    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="searchpatientopdiscount.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>OP Discount</strong></td>
          ...
          <tr>
              ...
              <td colspan="3" bgcolor="#FFFFFF"><select name="location" id="location" onChange="ajaxlocationfunction(this.value);" style="border: 1px solid #001E6A;">
                  <?php
...
if ($cbfrmflag1 == 'cbfrmflag1' || isset($_REQUEST['page']))
{
	...
	if(isset($_POST['patient'])){$_SESSION['servispatient'] = $_POST['patient']; }
	$searchpatient = $_SESSION['servispatient'];
	if(isset($_POST['patientcode'])){$_SESSION['servispatientcode'] = $_POST['patientcode'];}
	$searchpatientcode=$_SESSION['servispatientcode'];
	if(isset($_POST['visitcode'])){$_SESSION['servisvisitcode'] = $_POST['visitcode'];}
	$searchvisitcode = $_SESSION['servisvisitcode'];
	if(isset($_POST['ADate1'])){$_SESSION['servisADate1'] = $_POST['ADate1'];}
	$fromdate=$_SESSION['servisADate1'];
	if(isset($_POST['ADate2'])){$_SESSION['servisADate2'] = $_POST['ADate2'];}
...
<form name="form1" id="form1" method="post" action="stockadjustment.php">	
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="1208" 
            align="left" border="0">
          <tbody>
           <tr>
				 <td colspan="14"  bgcolor="#CCCCCC" class="bodytext31">
				      <?php //error_reporting(0);
							...
							*/
							...
							echo $reslocationanumm= $_REQUEST['location'];
							$query111 = "select * from master_visitentry where billtype = 'PAY NOW' and patientfullname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and locationcode = '$reslocationanumm' and consultationdate between '$fromdate' and '$todate' and visitcode NOT IN (select patientvisitcode from opconsultdiscount) and visitcode NOT IN (select patientvisitcode from billing_consultation) order by auto_number desc";
           ...
           <tr>
               ...
               <td width="51" align="left" valign="center"  
                ...
                <td width="123" align="left" valign="center"  
                ...
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>User</strong></div></td>
					<td width="69"  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Discount</strong></div></td>
                 </tr>
			  <?php 
			 
			  $reslocationanumm= $_REQUEST['location'];
              $query2 = "select * from master_visitentry where billtype = 'PAY NOW' and patientfullname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and locationcode = '$reslocationanumm' and consultationdate between '$fromdate' and '$todate'order by auto_number desc LIMIT $start , $limit";
			 ...
			 // echo $num2;
			  ...
			  $query7 = "select patientvisitcode from opconsultdiscount where patientvisitcode = '$res2visitcode'";
			  $exec7 = mysql_query($query7) or die ("Error in Query7".mysql_error());
			  $num7 = mysql_num_rows($exec7);
			  
			  $query72 = "select patientvisitcode from billing_consultation where patientvisitcode = '$res2visitcode'";
			  $exec72 = mysql_query($query72) or die ("Error in Query72".mysql_error());
			  $num72 = mysql_num_rows($exec72);
				 ...
				 ?>
                    ...
                    <td class="bodytext31" valign="center"  align="left"><?php echo $res2nationalidnumber; ?></td>
					 <td class="bodytext31" valign="center"  align="left"><?php echo $user; ?></td>
					  <td class="bodytext31" valign="center"  align="left"><a href="consultationopdiscount.php?patientcode=<?php echo $res2customercode; ?>&&visitcode=<?php echo $res2visitcode; ?>&&location=<?php echo $reslocationanumm; ?>"><?php echo 'Discount'; ?></a></td>
                  </tr>
			  <?php
			  }
			  }
