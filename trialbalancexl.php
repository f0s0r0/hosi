...
<table width="600" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            align="left" border="1">
			<tr>
			<td colspan="2" align="center" class="bodytext3"><strong>Trialbalance</strong></td>
			</tr>
			<tr>
			<td>
			<table width="600" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
			...
			{	
				...
				if (isset($_REQUEST["location"])) { $location = $_REQUEST["location"]; } else { $location = ""; }
				$query2 = "select accountssub,auto_number,tbinclude,tbledgerview,id from master_accountssub where accountsmain = '$parentid' and recordstatus <> 'deleted' order by accountssub";
			...
			?>
			<tr>
			<td width="695" align="left" class="bodytext3" style="color:#000"><strong><?php echo $accountsmain; ?></strong></td>
			<td width="100" align="right" class="bodytext3" style="color:#000"><strong><?php //echo number_format($totalamount12,2,'.',','); ?></strong>&nbsp;&nbsp;</td>
			</tr>
			<?php		
			...
			<td width="100" align="right" class="bodytext3" style="color:;"></td>
			</tr>
			<?php
			}
			?>
			...
			<?php echo number_format($groupleft12,2,'.',''); ?></td>
			</tr>
</table>
</td>
 <td valign="top"><table width="600" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
			...
			<?php echo number_format($groupright12,2,'.',''); ?></td>
			</tr>
			<?php
			if (isset($_REQUEST["cbfrmflag1"])) { $cbfrmflag1 = $_REQUEST["cbfrmflag1"]; } else { $cbfrmflag1 = "cbfrmflag1"; }
			//$cbfrmflag1 = $_REQUEST['cbfrmflag1'];
