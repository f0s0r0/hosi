    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
        ...
        <td width="860">
              ...
              <form name="cbform1" method="post" action="patientwiseicd.php">
                <table width="750" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                    <tr bgcolor="#011E6A">
                      <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Patientwise ICD </strong></td>
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="1292" 
            align="left" border="0">
          <tbody>
			...
			<tr>
				...
				<td width="6%" align="left" valign="center" bgcolor="#FFFFFF" class="style3">Reg.No</td>
				<td width="5%" align="left" valign="center" bgcolor="#FFFFFF" class="style3">OP No</td>
				...
				<td width="5%" align="left" valign="center" bgcolor="#FFFFFF" class="style3">Age</td>
				<td width="9%" align="left" valign="center" bgcolor="#FFFFFF" class="style3">Department</td>
				<td width="20%" align="left" valign="center" bgcolor="#FFFFFF" class="style3">Primary Diagnosis</td>
				<td width="5%" align="left" valign="center" bgcolor="#FFFFFF" class="style3">ICD Code</td>
				<td width="18%" align="left" valign="center" bgcolor="#FFFFFF" class="style3">Secondary Diagnosis</td>
				<td width="5%" align="left" valign="center" bgcolor="#FFFFFF" class="style3">ICD Code</td>
				<td width="3%" rowspan="2" align="left" valign="center" bgcolor="#E0E0E0" class="style3"><span class="bodytext31"><a download="download" href="print_patientwiseicd.php?ADate1=<?php echo $icddatefrom; ?>&&ADate2=<?php echo $icddateto; ?>&&age=<?php echo $icdage; ?>&&range=<?php echo $icdrange; ?>&&icdcode=<?php echo $icdcode1; ?>"><img src="images/excel-xls-icon.png" width="30" height="30"></a></span></td>
			</tr>
