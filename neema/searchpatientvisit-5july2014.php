    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="searchpatientvisit.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong>Edit Visit Details </strong></td>
              </tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
           ...
           <tr>
			  ...
			  <?php 
            $query2 = "select * from master_visitentry where patientfullname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and consultationdate between '$fromdate' and '$todate'order by auto_number desc";
			 ...
			 // echo $num2;
              ...
              <tr <?php echo $colorcode; ?>>
				...
				<a href="editpatientvisit.php?patientcode=<?php echo $res2customercode; ?>&&visitcode=<?php echo $res2visitcode; ?>" class="bodytext3">
