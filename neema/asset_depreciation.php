...
if ($frmflag1 == 'frmflag1')
{
	...
	$depreciationvalue = $_REQUEST['depreciationvalue'];
	$depreciationvalue = str_replace(',','',$depreciationvalue);
	...
	if($row33 > 0)
	{ 
		$query88 = "UPDATE assets_register SET `depreciationledger` = '$depreciation', `depreciationledgercode` = '$depreciationcode', `accdepreciationledger` = '$accdepreciation',
		`accdepreciationledgercode` = '$accdepreciationcode', `depreciation` = '$depreciationvalue', `accdepreciation` = '$accdepreciationvalue' WHERE `auto_number` = '$assetanum'";
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="asset_depreciation.php" onSubmit="return addward1process1()">
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="" bgcolor="#CCCCCC" class="bodytext3"><strong>Asset Depreciation </strong></td>
                  ...
                  <?php
					  ...
					  <tr>
						...
						<input type="hidden" name="accdepreciationcode" id="accdepreciationcode" value="<?php echo $accdepreciationledgercode; ?>"></td>
                      </tr>
					  <tr>
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Depreciation </div></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
						<input name="depreciationvalue" id="depreciationvalue" value="<?php echo $depreciation; ?>" style="border: 1px solid #001E6A; text-transform:uppercase" size="40"/></td>
                      </tr>
					  <tr>
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Accu Depreciation </div></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
						<input name="accdepreciationvalue" id="accdepreciationvalue" value="<?php echo $accdepreciation; ?>" style="border: 1px solid #001E6A; text-transform:uppercase" size="40"/></td>
                      </tr>
                      <tr>
