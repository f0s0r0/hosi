...
{		
	...
	{
		$query61 = "select * from consultation_departmentreferal where patientvisitcode = '$visitcode' and paymentstatus='completed' and status='' and auto_number='$auto_number'";
		...
		$query29=mysql_query("update consultation_departmentreferal set referalrefund='$status1',status='$status1', refundapprovedby = '$username', approvalstatus = 'approved' where auto_number='$auto_number' and referalname='$referalname' and patientvisitcode='$visitcode'");
		$query29=mysql_query("update consultation_referal set referalrefund='$status1',status='$status1', refundapprovedby = '$username', approvalstatus = 'approved' where auto_number='$auto_number' and referalname='$referalname' and patientvisitcode='$visitcode'");
  ...
  header("location:refundreferrallistapprove.php?patientcode=$patientcode&&visitcode=$visitcode");  
  exit;
}
...
<form name="frmsales" id="frmsales" method="post" action="refundreferralapprove.php" onKeyDown="return disableEnterKey(event)" onSubmit="funcPrintBill1();">
...
-->
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
            <tr>
                ...
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Approve</strong></div></td>
			...
			$ssno=0;
			$totalamount=0;			
			$query61 = "select * from consultation_departmentreferal where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and paymentstatus='completed' and status='refund' and approvalstatus='pending'";
			$exec61 = mysql_query($query61) or die ("Error in Query1".mysql_error());
			$numb=mysql_num_rows($exec61);
  ...
  <td class="bodytext31" valign="center"  align="left"><div align="center">
		...
		<?php
			...
			$ssno=0;
			$totalamount=0;			
			$query61 = "select * from consultation_referal where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and paymentstatus='completed' and status='refund' and approvalstatus='pending'";
			$exec61 = mysql_query($query61) or die ("Error in Query1".mysql_error());
			$numb=mysql_num_rows($exec61);
			while($res61 = mysql_fetch_array($exec61))
			{
