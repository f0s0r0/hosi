...
$stringbuild1 = "";
 $query1 = "select * from master_services where itemname like '%$searchsuppliername1%' and status <> 'Deleted' AND locationcode = '".$locationcode."' AND rateperunit <> 0 order by itemname limit 0,20";
