    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="medicineissuelist.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong>Medicine Issue List </strong></td>
              </tr>
          	<tr>
...
?>
		...
		$query1 = "select * from pharmacysales_details where locationcode = '".$locationcode."' AND patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and issuedfrom <> 'ip' and patientcode<>'walkin' and entrydate between '$fromdate' and '$todate' group by docnumber order by auto_number desc";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
	...
	$colorloopcount = $colorloopcount + 1;
          ...
          <tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $sno = $sno + 1; ?></div></td>
			   <td class="bodytext31" valign="center"  align="left">
			    <div align="center"><a href="print_medicine_label.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&billnumber=<?php echo $docnumber; ?>" onClick="window.open(this.href, 'mywin','left=20,top=20,width=500,height=500,toolbar=1,resizable=0'); return false;">Print</a></div></td>
			  <td class="bodytext31" valign="center"  align="left">
              ...
              <td class="bodytext31" valign="center"  align="left"><a href="pharmacyrefund.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&docnumber=<?php echo $docnumber; ?>"><strong>Refund</strong></a></td>
              </tr>
		   <?php 
		   } 
		...
		$query1 = "select * from pharmacysales_details where locationcode = '".$locationcode."' AND patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and issuedfrom = 'ip' and entrydate between '$fromdate' and '$todate' group by ipdocno order by auto_number desc";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		$num1=mysql_num_rows($exec1);
	...
	$colorloopcount = $colorloopcount + 1;
		...
		$query11 = "select * from medicine_return_request where  patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and refundstatus <> 'refund' and date between '$fromdate' and '$todate' group by visitcode order by auto_number desc";
		...
		$query13 = "select * from pharmacysales_details where locationcode = '".$locationcode."' AND patientcode = '".$patientcode."' and visitcode ='".$visitcode."'  group by ipdocno order by auto_number desc";
