...
//include ("autocompletebuild_expenseaccount.php");
...
include ("nmpurchaseinclude.php"); //handles all the purchase insert operations
...
<?php include ("nmpurchasescripting.php"); ?>
...
<script type="text/javascript" src="js/autocomplete_12accounts.js"></script>
...
{
?>
	var  invoice_number="<?= $_REQUEST['invoice_number'] ?>";

	window.open("print_invoiceentry.php?invoice_number="+invoice_number+"","OriginalWindowA4",'width=900,height=600,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25'); 
<?php
}
?>
</script>
...
<body>
<form name="frmpurchase" id="frmpurchase" method="post" action="nmpurchase.php" onKeyDown="return disableEnterKey(event)">
    ...
    <td width="99%" valign="top"><table width="950" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="100%"><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
		  <tr bgcolor="#011E6A">
		  <td bgcolor="#CCCCCC" class="bodytext3" colspan="10"><strong>NM Purchase Bill  </strong></td>
		  </tr>
            <tr>
              ...
              <td class="bodytext3"><strong>
                ...
                <input name="billnumber" readonly id="billnumber" value="<?php echo $billnumber; ?>" style="text-align:right" size="5" />
              ...
              <td width="12%" class="bodytext3"><span class="bodytext312">
                <input name="ADate" id="ADate" value="<?php echo $dateonly; ?>"  size="10"  readonly="readonly" onKeyDown="return disableEnterKey()" />
...
*/            <?php
			  ...
			  ?>
            <tr>
              <td colspan="8" align="left" valign="middle"  bgcolor="#FFFF00" class="bodytext3"> * WARNING : Please Note You Are Editing Bill No. <?php echo $delsupplierbillnumber; ?> . All The Data For This Bill Will Be Over Written Including Payments. You May Need To Re-Enter Again Everything For This Bill. </td>
            </tr>
            <?php
			  //include ("zprintdmp1test2.php"); 
			  }
            ...
            <tr>
			  ...
			  <input name="supplier" id="supplier" value="<?php echo $res41suppliername; ?>" size="40" autocomplete="off"/>
              ...
              <td width="9%" align="left" valign="top" ><span class="bodytext3"><span class="style6"><span class="bodytext312"><a href="javascript:displayDatePicker('ADate1', false, 'ymd', '-');"></a></span></span></span><span class="bodytext311">
                  <?php
				  ...
				  ?>
                <input name="supplierbillnumber" id="supplierbillnumber" value="<?php echo $supplierbillnumber; ?>" size="10"  />
				
                  </span></td>
             <td width="9%" align="left" valign="middle" class="bodytext3"><strong>Currency</strong></td>
              <td width="9%" align="left" valign="top"><select name="currency" id="currency" style="width: 130px;">
				<?php  $query_currency=mysql_query("SELECT rate,currency,defaultcurr FROM master_currency where recordstatus=''") or die("Error ".mysql_error()); 
				while($exec_currency=mysql_fetch_array($query_currency)){
				?>
				<option value="<?= $exec_currency['rate'].'||'.$exec_currency['currency'] ?>" <?= ($exec_currency['defaultcurr']=="yes")?"selected='selected'":""; ?> > <?= $exec_currency['currency'] ?></option>
				<?php } ?>
				</select>
				</td>
             <td width="11%" ><span class="bodytext312">
                <input name="ADate2" id="ADate2" value="<?php echo $suppdateonly; ?>"  size="15"  readonly="readonly" onKeyDown="return disableEnterKey()" type="hidden"/>
                 </span> </td>
            </tr>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="tblrowinsert">
               ...
               <!-- <td width="9%" align="left" valign="center"  
                bgcolor="#CCCCCC" class="bodytext31"><strong> Code </strong></td>-->
                <td width="38%" align="left" valign="center"  
                bgcolor="#CCCCCC" class="bodytext31"><strong>Item Name </strong></td>
				<td width="38%" align="left" valign="center"  
                bgcolor="#CCCCCC" class="bodytext31"><strong>Account Name </strong></td>
                               <td width="7%" align="left" valign="center"  
                bgcolor="#CCCCCC" class="bodytext31"><strong>Price</strong></td>
                <td width="2%" align="left" valign="center"  
                bgcolor="#CCCCCC" class="bodytext31"><strong>Qty </strong></td>
                <!-- <td width="3%" align="left" valign="center"  
                bgcolor="#CCCCCC" class="bodytext31"><strong>Free</strong></td>
                              <td width="5%" align="left" valign="center"  
                bgcolor="#CCCCCC" class="bodytext31"><strong>Batch</strong></td>
                <td width="5%" align="left" valign="center"  
                bgcolor="#CCCCCC" class="bodytext31"><strong>Expiry</strong></td>
                <td width="5%" align="left" valign="center"  
                bgcolor="#CCCCCC" class="bodytext31"><strong>Pack</strong></td>
				 <td width="5%" align="left" valign="center"  
                bgcolor="#CCCCCC" class="bodytext31"><span class="bodytext311"><strong>TotalQty</strong></span></td>-->
                ...
                bgcolor="#CCCCCC" class="bodytext31"><strong>SP</strong></td>-->
                <td width="7%" align="left" valign="center"  
            ...
            <!--<tr>
              ...
              <td align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31"><strong>Price</strong></td>
              <td align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31"><strong>Qty</strong></td>
              <td align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31"><strong>Free</strong></td>
              ...
              <td align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31"><strong>Pack</strong></td>
			  <td align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31"><strong>TotalQty</strong></td>
              <td align="center" valign="center"  bgcolor="#CBDBFA" class="bodytext31"><strong>Total</strong></td>-->
              <!--<td align="center" valign="center"  bgcolor="#CBDBFA" class="bodytext31"><span class="bodytext311"><strong>SP</strong></span></td>
              <td align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31">&nbsp;</td>
            </tr>-->
            <tr>
              <td width="2%" align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31">
			  <input type="hidden" name="dummy1" id="dummy1" style="border: 0px solid #001E6A; background-color:#CBDBFA; text-align:right" value="" size="1" readonly="readonly" />
			  <input type="text" value="<?php echo $itemcount + 1; ?>" name="itemserialnumber" id="itemserialnumber" style="text-align:right" size="1" readonly="readonly" /></td>
             <!-- <td width="7%" align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31">
			  <input onKeyDown="return itemcodekeypress1(event)" name="itemcode" id="itemcode" style="text-align:left;text-transform: uppercase;" value="" size="5" /></td>-->
			  ...
			  <input name="itemdescription" type="hidden" id="itemdescription" style="text-align:left" value="" size="35">
			  </strong></span></td>
           	  <td width="26%" align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31">
			  <input name="account" id="account" autocomplete="off" style="text-align:left" value="" size="35" />
			  <input type="hidden" name="accountcode" id="accountcode" readonly>
			  </td>
			  <!--<input type="button" name="itemsearch2" onClick="javascript:itemsearch1('purchase')" value="Alt+S" accesskey="s" style="border: 1px solid #001E6A">-->
				...
				<input type="hidden" name="manufacturername" id="manufacturername" onFocus="return funcManufacturerPopulate1()" style="width:80px">
				
              <td width="3%" align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31">
			  <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemmrp" value="0.00" id="itemmrp" style="text-align:right" size="15" /></td>
              <td width="7%" align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31">
			  <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemquantity" value="1" id="itemquantity" style="text-align:right" size="4" />
              
                <input type="hidden" name="itemfreequantity" id="itemfreequantity" style="text-align:right" onBlur="return itemtotalamountupdate1()" onKeyDown="return itemquantitykeypress1(event)" value="0" size="1" />
				<input type="hidden" onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemdiscountpercent" value="0.00" id="itemdiscountpercent" style="text-align:right" size="2" /></td>
              
              
            <!--  <td width="7%" align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31">
			    <span class="bodytext311"><strong>
			    <input name="batchnumber" id="batchnumber" onBlur="return itemtotalamountupdate1()" value="<?php //echo $batchnumber; ?>" size="5" />
			    </strong></span>
			    <input type="hidden"s onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemdiscountpercent" value="0.00" id="itemdiscountpercent" style="text-align:right" size="2" /></td>
			  ...
			  <span class="bodytext311"><strong>
			  <input name="expirydate" id="expirydate" value="<?php //echo date('m/y'); ////echo $batchnumber; ?>" onBlur="return itemtotalamountupdate1()" onFocus="javascript:select(this);" size="3" />
			  <strong><span class="bodytext312"> </span></strong
				>			  </strong
				></span></td>
			  ...
			  <td width="7%" align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31"><span class="bodytext311">
                <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemtotalquantity" value="1" readonly="readonly" id="itemtotalquantity" style="text-align:right" size="2" />
              </span></td>-->
              <td width="4%" align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31">
			  <input name="itemtotalamount" value="0.00" id="itemtotalamount" readonly style="text-align:right" size="15" /></td>
              <!--<td width="5%" align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31"><span class="bodytext311">
                ...
                <strong>
				<input type="hidden" name="spmarkup" id="spmarkup">
				<input type="hidden" name="costprice" id="costprice">
                <input name="salesprice" id="salesprice" value="<?php //echo $batchnumber; ?>" size="3" />
                </strong></span></td>-->
              <td width="11%" align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31"><span class="bodytext311"><strong>
            ...
            <!--  <td align="left" valign="center"  bgcolor="#FFFFFF" class="bodytext31">&nbsp;</td>
             ...
             <td align="left" valign="center"  bgcolor="#FFFFFF" class="bodytext31">&nbsp;</td>
              ...
              <td colspan="2" align="left" valign="center"  bgcolor="#FFFFFF" class="bodytext31"><!--<span class="bodytext311"><strong>
                <input onKeyDown="return disableEnterKey()" name="showcurrentstock1" id="showcurrentstock1" onFocus="javascript:this.select()" readonly="readonly" style="text-align:left;text-transform: uppercase; background:#CDCDCD" autocomplete="off" value="" size="5" />
              </strong></span>--></td>
              ...
              <td align="left" valign="center"  bgcolor="#FFFFFF" class="bodytext31"><span class="bodytext311">
                <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemtaxpercent" value="0.00" id="itemtaxpercent" readonly="readonly" style="text-align:right" size="2" />
              </span></td>
            </tr>
        </table></td>
      </tr>
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="2" width="90%" 
            align="left" border="0">
            <tbody id="foo">
              ...
              <tr>
				...
				style="text-align:right;" value="0.00" size="6" />
				    ...
				    <input name="subtotaldiscountpercent" id="subtotaldiscountpercent" onKeyDown="return funcResetPaymentInfo1()" 
					 type="hidden" onBlur="return funcbillamountcalc1()" value="0.00" style="text-align:right" size="15" />
				    <input name="totaldiscountamount" id="totaldiscountamount" value="0.00" type="hidden" style="text-align:right" size="15"  readonly="readonly" />
				    <input type="hidden" name="subtotaldiscountrupees" id="subtotaldiscountrupees" onKeyDown="return funcResetPaymentInfo1()" onBlur="return funcbillamountcalc1()" value="0.00" style="text-align:right" size="15" />
				    <input type="hidden" name="afterdiscountamount" id="afterdiscountamount" value="0.00" style="text-align:right" size="15"  readonly="readonly" />
				  </strong></span></td>
				  </tr>
				  <tr>
				...
				type="hidden" style="text-align:right;" value="0.00" size="15" />
                    </strong>
-->
                    </span></td>
				    </tr>
                ...
                bgcolor="#F3F3F3" class="bodytext31"><span class="bodytext311">
                    ...
                    <td width="40%"><span class="bodytext312">
                      <input name="totaltaxamount<?php echo $res5anum; ?>" id="totaltaxamount<?php echo $res5anum; ?>" value="0.00" style="text-align:right" onKeyDown="return disableEnterKey()" size="15"  readonly="readonly" />
                    </span></td>
                  </tr>
 				<?php
				$res6loopcount = '';
                ...
                bgcolor="#F3F3F3" class="bodytext31"><span class="bodytext311">
                    ...
                    <td width="40%"><span class="bodytext312">
                      <input name="totaltaxsubamount<?php echo $res5anum; ?><?php echo $res6loopcount; ?>" id="totaltaxsubamount<?php echo $res5anum; ?><?php echo $res6loopcount; ?>" value="0.00" style="text-align:right" onKeyDown="return disableEnterKey()" size="15"  readonly="readonly" />
                    </span></td>
                  </tr>
				<?php
				}
                ...
                <td align="left" valign="top" ><span class="bodytext311">
                  <input name="subtotal" id="subtotal" value="0.00" style="text-align:right" size="15"  readonly="readonly" />
                </span></td>
              </tr>
              <tr>
                <td align="left" valign="center"  
                ...
                <td align="left" valign="top" ><span class="bodytext311">
                  <input name="subtotalaftercombinediscount" id="subtotalaftercombinediscount" value="0.00" style="text-align:right" size="15"  readonly="readonly" />
                </span></td>
              </tr>
              <tr>
                <td align="left" valign="center"  
                ...
                <td align="left" valign="top" ><span class="bodytext312">
                  <input name="totalaftertax" id="totalaftertax" value="0.00"  onKeyDown="return disableEnterKey()" onBlur="return funcSubTotalCalc()" style="text-align:right" size="15"  readonly="readonly"/>
                </span></td>
              </tr>
              <tr>
                <td align="left" valign="center"  
                ...
                <td align="left" valign="top" ><input type="text" name="packaging" id="packaging" value="0.00" onKeyDown="return disableEnterKey()" onBlur="return funcbillamountcalc1()" style="text-align:right" size="15"/></td>
              </tr>
              <tr>
                <td align="left" valign="center"  
                bgcolor="#F3F3F3" class="bodytext31">&nbsp;</td>
                ...
                <td align="left" valign="top" ><span class="bodytext312"><span class="bodytext311">
                  <input type="text" name="delivery" id="delivery" value="0.00" onKeyDown="return disableEnterKey()" onBlur="return funcbillamountcalc1()" style="text-align:right" size="15"/>
                </span></span></td>
              </tr>
              <tr>
                <td align="left" valign="center"  
                ...
                <td align="left" valign="top" ><span class="bodytext311">
                  <input name="roundoff" id="roundoff" value="0.00" style="text-align:right"  readonly="readonly" size="15"/>
                </span></td>
              </tr>
              <tr>
                <td align="left" valign="center"  
                ...
                <td align="left" valign="top" ><span class="bodytext311">
                  <input name="totalamount" id="totalamount" value="0.00" style="text-align:right" size="15"  readonly="readonly" />
                </span></td>
              </tr>
				<?php
				$query5 = "select * from master_tax where status = '' order by taxname desc";
...
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Cash Amount </strong></div></td>
                <td align="left" valign="top" ><span class="bodytext31">
                  <input name="cashamount" id="cashamount" onBlur="return funcbillamountcalc1()" tabindex="1" value="0.00" style="text-align:right" size="15"  readonly="readonly" />
                </span></td>
              </tr>
			  
                       <input type="hidden" name="cashgivenbysupplier" id="cashgivenbysupplier" onBlur="return funcbillamountcalc1()" onFocus="return cashentryonfocus1()" tabindex="2" value="0.00" style="text-align:right" size="15"  />
              
                         <input type="hidden" name="cashgiventosupplier" id="cashgiventosupplier" onBlur="return funcbillamountcalc1()" value="0.00" style="text-align:right" size="15" readonly="readonly"  />
...
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Credit Amount </strong></div></td>
                <td align="left" valign="top" ><span class="bodytext31">
                  <input name="creditamount" id="creditamount" onBlur="return funcbillamountcalc1()" value="0.00" style="text-align:right" size="15"  readonly="readonly" />
                </span></td>
              </tr>
              <tr id="chequeamounttr">
                ...
                <td align="left" valign="center"  
                bgcolor="#F3F3F3" class="bodytext31"><span class="bodytext311">
                  <input name="chequedate" id="chequedate" value="" style="text-align:left; text-transform:uppercase" size="15"  />
                </span></td>
                <td align="left" valign="center"  
                bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong> Chq No. </strong></div></td>
                <td align="left" valign="center"  
                bgcolor="#F3F3F3" class="bodytext31"><input name="chequenumber" id="chequenumber" value="" style="text-align:left; text-transform:uppercase" size="15"  /></td>
                <td align="left" valign="center"  
                bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong> Bank  </strong></div></td>
                <td align="left" valign="center"  
                bgcolor="#F3F3F3" class="bodytext31"><!--				<input name="bankname" id="bankname" value="" style="text-align:left; text-transform:uppercase"  size="15"  />
-->
                  <span class="bodytext311">
                  <input name="chequebank" id="chequebank" value="" style="text-align:left; text-transform:uppercase" size="15"  />
                  </span></td>
                <td align="left" valign="center"  
                bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Cheque Amount </strong></div></td>
                <td align="left" valign="top" ><span class="bodytext31">
                  <input name="chequeamount" id="chequeamount" onBlur="return funcbillamountcalc1()" value="0.00" style="text-align:right" size="15"  readonly="readonly" />
                </span></td>
              </tr>
              <tr id="cardamounttr">
                <td align="left" valign="center"  
                ...
                <td width="6%" align="left" valign="center"  
                bgcolor="#F3F3F3" class="bodytext31"><input name="cardnumber" id="cardnumber" value="" style="text-align:left; text-transform:uppercase" size="15"  /></td>
                <td width="17%" align="left" valign="center"  
                bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong> Bank  </strong></div></td>
                <td align="left" valign="center"  
                bgcolor="#F3F3F3" class="bodytext31">
                <!--				<input name="bankname" id="bankname" value="" style="text-align:left; text-transform:uppercase"  size="15"  />
-->				
                ...
                <td align="left" valign="top" ><span class="bodytext31">
                  <input name="cardamount" id="cardamount" onBlur="return funcbillamountcalc1()" value="0.00" style="text-align:right" size="15"  readonly="readonly" />
                </span></td>
              </tr>
...
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Online Amount </strong></div></td>
                <td align="left" valign="top" ><span class="bodytext31">
                  <input name="onlineamount" id="onlineamount" onBlur="return funcbillamountcalc1()" value="0.00" style="text-align:right" size="15" readonly="readonly" />
                </span></td>
              </tr>
			   <tr id="">
...
bgcolor="#F3F3F3" class="bodytext31"><span class="bodytext32"><strong><?php //echo $f18;?></strong></span>
                ...
                <td colspan="2" align="left" valign="center"  
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Total FX Amount</strong></div></td>
                <td align="left" valign="top" ><span class="bodytext31">
                  <input name="fxamount" id="fxamount" value="0.00" style="text-align:right" size="15" readonly="readonly" />
...
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Nett Amount</strong></div></td>
                <td align="left" valign="top" ><span class="bodytext31">
                  <input name="nettamount" id="nettamount" value="0.00" style="text-align:right" size="15" readonly="readonly" />
                </span></td>
              </tr>
              <tr>
                <td colspan="7" align="left" valign="center"  
                ...
                bgcolor="#CCCCCC" class="bodytext31"><div align="right"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
				  ...
				  <input name="Submit2223" type="submit" id="Submit2223" onClick="return funcSaveBill1()" value="Save Bill" accesskey="b" class="button" />
          ...
          <tbody>
            <tr>
              <td width="54%" align="left" valign="top" ><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
                ...
                <input name="Button1" type="hidden" class="button" id="Button1" accesskey="c" onClick="return funcRedirectWindow1()" value="Clear All"/>
                </font></font></font></font>
                <input type="hidden" name="suppliersearch2" onClick="javascript:suppliersearch1('purchase')" value="Supplier Alt+M" accesskey="m" style="border: 1px solid #001E6A">
                <span class="bodytext31">
                <input type="hidden" name="itemsearch22" onClick="javascript:itemsearch1('purchase')" value="Item Alt+S" accesskey="s" style="border: 1px solid #001E6A">
              ...
              <td width="46%" align="left" valign="top" ><div align="right"><span class="bodytext31"><span class="bodytext311">
                <input type="hidden" name="quickprintbill" id="quickprintbill" value="<?php echo $previousbillnumber; ?>" style="text-align:right; text-transform:uppercase"  size="11"  />
              </span><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
				
                <!--<input name="print4inch2" type="button" class="button" id="print4inch2" onClick="return quickprintbill1purchase()" value="Print 40" accesskey="p"/>-->
				  
                </font></font></font></font></font></font></font></font></font>                <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
                  
				 <!-- <input name="print4inch" type="button" class="button" id="print4inch" onClick="return quickprintbill2purchase()" value="View 40" accesskey="p"/>-->
				  
				  
                  <input onClick="return loadprintpage1('A4<?php //echo $previousbillnumber; ?>')" value="View A4" 
				  name="printA4" type="hidden" class="button" id="printA4" style="border: 1px solid #001E6A"/>
