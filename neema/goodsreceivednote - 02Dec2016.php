...
<?php $sno = $sno + 1; ?>
  <tr>
  		<td class="bodytext31" valign="center"  align="left"><input type="checkbox" class="selectitem" name="selectitem[]" id="selectitem<?php echo $sno ; ?>" value="<?php echo $itemcode; ?>"></td>
