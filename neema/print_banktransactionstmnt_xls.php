...
header('Content-Disposition: attachment;filename="BankStatement.xls"');
...
<body>
<table width="" border="1" align="left" cellpadding="4" cellspacing="0"  style="border-collapse: collapse">
				<?php
 					$sno = 0;
