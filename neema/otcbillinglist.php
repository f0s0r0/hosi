...
?>
	...
	if(savedbillnumberr != "") 
	{
		window.open("print_otcbilling_dmp4inch1.php?billnumber="+savedbillnumberr+" ","OriginalWindowA14",'width=400,height=500,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25'); 
	}
</script>
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="732" 
            align="left" border="0">
          <tbody>
            <tr>
              <td colspan="5" bgcolor="#cccccc" class="bodytext31">
                <!--<input onClick="javascript:printbillreport1()" name="resetbutton2" type="submit" id="resetbutton2"  style="border: 1px solid #001E6A" value="Print Report" />-->
                <div align="left"><strong>OTC Billing </strong></div></td>
              </tr>
            <tr>
			...
			$query1 = "select * from master_consultationpharm where patientcode='walkin' and medicineissue='pending' and pharmacybill='pending' group by billnumber order by recorddate desc";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center" align="left">
			    <div align="left"><a href="otcbilling.php?billnumber=<?php echo $billnumber; ?>"><strong>Bill Now</strong></a></div></td>
              </tr>
			<?php
			}    
			?>
