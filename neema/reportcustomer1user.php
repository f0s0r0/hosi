    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="reportcustomer1user.php">
		<table width="791" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Statement - By Account</strong>&nbsp;&nbsp;&nbsp;<a href="#" onClick="viewReport();"><strong>W</strong></a></td>
            ...
            <tr>
              <td width="17%"  align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3">Select Account </td>
...
&nbsp;				<input value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" /></td>
            ...
            <tr>
              ...
              <td width="16%"  align="left" valign="center" 
               ...
               <td width="11%"  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>By Finalize </strong></div></td>
              <td width="10%"  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>By  Refund </strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><div align="right"><strong>By Settlement </strong></div></td>
			...
			$query2 = "select * from master_transactionpaylater where accountname like '%$suppliername%' and particulars <> '' and transactiondate between '$transactiondatefrom' and '$transactiondateto' and companyanum = '$companyanum' and recordstatus <> 'DELETED' group by visitcode order by transactiondate";// desc";
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left"><div class="bodytext31"><?php echo $name; ?>(<?php echo $visitcode; ?>)</div></td>
              <td class="bodytext31" valign="center"  align="left">
