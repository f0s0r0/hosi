...
$query3 = "select labrefnoprefix from master_company where companystatus = 'Active'";
	...
	else
	{
		...
		if($labname!="")
		{
		$labquery1=mysql_query("insert into consultation_lab(consultationid,patientcode,patientname,patientvisitcode,labitemcode,labitemname,labitemrate,consultationdate,paymentstatus,labsamplecoll,resultentry,labrefund,billnumber,refno,billtype,accountname,consultationtime,locationname,locationcode,username)values('$consultationid1','$patientcode','$patientfullname','$visitcode','$labcode','$labname','$labrate','$currentdate','$status1','pending','pending','norefund','$consultationid','$labrefcode','$billingtype','$accountname','$timestamp','$locationname','$locationcode','$username')") or die(mysql_error());
		...
		if($num61 == 0)
		{
		$radiologyquery1=mysql_query("insert into consultation_radiology(consultationid,patientcode,patientname,patientvisitcode,radiologyitemcode,radiologyitemname,radiologyitemrate,billtype,accountname,consultationdate,paymentstatus,refno,resultentry,consultationtime,billnumber,username,locationname,locationcode)values('$consultationid1','$patientcode','$patientfullname','$visitcode','$radiologycode','$pairvar','$pairvar1','$billingtype','$accountname','$currentdate','$status1','$radrefcode','pending','$timestamp','$consultationid','$username','$locationnameget','$locationcodeget')") or die(mysql_error());
		}
		}
...
<script type="text/javascript" src="js/insertnewitem222.js"></script>
<script type="text/javascript" src="js/insertnewitem333.js"></script>
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
		  			   ...
		  			   <tr>
				   <td colspan="11" align="left" valign="middle"  bgcolor="#CCCCCC" class="bodytext3"><span class="bodytext32"><strong>Lab </strong></span></td>
			      </tr>
		         ...
		         <tr>
				   <td colspan="11" align="left" valign="middle"  bgcolor="#CCCCCC" class="bodytext3"><span class="bodytext32"><strong>Radiology </strong></span></td>
		        </tr>
				<tr id="radid">
				   <td colspan="11" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">
