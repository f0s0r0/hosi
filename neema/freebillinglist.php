...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
   ...
   <tr>
    ...
    <td width="99%" valign="top"><table width="105%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
        <td width="1152">
              <form name="cbform1" method="post" action="freebillinglist.php" onSubmit="return searchcheck()">
  ...
  <form name="form1" id="form1" method="post" action="freebillinglist.php">	
  <?php
		  if ($searchvisitcode != '') {
          ...
          <tbody>
		    <tr>
              ...
              <td colspan="9" bgcolor="#cccccc" class="bodytext31"><script language="javascript">
                ...
                <div align="left"><strong>Free Billing</strong><label class="number">&nbsp;</label></div></td>
              </tr>
            <tr>
			...
			$query1 = "select * from master_visitentry where billtype <> 'PAY NOW' and overallpayment <> 'completed' and complaint = '0' and consultationfees <> '0' and patientfullname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and planfixedamount='0.00' and planpercentage='0.00' order by auto_number desc";
            ...
            <tr <?php echo $colorcode; ?>>
             ...
             <td class="bodytext31" valign="center"  align="left">
			  ...
			  {?>
			    <div align="left">
				<a href="freebilling.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>"><strong> Billing</strong></a></div>
				<?php } else{?>
				<div align="left">
				<a href="freebilling.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>"><strong> Billing</strong></a></div>
				<?php }?>
			...
			$query1 = "select * from master_visitentry where patientfullname like '%$searchpatient%' and overallpayment <> 'completed' and complaint = '0' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and consultationfees='0' order by auto_number desc";
