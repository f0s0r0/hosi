...
$query34="select * from op_ambulancerequest where recordstatus='' and recorddate between '$transactiondatefrom' and '$transactiondateto'  order by auto_number asc";
...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
              <form name="cbform1" method="post" action="ambulancerequestlistop.php">
                <table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                    <tr bgcolor="#011E6A">
                      <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Ambulanc Request List-OP</strong></td>
...
-->				 <td class="bodytext31" valign="center"  align="left" 
        ...
        <?php      
          ...
          <tbody>
            <tr>
              ...
              <td colspan="7" bgcolor="#cccccc" class="bodytext31">
                <div align="left"><strong>Ambulanc Request List-OP</strong>
		  ...
		  $query11 = "select * from op_ambulancerequest where recordstatus='' and recorddate between '$transactiondatefrom' and '$transactiondateto'  order by auto_number asc";
		...
		// $suppliername = $res11['suppliername'];
			...
			?>
			  ...
			  <div class="bodytext31" align="center"><a href="opambulancerequest1.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&docno=<?php echo $docno; ?>">Process </a></div></td>
