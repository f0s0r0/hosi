      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			$query1 = "select * from master_transactionpharmacy where transactionstatus='onaccount' group by docno";
			...
			$query2 = "select sum(transactionamount) as adjustedamount from master_transactionpharmacy where docno='$docno' and transactiontype = 'PAYMENT' and transactionstatus = '' and recordstatus <> 'deallocated'";
