...
$query2 = "select description, icdcode, chapter, auto_number from master_icd where (disease like '%$searchdisease1%' OR description like '%$searchdisease1%' OR icdcode like '%$searchdisease1%') and recordstatus = 'active' order by auto_number limit 1000";// order by subtype limit 0, 15";
