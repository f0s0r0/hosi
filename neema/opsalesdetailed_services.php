...
<body>
<table width="108%" border="0" cellspacing="0" cellpadding="2">
  <tr>
  ...
  <td width="994" colspan="10">
   <?php
	  $query341 = "select auto_number from master_employee where username = '$username' and statistics='on'";
				 ...
				 {
	  ?>
<table width="944"  border="0" cellpadding="2" cellspacing="0">
<tr>
	<td>&nbsp;</td>
</tr>
...
<tr>
  ...
  <tr>
    <td width="34" bgcolor="#ffffff" align="center" class="bodytext31"><strong>Sno</strong></td>
    <td width="84" bgcolor="#ffffff" class="bodytext31"><strong>Date</strong></td>
    <td width="104" bgcolor="#ffffff" class="bodytext31"><strong>Patient Name</strong></td>
    <td width="80"  bgcolor="#ffffff" class="bodytext31"><strong>Patient Code</strong></td>
    <td width="82" bgcolor="#ffffff" class="bodytext31"><strong>Visit Code</strong></td>
    <td width="136" bgcolor="#ffffff" class="bodytext31"><strong>Account</strong></td>
    <td width="201" bgcolor="#ffffff" class="bodytext31"><strong>Test Name</strong></td>
    <td width="50" bgcolor="#ffffff" class="bodytext31" align="right"><strong>Rate</strong></td>
    <td width="78" bgcolor="#ffffff" class="bodytext31" align="right"><strong>Qty</strong></td>
    <td width="55" bgcolor="#ffffff" class="bodytext31" align="right"><strong>Amount</strong></td>
  ...
  $newamount=0;
		  ...
		  $querypaynow="select amount as amount,serviceqty,servicesitemrate,patientcode,patientvisitcode,patientname,billdate,accountname,servicesitemname from  billing_paynowservices where billdate between '$ADate1' and '$ADate2' and locationcode='$locationcode1' ";
		  ...
		  while($respaynow = mysql_fetch_array($execpaynow))
		  {
		   ...
		   $serviceqty= $respaynow['serviceqty'];
  ...
  <tr <?php echo $colorcode; ?> class="bodytext31">
    <td align="center" width="34"><?php echo $sno+=1;?></td>
    <td width="84"><?php echo $billdate; ?></td>
    <td width="104"><?php echo $patientname; ?></td>
    <td width="80"><?php echo $patientcode ;?></td>
    <td width="82"><?php echo $patientvisitcode; ?></td>
    <td width="136"><?php echo $accountname; ?></td>
    <td width="201"><?php echo $servicesitemname; ?></td>
    <td width="50" align="right"><?php echo number_format($servicesitemrate); ?></td>
    <td width="78" align="right"><?php echo number_format($serviceqty,0); ?></td>    
    <td width="55" align="right"><?php echo $amount; ?></td>
...
<tr>
 ...
 <?php
     $querypaylater="select servicesitemrate,amount as amount,serviceqty,patientcode,patientvisitcode,patientname,billdate,accountname,servicesitemname from  billing_paylaterservices where billdate between '$ADate1' and '$ADate2' and locationcode='$locationcode1'";
		  ...
		  while($respaylater = mysql_fetch_array($execpaylater))
		  {
		   ...
		   $serviceqty= $respaylater['serviceqty'];
  ...
  <tr <?php echo $colorcode; ?> class="bodytext31">
    ...
    <td width="104"><?php echo $patientname1; ?></td>
    <td width="80"><?php echo $patientcode1; ?></td>
    <td width="82"><?php echo $patientvisitcode1; ?></td>
    <td width="136"><?php echo $accountname; ?></td>
    <td width="201"><?php echo $servicesitemname; ?></td>
    <td width="50" align="right"><?php echo number_format($servicesitemrate); ?></td>
    <td width="78" align="right"><?php echo number_format($serviceqty,0); ?></td>
    <td width="55" align="right"><?php echo number_format($amount1); ?></td>
