        ...
        <td valign="top"><table width="919" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            <?php
				...
				{  
					...
					$querydr1 = "SELECT `subtotal` as td1, `entrydate` as td2, `billnumber` as td3, `assetcode` as td4, `asset` as td5 FROM `assetpurchase_details` WHERE `assetcode` = '$id' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2'
								 UNION ALL SELECT debitamount as td1, `entrydate` as td2, `docno` as td3, `ledgerid` as td4, `ledgername` as td5 FROM `master_journalentries` WHERE `ledgerid` = '$id' AND selecttype = 'Dr' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2'
								 UNION ALL SELECT (-1*creditamount) as td1, `entrydate` as td2, `docno` as td3, `ledgerid` as td4, `ledgername` as td5 FROM `master_journalentries` WHERE `ledgerid` = '$id' AND selecttype = 'Cr' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2'";
