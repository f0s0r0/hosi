...
include ("manuallpoinclude.php"); //handles all the purchase insert operations
...
<script type="text/javascript" src="js/nmpurchaseinsertitempo.js"></script>
...
<!--<script type="text/javascript" src="js/autoitemsearch3purchase.js"></script> 
...
<script type="text/javascript" src="js/automedicinecodesearch5mlpo.js"></script>
...
?>
	...
	if(otcbillnumberr != "") 
	{
		window.open("print_manualpurchaseorder.php?billnumber="+otcbillnumberr,"OriginalWindowA25",'width=400,height=500,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25'); 
	}	
</script>
...
{	
	...
	{
		$("#itemmrp").prop('readonly', true);
		$("#itemname").autocomplete( "option", "disabled", false );
		$("#itemname").autocomplete({
		source: "ajax/ajaxmedicine.php?purchasetype="+$("#purchasetype").val(),
		minLength: 2,
			select: function(event, ui) {
				$("#itemcode").val(ui.item.itemcode) ;
				$("#itemnamess").val(ui.item.value);
				funcmedicinesearch4()
			},
			//funcmedicinesearch4()
			html: true
	...
	else if(purchasetype=='non-inventory')
	{
		$("#itemname").autocomplete( "option", "disabled", true );
		$("#itemmrp").prop('readonly', false);
	}
	else
	{
		$("#itemmrp").prop('readonly', false);
	...
	{
	//alert();
	if($("#itemname").val().trim()!=$("#itemnamess").val().trim())
	{
	//alert();
	$("#itemcode").val('');
	$("#itemmrp").val('');
...
<form name="frmpurchase" id="frmpurchase" method="post" action="manuallpo.php" onKeyDown="return disableEnterKey(event)">
    ...
    <td width="99%" valign="top"><table width="950" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="100%"><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
		  <tr bgcolor="#011E6A">
		  <td bgcolor="#CCCCCC" class="bodytext3" colspan="7"><strong>Manual LPO  </strong></td>
          <td colspan="3" align="right" bgcolor="#CCCCCC" class="bodytext3" id="ajaxlocation"><strong> Location </strong>
            ...
            <tr>
              ...
              <td class="bodytext3"><strong>
                ...
                <input name="billnumber" id="billnumber" value="<?php echo $billnumber; ?>" style="text-align:right" size="8" readonly="readonly" />
              ...
              <td width="11%" align="left" valign="middle"  bgcolor="" class="bodytext3"><strong>Location</strong></td>
              ...
              <td width="1%" class="bodytext3"><div align="right"><strong><!--Tax--></strong></div></td>
...
*/            <?php
            ...
            <?php
			  ...
			  ?>
            <tr>
              <td width="6%" align="left" valign="middle" class="bodytext3"><strong>Supplier   </strong></td>
              ...
              <td width="7%" align="left" valign="top" ><span class="bodytext3">
                <input name="suppliercode" id="suppliercode" value="<?php echo $res41suppliercode; ?>" readonly size="10" rsize="20" />
				<input type="hidden" name="currency" id="currency" value="1||KSH">
				<input type="hidden" name="fxamount" id="fxamount" value="0">
              </span></td>
              <td width="7%" align="left" valign="middle" class="bodytext3"><strong></strong>&nbsp;</td>
          ...
          <tbody id="foo">
            ...
            <tr>
             ...
             <!-- <td width="7%" align="left" valign="center"  bgcolor="#CBDBFA" class="bodytext31">
			  ...
			  <input type="hidden" name="itemnamess" id="itemnamess" autocomplete="off" style="text-align:left" value="" size="35" />
			  <input type="hidden" name="itemcode" id="itemcode" style="text-align:left;text-transform: uppercase;" value="1" size="5" />
            ...
            <tbody id="foo">
              ...
              <tr>
				...
				style="text-align:right;" value="0.00" size="6" />
				    ...
				    <input type="hidden" name="subtotaldiscountpercent" id="subtotaldiscountpercent" onKeyDown="return funcResetPaymentInfo1()" 
				...
				type="hidden" style="text-align:right; background-color:#CCCCCC" value="0.00" size="4" />
                          
				      
                      <input name="subtotaldiscountamountonlyapply1" id="subtotaldiscountamountonlyapply1" onBlur="return funcSubTotalDiscountApply1()" 
				type="hidden" style="text-align:right;" value="0.00" size="4" />
				...
				?>
				  <span class="bodytext311">
                      ...
                      <div align="right"><strong><?php //echo strtoupper($res5taxname); //.' '.$res5taxpercent.'%'; ?></strong></div>
					  <span class="bodytext312">
                      <input type="hidden" name="totaltaxamount<?php echo $res5anum; ?>" id="totaltaxamount<?php echo $res5anum; ?>" value="0.00" style="text-align:right" onKeyDown="return disableEnterKey()" size="8"  readonly="readonly" />
                    </span>
 				<?php
				$res6loopcount = '';
				...
				?>
				  <span class="bodytext311">
                      ...
                      <div align="right"><strong><?php //echo strtoupper($res6taxname);//.' '.$res6taxpercent.'%'; ?></strong></div>
					  <span class="bodytext312">
                      <input type="hidden" name="totaltaxsubamount<?php echo $res5anum; ?><?php echo $res6loopcount; ?>" id="totaltaxsubamount<?php echo $res5anum; ?><?php echo $res6loopcount; ?>" value="0.00" style="text-align:right" onKeyDown="return disableEnterKey()" size="8"  readonly="readonly" />
                    </span>
				<?php
				}
				}
...
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Cash Amount </strong></div></td>
                <td align="left" valign="top" ><span class="bodytext31">
                  <input name="cashamount" id="cashamount" onBlur="return funcbillamountcalc1()" tabindex="1" value="0.00" style="text-align:right" size="8"  readonly="readonly" />
                       ...
                       <input type="hidden" name="cashgivenbysupplier" id="cashgivenbysupplier" onBlur="return funcbillamountcalc1()" onFocus="return cashentryonfocus1()" tabindex="2" value="0.00" style="text-align:right" size="8"  />
              
                         <input type="hidden" name="cashgiventosupplier" id="cashgiventosupplier" onBlur="return funcbillamountcalc1()" value="0.00" style="text-align:right" size="8" readonly  />
