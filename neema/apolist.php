...
<script type="text/javascript">
    $(document).ready(function() {
        $("#but").click(function(){
            $.each($("input[name='chkpnt']:checked"), function(){ 
                 var wpdf = $(this).parents('tr').find('a.printchk').attr('href');			
               
				var myWindow = window.open(wpdf, "_blank");
            });
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			<td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><div align="center"><strong>chkprint</strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
              ...
              <td width="15%"  align="left" valign="center" 
                ...
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Print</strong></div></td>
             	<td width="20%"  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong><input type="button" id="but" value="blkprint" /> </strong></div></td>
		...
		while($res34=mysql_fetch_array($exec34))
			...
			?>
			  ...
			  <td class="bodytext31" valign="center"  align="left"><div align="center"><input type="checkbox" name="chkpnt" /></div></td>
			  ...
			  <div class="bodytext31" align="center"><a href="viewapo.php?billnumber=<?php echo $pono; ?>">View</a></div></td>
			    <td class="bodytext31" valign="center"  align="left">
			  <div class="bodytext31" align="center"><a class="printchk"id="print<?php echo $sno;?>" href="print_viewapo.php?billnumber=<?php echo $pono; ?>" target="_blank">Print</a></div></td>
			     <td class="bodytext31" valign="center"  align="left">
