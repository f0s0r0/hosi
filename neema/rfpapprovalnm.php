...
if($_POST['discard'] != $docno)
{
  foreach($_POST['itemname'] as $key => $value)
	...
	//echo "<br>".$itemcode;
		...
		$query45="update purchasenm_rfqrequest set approvalstatus='$status',quantity='$reqqty',amount='$amount' where docno='$docno' and itemname='$itemname1'";
		...
		{
		$query46="update purchasenm_rfqrequest set approvalstatus='rejected' where docno='$docno'";
...
<form name="form1" id="frmsales" method="post" action="rfpapprovalnm.php" onKeyDown="return disableEnterKey(event)" onSubmit="return acknowledgevalid()">
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <td>&nbsp;
			...
			<tr>
              <td bgcolor="#CCCCCC" class="bodytext3" colspan="8"><strong>NM Review RFQ</strong></td>
