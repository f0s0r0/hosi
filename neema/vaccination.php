...
if ($frmflag1 == 'frmflag1')
{
	...
	$dose = $_REQUEST['dose'];
	$vaccine = $_REQUEST['foodallergy'];
	$celsius = $_REQUEST['celsius'];
		
	if ($vaccine != '')
	{
		$query1 = "insert into vaccination (childname,height,weight,bmi,dateofbirth,age,ageduration,vaccine,batch,dose,ipaddress,recorddate,username,temp,gender) 
		values ('$name','$height','$weight','$bmi','$dob','$age','$ageduration','$vaccine','$batch','$dose','$ipaddress','$date','$username','$celsius','$gender')";
...
function addward1process1()
{
	...
	var foodallergy = document.form1.foodallergy.value;
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="vaccination.php" onSubmit="return addward1process1()">
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong>Vaccination </strong></td>
                      </tr>
					  <tr>
				  ...
				  <input type="text" name="dateofbirth" id="dateofbirth" value="" onChange="return GetDifference1()" readonly="readonly">
                      ...
                      <input type="hidden" name="todaydate" id="todaydate" value="<?php echo date('Y-m-d'); ?>"></td>
					   ...
					   <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><input name="age" type="text" id="age" value="" size="5" onKeyUp="return dobcalc();" onBlur="return idhide();"><input name="ageduration" id="ageduration" value="" size="5" readonly="readonly"></td>
					  </tr>
					  <tr>
                       ...
                       <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">BMI</div></td>
                        ...
                        <td colspan="2" align="left" valign="top"  bgcolor="#FFFFFF"><input type="hidden" name="bmicategory" id="bmicategory" class="bal" readonly="readonly" size="21" value=""></td>
					   </tr>
						<tr>
					  ...
					  <tr>
                       <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Vaccinations</div></td>
                        <td width="43%" align="left" valign="top"  bgcolor="#FFFFFF">
						 <input name="autonumber" id="autonumber" type="hidden" />
						<input name="food" id="food" type="text" class="bodytext32" size="38"  autocomplete="off" ></td>
                        <td width="8%" align="left" valign="top"  bgcolor="#FFFFFF">&nbsp;</td>
                        <td width="28%" align="left" valign="top"  bgcolor="#FFFFFF">&nbsp;</td>
                      </tr>
					  <tr>
                       <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">&nbsp;</div></td>
                        <td width="43%" align="left" valign="top"  bgcolor="#FFFFFF">
						<textarea name="foodallergy" cols="30" rows="3" class="bodytext32" id="foodallergy" ></textarea>						</td>
                        <td width="8%" align="left" valign="top"  bgcolor="#FFFFFF">&nbsp;</td>
                        <td width="28%" align="left" valign="top"  bgcolor="#FFFFFF">&nbsp;</td>
                      </tr>
					  <tr>
                       <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Batch</div></td>
                        <td width="43%" align="left" valign="top"  bgcolor="#FFFFFF">
					  ...
					  <tr>
                       <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Dose</div></td>
                        <td width="43%" align="left" valign="top"  bgcolor="#FFFFFF">
