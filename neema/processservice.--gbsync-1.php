...
if($servicename != "")
   {
 $query26="insert into process_service(patientname,patientcode,patientvisitcode,recorddate,recordtime,itemcode,itemname,acknowledge,refund,docnumber,locationname,locationcode)values('$patientname','$patientcode',
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
			...
			$sno = '';
			$totalamount=0;			
			$query61 = "select * from consultation_services where paymentstatus='completed' and patientcode = '$patientcode' and patientvisitcode = '$visitcode' and process='pending' and (billtype='PAY NOW' or (billtype='PAY LATER' and (approvalstatus='1' or approvalstatus='2')))";
