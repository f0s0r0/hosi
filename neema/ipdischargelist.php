    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="ipdischargelist.php">
		<table width="510" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="1" bgcolor="#CCCCCC" class="bodytext3"><strong>Inpatient Discharge</strong></td>
...
?>
          ...
          <tbody>
            ...
            <tr>
			 ...
			 <td width="8%"  align="left" valign="center" 
                ...
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Package Name</strong></div></td>
		...
		$query59 = "select * from ip_bedallocation where ward='$wardnum' and bed='$bedanum' and recordstatus = 'request' and locationcode='$locationcode' order by auto_number desc limit 0, 1";
		...
		$query401 = "select packagename from master_ippackage where   auto_number = '$package'";
		   $exec401 = mysql_query($query401) or die(mysql_error());
		   $res401 = mysql_fetch_array($exec401);
		  $packagename1 = $res401['packagename'];
		  
		$type=$res49['type'];
	
		$query67 = "select * from ip_bedtransfer where ward='$wardnum' and bed='$bedanum' and recordstatus='request' and locationcode='$locationcode' order by auto_number desc limit 0, 1";
		...
		{
		$query592 = "select * from ip_bedtransfer where ward='$wardnum' and bed='$bedanum' and recordstatus = 'request' and locationcode='$locationcode' order by auto_number desc limit 0, 1";
			...
			if($num69 > 0)
		{
		   ...
		   $query82 = "select * from master_ipvisitentry where patientcode='$patientcode' and visitcode='$visitcode' and discharge = 'request' and locationcode='$locationcode'";
	...
	<a href="ipdischarge.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode;?>&&patientlocation=<?php echo $location;?>">Discharge</a>
    
				</td>
                 <td class="bodytext31" valign="center"  align="left">
			    <div align="center"><?php echo $packagename1; ?></div></td>
                 <td class="bodytext31" valign="center"  align="left" >
			    <div align="center" style="color:red;"><?php  if($type="Hospital"){echo "H";}else if($type="private"){echo "P";}?></div></td>
              </tr>
		   <?php 
		   }
		}
