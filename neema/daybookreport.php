...
<tr>
		...
		if($res37transactionamount != '0.00')
		{
			...
			<?php
			 ...
			 $query27 = "select * from master_mortuaryexternaldeposit where username = '$res21username' and transactiondate between '$transactiondatefrom' and '$transactiondateto' order by username desc";
			$exec27 = mysql_query($query27) or die ("Error in Query24".mysql_error());
	        while($res27 = mysql_fetch_array($exec27))
			{
			$res27billnumber = $res27['docno'];
