...
else
{
	...
	$customercode = substr($res2customercode,9);
	...
	if ($res2 == 0)
	{
		...
		if ($_FILES['browse1']['name'] != '')
		{
			if(move_uploaded_file($_FILES['browse1']['tmp_name'], $target_path)) 
			{
				...
				maintype, billtype,accountexpirydate, planexpirydate, overalllimit, planfixedamount, planpercentage, mrdno, promotion,username,locationname,locationcode) 
				...
				'$kinname', '$kincontactnumber', '$paymenttype','$subtype','$planname', 
				'$planvaliditystart', '$accountname', '$customermiddlename','$visitlimit', 
				'$maintype', '$billtype','$accountexpirydate', '$planexpirydate', '$overalllimit', '$planfixedamount', '$planpercentage', '$mrdno', '$promotion','$username','$locationname1','$locationcode1')";
		...
		else
		{
				...
				planvaliditystart, accountname, customermiddlename,visitlimit, 
				maintype, accountexpirydate, planexpirydate, overalllimit, planfixedamount, planpercentage, mrdno, promotion,username,locationname,locationcode) 
				values('$customercode','$customername','$typeofcustomer','$address1','$address2','$area','$city',
				'$state','$country','$pincode','$phonenumber1','$phonenumber2','$faxnumber','$mobilenumber','$emailid1',
				'$emailid2','$remarks','$status', '$tinnumber', '$cstnumber', '$openingbalance', '$insuranceid', 
				'$gender','$mothername', '$age', '$nameofrelative', '$dateofbirth', '$maritalstatus', '$occupation', '$nationalidnumber', 
				...
				'$kinname', '$kincontactnumber', '$paymenttype','$subtype','$billtype','$planname', 
				'$planvaliditystart', '$accountname', '$customermiddlename','$visitlimit', 
				'$maintype', '$accountexpirydate', '$planexpirydate', '$overalllimit', '$planfixedamount', '$planpercentage', '$mrdno', '$promotion','$username','$locationname1','$locationcode1')";
				$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
          ...
          <td width="860"><table width="1316" height="282" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              ...
              <tr>
				...
				bgcolor="<?php if ($errmsg == '') { echo '#FFFFFF'; } else  { echo 'red'; } ?>" class="bodytext3"><?php echo $errmsg;?>&nbsp;</td></tr>
                <?php
		$query1113 = "select * from login_locationdetails where username = '$username' and docno='$docno'";
    $exec1113 = mysql_query($query1113) or die ("Error in Query1111".mysql_error());
	while ($res1113 = mysql_fetch_array($exec1113))
	{
	  $locationname = $res1113["locationname"];
	 	  $locationcode = $res1113["locationcode"];
			 ...
			 while ($res1112 = mysql_fetch_array($exec1112))
			 {
              ...
              <!--<tr>
				...
				<tr>
				  ...
				  <select name="paymenttype" id="paymenttype" onChange="return funcPaymentTypeChange1();"  style="width: 150px;" tabindex="1">
				...
				?>
				  ...
				  <select name="subtype" id="subtype" onChange="return funcSubTypeChange1()" tabindex="2">
...
-->				  
				  ...
				  <td width="15%" align="left" valign="middle"  bgcolor="#E0E0E0"><strong>
						<select name="accountname" id="accountname" onChange="return funcAccountNameChange1()" tabindex="3">
...
<td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">DOB </td>
			      ...
			      <td align="left" valign="middle" bgcolor="#E0E0E0"><input name="age" type="text" id="age" value="" size="5" onKeyUp="return dobcalc();" onBlur="return idhide();" onKeyPress="return validatenumerics(event);" tabindex="7">
			        <!--				  
				  <select name="age">
			...
			?>
				 ...
				 <td width="6%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">Reg  Code </td>
				  <td width="13%" align="left" valign="middle"  bgcolor="#E0E0E0"><strong><span class="bodytext312">
                    ...
                    <input  name="customercode" id="customercode" value="<?php echo $prefix; ?>-<?php echo $customercode; ?>-<?php echo $suffix; ?>" readonly style=" background-color:#E0E0E0;" size="20">
                  </span></strong></td>
                ...
                <td colspan="7" align="middle"  bgcolor="#E0E0E0"><div align="right"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
				  ...
				  <input name="Submit222" type="submit" id="submit2" value="Save & Go IP Visit (Alt+I)" accesskey="i" class="button" onClick="return funcRegistrationIPLabel()"/>
				  </font></font></font></font>
				  <?php
				  }
				  ?>
