...
<?php 
if($itemcode==""){
$query341 = "select * from consultation_lab where patientvisitcode= '$visitcode' and resultentry = 'completed' and consultationdate between '$fromdate' and '$todate' order by auto_number";
...
$query612 = "select * from consultation_lab where patientvisitcode= '$visitcode' and labitemcode = '$labitemcode34' order by auto_number desc";
...
$query613 = "select * from resultentry_lab where patientname = '$patientname' and patientvisitcode = '$visitcode' order by auto_number desc";
$exec613 = mysql_query($query613) or die(mysql_error());
$res613 = mysql_fetch_array($exec613);
$docno = $res613['docnumber'];


$query123 = "select * from samplecollection_lab where patientcode = '$patientcode' and patientname = '$patientname' order by auto_number desc";
...
$query771 = "select username from master_consultation where patientcode = '$patientcode' and patientvisitcode = '$visitcode'";
$exec771=mysql_query($query771) or die(mysql_error());
$res771=mysql_fetch_array($exec771);
...
<table border="0" cellspacing="0" cellpadding="2">
	...
	<?php
	$labpending = '';
	$query68 = "select * from consultation_lab where billnumber = '$billnumber' and patientcode = '$patientcode' and patientvisitcode = '$visitcode' and resultentry <> 'completed' order by labitemname";
