...
<tr>
  ...
  $paylateramount=0;
  $newamount=0;
  $queryvisit="select patientvisitcode from refund_paynowpharmacy where locationcode='$locationcode1' and billdate between '$ADate1' and '$ADate2' group by patientvisitcode";
  $execvisit = mysql_query($queryvisit) or die(mysql_error());
   ...
   $querypaynow=  "select patientcode,patientvisitcode,patientname,billdate,sum(amount) as amount from refund_paynowpharmacy where locationcode='$locationcode1' and  billdate between '$ADate1' and '$ADate2' and patientvisitcode='$newpatientvisitcode'";
  ...
  <?php } }}?>
  <?php
   $queryvisit1="select patientvisitcode from refund_paylaterpharmacy where locationcode='$locationcode1' and billdate between '$ADate1' and '$ADate2' group by patientvisitcode";
  $execvisit1 = mysql_query($queryvisit1) or die(mysql_error());
   while($resvisit1 = mysql_fetch_array($execvisit1))
     ...
     $querypaylater=  "select patientcode,patientvisitcode,patientname,billdate,sum(amount) as amount from refund_paylaterpharmacy where locationcode='$locationcode1' and  billdate between '$ADate1' and '$ADate2' and patientvisitcode='$newpatientvisitcode1'";
  ...
  <tr <?php echo $colorcode; ?> class="bodytext31">
    ...
    <td width="103"><?php echo $amount1; ?></td>
