            ...
            <tr>
              <td><form name="form1" id="form1" method="post" action="editaccountsmain.php" onSubmit="return addward1process1()">
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong> Accounts Main Master - Edit </strong></td>
                      </tr>
					  <tr>
					  ...
					  <tr>
						...
						{
						$query4 = "select * from master_accountsmain where auto_number = '$res1autonumber'";
						$exec4 = mysql_query($query4) or die ("Error in Query4".mysql_error());
						$res4 = mysql_fetch_array($exec4);
						
						$res4section = $res4['section'];
						$res4sectioncap = strtoupper($res4section);
					
						echo '<option value="'.$res4section.'" selected="selected">'.$res4sectioncap.'</option>';
						}
						?>
