...
$itemstatus = '';
			...
			$query44 = "select accountssub from master_accountname where id = '$expensecode'";
			...
			if($accountssub == '16')
			{
				$query4asset = "insert into assets_register (bill_autonumber, companyanum, billnumber, itemname, rate, quantity, subtotal, free, discountpercentage, totalamount, 
					...
					'$itemtaxpercent', '$itemtaxamount', '$free', '$quantity', 'MLPOProcess','$suppliername','$suppliercode','$supplierbillno','$location','$expensecode','$locationcode','$expense','$expense','$billnumber')";
