	 ...
	 <td width="860">
              <form name="cbform1" method="post" action="patientvisitlist.php">
                ...
                bgcolor="#FFFFFF"> Date From </td>
                      <td width="44%" align="left" valign="center"  bgcolor="#FFFFFF" class="bodytext31"><input name="ADate1" id="ADate1" value="<?php echo $transactiondatefrom; ?>"  size="10"  readonly="readonly" onKeyDown="return disableEnterKey()" />
			 		...
			 		<tr>
					  <td width="16%" align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3">Patient Type</td>
					  <td width="44%" colspan="1" align="left" valign="top"  bgcolor="#FFFFFF"><span class="bodytext3">
	  ...
	  <tr><form action="patientvisitlist.php" name="checklist" method="post">
        <td><table width="78%" height="80" border="0" 
          ...
          <tbody>
			...
			$sno = '';
			if($code <= 1){		
			$query1 = "select * from master_visitentry where consultationdate between '$ADate1' and '$ADate2' and visitcount like '%$code%' and departmentname like '%$department%' order by patientfullname";
			$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
			}
			else
			{
			$query1 = "select * from master_visitentry where consultationdate between '$ADate1' and '$ADate2' and visitcount NOT IN (1) and departmentname like '%$department%' order by patientfullname";
			$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
			}
