...
$query1 = "select * from receiptsub_details where docnumber LIKE '%RE%' AND  recordstatus <> 'DELETED' and companyanum = '$companyanum' order by auto_number desc";
...
if ($receiptanum != '')
{
	$query21 = "select * from receiptsub_details where docnumber like '%RE%' AND  auto_number = '$receiptanum'";
}
else
{
	$query21 = "select * from receiptsub_details where docnumber like '%RE%' AND recordstatus <> 'DELETED' and companyanum = '$companyanum' order by auto_number desc";
}
...
$transactionmode = 'Through '.$transactionmode;
...
?>
	...
	<?php
	  ...
	  <td width="172" colspan="2" class="bodytext32"><div align="left" style="font-size:18px;">RECEIPT</div></td>
  </tr>
		<tr>
			...
			<td colspan="2" class="bodytext32"><div align="left">Doc No: <?php echo $docno; ?></div></td>
		</tr>
		<tr>
...
<tr>
<td align="left" class="bodytext32"><?php echo 'Paid To:'; ?></td>
<td align="left" class="bodytext32"><?php echo $receiptfullname; ?></td>
</tr>
<tr>
<td colspan="2" align="left" class="bodytext32">&nbsp;</td>
</tr>
<tr>
<td align="left" class="bodytext32"><?php echo 'Amount Paid:'; ?></td>
<td align="left" class="bodytext32"><?php echo $amount;
