...
$query34="select * from purchase_rfq where analyzestatus='pending' group by docno order by auto_number asc";
...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
              <form name="cbform1" method="post" action="rfqgeneratedlist.php">
                <table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                    <tr bgcolor="#011E6A">
                      <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>RFQ List</strong></td>
...
-->				 <td class="bodytext31" valign="center"  align="left" 
          ...
          <tbody>
            <tr>
              ...
              <td colspan="5" bgcolor="#cccccc" class="bodytext31">
                <div align="left"><strong>RFQList</strong>
	...
	<td   align="left" valign="center" width="10" width="10"
		  ...
		  $query11 = "select * from purchase_rfq where analyzestatus='pending' and date between '$transactiondatefrom' and '$transactiondateto'  group by docno order by auto_number asc";
		...
		// $suppliername = $res11['suppliername'];
		 ...
		 $query12 = "select * from master_rfq where status='' and docno='$docno'";
		 $exec12 = mysql_query($query12) or die(mysql_error());
		 $numrows=mysql_num_rows($exec12);
		 $res12 = mysql_fetch_array($exec12)
			?>
			  ...
			  <div class="bodytext31" align="center"><a href="uploadrtq.php?billnumber=<?php echo $docno; ?>">Action </a></div></td>
              
	<td   align="left" valign="center" 
                 class="bodytext31" width="10"><div align="center"><strong>
                <?php 
				if($numrows!=0)
				{
				?>
                <a href="analyzecomparison.php?billnumber=<?php echo $docno; ?>">Analyse</a></strong></div>
                <?php
				}
				else
				{
