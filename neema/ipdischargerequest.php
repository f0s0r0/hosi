...
else
{
	...
	$billnumbercode7 = $paynowbillprefix7 .$maxanum7;
		...
		if($num51 == 0)
		{
			$query88 = "update ip_bedallocation set recordstatus='request' where patientcode='$patientcode' and visitcode='$visitcode' and locationcode='".$locationcodeget."' and recordstatus=''";
		...
		{	
			...
			$query881 = "update ip_bedtransfer set recordstatus='request' where patientcode='$patientcode' and visitcode='$visitcode' and locationcode='".$locationcodeget."' and recordstatus=''";
