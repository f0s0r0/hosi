...
<tr>
  ...
  <tr>
    ...
    <td width="205" bgcolor="#ffffff" class="bodytext31"><strong>PatientName</strong></td>
    <td width="94" bgcolor="#ffffff" class="bodytext31"><strong>Amount</strong></td>
  ...
  $colorloopcount = '';
  $newamount=0;
  $queryvisit="select patientvisitcode from billing_ippharmacy where locationcode='$locationcode1' and billdate between '$ADate1' and '$ADate2' group by patientvisitcode";
  $execvisit = mysql_query($queryvisit) or die(mysql_error());
   while($resvisit = mysql_fetch_array($execvisit))
    ...
    $querypay=  "select patientcode,patientvisitcode,patientname,billdate,sum(amount) as amount from billing_ippharmacy where locationcode='$locationcode1' and billdate between '$ADate1' and '$ADate2' and patientvisitcode='$newpatientvisitcode'";
  ...
  <tr <?php echo $colorcode; ?> class="bodytext31">
    ...
    <td width="205"><?php echo $patientname; ?></td>
    <td width="94"><?php echo $amount; ?></td>
