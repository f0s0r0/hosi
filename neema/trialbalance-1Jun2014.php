    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong> Trial Balance</strong></td>
              </tr>
            <!--<tr>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
		  ...
		  ?>
            <tr>
              ...
              <td width="103" align="right" valign="center"  
...
/*			$query6 = "select * from master_accountssub where recordstatus <> 'deleted'";
	...
	?>	      
		<?php
			...
			if(($labamount == '')&&($pharmacyamount == '')&&($radiologyamount == '')&&($servicesamount == ''))
			{
			$query85 = "select sum(referalrate) as referalamount from billing_paynowreferal where referalcoa='$accountcoa' and billdate between '$ADate1' and '$ADate2'";
			$exec85 = mysql_query($query85) or die(mysql_error());
			$res85 = mysql_fetch_array($exec85);
			$referalamount = $res85['referalamount'];
			}	
		...
		if($grandtotalcreditamount > 0)
		{
           ...
           <tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left"><?php echo $snocount; ?></td>
                ...
                <div class="bodytext31"><?php echo $accountsubname; ?></div></td>
              <td class="bodytext31" valign="center"  align="right">
			  <?php echo number_format($grandtotalcreditamount,2,'.',','); ?></td>
           ...
           <tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left"><?php echo $snocount; ?></td>
                ...
                <div class="bodytext31"><?php echo $accountsubname; ?></div></td>
              <td class="bodytext31" valign="center"  align="right">
			  <?php echo number_format($totalreceiptcreditamount81,2,'.',','); ?></td>
	...
	$totalgrandbalanceamount = '0.00';
			...
			$query12 = "select sum(transactionamount) as totalpaymentamount from master_transactionpharmacy where supplieranum='$accountsubid' and transactionmodule='PAYMENT' and transactiondate between '$ADate1' and '$ADate2'";
			$exec12 = mysql_query($query12) or die(mysql_error());
			$res12 = mysql_fetch_array($exec12);
			$totalpaymentamount = $res12['totalpaymentamount'];
...
if(($totalgrnamount != '')||($totalpaymentamount != '')||($totalreturnamount != ''))
{
           ...
           <tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left"><?php echo $snocount; ?></td>
                ...
                <div class="bodytext31"><?php echo $accountsubname; ?></div></td>
              <td class="bodytext31" valign="center"  align="right">
			  <?php echo number_format($grandbalanceamount,2,'.',','); ?></td>
		  ...
		  $grandbalanceamount = '0.00';
			...
			$totaldepositamount = $totalipdepositamount8 + $totaladvancedepositamount8;
			if($totalipdepositamount8 != '0.00')
			{
           ...
           <tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left"><?php echo $snocount; ?></td>
                ...
                <div class="bodytext31"><?php echo $accountsubname; ?></div></td>
              <td class="bodytext31" valign="center"  align="right">
			  <?php echo number_format($totaldepositamount,2,'.',','); ?></td>
	...
	?>
			 ...
			 <td class="bodytext31" valign="center"  align="left"></td>
			  ...
			  <td class="bodytext31" valign="center"  align="right"><?php echo number_format($grandtotalcredit,2,'.',','); ?></td>
			 </tr>
				  </table>
				</td>
		  ...
		  $grandtotal31 = $grandtotal3 - $grandtotal1;
           ...
           <tr <?php echo $colorcode; ?>>
			...
			$billtotalamount = $res2['transactionamount'];
			    ...
			    $query31 = "select * from master_transactionpaylater where billnumber = '$billnumber' and transactionmodule = 'PAYMENT' and companyanum='$companyanum' and recordstatus <>'deallocated'";
	...
	$totalexpense = $totalexpense - $totalpaylaterpharmrefundamount;
		   ...
		   <?php
			...
			$query883 = "select * from purchase_details where coa='$accountcoa' and entrydate between '$ADate1' and '$ADate2' group by billnumber";
	...
	<?php
			...
			$totaldeposit1 = $totaldeposit1 + $totalcreditdeposit +  $totaldeposit;
			if($totaldeposit1 != '')
			{
			
			
			$grandtotaldeposit = $totaldeposit1;
			$snocount = $snocount + 1;	
			//echo $cashamount;
			$colorloopcount = $colorloopcount + 1;
			$showcolor = ($colorloopcount & 1); 
           ...
           <tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left"><?php echo $snocount; ?></td>
                ...
                <div class="bodytext31"><?php echo $accountsubname; ?></div></td>
              <td class="bodytext31" valign="center"  align="right">
			  <?php echo number_format($totaldeposit1,2,'.',','); ?></td>
	...
	$grandtotaldebit = $totalexpense10 + $grandtotal31 + $totalexpensecreditamount81 + $totalgrnamount81 + $grandtotaldeposit + $grandtotalnhif;
	?>
	         <tr>
			 <td class="bodytext31" valign="center"  align="left"></td>
			  <td class="bodytext31" valign="center"  align="right"><strong>Total</strong></td>
			  <td class="bodytext31" valign="center"  align="right"><?php echo number_format($grandtotaldebit,2,'.',','); ?></td>
			 </tr>
