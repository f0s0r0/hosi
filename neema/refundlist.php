          ...
          <tbody>
       	<tr>
			<td width="860">
              ...
              <form name="cbform1" method="post" action="refundlist.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong>PAY NOW Refund </strong></td>
              </tr>
...
if ($cbfrmflag1 == 'cbfrmflag1')
{
	...
	<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
             <tr>
			 <td colspan="8" bgcolor="#cccccc" class="bodytext31"><div align="left"><strong>PAY NOW Refund</strong></div></td>
			 </tr>
            <tr>
			...
			$query31=mysql_query("select * from master_visitentry where itemrefund='refund' and billtype='PAY NOW' and overallpayment='completed' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and patientfullname like '%$searchpatient%' and consultationdate between '$fromdate' and '$todate'order by consultationdate desc") or die(mysql_error());
			...
			?>
             ...
             <td class="bodytext31" valign="center"  align="left"><a href="refund_paynow.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $patientvisitcode; ?>"><strong>Refund</strong></a>			  </td>
              </tr>
			  <?php
			}
			?>
