...
$querynw1 = "select * from ipconsultation_lab where labsamplecoll='pending' and locationcode='$locationcode' and paymentstatus = 'pending' group by patientvisitcode order by consultationdate desc"; // and (billingdatetime between '$triagedatefrom' and '$triagedateto')";// 
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
              ...
              <td width="860">
              <form name="cbform1" method="post" action="ipamendlab_pending.php">
          ...
          <tbody>
            <tr>
			  ...
			  <script language="javascript">
                ...
                <!--<input onClick="javascript:printbillreport1()" name="resetbutton2" type="submit" id="resetbutton2"  style="border: 1px solid #001E6A" value="Print Report" />-->
                <div align="left"> <strong>IP Amend Lab</strong><label class="number">&nbsp;</div> </td>
              </tr>
	        ...
	        $query1 = "select * from ipconsultation_lab where labsamplecoll='pending' and locationcode='$searchlocationcode' and consultationdate between '$searchadate1'and '$searchadate2' group by patientvisitcode order by consultationdate desc"; 
			$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left"><a href="ipamendlab.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&locationcode=<?php echo $locationcode; ?>"><strong>Amend</strong></a>			  </td>
              </tr>
			<?php
			}
}    
