            ...
            <tr>
              <td><form name="form1" id="form1" method="post" action="vehicle.php" onSubmit="return addward1process1()">
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Ambulance Master</strong></td>
                      </tr>
					  <tr>
                      ...
                      <tr>
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Vehicle Type </div></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
                        <input name="vehicletype" type="text" id="vehicletype" style="border: 1px solid #001E6A;" size="30">
					</td>
                      </tr>
					  
					    
				<tr>
				 <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Vehicle Model</div></td>
				  <td align="left" valign="middle"  bgcolor="#FFFFFF"> 
				  <input name="vehiclemodel" type="text" id="vehiclemodel" style="border: 1px solid #001E6A;" size="30">
				  </td>
				  </tr>   
				    <tr>
				 <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Vehicle Number</div></td>
				  <td align="left" valign="middle"  bgcolor="#FFFFFF">
				  <input name="vehiclenumber" type="text" id="vehiclenumber" style="border: 1px solid #001E6A;" size="30">
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#FFFFFF"><input name="insurancecompany" id="insurancecompany" style="border: 1px solid #001E6A;text-transform: uppercase;" size="30" />                                      </td>
                      </tr>
                      <tr>
                        <td align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Insurance Amount  </div></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
                          <input name="insuranceammount" type="text" id="insuranceammount" style="border: 1px solid #001E6A;" size="30">                     </td>
                      </tr>
                      <tr>
                        <td align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Renewable Date</div></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
                         <input name="renewabledate" type="text" id="renewabledate" style="border: 1px solid #001E6A;" size="30" onFocus="return funcexpiry();" readonly>                   
                         <img src="images2/cal.gif" onClick="javascript:NewCssCal('renewabledate')" style="cursor:pointer"/> </td>
                      </tr>
                       <tr>
                        <td align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Driver Assigned </div></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
                         <input name="driverassigned" type="text" id="driverassigned" style="border: 1px solid #001E6A;" size="30">                     </td>
                      </tr>
                        <tr>
                        <td align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Rate1  </div></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
                         <input name="rateperkm1" type="text" id="rateperkm1" style="border: 1px solid #001E6A;" size="30" onkeypress="return IsNumeric(event);">                     </td>
                      </tr>
                         <tr>
                        <td align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Rate2  </div></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
                         <input name="rateperkm2" type="text" id="rateperkm2" style="border: 1px solid #001E6A;" size="30" onkeypress="return IsNumeric(event);">                     </td>
                      </tr>
                      <tr>
