    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="refundreferrallistapprove.php">
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            <tr>
              ...
              <td colspan="10" bgcolor="#cccccc" class="bodytext31"><span class="bodytext311"><strong>Referral List</strong>
...
&nbsp;				<input  value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />-->
		  ...
		  $query2 = "select * from consultation_departmentreferal where paymentstatus='completed' and status='refund' and approvalstatus = 'pending' group by patientvisitcode";
		  ...
		  $query18 = "select * from consultation_departmentreferal where patientvisitcode='$res2visitcode' and status='refund' and approvalstatus = 'pending' and patientcode='$res2patientcode' and consultation='completed' order by auto_number limit 0,1";
		  ...
		  $snocount = $snocount + 1;
           ...
           <tr <?php echo $colorcode; ?>>
			 ...
			 <td  align="left" valign="center" class="bodytext31"><div align="left"><a href="refundreferralapprove.php?patientcode=<?php echo $res2patientcode; ?>&&visitcode=<?php echo $res2visitcode; ?>">Approve</a></div></td>
			 
           </tr>
			<?php
			}
			 $query2 = "select * from consultation_referal where paymentstatus='completed' and status='refund' and approvalstatus = 'pending' group by patientvisitcode";
		  $exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
		  $nums = mysql_num_rows($exec2);
		  while ($res2 = mysql_fetch_array($exec2))
		  {
		  ...
		  $res3age = $res3['age'];
		  $res3departmentname = $res3['departmentname'];
		  $query18 = "select * from consultation_referal where patientvisitcode='$res2visitcode' and status='refund' and approvalstatus = 'pending' and patientcode='$res2patientcode' order by auto_number limit 0,1";
		  $exec18 = mysql_query($query18) or die ("Error in Query18".mysql_error());
		  $num18 = mysql_num_rows($exec18);
		  $res18 = mysql_fetch_array($exec18);
		  if($num18!=0)
