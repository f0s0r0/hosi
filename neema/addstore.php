...
if ($frmflag1 == 'frmflag1')
{
	...
	if ($res2 == 0)
	{
		$query1 = "insert into master_store (location, store,storecode, ipaddress, recorddate, username,locationcode,locationname,type) 
		values ('$location', '$store', '$storeno','$ipaddress', '$updatedatetime', '$username','$locationcode','$locationname','".$type."')";
      ...
      <tr>
            ...
            <tr>
              <td><form name="form1" id="form1" method="post" action="addstore.php" onSubmit="return addward1process1()">
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="" bgcolor="#CCCCCC" class="bodytext3"><strong>Store Master - Add New </strong></td>
                         <td width="71%" align="right" bgcolor="#CCCCCC" class="bodytext3" id="ajaxlocation"><strong> Location </strong>
				...
				?>
                       ...
                       <tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
						<select name="type" style="border: 1px solid #001E6A;">
                      ...
                      <tr>
					   ...
					   <tr>
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Store ID </div></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
                ...
                <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="6" bgcolor="#CCCCCC" class="bodytext3"><strong>Store Master - Existing List </strong></td>
                      </tr>
                      <tr>
                        ...
                        <td width="14%" align="left" valign="top" bgcolor="#CCCCCC"  class="bodytext3"><strong>Store ID</strong></td>
						<td width="24%" align="left" valign="top" bgcolor="#CCCCCC"  class="bodytext3"><strong>Store </strong></td>
                        <td width="24%" align="left" valign="top" bgcolor="#CCCCCC"  class="bodytext3"><strong>Type </strong></td>
                        <td width="7%" align="left" valign="top" bgcolor="#CCCCCC"  class="bodytext3"><strong>Edit</strong></td>
                      </tr>
                      <?php
		...
		?>
                      <tr <?php echo $colorcode; ?>>
                        ...
                        <td width="27%" align="left" valign="top"  class="bodytext3"><?php echo $location; ?> </td>
