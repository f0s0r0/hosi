...
if ($frmflag1 == 'frmflag1')
{
	...
	if ($res2 != 0)
	{
		...
		reports_daterange_option = '$reports_daterange_option', option_edit_delete = '$option_edit_delete',location='$location',store='$store' ,shift = '$shift',jobdescription='$jobdescription',validitydate='$validitydate',cashlimit='$cashlimit',showlocations='$showlocations',statistics='$statistics',ip_dept='$ip_dept'
		...
		*/
			...
			$query333 = "update master_employeelocation set username = '$username1' where employeecode = '$employeecode'";
...
$query505 = "select department from master_ipadmdept where recordstatus = '' and deptid='$ip_dept'";
$exec505 = mysql_query($query505) or die ("Error in Query505".mysql_error());
$res505 = mysql_fetch_array($exec505);
$department505 = $res505["department"];
          ...
          <td width="860"><table width="900" height="250" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              ...
              <tr>
                ...
                <td valign="middle" align="left" >&nbsp;</td>
                <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3">IP Dept.</td>
                <td valign="middle" align="left" >
                <select name="ipdept" id="ipdept" style="border: 1px solid #001E6A;">
                <?php
				if($ip_dept!='')
				{
				?>
                <option value="<?php echo $ip_dept;?>" selected="selected"><?php echo $department505;?></option> 
...
?>
				...
				$query5 = "select * from master_ipadmdept where recordstatus = '' and deptid <> '$ip_dept' order by auto_number";
				$exec5 = mysql_query($query5) or die ("Error in Query5".mysql_error());
