...
if ($frmflag1 == 'frmflag1')
{
	...
	if ($res2 == 0)
	{
		...
		subtotalamount, copayfixedamount, copaypercentageamount, totalamountbeforediscount, discountamount, totalamount) 
		...
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		 ...
		 $query221 = mysql_query("update master_visitentry set overallpayment = 'completed' where visitcode = '$visitcode' and patientcode = '$patientcode'") or die(mysql_error());
...
$query32=mysql_query("select * from master_consultation where patientvisitcode='$visitcode'");
...
if($planfixedamount != 0)
{
	...
	{
		$patientlessedamount = $planfixedamount - $billamount ;
		$billamountpatient = '0';
	}
	else 
	{
...
if($planpercentage != 0)
{
	...
	$billamountpatient = $billamount - $percentagebalanceamount;
}
...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
	...
	<td width="97%" valign="top">
		  ...
		  <form name="form1" id="form1" method="post" onKeyDown="return disableEnterKey()" action="billing_op3.php" onSubmit="return process1()">
			  ...
			  <!--<tr>
				...
				<tr>
				  ...
				  <?php echo $patientcode; ?>
					  <input type="hidden" name="patientcode" id="patientcode" value="<?php echo $patientcode; ?>" readonly="readonly" style="border: 1px solid #001E6A"  size="20" /></td>
				  ...
				  <?php echo $visitcode; ?>
					 ...
					 <input type="hidden" name="fixedamountbalance" id="fixedamountbalance" value="<?php echo $patientlessedamount; ?>" readonly="readonly" style="border: 1px solid #001E6A;"  size="20" />					  </td>
				  </tr>
				<tr>
...
-->				
				 ...
				 <tr>
				   ...
				   <input type="hidden" name="consultationdate" id="consultationdate" value="<?php echo $consultationdate; ?>" readonly="readonly" style="border: 1px solid #001E6A;">
				...
				<input type="hidden" name="consultationtime" id="consultationtime" value="<?php echo $consultationtime; ?>" readonly="readonly" style="border: 1px solid #001E6A"  size="20" />
<!--				
...
--></td>
				 ...
				 <tr>
				   ...
				   <input type="hidden" name="paymenttype" id="paymenttype"  value="<?php echo $paymenttype;?>" readonly="readonly"   style="border: 1px solid #001E6A;">    
				   </span></td>
				 ...
				 <tr>
				   ...
				   <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><span class="style1"><strong><?php echo $billnumber;?></strong>
				   <input type="hidden" name="billnumber" id="billnumber" value="<?php echo $billnumber; ?>" readonly="readonly" style="border: 1px solid #001E6A;">
				   </span></td>
				   ...
				   <input type="hidden" name="billtype" id="billtype"  value="<?php echo $billtype;?>"  readonly="readonly"  style="border: 1px solid #001E6A;">
				   </span></td>
				  </tr>
				 <tr>
				   ...
				   <input type="hidden" name="billamount" id="billamount" value="<?php echo $billamount; ?>" readonly="readonly" style="border: 1px solid #001E6A;">
				   </span></td>
				 </tr>
				 ...
				 <tr>
				   ...
				   <input type="hidden" name="billingdatetime" id="billingdatetime" value="<?php echo $billdatetime; ?>" readonly="readonly" style="border: 1px solid #001E6A;">
				   </span></td>
				   ...
				   <?php echo  number_format($billamountpatient, 2, '.', ''); ?></strong></span>&nbsp;
                       <input type="hidden" name="patientbillamount" id="patientbillamount" value="<?php echo $billamountpatient; ?>" readonly="readonly" style="border: 1px solid #001E6A;">                   </td>
				 </tr>
				 <tr>
				   ...
				   <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><span class="bodytext3"><strong><?php echo $billentryby; ?></strong>
                         <input type="hidden" name="billentryby" id="billentryby" value="<?php echo $billentryby; ?>" readonly="readonly" style="border: 1px solid #001E6A;">
                   </span></td>
				   <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">&nbsp;</td>
			       <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">&nbsp;</td>
				 </tr>
				 <tr>
				   ...
				   <td align="left" valign="middle"  bgcolor="#E0E0E0"><label>
                     <input name="subtotalamount" type="text" id="subtotalamount" value="<?php echo number_format($consultationfees, 2, '.', ''); ?>" readonly="readonly" style="border: 1px solid #001E6A; background-color:#E0E0E0; text-align:right" size="10">
                   </label></td>
				 </tr>
				 <tr>
				   <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">&nbsp;</td>
				   ...
				   <td align="left" valign="middle"  bgcolor="#E0E0E0"><label>
                     <input name="copayfixedamount" type="text" id="copayfixedamount" value="<?php echo $planfixedamount; ?>" readonly="readonly" style="border: 1px solid #001E6A; background-color:#E0E0E0; text-align:right" size="10">
                   </label></td>
				 </tr>
				 <tr>
				   <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">&nbsp;</td>
				 ...
				 <tr>
				   ...
				   <td align="left" valign="middle"  bgcolor="#E0E0E0"><label>
                     <input name="totalamountbeforediscount" type="text" id="totalamountbeforediscount" value="<?php echo number_format($billamountpatient, 2, '.', ''); ?>" readonly="readonly" style="border: 1px solid #001E6A; background-color:#E0E0E0; text-align:right" size="10">
                   </label></td>
				 </tr>
				 <tr>
				   <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">&nbsp;</td>
				 ...
				 <tr>
				   ...
				   <td align="left" valign="middle"  bgcolor="#E0E0E0"><label>
                     <input name="totalamount" type="text" id="totalamount" value="<?php echo number_format($billamountpatient, 2, '.', ''); ?>" readonly="readonly" style="border: 1px solid #001E6A; background-color:#E0E0E0; text-align:right" size="10">
                   </label></td>
				 </tr>
				 <tr>
				   <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">&nbsp;</td>
				   ...
				   <td align="left" valign="middle"  bgcolor="#E0E0E0"><select name="patientpaymentmode" id="patientpaymentmode">
  ...
  &nbsp;</td>
				...
				<td colspan="4" align="middle"  bgcolor="#E0E0E0"><div align="right"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
				  ...
				  <input name="Submit222" type="submit"  value="Save Bill Entry"  class="button" style="border: 1px solid #001E6A"/>
