...
if ($frmflag1 == 'frmflag1')
{
	...
	if ($length<=100)
	{
	$query2 = "select * from master_accountsmain where accountsmain = '$accountsmain'";
	$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
	$res2 = mysql_num_rows($exec2);
	if ($res2 == 0)
	{
		$query1 = "insert into master_accountsmain (accountsmain, ipaddress, recorddate, username,id,section) 
		values ('$accountsmain', '$ipaddress', '$updatedatetime', '$username','$id','$section')";
...
function addward1process1()
{
	...
	{
		alert ("Pleae Enter Accounts Main Name.");
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="addaccountsmain.php" onSubmit="return addward1process1()">
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Accounts Type Master - Add New </strong></td>
                      </tr>
					  <tr>
                      ...
                      <tr>
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Add New Accounts Main </div></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
						<input name="accountsmain" id="accountsmain" style="text-transform:uppercase" size="40" /></td>
                      </tr>
					  <tr>
                ...
                <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong> Accounts Type Master - Existing List </strong></td>
                        <td bgcolor="#CCCCCC" class="bodytext3"><strong>Edit</strong></td>
                      </tr>
                      <?php
	    $query1 = "select * from master_accountsmain where recordstatus <> 'deleted' order by accountsmain ";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
        ...
        <tr <?php echo $colorcode; ?>>
						...
						<div align="center">	
					<a href="addaccountsmain.php?st=del&&anum=<?php echo $auto_number; ?>" onClick="return funcDeletePaymentType('<?php echo $accountsmain;?>')">
						<img src="images/b_drop.png" width="16" height="16" border="0" /></a></div></td>
                        <td width="22%" align="center" valign="top"  class="bodytext3"><?php echo $id; ?></td>
                        <td width="36%" align="left" valign="top"  class="bodytext3"><?php echo $accountsmain; ?> </td>
                        <td width="31%" align="left" valign="top"  class="bodytext3"><?php echo $section; ?></td>
                        <td width="7%" align="left" valign="top"  class="bodytext3">
						<a href="editaccountsmain.php?st=edit&&anum=<?php echo $auto_number; ?>" style="text-decoration:none">Edit</a>						</td>
                      </tr>
                      <?php
		}
		?>
                ...
                <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="5" bgcolor="#CCCCCC" class="bodytext3"><strong> Accounts Type Master - Deleted </strong></td>
                      </tr>
                      <?php
        ...
        <tr <?php echo $colorcode; ?>>
						...
						<a href="addaccountsmain1.php?st=activate&&anum=<?php echo $auto_number; ?>" class="bodytext3">
                          <div align="center" class="bodytext3">Activate</div>
                        </a></td>
                        <td width="15%" align="left" valign="top"  class="bodytext3"><?php echo $accountsmain; ?></td>
