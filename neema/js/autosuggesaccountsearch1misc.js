...
AutoSuggestControl.prototype.autosuggest = function (aSuggestions /*:Array*/,
 ...
 //alert('hi');
	...
	if (xmlHttp==null)
	{
  	...
  	var searchsuppliername1 = document.getElementById("searchaccountname").value;
	...
	var url = "";
	var url="autoaccountsearch1misc.php?RandomKey="+Math.random()+"&&accountname="+searchsuppliername1;
   	//alert(url);
	...
	xmlHttp.onreadystatechange=function()
	{
		...
		{ 
			...
			//alert("Inside"+t);
			document.getElementById("autobuildaccount").value = t;
	...
	var varCompleteStringReturned = document.getElementById("autobuildaccount").value;
...
AutoSuggestControl.prototype.createDropDown = function () {
    ...
    this.layer.onmouseover = function (oEvent) {
        ...
        if (oEvent.type == "mousedown") {
			...
			document.getElementById("searchaccountcode").value = varEmployeeCode;
...
function suppliernamelostfocus()
{
	...
	var varEmployeeName = document.getElementById("searchaccountname").value;
	//alert (varSupplierName);
	var varEmployeecode = document.getElementById("searchaccountcode").value;
	
	 document.getElementById("searchaccountnamess").value = document.getElementById("searchaccountname").value;	
