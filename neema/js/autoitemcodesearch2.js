...
function funcitemsearch2()
{
	...
	{
		var varCustomerSearch = document.getElementById("drug").value;
...
function ajaxprocessACCS22()
{
	...
	if (xmlHttp==null)
	{
  	...
  	var customersearch=document.getElementById("drug").value;
	//alert(customersearch);
	var url = "";
	var url="autoitemcodesearch2.php?RandomKey="+Math.random()+"&&customersearch="+customersearch;
    //alert(url);
...
{ 
	...
	for (m=0;m<=varNewLineLength;m++)
	{
		...
		var itemname1 = varNewRecordValue[0];
		//alert (itemname1);
