...
//alert('hi');
	...
	var url = "";
	var url="ajaxcustomerhomecare.php?customer="+customer+"&&location="+location+"&&RandomKey="+Math.random()+"";
    //alert(url);
	///*
...
AutoSuggestControlcustomer.prototype.createDropDown = function () {
    ...
    this.layer.onmouseover = function (oEvent) {
        ...
        if (oEvent.type == "mousedown") {
			...
			var varaopip = arrSupplierName[4];
			...
			document.getElementById("patientvisitcode").value = varcustomervisitcode;
			document.getElementById("accountnamename").value = varaccountname;
			document.getElementById("showdetails").value = 'yes';
			document.getElementById("opip").value = varaopip;
			funcCustomerSearch2();
			//alert('h');
			//funcmedicinesearch4();
...
function suppliernamelostfocus()
{
	...
	else
	{
		document.getElementById("customer").value = "";
			...
			document.getElementById("patientvisitcode").value = "";
