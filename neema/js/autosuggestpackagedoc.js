...
AutoSuggestControlcustomer.prototype.autosuggest = function (aSuggestions /*:Array*/,
													...
													var oTextbox1=document.getElementById("pvtdoctor1").value;
													// alert(oTextbox1);
...
//alert('hi');
	...
	if(oTextbox1!=''){
		...
		document.getElementById("pvtdoctor1").value='';
		document.getElementById("pvtdoctorcode1").value = '';
		document.getElementById("pvtdoctorrate1").value = '';
		return false;
		}
	...
	if (xmlHttp==null)
	{
  	...
  	var customer = document.getElementById("hpldoctor1").value;
...
AutoSuggestControlcustomer.prototype.createDropDown = function () { 
    ...
    this.layer.onmouseover = function (oEvent) {
        ...
        if (oEvent.type == "mousedown") {
			...
			var varSupplierName = document.getElementById("hpldoctor1").value;
			...
			//alert (varSupplierName);
			document.getElementById("hpldoctor1").value = vardoctorname;
			...
			document.getElementById("hpldoctorcode1").value = vardoctorcode;
			document.getElementById("hpldoctorrate1").value = vardoctorrate;
...
AutoSuggestControlcustomer.prototype.handleKeyUp = function (oEvent /*:Event*/) {
    ...
    //make sure not to interfere with non-character keys
		...
		//alert (varSupplierName);
		document.getElementById("hpldoctor1").value = varSupplierName;
		//code end by prem.
