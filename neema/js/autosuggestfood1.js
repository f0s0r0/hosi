...
function customernamelostfocus1()
{
	...
	var Varitemname = document.getElementById("food").value;
	//alert (Varitemname);
	...
	//{
		...
		if(document.form1.foodallergy.value == "")
		{
		  document.getElementById("foodallergy").value = varCustomerName; 
		}
		else
		{
			var varFoodAllergyValue = document.getElementById("foodallergy").value;
			var varCustomerName = varFoodAllergyValue+"\n"+varCustomerName;
			document.getElementById("foodallergy").value = varCustomerName;
		}
