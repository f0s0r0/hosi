...
{ 
	...
	//{
		...
		//alert (varMedicineName);
		document.getElementById("fxrate").value = formatMoney(varMedicineRate);
		var fxamount = parseFloat(document.getElementById("fxamount").value);
		
		document.getElementById("rate").value = formatMoney(varMedicineRate/fxamount);
		
		var varMedicineStock = varNewLineValue[3];
		
		document.getElementById("avlqty").value = varMedicineStock;
		
		var varMedicinePack = varNewLineValue[4];
		
		document.getElementById("packsize").value = varMedicinePack;
		
		var varCategory = varNewLineValue[5];
		
		document.getElementById("category").value = varCategory;
		
		var varStrength = varNewLineValue[6];
		...
		document.getElementById("medicinename").value = Varmedicinename1;
