function insertitem10()
{
	...
	if(document.frmpurchase.medicinename.value=="" )
	{
		alert("Please enter Item name");
		//document.frmpurchase.medicinename.focus();
		return false;
	}
	
	if(document.frmpurchase.medicinename.value=="undefined" )
	{
	...
	itemquantity
	if(document.frmpurchase.medicinecode.value=="" )
	{
	...
	var varSerialNumber = document.getElementById("serialnumberinc").value;
	...
	var varcostprice = document.getElementById("itemmrp").value;
	var varAmount = document.getElementById("itemtotalamount").value;
...
//	var td4 = document.createElement ('<td id="idTD3'+i+'" align="left" valign="top" bordercolor="#F3F3F3" bgcolor="#FFFFFF" class="bodytext3"></td>');
	...
	text5.id = "itemquantity"+i+"";
	text5.name = "itemquantity"+i+"";
	text5.type = "text";
	text5.size = "8";
	text5.value = varItemquantity;
...
/*	var td51 = document.createElement ('td');
	...
	document.getElementById("serialnumberinc").value = parseInt(i) + 1;
...
//	var vartransferqty = document.getElementById("transferqty").value = "";
	...
	combo.options[0] = new Option("Select Batch","");
