...
if (xmlHttp==null)
  ...
  return
	...
	var url = "";
	var url="autocompleteitemdata1pharmacy.php?RandomKey="+Math.random()+"&&itemcode="+varItemCode;
	//alert(url);
...
*/				//document.getElementById("unitname").value = brokenstring2[1];
				...
				itemsearch3(varItemCodeCatch)  //Function called from autoitemsearch3purchase.js
				//funcSubTotalCalc(z);
		}
	}
 } 
