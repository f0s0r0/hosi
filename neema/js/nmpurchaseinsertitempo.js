...
//	var totfxamount=varItemTotalAmount*currrate;
	...
	*/
	...
	var text3c = document.createElement ('input');
	text3c.id = "itemcode"+k+"";
	text3c.name = "itemcode"+k+"";
	text3c.type = "hidden";
	text3c.size = "10";
	text3c.value = varItemCode;
	text3c.readOnly = "readonly";
	text3c.style.backgroundColor = "#FFFFFF";
	text3c.style.border = "0px solid #001E6A";
	text3c.style.textAlign = "left";
	td3.appendChild (text3c);
	tr.appendChild (td3);
...
//alert("hi");
	...
	*/
	...
	document.getElementById("itemcode").value = "";
	document.getElementById("itemname").value = "";
	document.getElementById("itemnamess").value = "";
