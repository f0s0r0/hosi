...
AutoSuggestControl.prototype.autosuggest = function (aSuggestions /*:Array*/,
 ...
 //alert('hi');
	...
	if (xmlHttp==null)
	{
  	...
  	var searchsuppliername1 = document.getElementById("searchemployee").value;
	...
	var url = "";
	var url="autoemployeecodesearch7.php?RandomKey="+Math.random()+"&&employeesearch="+searchsuppliername1;
   	//alert(url);
	...
	xmlHttp.onreadystatechange=function()
	{
		...
		{ 
			...
			//alert("Inside"+t);
			document.getElementById("autobuildemployee").value = t;
	...
	var varCompleteStringReturned = document.getElementById("autobuildemployee").value;
...
AutoSuggestControl.prototype.createDropDown = function () {
    ...
    this.layer.onmouseover = function (oEvent) {
        ...
        if (oEvent.type == "mousedown") {
			...
			var varSupplierName = document.getElementById("searchemployee").value;
			...
			document.getElementById("searchemployee").value = varSupplierName;
...
function suppliernamelostfocus()
{
	...
	var varEmployeeName = document.getElementById("searchemployee").value;
	//alert (varSupplierName);
