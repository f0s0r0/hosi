 ...
 * @scope public
 */
function AutoSuggestControl1(oTextbox1 /*:HTMLInputElement*/, 
...
AutoSuggestControl1.prototype.autosuggest = function (aSuggestions /*:Array*/,
 ...
 //alert('hi');
	...
	if (xmlHttp==null)
	{
  	...
  	var searchempname1 = document.getElementById("employeename").value;
	//var locationcode = "LTC-1";
	...
	//alert(lab1);
    if (searchempname1.length < 2) 
	{
		var searchempname1 = 'xyzxyzxyzxyz'; //To hide the already populated drop list automatically.
		//return false;
	}

//	alert(searchempname1);
	
	var url = "";
	var url="ajaxshiftuserbuild.php?searchempname="+searchempname1+"&&RandomKey="+Math.random()+"";
    //alert(url);
	///*
	xmlHttp.onreadystatechange=function()
	{
		...
		{ 
			...
			document.getElementById("employehiddentxt").value = t;
	...
	var varCompleteStringReturned = document.getElementById("employehiddentxt").value;
...
AutoSuggestControl1.prototype.createDropDown = function () {
    ...
    this.layer.onmouseover = function (oEvent) {
        ...
        if (oEvent.type == "mousedown") {
			...
			var varEmpName = document.getElementById("employeename").value;
			var arrEmpName = varEmpName.split('||'); 
		    var varEmpUserName = arrEmpName[0];
		  var varEmpName = arrEmpName[1];
			
			//alert (varEmpName);
		//	var varDescription = arrEmpName[1];
//var varEmployeeCode = arrEmpName[2];
			//alert (varEmployeeCode);
			//var varVisitCode = arrEmpName[2];
			//alert (varVisitCode);
			
			//document.getElementById("searchsuppliercode").value = varSubtypeAnum;
			document.getElementById("employeename").value = varEmpName;
			document.getElementById("employeeusername").value = varEmpUserName;
		//	funclabsearch5();
...
AutoSuggestControl1.prototype.handleKeyUp = function (oEvent /*:Event*/) {
    ...
    //make sure not to interfere with non-character keys
		...
		var varEmpName = varEmpName.toUpperCase();
		//alert (varEmpName);
		document.getElementById("employeename").value = varEmpName;
		//code end by prem.
...
//	alert (arrEmpName);
	var varEmpUserName = arrEmpName[0];
//	alert(varEmpUserName);
	var varEmpName = arrEmpName[1];
	

	
	if (varEmpName != undefined)
	{
