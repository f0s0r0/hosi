...
function customernamelostfocus2()
{
	...
	var Varitemname = document.getElementById("services").value;
	//alert (Varitemname);
	...
	//{
		...
		{
		  document.getElementById("services").value = varCustomerName; 
		}
		else
		{
			var varServicesitemsValue = document.getElementById("serviceitems").value;
			var varCustomerName = varServicesitemsValue+"\n"+varCustomerName;
			document.getElementById("serviceitems").value = varCustomerName;
		}
