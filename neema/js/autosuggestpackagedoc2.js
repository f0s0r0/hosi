 ...
 * @scope public
 */
function AutoSuggestControlcustomer2(oTextbox /*:HTMLInputElement*/, 
...
AutoSuggestControlcustomer2.prototype.autosuggest = function (aSuggestions /*:Array*/,
                                                     bTypeAhead /*:boolean*/) {  
													 
													 //alert(document.getElementById("keyforahpl").value);
													 
													var oTextbox1=document.getElementById("pvtdoctor3").value;
													// alert(oTextbox1);
...
//alert('hi');
	...
	if(oTextbox1!=''){
		...
		document.getElementById("pvtdoctor3").value='';
		document.getElementById("pvtdoctorcode3").value = '';
		document.getElementById("pvtdoctorrate3").value = '';
		return false;
		}
	...
	if (xmlHttp==null)
	{
  	...
  	var customer = document.getElementById("hpldoctor3").value;
 ...
 * @scope private
 */
AutoSuggestControlcustomer2.prototype.createDropDown = function () { 
    ...
    this.layer.onmouseover = function (oEvent) {
        ...
        if (oEvent.type == "mousedown") {
			...
			var varSupplierName = document.getElementById("hpldoctor3").value;
			...
			//alert (varSupplierName);
			document.getElementById("hpldoctor3").value = vardoctorname;
			...
			document.getElementById("hpldoctorcode3").value = vardoctorcode;
			document.getElementById("hpldoctorrate3").value = vardoctorrate;
 ...
 */
AutoSuggestControlcustomer2.prototype.getLeft = function () /*:int*/ {
 ...
 */
AutoSuggestControlcustomer2.prototype.getTop = function () /*:int*/ {
 ...
 */
AutoSuggestControlcustomer2.prototype.handleKeyDown = function (oEvent /*:Event*/) {
 ...
 */
AutoSuggestControlcustomer2.prototype.handleKeyUp = function (oEvent /*:Event*/) {
    ...
    //make sure not to interfere with non-character keys
		...
		//alert (varSupplierName);
		document.getElementById("hpldoctor3").value = varSupplierName;
		//code end by prem.
 ...
 * @scope private
 */
AutoSuggestControlcustomer2.prototype.hideSuggestions = function () {
    this.layer.style.visibility = "hidden";
};
 ...
 */
AutoSuggestControlcustomer2.prototype.highlightSuggestion = function (oSuggestionNode) {
 ...
 * @scope private
 */
AutoSuggestControlcustomer2.prototype.init = function () {
 ...
 * @scope private
 */
AutoSuggestControlcustomer2.prototype.nextSuggestion = function () {
 ...
 * @scope private
 */
AutoSuggestControlcustomer2.prototype.previousSuggestion = function () {
    var cSuggestionNodes = this.layer.childNodes;
 ...
 */
AutoSuggestControlcustomer2.prototype.selectRange = function (iStart /*:int*/, iLength /*:int*/) {
 ...
 */
AutoSuggestControlcustomer2.prototype.showSuggestions = function (aSuggestions /*:Array*/) {
 ...
 */
AutoSuggestControlcustomer2.prototype.typeAhead = function (sSuggestion /*:String*/) {
