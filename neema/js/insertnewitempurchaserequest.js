function insertitem10()
{
	...
	{
		t=t-1;
	if(varMedicineName == document.getElementById("medicinename"+t+"").value)
	{
		alert('Item is added already');
		var varMedicineName = document.getElementById("medicinename").value = "";
	var varCategory = document.getElementById("category").value = "";
	var varStrength = document.getElementById("strength").value = "";
...
/*
	...
	*/
	...
	text25.id = "category"+i+"";
	text25.name = "category"+i+"";
	text25.type = "text";
	text25.size = "13";
	text25.value = varCategory;
	text25.readOnly = "readonly";
	text25.style.backgroundColor = "#FFFFFF";
	text25.style.border = "0px solid #001E6A";
	text25.style.textAlign = "left";
	...
	td26.align = "left";
	td26.valign = "top";
	td26.style.backgroundColor = "#FFFFFF";
	td26.style.border = "0px solid #001E6A";
	//var text2 = document.createElement ('<input name="itemcode'+i+'" value="'+varItemCode+'" id="itemcode'+i+'" style="border: 0px solid #001E6A; text-align:left" size="10" readonly="readonly" />');
	var text26 = document.createElement ('input');
	text26.id = "strength"+i+"";
	text26.name = "strength"+i+"";
	text26.type = "text";
	text26.size = "8";
	text26.value = varStrength;
	text26.readOnly = "readonly";
	text26.style.backgroundColor = "#FFFFFF";
	text26.style.border = "0px solid #001E6A";
	text26.style.textAlign = "left";
