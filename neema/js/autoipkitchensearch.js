...
function funclabsearch5()
{
	...
	{
		var varlabsearch = document.getElementById("typecode").value;
...
function ajaxprocessACCS25()
{
	...
	if (xmlHttp==null)
	{
  	...
  	var labsearch = document.getElementById("typecode").value;
	
//	var varpatienttype = document.getElementById("billtypes").value;
//	var varpaymenttype = document.getElementById("payment").value;
	...
	var url = "";
	var url="autoipkitchencodesearch.php?RandomKey="+Math.random()+"&&typecode="+labsearch+"&&locationcode="+locationcode;
    //alert(url);
...
{ 
	...
	//{
		...
		//alert (varlabRate);
		document.getElementById("amountkitchen").value = varlabRate;
		
		var vardiscription = varNewLineValue[3];
		//alert (varlabRate);
		document.getElementById("description").value = vardiscription;
		
		var varcalories = varNewLineValue[4];
		//alert (varlabRate);
		document.getElementById("calories").value = varcalories;
	...
	//alert(varlabRate);
		...
		document.getElementById("typename").value = Varlabname1;
