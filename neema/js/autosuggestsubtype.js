...
AutoSuggestControl1.prototype.autosuggest = function (aSuggestions /*:Array*/,
 ...
 //alert('h');
	...
	if (xmlHttp==null)
	{
  	...
  	var searchsuppliername1 = document.getElementById("searchsuppliername1").value;
	...
	var url = "";
	var url="ajaxsubtype1build1.php?searchsuppliername1="+searchsuppliername1+"&&RandomKey="+Math.random()+"";
    //alert(url);
	///*
...
AutoSuggestControl1.prototype.createDropDown = function () {
    ...
    this.layer.onmouseover = function (oEvent) {
        ...
        if (oEvent.type == "mousedown") {
			...
			var varSupplierName = document.getElementById("searchsuppliername1").value;
			...
			document.getElementById("searchsubtypeanum1").value = varSubtypeAnum;
			document.getElementById("searchsuppliername1").value = varSupplierName;
...
function suppliernamelostfocus()
{
	...
	if (varSupplierCode != undefined)
	{
		...
		document.getElementById("searchsuppliername1").value = varSubtypeName;
		document.getElementById("searchsubtypeanum").value = varSubtypeAnum;
	...
	else
	{
		...
		document.getElementById("searchsubtypeanum").value = "";
	}
