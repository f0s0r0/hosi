...
function ajaxprocessACCS30()
{
	...
	//alert(referalsearch);
	var url = "";
	var url="autootbillingsearch2.php?RandomKey="+Math.random()+"&&referalsearch="+referalsearch+"&&patienttype="+patienttype;
    //alert(url);
...
{ 
	...
	//{
		...
		var varreferalName = varNewLineValue[0];
		//alert (varreferalName);
		document.getElementById("referal").value = varreferalName;

		var varreferalRate = varNewLineValue[1];
