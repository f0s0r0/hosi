...
AutoSuggestControl.prototype.autosuggest = function (aSuggestions /*:Array*/,
    ...
    /*if (document.getElementById("searchsubtypeanum1").value == "") 
	{
  	...
  	var searchsuppliername = document.getElementById("searchsuppliername").value;
    ...
    if (searchsuppliername.length < 2) 
	{
  	...
  	var searchsubtypeanum1 = document.getElementById("searchsubtypeanum1").value;
	//alert(searchsuppliername1);
	
	var url = "";
	var url="ajaxaccountname1build1.php?searchsubtypeanum1="+searchsubtypeanum1+"&searchsuppliername="+searchsuppliername+"&&RandomKey="+Math.random()+"";
    //alert(url);
	///*
...
AutoSuggestControl.prototype.createDropDown = function () {
    ...
    this.layer.onmouseover = function (oEvent) {
        ...
        if (oEvent.type == "mousedown") {
			...
			document.getElementById("searchaccountnameanum1").value = varSubtypeAnum;
...
function suppliernamelostfocus()
{
	...
	if (varSupplierCode != undefined)
	{
		...
		document.getElementById("searchsuppliername").value = varSubtypeName;
		document.getElementById("searchaccountnameanum").value = varSubtypeAnum;
	...
	else
	{
		...
		document.getElementById("searchaccountnameanum").value = "";
	}
