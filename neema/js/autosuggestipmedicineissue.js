...
AutoSuggestControlmed.prototype.autosuggest = function (aSuggestions /*:Array*/,
	...
	var url = "";
	var url="ajaxmedicinebuildipmedicineissue.php?searchmedicinename1="+searchmedicinename1+"&&searchlocation="+locationcode+"&&RandomKey="+Math.random()+"";
    //alert(url);
	///*
