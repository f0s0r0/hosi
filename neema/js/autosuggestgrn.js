 ...
 * @scope public
 */
function AutoSuggestControl3(oTextbox1 /*:HTMLInputElement*/, 
...
AutoSuggestControl3.prototype.autosuggest = function (aSuggestions /*:Array*/,
	...
	document.getElementById("grn").value = grn.toUpperCase();
	//alert(genericname1);
    if (grn.length < 2) 
	{
		var grn = 'xyzxyzxyzxyz'; //To hide the already populated drop list automatically.
		//return false;
	}

	
	var url = "";
	var url="autocompletebuild_grn.php?grn="+grn+"&&RandomKey="+Math.random()+"";
    //alert(url);
	///*
	xmlHttp.onreadystatechange=function()
	{
		...
		{ 
			...
			//alert("Inside"+t);
			document.getElementById("grnhidden").value = t;
	...
	var varCompleteStringReturned = document.getElementById("grnhidden").value;
...
{
	var vargrnname = document.getElementById("grn").value;
	//alert(varponame);
	
		if (vargrnname != undefined)
	{
		//alert (varmedicinename);
		
		//alert(varservicescode);
		
		document.getElementById("grn").value = vargrnname;
