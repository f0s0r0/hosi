...
<table width="101%" align="left" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
   ...
   <td width="1%" align="left" valign="top">&nbsp;</td>
	...
	<tr>
	<td width="38" align="center" bgcolor="#CCCCCC" class="bodytext3"><strong>S.No</strong></td>
	<td width="82" align="left" bgcolor="#CCCCCC" class="bodytext3"><strong>PAYROLL NO</strong></td>
	<td width="237" align="left" bgcolor="#CCCCCC" class="bodytext3"><strong>EMPLOYEE'S NAME</strong></td>
	<td width="79" align="left" bgcolor="#CCCCCC" class="bodytext3"><strong>NSSF NO</strong></td>
	<td width="127" align="right" bgcolor="#CCCCCC" class="bodytext3"><strong>STD.AMT</strong></td>
	<td width="151" align="right" bgcolor="#CCCCCC" class="bodytext3"><strong>EMP Contribution</strong></td>
	<td width="122" align="right" bgcolor="#CCCCCC" class="bodytext3"><strong>TOTAL AMT</strong></td>
	<td width="15" align="left" bgcolor="#CCCCCC" class="bodytext3">&nbsp;</td>
	<td width="101" align="left" bgcolor="#CCCCCC" class="bodytext3"><strong>ID NO</strong></td>
	<td width="12" align="left" bgcolor="#CCCCCC" class="bodytext3">&nbsp;</td>
	</tr>
	<?php 
	$totalnssf = '0.00';
	$totalamount = '0.00';
	...
	<td align="left" class="bodytext3"><?php eval(base64_decode('IGVjaG8gJG5zc2Y7IA==')); ?></td>
	<?php 
