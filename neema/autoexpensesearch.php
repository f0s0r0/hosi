...
if (isset($_REQUEST["expensesearch"])) { $expense = $_REQUEST["expensesearch"]; } else { $expense = ""; }
$searchresult = "";
 
  $query2 = "select * from master_accountname where accountsmain IN ('4','6') and accountname like '%$expense%' and recordstatus <> 'deleted'  order by accountname  ";
