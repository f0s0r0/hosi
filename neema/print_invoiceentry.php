...
if (isset($_REQUEST["invoice_number"])) { $invoice_number = $_REQUEST["invoice_number"]; } else { $invoice_number = ""; }

	

	include('convert_currency_to_words.php');
	
	$query1 = "select * from purchase_details where billnumber = '$invoice_number' ";
...
<tr>
<td colspan="5" class="bodyhead" align="center">INVOICE ENTRY</td>
</tr>
    <tr>
   	  <td width="100" class="bodytext4">Supplier: </td>
      <td width="326" class="bodytext3"><?php echo $res1suppliername; ?></td>
      <td width="161">&nbsp;</td>
      <td width="102" class="bodytext4">Bill No: </td>
      <td width="203" class="bodytext3"><?php echo $invoice_number; ?></td>
	</tr>
    <tr>
   	  <td class="bodytext4" width="100">Address: </td>
        <td class="bodytext3" width="326"><?php echo $supplieraddress; ?></td>
      <td>&nbsp;</td>
      <td class="bodytext4">Bill Date:</td>
      <td class="bodytext3"><?php echo date('d/m/Y',strtotime($res1entrydate)); ?></td>
	</tr>
    <tr>
   	  <td class="bodytext4" width="100">Phone No:</td>
        <td class="bodytext3"><?php echo $supplierph; ?></td>
      <td>&nbsp;</td>
      <td class="bodytext4">Invoice No:</td>
      <td class="bodytext3" width="250"><?php echo smart_wordwrap($res1supplierbillnumber, 15); ?></td>
	</tr>
    <tr>
   	  <td width="100"></td>
        <td></td>
    ...
    <tr>
    	<td class="bodytext4" width="100"></td>
...
<table border=""  align="center" cellpadding="5" cellspacing="">
	...
	<tr>
        <td  align="center"   class="bodytext4 border" width="200">Item Description</td>
        <td   align="center"   class="bodytext4 border">Expense Ledger</td>
     ...
     <?php
			...
			$totalamount = 0;
			$temp = 0;
			$query11 = "select * from purchase_details where billnumber = '$invoice_number' ";
		 ...
		 ?>
    <tr>
        <td class="bodytext3 border"  align="left" width="200" ><?php echo $res11itemname; ?></td>
        <td class="bodytext3 border" align="left" width="150" ><?php echo ucwords(strtolower($res11expense)); ?></td>
    ...
    <?php 
		...
		?>
	<tr>
    	<td align="right" class="bodytext4" colspan="4">Total Amount:</td>
		<td align="right" class="bodytext3"><?php echo number_format($totalamount,2,'.',',');?></td>
    </tr>
    <tr>
    	<td align="right" class="bodytext4" colspan="4">Disc Amount:</td>
		<td align="right" class="bodytext3"><?php echo number_format($totaldiscount,2,'.',','); ?></td>
    </tr>
    <tr>
    	<td align="right" class="bodytext4" colspan="4">Net Amount:</td>
		<td align="right" class="bodytext3"><?php echo number_format($grandtotalamount,2,'.',','); ?></td>
    </tr>
    <tr>
    	<td width="1000" class="bodytext3" colspan="5"><strong>Amount In Words: </strong><?php echo str_replace('Kenya Shillings','',$totalamountinwords); ?></td>
    </tr>
    <tr>
    	<td width="1000" class="bodytext3" colspan="5"><strong>Prepared By&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</strong>&nbsp;<?php echo $username; ?></td>
    </tr>
</table>
</page>
<!----------------------------------------------unwanted------------------------------------>
