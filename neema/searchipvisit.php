    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Edit IP Visit Details </strong></td>
...
<form name="form1" id="form1" method="post" action="searchipvisit.php">	
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
             <tr>
				 <td colspan="16"  bgcolor="#CCCCCC" class="bodytext31">
            ...
            $query2 = "select * from master_ipvisitentry where  locationcode='$searchlocationcode'  and patientfullname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and consultationdate between '$fromdate' and '$todate'order by auto_number desc LIMIT $start , $limit";
			 ...
			 // echo $num2;
			  ...
			  $package= $res2['package'];
				  ...
				  $query344 = "select * from master_ippackage where  auto_number='$package'";
			  $exec344 = mysql_query($query344) or die(mysql_error());
			  $res344 = mysql_fetch_array($exec344);
			  $res2package = $res344['packagename'];
			  $patienttype= $res2['type'];
	...
	//$packcharge = '';
		...
		*/	  
              ...
              <tr <?php echo $colorcode; ?>>
				...
				<div align="center"><strong><a target="_blank" href="print_ipvisit_label.php?patientcode=<?php echo $res2customercode; ?>">Print</a></strong></div></td>
                <td class="bodytext31" valign="center"  align="left">
				<div align="center">
                ...
                <td  align="left" valign="center" class="bodytext31"><div align="left"> <?php echo $res2package; ?></div></td>
                  <td class="bodytext31" valign="center"  align="left">
                ...
                <td  align="left" valign="center" class="bodytext31"><div align="left"><?php echo $res2gender; ?></div></td>
                    ...
                    <td  align="left" valign="center" class="bodytext31"><div class="bodytext31">
                    <div align="left"><span class="bodytext3"  style="color:red;"><span class="bodytext32" style="color:red;"><?php if($patienttype = "hospital"){echo "H";}else if($patienttype = "private"){ echo "P";}  ?></span></span></div>
                </div></td>
                  </tr>
			  <?php
			  }
