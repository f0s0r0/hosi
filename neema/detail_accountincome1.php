        ...
        <td valign="top"><table width="919" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            <?php
				...
				{  
					...
					$querydr1 = "SELECT `transactionamount` as td1,`transactiondate` as td2,`docnumber` as td3,`receiptcoa` as td4,CONCAT(`remarks`,'  ',`payee`) as td5, `chequenumber` as td6 FROM `receiptsub_details` WHERE `receiptcoa` = '$id' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2'
								 UNION ALL SELECT (-1*debitamount) as td1,`entrydate` as td2,`docno` as td3,`ledgerid` as td4,`narration` as td5, `ledgerid` as td6 FROM `master_journalentries` WHERE `ledgerid` = '$id' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2'
								 UNION ALL SELECT (creditamount) as td1,`entrydate` as td2,`docno` as td3,`ledgerid` as td4,`narration` as td5, `ledgerid` as td6 FROM `master_journalentries` WHERE `ledgerid` = '$id' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2'";
