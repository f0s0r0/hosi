...
<body>
<?php $querynw1 = "select * from master_ipvisitentry where deposit='' and billtype='PAY NOW' group by visitcode order by auto_number desc";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
          ...
          <tbody>
            <tr>
              ...
              <td colspan="6" bgcolor="#cccccc" class="bodytext31">
                ...
                <div align="left"><strong>IP Deposit Collection</strong><label class="number"><<<?php echo $resnw1;?>>></label></div></td>
              </tr>
            <tr>
			...
			$query1 = "select * from master_ipvisitentry where deposit='' and billtype='PAY NOW' group by visitcode order by auto_number desc";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left">
			    <div align="left"><?php echo $patientfullname; ?></div></td>
				  <td class="bodytext31" valign="center"  align="left"><?php echo $billtype; ?></td>
              <td class="bodytext31" valign="center"  align="left"><?php echo $accountname; ?></td>
              <td class="bodytext31" valign="center" align="left">
			    <div align="left"><a href="depositform.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>"><strong>Deposit</strong></a></div></td>
              </tr>
			<?php
			}    
			?>
