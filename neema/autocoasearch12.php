...
$query2 = "select * from master_accountname where (accountsmain='3' or accountsmain ='4')  and accountname like '%$coasearch%' and recordstatus <> 'deleted' order by accountname";
...
while ($res2 = mysql_fetch_array($exec2))
{
	...
	$accountssubid = $res2["accountssub"];
	...
	$type = $res21['section'];
	$accountsmainname = $res21['accountsmain'];
