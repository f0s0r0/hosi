 ...
 <tr>
  ...
  <tr>
    ...
    <td width="97%" valign="top">
		  	  	<form id="form1" name="form1" method="post" action="editipredepositscoaintegration.php" onSubmit="return process1login1()">
    ...
    <td>&nbsp;</td>
                 ...
                 <tr bgcolor="#011E6A">
                        <td colspan="10" bgcolor="#CCCCCC" class="bodytext3"><strong>Edit IP Re-Deposits</strong></td>
                  </tr>
					   <tr>
				     ...
				     <tr>
				  <td width="248" align="left" valign="top"  class="bodytext5">IP Deposits <input type="hidden" name="labpaynow5" value="ipredeposits" /></td>
                        <td width="332" align="left" valign="top"  class="bodytext3"><input type="text" name="paynowlabcoa5" id="paynowreferalcoa" size="40" value="<?php echo $ipdepositscoaname; ?>"/>
						...
						if($ipdepositsselect != '')
						{
						if($ipdepositsselect == 'dr')		
						{
						$ipdepositsselect1 = 'Dr';
						}	
						else
						{
						$ipdepositsselect1 = 'Cr';
						}	
						?>
						<option value="<?php echo $ipdepositsselect; ?>"><?php echo $ipdepositsselect1; ?></option>
						<?php
						}
						?>
                        ...
                        <td width="110" align="left" valign="top"  class="bodytext3"><input type="text" name="paynowlabtype5" id="paynowreferaltype" size="10" value="<?php echo $ipdepositstype; ?>"/></td>
                        <td width="103" align="left" valign="top"  class="bodytext3"><input type="text" name="paynowlabcode5" id="paynowreferalcode" size="10" value="<?php echo $ipdepositscoa; ?>"/></td>
				  </tr>
