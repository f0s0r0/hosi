...
function suppliersearch1(varCallFrom)
{
	...
	//window.open("message_popup.php?anum="+anum,"Window1",'toolbar=0,scrollbars=0,location=0,statusbari=0,menubar=0,resizable=1,width=200,height=400,left=312,top=84');
}
...
function funcSubTotalDiscountApply1()
{
...

	{
		...
		{
			//alert (z);
			var varTaxPercentageTextBoxZ = document.getElementById('taxpercent'+z).value;select
...
mrp=parseFloat(mrp).toFixed(2);
	mrp=mrp.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
...
document.getElementById('itemmrp').value=mrp;
		...
		varItemMRP=varItemMRP.replace(/,/g , "");
		//alert (varItemMRP);
		if (varItemMRP == "")
		{
		...
		//var packvalue=varitempackagename.substring(0,varitempackagename.length - 1);
		
		//var varItemTotalQuantity = (parseInt(varItemQuantity) * parseInt(packvalue))+ parseFloat(varItemFreeQuantity);
		...
		varItemTotalAmount = parseFloat(varItemTotalAmount).toFixed(2);
		varItemTotalAmount = varItemTotalAmount.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
		document.getElementById("itemtotalamount").value = varItemTotalAmount;
		
		varItemTotalQuantity1 = varItemTotalQuantity - varItemFreeQuantity;
		
		var spmarkup = document.getElementById("spmarkup").value;
		
		var costprice = varItemTotalAmount/varItemTotalQuantity1;
		
		document.getElementById("costprice").value = costprice.toFixed(2);
		
		
		var salesprice = (varItemTotalAmount * spmarkup)/varItemTotalQuantity1;
...
{
var currtype1=document.getElementById('currency').value;
var currtypesp = currtype1.split('||');
var currtype = currtypesp[0];
	...
	for (m=1;m<1000;m++)
	{
		...
		if (document.getElementById('serialnumber'+m) != null) 
		{
			...
			if (varTotalAmountLoop != null) 
			{
				...
				varTotalAmountLoop=varTotalAmountLoop.replace(/,/g,'');
	...
	varTotalAmount = parseFloat(varTotalAmount).toFixed(2);
	varTotalAmount = varTotalAmount.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
	document.getElementById('subtotal').value = varTotalAmount;
	
	var varSubTotalAmount = document.getElementById("subtotal").value;
	varSubTotalAmount=varSubTotalAmount.replace(/,/g,'');
	...
	varTotalAfterDiscount=varTotalAfterDiscount.replace(/,/g,'');
	
	varTotalAmount=varTotalAmount.replace(/,/g,'');
	var totalfxamount=varTotalAmount*currtype;
	totalfxamount = parseFloat(totalfxamount).toFixed(2);
	totalfxamount = totalfxamount.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
	document.getElementById("fxamount").value=totalfxamount;
	//Calculation of TAX.
	...
	else
	{
		...
		var varTotalAfterDiscount = parseFloat(varTotalAfterDiscount);
		//alert (varTotalAfterDiscount);
		varTotalAfterDiscount = parseFloat(varTotalAfterDiscount).toFixed(2);
		varTotalAfterDiscount = varTotalAfterDiscount.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
		document.getElementById("subtotalaftercombinediscount").value = varTotalAfterDiscount;	

		document.getElementById('afterdiscountamount').value = varTotalAfterDiscount;
	}
	...
	var varTotalAfterTax = varNetTotalTaxAmount + varTotalAfterDiscount;
	//alert (varTotalAfterTax);
	varTotalAfterTax = parseFloat(varTotalAfterTax).toFixed(2);
	varTotalAfterTax = varTotalAfterTax.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
...
function funcNetAmountCalc1()
{
	...
	varTotalAfterTax=varTotalAfterTax.replace(/,/g,'');
...
?>
	...
	varAfterRoundOff = parseFloat(varAfterRoundOff).toFixed(2);
	varAfterRoundOff = varAfterRoundOff.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
	document.getElementById("totalamount").value = varAfterRoundOff;
	
	var varTDShowTotalAmount1 = document.getElementById("totalamount").value;
	//var varTDShowTotalAmount1 = "Total: "+varTDShowTotalAmount1;
	varTDShowTotalAmount1=varTDShowTotalAmount1.replace(/,/g,'');
	varTDShowTotalAmount1 = parseFloat(varTDShowTotalAmount1).toFixed(2);
	varTDShowTotalAmount1 = varTDShowTotalAmount1.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
...
{
	if (document.getElementById("supplierbillnumber").value == "")
	{
		alert ("Please Enter Supplier Bill Number To Proceed.");
		document.getElementById("supplierbillnumber").focus();
		return false;
	}
...
function funcPaymentInfoCalculation1()
{
	...
	{	
		...
		Credit=Credit;
		document.getElementById("nettamount").value = Credit;
	}
	if (document.getElementById("billtype").value == "ONLINE")
	{	
...
function funcTaxReverseCalc1()
{
	...
	{
		var varItemTotalAmount = document.getElementById("itemtotalamount").value;
		varItemTotalAmount=varItemTotalAmount.replace(/,/g , "");
