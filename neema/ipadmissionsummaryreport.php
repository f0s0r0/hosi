...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><form name="cbform1" method="post" action="ipadmissionsummaryreport.php">
          <table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Admission Summary Report </strong></td>
...
$querynw1 = "select * from ip_bedallocation where locationcode='$locationcode1' and recorddate between '$fromdate' and '$todate'";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
...
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
             <tr>
			 <td colspan="7" bgcolor="#cccccc" class="bodytext31"><div align="left"><strong>Admission Summary Report </strong><label class="number"><<<?php echo $resnw1;?>>></label></div></td>
			 </tr>
            <tr>
		   ...
		   ?>
            ...
            <tr>
              ...
              <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left" 
                ...
                <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left" 
                bgcolor="#cccccc">&nbsp;</td>
                <td colspan="5" align="left" class="bodytext3"><a href="print_ipadmissionsummaryreport.php?locationcode=<?php echo $location; ?>&&fromdate=<?php echo $transactiondatefrom; ?>&&todate=<?php echo $transactiondateto; ?>"><img src="images/excel-xls-icon.png" height="40" width="40"></a></td>
      </tr>
          </tbody>
        </table>
<?php
