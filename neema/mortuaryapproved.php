...
if ($frmflag1 == 'frmflag1')
{
	  ...
	  $query381="update mortuary_receivedetails set conditionofdecease='$conditionofdisease',scarsmarkings='$scars',comments='$comments',shirt='$shirt',belt='$belt',trousers='$trousers',jacket='$jacket',socks='$socks',
	  ...
	  nextofkin='$nextofkin',kinrelationship='$nextofkinrelationship',nextofkintelephone='$nextofkinrelationshitelephone' where docno='$docno'";
	   
	  $exec381=mysql_query($query381) or die(mysql_error());
...
<body>
<form name="form1" id="form1" method="post" action="mortuaryapproved.php" onSubmit="return validcheck()">	
...
<td width="98">&nbsp;</td>
      ...
      <td width="181"><input type="submit" name="update" value="update" style="border: 1px solid #001E6A" onClick="return funcvalidation()"/></td>
	 <td  align="left" valign="middle" width="940"><a href="print_mortuarylist.php?docno=<?php echo $docno;?>&&patientcode=<?php echo $patientcode;?>&&visitcode=<?php echo $visitcode;?>"><strong><u>Print</u></strong></a></td>
      <td  align="left" valign="middle" width="229"><a href="mortuaryshellallocation.php?docno=<?php echo $docno;?>&&patientcode=<?php echo $patientcode;?>&&visitcode=<?php echo $visitcode;?>"><strong><u>Back</u></strong></a></td>
