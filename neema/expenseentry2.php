...
else
{
	...
	*/
	...
	chequenumber, bankname, chequedate, remarks,docnumber,expensecoa,username,bankcode,payee) 
	...
	'$chequenumber', '$bankname', '$chequedate', '$remarks','$docnumber','$expenseentrycoa','$username','$bankcode','$payee')";
	...
	cashamount, onlineamount, chequeamount, adjustmentamount, cardamount, 
	updatedate, companyanum, companyname, transactionmodule, 
	chequenumber, bankname, chequedate, remarks,docnumber,expensecoa,username,cashcode,payee) 
	values ('$expensemainanum', '$expensemainname', '$expensesubanum', '$expensesubname', 
	'$transactiondate', '$particulars1',  
	'$transactionmode1', '$transactiontype1', '$transactionamount', '$ipaddress', 
	'$cashamount', '$onlineamount', '$chequeamount', '$adjustmentamount', '$cardamount', 
	'$updatedate', '$companyanum', '$companyname', '$transactionmodule1', 
	'$chequenumber', '$bankname', '$chequedate', '$remarks','$docnumber','$expenseentrycoa','$username','$cashcode','$payee')";
	$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());	
	...
	cashamount, onlineamount, chequeamount, adjustmentamount, cardamount, 
	updatedate, companyanum, companyname, transactionmodule, 
	chequenumber, bankname, chequedate, remarks,docnumber,expensecoa,username,payee) 
	values ('$expensemainanum', '$expensemainname', '$expensesubanum', '$expensesubname', 
	'$transactiondate', '$particulars1',  
	'$transactionmode1', '$transactiontype1', '$transactionamount', '$ipaddress', 
	'$cashamount', '$onlineamount', '$chequeamount', '$adjustmentamount', '$cardamount', 
	'$updatedate', '$companyanum', '$companyname', '$transactionmodule1', 
	'$chequenumber', '$bankname', '$chequedate', '$remarks','$docnumber','$expenseentrycoa','$username','$payee')";
	$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());		
...
*To Print Other Receipts Please Go To Menu:	Reports	-&gt; Expense Report </span></td>
				...
				<input type="hidden" name="onlinecoa" value="<?php echo $onlinecoa; ?>">
                    ...
                    <td align="left" valign="top"  bgcolor="#FFFFFF"><input type="text" id="balanc" readonly="readonly" value="" style="border:none; display:none;"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td align="left" valign="top"  bgcolor="#FFFFFF">
					<input name="expenseamount" id="expenseamount" onChange="balances();" style="border: 1px solid #001E6A" value="0.00"  size="20" /></td>
                    <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3">Expense Mode </td>
                    <td align="left" valign="top"  bgcolor="#FFFFFF">
					<select name="expensemode" id="expensemode" onChange="balances();" style="width: 130px;">
                  ...
                  <tr>
                    ...
                    <td align="left" valign="top"  bgcolor="#FFFFFF"><input name="remarks" id="remarks" style="border: 1px solid #001E6A" value=""  size="30" /></td>
                  </tr>
                  <tr>
                    <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3">Payee</td>
                    <td align="left" valign="top"  bgcolor="#FFFFFF"><input type="text" name="payee" id="payee" style="border: 1px solid #001E6A" value=""  size="30"></td>
