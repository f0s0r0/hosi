...
*/				  
				...
				<tr <?php echo $colorcode; ?>>
				  ...
				  <td class="bodytext31" valign="center"  align="left"><?php echo $accountname; ?></td>
				  <td class="bodytext31" valign="center" align="left">
					<div align="left"><a href="depositform.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&docno=<?php echo $docno; ?>&&anum=<?php echo $anum; ?>"><strong>Mortuary Deposit</strong></a></div></td>
				  </tr>
				<?php
			} 
			}   
...
*/				  
				...
				<tr <?php echo $colorcode; ?>>
				  ...
				  <td class="bodytext31" valign="center"  align="left"><?php echo $accountname; ?></td>
				  <td class="bodytext31" valign="center" align="left">
					<div align="left"><a href="externaldepositform.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&docno=<?php echo $docno; ?>&&anum=<?php echo $anum; ?>"><strong>Mortuary Deposit</strong></a></div></td>
				  </tr>
				<?php
			} 
			?>
           ...
           $query122 = "select consultationdate,patientname,mortuarydocno,patientcode,patientvisitcode from mortuaryexternal_services where patientname like '%$searchpatient%' and patientname like '%$searchpatientcode%' and patientname like '%$searchvisitcode%' and  paymentstatus ='pending' and freestatus = '0' and consultationdate between '$fromdate' and '$todate' group by mortuarydocno";
			...
			$accountname='CASH';
			  ...
			  ?>
              <?php
			$query21=mysql_query("select * from pharmacysalesreturn_details where billstatus<>'completed' and  patientcode <> 'walkin' and entrydate between '$fromdate' and '$todate' and locationcode='$locationcode' and visitcode NOT LIKE ('%-IP%') and refundapprove='approved' group by docnumber order by entrydate desc") or die(mysql_error());
			while($exec21=mysql_fetch_array($query21))
			{
			...
			$query21=mysql_query("select * from consultation_radiology where patientname like '%$searchpatient%' and  radiologyrefund='refund' and refundapprove='approved' and patientcode = 'walkin' and consultationdate between '$fromdate' and '$todate' and locationcode='$locationcode' group by patientvisitcode order by consultationdate desc") or die(mysql_error());
			while($exec21=mysql_fetch_array($query21))
			{
			 $billno = $exec21['billnumber'];
			...
			?>
			  ...
			  ?>
                <?php
			  $billnos="'".''."'";
			$query21=mysql_query("select * from consultation_radiology where patientname like '%$searchpatient%' and  radiologyrefund='refund' and refundapprove='approved'  and billtype='PAY NOW' and consultationdate between '$fromdate' and '$todate' group by patientvisitcode order by consultationdate desc") or die(mysql_error());
			while($exec21=mysql_fetch_array($query21))
			{
			 $billno = $exec21['billnumber'];
			...
			$query21=mysql_query("select * from consultation_services where patientname like '%$searchpatient%' and  servicerefund='refund' and refundapprove='approved' and patientcode = 'walkin'  AND consultationdate between '$fromdate' and '$todate' group by patientvisitcode order by consultationdate desc") or die(mysql_error());
			while($exec21=mysql_fetch_array($query21))
			{
			$billno = $exec21['billnumber'];
			...
			$query21=mysql_query("select * from consultation_services where patientname like '%$searchpatient%' and  servicerefund='refund' and refundapprove='approved' and billtype='PAY NOW' AND consultationdate between '$fromdate' and '$todate' group by patientvisitcode order by consultationdate desc") or die(mysql_error());
			while($exec21=mysql_fetch_array($query21))
			{
			$billno = $exec21['billnumber'];
			...
			?>
			  ...
			  ?>
			  <?php 
			$query21=mysql_query("select * from consultation_lab where patientname like '%$searchpatient%' and  labrefund='refund' and refundapproval='approved' and
	 patientcode = 'walkin'   and consultationdate between '$fromdate' and '$todate' GROUP BY billnumber order by consultationdate desc") or die(mysql_error());
			while($exec21=mysql_fetch_array($query21))
			{
			$billno = $exec21['billnumber'];
...
<a href="refund_external.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $patientvisitcode; ?>&&billno=<?php echo $billno ?>&&rfkey=cl&&locationcode=<?php echo $locationcode2 ?>" ><strong>Refund</strong></a>	</td>
			...
			$query21=mysql_query("select * from consultation_lab where patientname like '%$searchpatient%' and  labrefund='refund' and refundapproval='approved' and
	 billtype = 'PAY NOW'   and consultationdate between '$fromdate' and '$todate' GROUP BY patientvisitcode order by consultationdate desc") or die(mysql_error());
			while($exec21=mysql_fetch_array($query21))
			{
			$billno = $exec21['billnumber'];
	 ...
	 billtype = 'PAY LATER'   and consultationdate between '$fromdate' and '$todate' and  locationcode='$locationcode' GROUP BY patientvisitcode order by consultationdate desc") or die(mysql_error());
			...
			?>
			  ...
			  ?>
			<?php
			$query76 = "select * from master_visitentry where paymentstatus='completed' and consultationrefund='torefund' and consultationrefundapproval = 'approved' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and patientfullname like '%$searchpatient%' and consultationdate between '$fromdate' and '$todate' and locationcode='$locationcode' group by visitcode order by consultationdate desc";
			...
			<tr <?php echo $colorcode; ?>>
                ...
                <td  align="left" valign="center" class="bodytext31"><div class="bodytext31">
                    ...
                    <td class="bodytext31" valign="center"  align="left">
					<a href="consultationrefund1.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $patientvisitcode; ?>&&locationcode=<?php echo $locationcode; ?>"><strong>Consultation Refund</strong></a>	</td>
                    </tr>
<?php
}
}
...
<?php
			  $billnos="'".''."'";
			$query21=mysql_query("select * from consultation_departmentreferal where patientname like '%$searchpatient%' and  status='refund' and billtype='PAY NOW' and approvalstatus = 'approved' and consultationdate between '$fromdate' and '$todate' group by patientvisitcode order by consultationdate desc") or die(mysql_error());
			while($exec21=mysql_fetch_array($query21))
			{
			 $billno = $exec21['refno'];
			...
			?>
			  <tr <?php echo $colorcode; ?>>
                ...
                <td  align="left" valign="center" class="bodytext31"><div class="bodytext31">
                    ...
                    <td class="bodytext31" valign="center"  align="left">
					<a href="refund_paynow.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $patientvisitcode; ?>&&billno=<?php echo $billno ?>&&rfkey=dr&&location=<?php echo $location ?>"><strong>Dept Refund</strong></a>	</td>
                    </tr>
			  <?php
			  }
			  //}
              ...
              <?php
			  $billnos="'".''."'";
			$query21=mysql_query("select * from consultation_referal where patientname like '%$searchpatient%' and  status='refund' and billtype='PAY NOW' and approvalstatus = 'approved' and consultationdate between '$fromdate' and '$todate' group by patientvisitcode order by consultationdate desc") or die(mysql_error());
			while($exec21=mysql_fetch_array($query21))
			{
			 $billno = $exec21['refno'];
