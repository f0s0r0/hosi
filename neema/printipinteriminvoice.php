...
<table width="530" align="center" border="" cellspacing="0" cellpadding="2">
        ...
        <tr><td colspan="7">&nbsp;</td></tr>
		   <tr>
             <td width="15%" align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Name : </strong></td> 
		     <td width="35%" align="left" valign="center" class="bodytext31"><?php echo $patientname; ?></td>
		     <td  width="10%" align="center" valign="center" class="bodytext31">&nbsp;</td>
		     <td width="20%" align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Bill Date : </strong></td> 
		     <td width="20%"  align="left" valign="center" class="bodytext31"><?php echo  date("d/m/Y", strtotime($currentdate)); ?></td>
          </tr>
		  
	       <tr>
             <td width="15%" align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><strong> Reg. No. : </strong></td>
          ...
          <tr>
             <td width="15%" align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><strong> Bill Type : </strong></td>
        ...
        <tr>
			<td  width="15%"  align="left" rowspan= "1" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Account : </strong></td>
		 ...
		 <tr>
         	<td  width="15%"  align="left" rowspan= "2" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Catagory : </strong></td>
			<td align="left"  valign="center" rowspan= "2" class="bodytext31"><?php echo $subtype; ?></td>
            <td  align="center" valign="left" rowspan= "2" class="bodytext31">&nbsp;</td>
          ...
          <tr>
			<td  align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Bed No : </strong></td>
			<td align="left" valign="center" class="bodytext31"><?php echo $bed;?></td>
		</tr>
		<tr>
		...
		<table width="530" align="center" border="0" cellspacing="4" cellpadding="2">
			<tr>
			 	<td colspan="7" class="underline" align="center">INTERIM INVOICE</td>
			</tr>
		<thead>
			<tr class="flyleaf">
	 ...
	 $reqdate = date('Y-m-d',strtotime($packagedate1) + (24*3600*$reqquantity));
		...
		<tr>
		   ...
		   $thresholdvalue = $threshold/100;
			...
			if($num91>0){
				echo "<tr><td colspan='7'><strong>BED CHARGES</strong></td></tr>";	
			}
		   ...
		   $allocatenewquantity = $quantity;
			...
			<tr>
			 <td class="bodytext31" valign="center"  align="left"><div align="left"><?php //echo $sno = $sno + 1; ?></div></td>
			    <td class="bodytext31" valign="center"  align="left"><div align="left"><?php echo date("d-m-Y", strtotime($reqdate)); ?></div></td>
		   ...
		   $allocatenewquantiy = $quantity;
			...
			$totalquantity = $totalquantity + $quantity;
			 ...
			 <tr>
			 <td class="bodytext31" valign="center"  align="left"><div align="left"><?php //echo $sno = $sno + 1; ?></div></td>
			    <td class="bodytext31" valign="center"  align="left"><div align="left"><?php echo date("d-m-Y", strtotime($date)); ?></div></td>
			 <td class="bodytext31" valign="center"  align="left"><div align="left"><?php echo $refno; ?></div></td>
			 <td class="bodytext31" valign="center"  align="left"><div align="left"><?php echo $charge; ?>(<?php echo $bedname; ?>)</div></td>
			 <td class="bodytext31" valign="center"  align="left"><div align="right"><?php echo $quantity; ?></div></td>
               <td class="bodytext31" valign="center"  align="left"><div align="right"><?php echo number_format($rate,2,'.',','); ?></div></td>
		...
		<tr>
			...
			<td class="bodytext31" valign="center"  align="right"><?php echo number_format($radrate,2,'.',','); ?></td>
			  ...
			  ?>
					...
					$totalser=0;
		    $query21 = "select * from ipconsultation_services where patientvisitcode='$visitcode' and patientcode='$patientcode' and servicesitemname != '' and servicerefund != 'refund' and freestatus = 'No' group by servicesitemname";
		...
		<tr>
			...
			while($res69 = mysql_fetch_array($exec69))
		   {
			...
			<tr>
			<td align="right" colspan="6"class="bodytext31" valign="middle"><strong>INVOICE TOTAL AMOUNT :</strong></td>
		...
		<tr>
        	<td colspan="5" class="bodytext31" align="left"><strong>Kenya Shillings:</strong><?php echo str_replace('Kenya Shillings','',$convertedwords); ?></td>
