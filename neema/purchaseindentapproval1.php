...
if($_POST['discard'] != $docno)
{
	...
	//echo "<br>".$itemcode;
		...
		foreach($_POST['app'] as $check)
		{
			...
			if($itemcode == $acknow)
			{
				...
				{
					$query45="update purchase_indent set approvalstatus='$status',quantity='$reqqty',packagequantity='$pkgqty',amount='$amount', remarks='$remarks',baremarks='$remarks',famailfrom='$famailfrom',famailcc='$famailcc',bausername='$username' where docno='$docno' and medicinecode='$itemcode'"; 
				}
				else
				{
					$query45="update purchase_indent set approvalstatus='$status',quantity='$reqqty',packagequantity='$pkgqty',amount='$amount', remarks='$remarks',baremarks='$remarks',famailfrom='$famailfrom',famailcc='$famailcc',bausername='$username' where docno='$docno' and auto_number='$itemcode'"; 
				}
  ...
  foreach($_POST['medicinename'] as $key => $value)
	...
	//echo "<br>".$itemcode;
		...
		if(trim($purchasetype)!='non-medical')
		{
			$query45="update purchase_indent set approvalstatus='reject',quantity='$reqqty',packagequantity='$pkgqty',amount='$amount', remarks='$remarks',famailfrom='$famailfrom',famailcc='$famailcc',bausername='$username' where docno='$docno' and medicinecode='$itemcode'"; 
		}
		else
		{
			$query45="update purchase_indent set approvalstatus='reject',quantity='$reqqty',packagequantity='$pkgqty',amount='$amount', remarks='$remarks',famailfrom='$famailfrom',famailcc='$famailcc',bausername='$username' where docno='$docno' and auto_number='$itemcode'"; 
		}
		$exec45 = mysql_query($query45) or die(mysql_error());	
		$actionstatus='reject'; 
		}
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
			...
			$sno = 0;
			$totalamount=0;			
			$query12 = "select * from purchase_indent where docno='$docno' and (approvalstatus='' or approvalstatus='rejected1')";
			$exec12= mysql_query($query12) or die ("Error in Query1".mysql_error());
			$numb=mysql_num_rows($exec12);
...
?>
  <tr>
		...
		<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" name="reqqty[]" id="reqqty<?php echo $sno ; ?>" value="<?php echo number_format($reqqty);?>" size="6" onKeyUp="return calc('<?php echo $sno; ?>','<?php echo $numb; ?>');" onFocus="funqty(this.id)" onBlur="funqty(this.id)"></div></td>
		...
		<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" name="amount[]" id="amount<?php echo $sno ; ?>" value="<?php echo number_format($amount,'2','.',',');?>" size="10" class="bal" readonly></div></td>
        <td class="bodytext31" valign="center"  align="left"><div align="center"><input type="checkbox" name="app[]" value="<?php echo $itemcode; ?>"/>
        </div></td>
	  ...
	  <td width="48%" align="left" valign="center"  
				...
				<td width="52%" bgcolor="#F3F3F3"> <input name="project" id="project" style="text-align:left;" value="<?php echo $project; ?>" size="" readonly /></td>
				<tr>
				<td width="48%" align="left" valign="center"  
				bgcolor="#F3F3F3" class="bodytext31"><div align="right"><span class="bodytext311"><strong>Budget Line</strong></span></div></td>
				<td bgcolor="#F3F3F3"> <input name="budgetline" id="budgetline" style="text-align:left;" value="<?php echo $budgetline; ?>" size="" readonly/></td></tr>
				...
				<td bgcolor="#F3F3F3"> <input name="budgetcode" id="budgetcode" style="text-align:left;" value="<?php echo $budgetcode; ?>" size="" readonly/></td></tr>
				<tr><td width="48%" align="left" valign="center"  
				bgcolor="#F3F3F3" class="bodytext31"><div align="right"><span class="bodytext311"><strong>Warranty</strong></span></div></td>
				<td bgcolor="#F3F3F3"> <input name="warrenty" id="warrenty" style="text-align:left;" value="<?php echo $warrenty; ?>" size="" readonly /></td></tr>
				<tr> <td width="48%" align="left" valign="center"  
				bgcolor="#F3F3F3" class="bodytext31"><div align="right"><span class="bodytext311"><strong>Delivery/Transport</strong></span></div></td>
				<td bgcolor="#F3F3F3"> <input name="deliveryortransport" id="deliveryortransport" style="text-align:left;" readonly value="<?php echo $deliveryortransport; ?>" size="" /></td></tr>
				<tr><td width="48%" align="left" valign="center"  
				bgcolor="#F3F3F3" class="bodytext31"><div align="right"><span class="bodytext311"><strong>Terms of Payment</strong></span></div></td>
				<td bgcolor="#F3F3F3"> <input name="payment" id="payment" style="text-align:left;" value="<?php echo $payment; ?>" size="" readonly/></td></tr>
				<tr>  <td width="48%" align="left" valign="center"  
				bgcolor="#F3F3F3" class="bodytext31"><div align="right"><span class="bodytext311"><strong>Quotation Number/Date</strong></span></div></td>
				<td bgcolor="#F3F3F3"><input type="text" name="quotationnum" id="quotationnum" value="<?php echo $quotationnum; ?>" readonly></td></tr>
				<tr>  <td width="48%" align="left" valign="center"  
				bgcolor="#F3F3F3" class="bodytext31"><div align="right"><span class="bodytext311"><strong>LPO Validity</strong></span></div></td>
				<td bgcolor="#F3F3F3"><input type="text" name="lpovalidity" id="lpovalidity" value="<?php echo $lpovalidity; ?>" readonly></td></tr>
				<tr>  <td width="48%" align="left" valign="center"  
				bgcolor="#F3F3F3" class="bodytext31"><div align="right"><span class="bodytext311"><strong>Reason for Expenditure</strong></span></div></td>
				<td bgcolor="#F3F3F3"><input type="text" name="expenditure" id="expenditure" value="<?php echo $expenditure; ?>" readonly></td></tr>
				<tr>  <td width="48%" align="left" valign="center"  
				bgcolor="#F3F3F3" class="bodytext31"><div align="right"><span class="bodytext311"><strong>VAT @16%</strong></span></div></td>
				<td bgcolor="#F3F3F3"><input type="text" name="vatpercent" id="vatpercent" value="<?php echo $vatpercent; ?>" readonly></td></tr>
				<td width="48%" align="left" valign="center"  
				bgcolor="#F3F3F3" class="bodytext31"><div align="right"><span class="bodytext311"><strong>Address</strong></span></div></td>
				<td bgcolor="#F3F3F3"> <textarea rows="2" cols="22" name="address" id="address" readonly><?php echo $address; ?></textarea></td>
				<tr>
				<td width="48%" align="left" valign="center"  
				bgcolor="#F3F3F3" class="bodytext31"><div align="right"><span class="bodytext311"><strong>Authorised By</strong></span></div></td>
				<td bgcolor="#F3F3F3"> <input name="authorisedby" id="authorisedby" style="text-align:left;" readonly value="<?php echo $authorisedby; ?>" size="" /></td></tr>-->
              </table>
	  </td>
	  </tr>
      <tr>
	 ...
	 <td width="66" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">User Name</td>
	   <td width="111" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"> <input type="text" name="username" value="<?php echo $username; ?>" size="10"></td>
	    <td width="47" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">Discard</td>
	   <td width="60" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"> <input type="checkbox" id="discard" name="discard"   onClick="discardchk(this)" value="<?php echo $docno; ?>"> </td>
