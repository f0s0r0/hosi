...
else
{
	...
	mysql_query("update master_visitentry set consultationrefundapproval='approved', consultrefundapprovedby = '$username' where visitcode='$visitcode'");
	
	
		header("location:consultationrefundlistapproval.php");
		exit;
...
function achk()
{
	var cc = document.getElementById("appchk").checked;
	if(cc == false)
	{
		alert("Please click Approve");
		return false;
	}
}
</script>
...
<form name="form1" id="frmsales" method="post" action="consultationrefund1approved.php" onKeyDown="return disableEnterKey(event)" onsubmit="return achk();">
...
-->
 ...
 <?php 
		...
		<table width="99%" border="0" 
            ...
            <tbody id="foo">
		<tr>
		<td align="center" class="bodytext31"><input type="checkbox" name="appchk" id="appchk" value="1">Approve</td>
		</tr>
              ...
              <tr>
                ...
                bgcolor="#CCCCCC" class="bodytext31"><div align="right"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
				  ...
				  <input name="Submit2223" type="submit" value="Submit" accesskey="b" class="button"/>
