...
$stringbuild1 = "";
$query1 = "select * from master_accountname where accountssub IN ('17','21','22','26') and recordstatus <> 'Deleted' and is_subtype = '1' order by accountname";
...
$filefolder = 'js';
$filename = 'autocomplete_accounts.'.'js';
