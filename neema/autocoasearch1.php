...
$query2 = "select * from master_accountname where accountsmain = '4' and accountssub <> '4' and accountname like '%$coasearch%' and recordstatus <> 'deleted' order by accountname";
