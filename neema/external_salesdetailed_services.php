...
<tr>
 ...
 <tr>
	<td colspan="8" bgcolor="#fff"  class="bodytext31" > <strong> <?= $scategory ?></strong></td>
</tr>	
...
<tr>
  ...
  $newamount=0;
		  ...
		  $querypaynow="select servicesitemrate as amount,patientcode,patientvisitcode,patientname,billdate,servicesitemname from  billing_externalservices where billdate between '$ADate1' and '$ADate2' and locationcode='$locationcode1' ";
  ...
  <tr <?php echo $colorcode; ?> class="bodytext31">
    ...
    <td width="139"><?php echo $servicesitemname; ?></td>
