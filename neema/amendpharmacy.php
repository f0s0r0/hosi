...
$query34 = "update master_consultationpharm set days='$adays',dose='$adose',quantity='$aquantity',route='$aroute',amount='$aamount',frequencyauto_number='$frequencyautonumber',frequencycode='$frequencycode',frequencynumber='$afrequency',instructions='$ainstructions' where patientcode='$patientcode' and patientvisitcode='$visitcode' and medicinecode='$aitemcode'";
...
$exec35 = mysql_query($query35) or die(mysql_error()); 
		...
		{	
			...
			if ($medicinename != "")// && $dose != "" && $frequency != "" && $days != "" && $quantity != "" && $instructions != "" && $rate != "" && $amount != "")
			{
				...
				values('$consultationid','$patientcode','$patientauto_number','$patientname','$patientvisit','$visitcode','$medicinename','$dose','$frequencyautonumber','$frequencycode','$frequencynumber','$days','$quantity','$instructions','$rate','$amount','completed','$consultationdate','$ipaddress','$consultingdoctor','$billtype','$accountname','pending','$medicinecode','$medrefnonumber','$status','pending','doctorconsultation','$route','$locationcode','$username')";
				$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
		...
		header("location:amend_pending_pharmacy.php");
		exit;
...
mysql_query("delete from master_consultationpharm where medicinecode='$medicinename' and patientvisitcode='$viscode'");
mysql_query("delete from master_consultationpharmissue where medicinecode='$medicinename' and patientvisitcode='$viscode'");
...
<form name="form1" id="frmsales" method="post" action="amendpharmacy.php" onKeyDown="return disableEnterKey(event)" onSubmit="return validcheck()">
...
-->
  <tr>
	...
	$status='completed';
			...
			$query17 = "select * from master_consultationpharm where patientvisitcode='$visitcode' and patientcode='$patientcode' and pharmacybill='$status' and medicineissue='pending'";
			...
			<select name="aroute[]" id="aroute">
			  <?php
				...
				?>
				 ...
				 <td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" onFocus="return autochangeins(<?= $sno;?>)" name="ainstructions[]" id="ainstructions<?php echo $sno; ?>" value="<?php echo $instructions; ?>" size="15"></div></td>
				 ...
				 <td class="bodytext31" valign="center"  align="left"><div align="center"><a onClick="return deletevalid()" href="amendpharmacy.php?delete=<?php echo $pharmitemcode; ?>&&patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>">Delete</a></div></td>
 ...
 <td class="bodytext31" valign="center"  align="left" 
     ...
     <tr id="pressid">
				...
				?>
				    ...
				    <tr>
				   <td colspan="8" align="right" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><span class="style2">Total</span><input type="text" id="total" readonly size="7" value="<?php echo number_format($totalamount,2,'.',''); ?>"></td>
			      </tr>
