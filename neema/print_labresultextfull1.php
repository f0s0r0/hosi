...
if($itemcode==""){
 $query341 = "select * from consultation_lab where billnumber = '$billnumber' and resultentry = 'completed' and consultationdate between '$fromdate' and '$todate' order by auto_number";
}else{
 $query341 = "select * from consultation_lab where billnumber = '$billnumber' and resultentry = 'completed' and consultationdate between '$fromdate' and '$todate' and labitemcode='$itemcode'   order by auto_number";
}
...
$query612 = "select * from consultation_lab where billnumber = '$billnumber' and labitemcode = '$labitemcode34' order by auto_number desc";
...
$query613 = "select * from resultentry_lab where patientname = '$patientname' and patientvisitcode = 'walkinvis' order by auto_number desc";
$exec613 = mysql_query($query613) or die(mysql_error());
$res613 = mysql_fetch_array($exec613);
$docno = $res613['docnumber'];


$query123 = "select * from samplecollection_lab where patientcode = 'walkin' and patientname = '$patientname' order by auto_number desc";
...
?>
	...
	<tr>
	 <td width="430" align="center" class="bodytext23" style="font-size:13px"><?php
			...
			$labemobile="Lab Mobile: ".$phonenumber1;
			$website="Website :";
  ...
  <table cellspacing="4" cellpadding="2" style="border-top:solid 1px #000000;border-bottom:solid 1px #000000;">
   <tr>
	...
	<td width="230" align="left" valign="top" class="bodytext27"><?php echo $patientname; ?>&nbsp;<?php if($patientcode !='') { echo '('.$patientcode.')' ; } ?></td>
	...
	<td width="130" align="left" valign="top" class="bodytext27"><?php echo date('Y-M-d g:i:A',strtotime($samplecollectedon)); ?></td>
   </tr>
   <tr>
	<td width="35" align="left" valign="top" class="bodytext27"><strong>Age</strong></td>
	<td width="230" align="left" valign="top" class="bodytext27"><?php echo $dob1; ?></td>
	...
	<td width="130" align="left" valign="top" class="bodytext27"><?php echo date('Y-M-d',strtotime($res123recorddate)).' '.date('g:i:A',strtotime($res123recordtime)); ?></td>
	</tr>
	<tr>
	...
	<td width="165" align="left" valign="top" class="bodytext27"><?php if($accountname != ''){ echo $accountname; }else{ echo 'SELF'; } ?></td>	
	<td width="80" align="left" valign="top" class="bodytext27"><strong>Reported On</strong></td>
	<td width="130" align="left" valign="top" class="bodytext27"><?php echo date('Y-M-d g:i:A',strtotime($res38publisheddatetime)); ?></td>
  </tr>
  <tr>
	<?php if($accountcode != '') { ?>
...
<table border="0" cellspacing="0" cellpadding="2">
	...
	<?php
	$labpending = '';
	$query68 = "select * from consultation_lab where billnumber = '$billnumber' and patientcode = 'walkin' and patientvisitcode = 'walkinvis' and resultentry <> 'completed' order by labitemname";
	...
	<tr>
	 <td colspan="5" align="center" valign="top" style="font-size:16px; text-decoration:underline;"><strong>Laboratory Report</strong> </td>
	</tr>
	<tr>
	 <td width="278" align="left" valign="top" class="bodytext27">&nbsp;</td>
	 <td width="146"  align="left" valign="top" class="bodytext27">&nbsp;</td>
	 ...
	 <td width="71" align="left" valign="top" class="bodytext27">&nbsp;</td>
	</tr>
	<tr>
	 <td width="278" align="left" valign="top" class="bodytext27"><strong>TESTS</strong></td>
	 <td width="146"  align="left" valign="top" class="bodytext27"><strong>RESULTS</strong></td>
	 <td width="51"  align="left" valign="top" class="bodytext27"><strong>UNIT</strong></td>
	 <td width="0"  align="left" valign="top" class="bodytext27"><strong></strong></td>
	 <td width="170" align="left" valign="top" class="bodytext27"><strong>REFERANCE RANGE</strong></td>
	 <td width="71" align="left" valign="top" class="bodytext27"><strong></strong></td>
	</tr>
	<?php
	$pagecount='';
	$itemnumbers=0;
	...
	$query616 = "select * from consultation_lab where billnumber = '$billnumber' and patientcode = 'walkin' and patientvisitcode = 'walkinvis' and labitemcode = '$labitemcode34' and consultationdate between '$fromdate' and '$todate'  order by auto_number desc";
	...
	?>
	<tr>
		<td colspan="6" align="left" valign="top" class="bodytext31"><strong><?php echo $res616itemname; ?></strong></td>
	</tr>
	<tr>
	...
	<?php
	 $query38="select * from master_labreference where itemcode = '$res616itemcode' and status <> 'deleted' group by referencename ";
  ...
  $referencename1=$res38['referencename'];
 	 ...
 	 $query32="select * from resultentry_lab where patientname = '$patientname' and patientcode = 'walkin' and patientvisitcode = 'walkinvis' and referencename = '$referencename1' and itemcode = '$res616itemcode'  order by auto_number ";
	...
	$referencerange=$res38['referencerange'];
	$referenceunit=$res38['referenceunit'];
	//$referenceunit='';
