...
$stringbuild1 = "";
$query1 = "select * from assetpurchase_details";
$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
while ($res1 = mysql_fetch_array($exec1))
{
	$res1autonumber = $res1['auto_number'];
	$res1itemcode=$res1['assetcode'];
	...
	if ($stringbuild1 == '')
	{
		$stringbuild1 = '"'.$res1itemcode.'||'.$res1autonumber.'||'.$res1itemname.'"';
	}
	else
	{
		$stringbuild1 = $stringbuild1.',"'.$res1itemcode.'||'.$res1autonumber.'||'.$res1itemname.'"';
	}
}
//echo $stringbuild1;
...
$filefolder = 'js';
$filename = 'autocomplete_depreciation.'.'js';
