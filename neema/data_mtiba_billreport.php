...
if (isset($_REQUEST["res"])) { $errorcode = $_REQUEST["res"]; } else { $errorcode = ""; }
...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
    ...
    <tr>
        <td width="860">
		<form name="cbform1" method="post" action="data_mtiba_billreport.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
			<tbody>
            <tr bgcolor="#011E6A">
				<td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Mtiba Bills Report</strong></td>
			...
			<tr>
                ...
                <td width="30%" align="left" valign="center"  bgcolor="#FFFFFF" class="bodytext31">
					<input name="ADate1" id="ADate1" value="<?php echo $paymentreceiveddatefrom; ?>"  size="10"  readonly="readonly" onKeyDown="return disableEnterKey()" />
			...
			<tr>
				<td align="left" valign="center" width="10%" align="left" valign="middle" bgcolor="#FFFFFF" class="bodytext3">Location</td>
				<td width="30%" align="left" valign="top"  bgcolor="#FFFFFF">
					<span class="bodytext3">
						<select name="location" id="location" onChange="ajaxlocationfunction1(this.value)">
						<?php
						
						$query1 = "select * from login_locationdetails where username='$username' and docno='$docno' Group By locationcode order by locationname ";
						$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
						$loccode=array();
	...
	<tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" bordercolor="#666666" cellspacing="0" cellpadding="4" width="800" align="left" border="0">
            ...
            <tr>
				...
				bgcolor="<?php if ($errmsg == 'success'){ echo 'green'; }elseif ($errmsg =='failed') { echo 'red'; }else{ echo ''; } ?>" class="bodytext31"><p style="color:white;"> <?php echo $errmsg;?>&nbsp;</p></td>
            </tr>			
            <tr>
              <td colspan="8" bgcolor="#cccccc" class="bodytext31">&nbsp;</td>  
            </tr>
            <tr>
				<td width="5%"class="bodytext31" valign="middle"  align="center" 
			...
			$query4 = "select * from billing_paylater where locationcode='$locationcode1' and sync_status='0' and visitcode IN (SELECT visitcode FROM `master_visitentry` WHERE transactionId <> '') and billdate between '$ADate1' and '$ADate2'"; 
			...
			<tr <?php echo $colorcode; ?>>
				<td class="bodytext31" valign="middle"  align="center"><?php echo $snocount; ?></td>
				<td class="bodytext31" valign="middle"  align="center"><div><?php echo $date; ?></div></td>
				<td class="bodytext31" valign="middle"  align="left"><div class="bodytext31"><?php echo $patientname; ?></div> </td>
				<td class="bodytext31" valign="middle"  align="left"><?php echo $patientcode; ?></td>
				...
				<td class="bodytext31" valign="middle"  align="left"><?php echo $billnumber; ?></td>
             	<td  align="left" valign="middle" class="bodytext31"><div align="right"><?php echo number_format($amount,2,'.',','); ?></div></td>
				<td class="bodytext31" valign="middle"  align="center">
					<a href="billing_paylater_mtiba_sync.php?billautonumber=<?php echo $billnumber; ?>&&visitcode=<?php echo $visitcode; ?>&&st=bill"> Update
					</a>
				</td>
            </tr>
			<?php
            ...
            <tr>
				...
				<td class="bodytext31" valign="middle"  align="left" 
                bgcolor="#cccccc">&nbsp;</td>
				<td class="bodytext31" valign="middle"  align="right" 
