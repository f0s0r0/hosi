...
while ($res2 = mysql_fetch_array($exec2))
{
  ...
  $customername = $res2["customername"];
	...
	$query66 = "select * from master_consultationtype where subtype = '$subtype' and department = '1' and recordstatus = ''";
