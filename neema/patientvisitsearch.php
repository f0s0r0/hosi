    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="patientvisitsearch.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Edit Visit Details </strong></td>
          ...
          <tr>
              ...
              <td><select name="location" id="location" onChange="ajaxlocationfunction(this.value);" style="border: 1px solid #001E6A;">
                  <?php
				 ...
				 <td colspan="15"  bgcolor="#CCCCCC" class="bodytext31">
				      <?php //error_reporting(0);
							...
							*/
							...
							$query111 = "select * from master_visitentry where patientfullname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and locationcode like '%$reslocationanumm%' and consultationdate between '$fromdate' and '$todate'order by auto_number desc";
            ...
            $query2 = "select * from master_visitentry where patientfullname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and locationcode like '%$reslocationanumm%' and consultationdate between '$fromdate' and '$todate'order by auto_number desc LIMIT $start , $limit";
			 ...
			 // echo $num2;
              ...
              <tr <?php echo $colorcode; ?>>
				...
				<div align="center"><strong><a target="_blank" href="patientstatusreport.php?locationcode1=<?php echo $locationcode; ?>&&visitcode=<?php echo $res2visitcode; ?>&&cbfrmflag1=cbfrmflag1">View</a></strong></div></td>
