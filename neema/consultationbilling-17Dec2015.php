...
else
{
	...
	$query22 = "insert into billing_consultation(billdate,patientcode,patientname,patientvisitcode,consultation,consultationcoa,copay,copaycoa,accountname,billnumber,ipaddress,username,billtype,locationname,locationcode)values('$consultationdate','$patientcode','$patientname','$visitcode','$patientbillamount','$consultationcoa','$copay','$copaycoa','$accountname','$billnumbercode','$ipaddress','$username','$patientbilltype','$locationname','$locationcode')";
