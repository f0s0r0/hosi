          ...
          <tbody>
            <tr>
              ...
              <td colspan="6" bgcolor="#cccccc" class="bodytext31"><script language="javascript">
                ...
                <div align="left"><strong>Service Billing</strong></div></td>
              </tr>
           ...
           <tr>
			...
			$colorloopcount = '';
			$sno = '';
			$query1 = "select * from consultation_services where billtype='PAY NOW' and paymentstatus='pending' group by patientvisitcode order by consultationdate desc";
		   ...
		   $patientaccountname=$res1['accountname'];
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left"><a href="billing_opnew3.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>"><strong>BillNow</strong></a>			  </td>
              </tr>
			<?php
			}    
			?>
