    ...
    <td valign="top"><table width="93%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#E0E0E0" id="AutoNumber3" style="border-collapse: collapse">
      <tbody>
        ...
        <tr bgcolor="#E0E0E0">
          ...
          <td width="14%" bgcolor="#E0E0E0" class="bodytext3" valign="middle"><input type="text" name="criteria" id="criteria" readonly value="<?php echo $criteria ?>" size="20"></td>
          <td width="6%" align="left" valign="middle" class="bodytext3"><strong>Age</strong></td>
          <td width="8%" align="left" valign="middle" class="bodytext3"><input type="text" name="age" id="age" readonly value="<?php echo $age ?>" size="5"></td>
          <td width="5%" align="left" valign="middle" class="bodytext3"><strong>Sex</strong></td>
          <td width="10%" align="left" valign="middle" class="bodytext3"><select name="sex" id="sex" value=""  readonly tabindex="12" autocomplete="off">
              <?php 
        ...
        <tr>
          ...
          <td colspan="4" bgcolor="#E0E0E0" class="bodytext3"><input type="text" name="reffrom" id="reffrom" readonly value="<?php echo $reffrom ?>" size="20"></td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<table width="848" height="182" border="0" align="left" cellpadding="4" cellspacing="0" id="AutoNumber3" style="border-collapse: collapse">
			 <tbody>
			   <tr>
			   <td height="20" colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong>Date&nbsp;</strong><input name="feeddate" readonly id="feeddate" style="border: 1px solid #001E6A" value="<?php if($feeddate==''){ echo $transactiondatefrom;}else{ echo $feeddate; } ?>" size="6"  readonly="readonly" onKeyDown="return disableEnterKey()" />
		  <img src="images2/cal.gif" onClick="javascript:NewCssCal('feeddate')" style="cursor:pointer"/></td>
			   ...
			   <tr>
			     ...
			     <td width="38%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><input type="text" readonly name="height" id="height" value="<?php echo $height ?>" size="5" onKeyPress="return isNumberDecimal(event);"></td>
			   ...
			   <tr>
			     ...
			     <td colspan="2" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><input type="text" readonly name="weight" id="weight" value="<?php echo $weight ?>" size="5" onKeyPress="return isNumberDecimal(event);" onKeyUp="taken();"></td>
			     </tr>
			   <tr>
			     ...
			     <td colspan="2" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><input type="text" readonly name="whz" id="whz" value="<?php echo $whz ?>" size="5"></td>
			     </tr>
			   <tr>
			     <td height="30" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">&nbsp;</td>
			     <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">MUAC(cm)</td>
			     <td colspan="2" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><input type="text" readonly name="muac" id="muac" value="<?php echo $muac ?>" size="5" onKeyPress="return isNumberDecimal(event);"></td>
			     </tr>
			   <tr>
			     <td height="30" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">&nbsp;</td>
			     <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">Oedema(+,++,+++)</td>
			     <td colspan="2" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><input type="text" readonly name="oedema" id="oedema" value="<?php echo $oedema ?>" size="5" onKeyPress="return isNumberDecimal(event);"></td>
			     </tr>
			</tbody>
			</table>
			</td>
