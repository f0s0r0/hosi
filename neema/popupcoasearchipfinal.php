...
<script type="text/javascript" src="js/autocoasearch.js"></script>
...
function escapekeypressed(e)
{
	...
	if(key == '13') //up arrow key press
	{
		...
		if (!isNaN(varActiveElementNumber)) //to prevent losing focus to submit2.
		{
			...
			//alert (varCustomerNameCatch);
			window.opener.document.getElementById("bedchargesipfinalcoa").value = varCoaCatch;
			window.opener.document.getElementById("bedchargesipfinaltype").value = varTypeCatch;
			window.opener.document.getElementById("bedchargesipfinalcode").value = varIdCatch;
				window.opener.document.getElementById("bedchargesipfinalcoa").focus();
				<?php
			}
			else if ($callfrom == '7')
			{
			...
			//alert (varCustomerNameCatch);
			window.opener.document.getElementById("rmoipfinalcoa").value = varCoaCatch;
			window.opener.document.getElementById("rmoipfinaltype").value = varTypeCatch;
			window.opener.document.getElementById("rmoipfinalcode").value = varIdCatch;
				window.opener.document.getElementById("rmoipfinalcoa").focus();
				<?php
			}
			else if ($callfrom == '8')
			{
			...
			//alert (varCustomerNameCatch);
			window.opener.document.getElementById("nursingipfinalcoa").value = varCoaCatch;
			window.opener.document.getElementById("nursingipfinaltype").value = varTypeCatch;
			window.opener.document.getElementById("nursingipfinalcode").value = varIdCatch;
			...
			//alert (varCustomerNameCatch);
			window.opener.document.getElementById("privatedoctoripfinalcoa").value = varCoaCatch;
			window.opener.document.getElementById("privatedoctoripfinaltype").value = varTypeCatch;
			window.opener.document.getElementById("privatedoctoripfinalcode").value = varIdCatch;
				window.opener.document.getElementById("privatedoctoripfinalcoa").focus();
				<?php
			}
			else if ($callfrom == '10')
			{
			...
			//alert (varCustomerNameCatch);
			window.opener.document.getElementById("ambulanceipfinalcoa").value = varCoaCatch;
			window.opener.document.getElementById("ambulanceipfinaltype").value = varTypeCatch;
			window.opener.document.getElementById("ambulanceipfinalcode").value = varIdCatch;
				window.opener.document.getElementById("ambulanceipfinalcoa").focus();
				<?php
			}
			else if ($callfrom == '11')
			{
			...
			//alert (varCustomerNameCatch);
			window.opener.document.getElementById("nhifipfinalcoa").value = varCoaCatch;
			window.opener.document.getElementById("nhifipfinaltype").value = varTypeCatch;
			window.opener.document.getElementById("nhifipfinalcode").value = varIdCatch;
				window.opener.document.getElementById("nhifipfinalcoa").focus();
				<?php
			}
			else if ($callfrom == '12')
			{
			...
			//alert (varCustomerNameCatch);
			window.opener.document.getElementById("otbillingipfinalcoa").value = varCoaCatch;
			window.opener.document.getElementById("otbillingipfinaltype").value = varTypeCatch;
			window.opener.document.getElementById("otbillingipfinalcode").value = varIdCatch;
				window.opener.document.getElementById("otbillingipfinalcoa").focus();
				<?php
			}
			else if ($callfrom == '13')
			{
			...
			//alert (varCustomerNameCatch);
			window.opener.document.getElementById("miscbillingipfinalcoa").value = varCoaCatch;
			window.opener.document.getElementById("miscbillingipfinaltype").value = varTypeCatch;
			window.opener.document.getElementById("miscbillingipfinalcode").value = varIdCatch;
				window.opener.document.getElementById("miscbillingipfinalcoa").focus();
				<?php
			}
			else if ($callfrom == '14')
			{
			...
			//alert (varCustomerNameCatch);
			window.opener.document.getElementById("admissionchargeipfinalcoa").value = varCoaCatch;
			window.opener.document.getElementById("admissionchargeipfinaltype").value = varTypeCatch;
			window.opener.document.getElementById("admissionchargeipfinalcode").value = varIdCatch;
				window.opener.document.getElementById("admissionchargeipfinalcoa").focus();
				<?php
			}
			else if ($callfrom == '15')
			{
			...
			//alert (varCustomerNameCatch);
			window.opener.document.getElementById("ipdepositscoa").value = varCoaCatch;
			window.opener.document.getElementById("ipdepositstype").value = varTypeCatch;
			window.opener.document.getElementById("ipdepositscode").value = varIdCatch;
				window.opener.document.getElementById("ipdepositscoa").focus();
				<?php
			}
			else if ($callfrom == '21')
			{
			...
			//alert (varCustomerNameCatch);
			window.opener.document.getElementById("ippackagecoa").value = varCoaCatch;
			window.opener.document.getElementById("ippackagetype").value = varTypeCatch;
			window.opener.document.getElementById("ippackagecode").value = varIdCatch;
				window.opener.document.getElementById("ippackagecoa").focus();
				<?php
			}
			?>
