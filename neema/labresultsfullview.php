	  ...
	  $query11="select * from resultentry_lab where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and recorddate between '$fromdate' and '$todate' and  resultstatus='completed' and publishstatus = 'completed' group by itemcode ";
		...
		$condate=$res1212['consultationdate'];
		   ...
		   ?>
		    ...
		    <?php
		$query22 = "select * from ipresultentry_lab where patientname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and recorddate between '$fromdate' and '$todate' group by patientvisitcode,docnumber order by auto_number desc ";
