	...
	*/
	...
	for ($i=1;$i<=1000;$i++)
	{
		...
		if ($serialnumber != '')
		{
			...
			discountamount, username, ipaddress, entrydate, itemtaxpercentage, itemtaxamount, unit_abbreviation, billdate,recordstatus) 
			...
			'$itemtaxpercent', '$itemtaxamount', '$itemunitabb', '$billdate','Manual')";
