...
$stringbuild1 = "";
 $query1 = "select * from master_doctor where doctorname like '%$searchsuppliername1%' and ipdoctor = '0' and status <> 'Deleted' AND locationcode='".$locationcode."' order by doctorname limit 0,10";
