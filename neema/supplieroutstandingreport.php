    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="supplieroutstandingreport.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong>Supplier Outstanding</strong></td>
              </tr>
            <!--<tr>
		 ...
		 //echo $totalamount30;
		  ...
		  $totalamountgreater = $totalamountgreater - $res112subtotal;
		   ...
		   ?>
			  <?php
		   // Onaccount 
		    $query145on = "select * from master_transactionpharmacy where suppliercode = '$arraysuppliercode' and transactiondate between '$ADate1' and '$ADate2' and transactionmodule = 'PAYMENT' and transactionstatus = 'onaccount' order by transactiondate desc";
		  $exec145on = mysql_query($query145on) or die ("Error in Query145on".mysql_error());
		  //echo $num = mysql_num_rows($exec3);
		  while ($res145on = mysql_fetch_array($exec145on))
		  {
		  ...
		  $exec146on = mysql_query($query146on) or die ("Error in Query146on".mysql_error());
		  //echo $num = mysql_num_rows($exec3);
		  while ($res146on = mysql_fetch_array($exec146on))
		  {
