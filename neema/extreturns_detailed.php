...
<tr>
  ...
  $execvisit = mysql_query($queryvisit) or die(mysql_error());
   while($resvisit = mysql_fetch_array($execvisit))
    ...
    $querypay=  "select patientcode,patientvisitcode,patientname,billdate,sum(amount) as amount from refund_paynowpharmacy where locationcode='$locationcode1' and billdate between '$ADate1' and '$ADate2'and patientvisitcode='$newpatientvisitcode'";
