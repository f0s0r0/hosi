			  ...
			  $num=mysql_num_rows($exec52);
			   ...
			   $labname2=$res52['itemname'];
				...
				$labitemanum = $res52['auto_number'];
				 ...
				 if($labreferencename != '')
				 {
				  $query87 = "select * from pending_test_orders where patientcode = '$patientcode' and visitcode = '$visitcode' and sample_id='$docnumber' and parametername = '$labreferencename'";
				...
				//echo $labreferencerange1[0];
				 ...
				 $pastresult = $res49['resultvalue'];
				  ...
				  <textarea readonly name="result[]" id="result<?php echo $sn; ?>" ><?php echo $resultvalue;?></textarea></div></td>
