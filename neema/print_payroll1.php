...
<?php include('a4pdfheader.php'); ?>
	...
	<tr>
	<td width="370" align="left" valign="top" nowrap="nowrap" style="border-right:dotted 1px #000000;">
	
	<table width="320" border="0" align="left" cellspacing="0" cellpadding="2"> 
        <tr>
		  <td width="70" rowspan="6" align="left" valign="top" nowrap="nowrap" class="bodytext27"><img src="logofiles/<?php echo $companyanum; ?>.jpg" height="60" width="50" /></td>
		...
		<table width="320" border="0" cellspacing="0" align="left" cellpadding="2"> 
		<tr>
          <td width="160" align="left" valign="middle" nowrap="nowrap" class="bodytext27"><strong>EARNINGS</strong></td>
		  <td width="160" align="right" valign="middle" nowrap="nowrap" class="bodytext27"><strong>AMOUNT</strong>&nbsp;&nbsp;</td>
        </tr>
		<?php
		$totalearnings = '0.00';
		$totaldeductions = '0.00';
		...
		while($res6 = mysql_fetch_array($exec6))
		{
			...
			$query3 = "select `$auto_number` as componentamount from details_employeepayroll where employeecode = '$employeesplit[$i]' and paymonth = '$assignmonth' and status <> 'deleted'  order by auto_number";
			$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
			$res3 = mysql_fetch_array($exec3);
		...
		while($res8 = mysql_fetch_array($exec8))
		{
			...
			$query7 = "select `$auto_number` as componentamount from details_employeepayroll where employeecode = '$employeesplit[$i]' and paymonth = '$assignmonth' and status <> 'deleted'  order by auto_number";
		...
		$query81 = "select `$auto_number` as componentamount from details_employeepayroll where employeecode = '$employeesplit[$i]' and paymonth = '$assignmonth' and status <> 'deleted' ";
		...
		while($res5 = mysql_fetch_array($exec5))
		{
			...
			$query79 = "select `$anum` as componentamount from details_employeepayroll where employeecode = '$employeesplit[$i]' and paymonth = '$assignmonth' and status <> 'deleted'  order by auto_number";
		...
		$query52 = "select `8` as componentamount from details_employeepayroll where employeecode = '$employeesplit[$i]' and paymonth = '$assignmonth' and status <> 'deleted' ";
		...
		while($res4 = mysql_fetch_array($exec4))
		{
			...
			$query41 = "select `$res4componentanum` as componentamount from details_employeepayroll where employeecode = '$employeesplit[$i]' and paymonth = '$assignmonth' and status <> 'deleted'  order by auto_number";
	...
	//$i++;
	?>
	<td width="370" align="left" valign="top" nowrap="nowrap">
	<?php
	$query2 = "select * from master_employee where employeecode = '$employeesplit[$i]' ";
	$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
	$res2 = mysql_fetch_array($exec2);
