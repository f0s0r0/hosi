...
if($labname != "")
 ...
 $query26="insert into ipsamplecollection_lab(patientname,patientcode,patientvisitcode,recorddate,recordtime,itemcode,itemname,sample,acknowledge,refund,docnumber)values('$patientname','$patientcode',
...
<form name="frmsales" id="frmsales" method="post" action="iplabsamplecollection.php" onKeyDown="return disableEnterKey(event)">
