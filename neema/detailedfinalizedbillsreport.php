...
//include ("autocompletebuild_account12.php");
...
<script type="text/javascript" src="js/autocomplete_accounts21.js"></script>
<script type="text/javascript" src="js/autosuggest4accounts12.js"></script>
    ...
    <td width="97%" valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>OP Finalized Bills Summary</strong></td>
            ...
            <tr>
              ...
              <td width="82%" colspan="3" align="left" valign="top"  bgcolor="#FFFFFF"><span class="bodytext3">
               ...
               <input name="searchmedicinename1hiddentextbox" type="hidden" id="searchmedicinename1hiddentextbox" value="" size="50" autocomplete="off">
       ...
       <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			$query21 = "select * from billing_paylater where locationcode='$locationcode1' and accountname like '%$searchsuppliername%' and billdate between '$ADate1' and '$ADate2' group by accountname order by accountname desc  ";
		  ...
		  $query2 = "select * from billing_paylater where patientname like '%$patientname%' and patientcode like '%$patientcode%' and visitcode like '%$visitcode%' and locationcode='$locationcode1' and accountname = '$res21accountname' and billdate between '$ADate1' and '$ADate2' order by accountname desc "; 
		  $exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
		  ...
		  $query10 = "select * from master_accountname where locationcode='$locationcode1' and accountname = '$res2accountname'";
		  $exec10 = mysql_query($query10) or die ("Error in Query10".mysql_error());
		  $res10 = mysql_fetch_array($exec10);
		  $res10paymenttype = $res10['paymenttype'];
		  
		  $query11 = "select * from master_paymenttype where locationcode='$locationcode1' and auto_number = '$res10paymenttype'";
		  $exec11 = mysql_query($query11) or die ("Error in Query11".mysql_error());
		  $res11 = mysql_fetch_array($exec11);
		  $res11paymenttype = $res11['paymenttype'];
		  
		  $query3 = "select * from master_customer where locationcode='$locationcode1' and customercode = '$res2patientcode'";
		  $exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
		  $res3 = mysql_fetch_array($exec3);
		  $res3planname = $res3['planname'];
		  
		  $query4 = "select * from master_planname where locationcode='$locationcode1' and auto_number = '$res3planname'";
		  $exec4 = mysql_query($query4) or die ("Error in Query4".mysql_error());
		  $res4 = mysql_fetch_array($exec4);
		  ...
		  $query6 = "select * from billing_paylaterservices where locationcode='$locationcode1' and billnumber = '$res2billno'";
