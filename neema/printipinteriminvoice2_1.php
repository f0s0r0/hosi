...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<table width="100%" align="center" border="0" cellspacing="4" cellpadding="2">
			...
			<tr>
				...
				<td width="50"  align="center" valign="top"	bgcolor="#ffffff" class="bodytext31"><strong>Qty</strong></td>
			...
			if($packageanum1 != 0)
	{
	 ...
	 $reqdate = date('Y-m-d',strtotime($packagedate1) + (24*3600*$reqquantity));
		...
		<tr>  
			...
			<td class="bodytext31" align="right"><strong><?php echo number_format($overalltotal+$totalcopay,2,'.',','); ?></strong></td>
		</tr>
		<?php
		if($totalcopay > 0) { ?>
		<tr>  
			<td colspan="6" class="bodytext31" align="right"><strong>Copay :</strong></td>
			<td class="bodytext31" align="right"><strong><?php echo number_format($totalcopay,2,'.',','); ?></strong></td>
		</tr>
	  <?php } ?>
			<tr>
