...
function ledgervalue($parentid,$ADate1,$ADate2,$tbinclude)
{
	...
	{
		//if($tbinclude == 'tb_accountbank.php' || $tbinclude == 'tb_accountar.php' || $tbinclude == 'tb_accountincome.php' || $tbinclude == 'tb_accountdeposit.php' 
		//|| $tbinclude == 'tb_accountinv.php' || $tbinclude == 'tb_accountap.php' || $tbinclude == 'tb_accountassets.php' || $tbinclude == 'tb_accountexpense.php' 
		//|| $tbinclude == 'tb_accountcgs.php' || $tbinclude == 'tb_accountincome1.php')
		//{
			include($tbinclude);
			return $sumbalance;
		//}
