...
<table width="101%" align="left" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
   ...
   <td width="1%" align="left" valign="top">&nbsp;</td>
	...
	<tr bgcolor="#FFFFFF">
	<td colspan="7" align="left" class="bodytext3"><strong>EMPLOYER'S CODE : <?php eval(base64_decode('IGVjaG8gJGNvbXBhbnljb2RlOyA=')); ?></strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	<td colspan="7" align="left" class="bodytext3"><strong>EMPLOYER'S NAME : <?php eval(base64_decode('IGVjaG8gJGNvbXBhbnluYW1lOyA=')); ?></strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	...
	<tr>
	<td width="35" align="center" bgcolor="#CCCCCC" class="bodytext3"><strong>S.No</strong></td>
	<td width="85" align="left" bgcolor="#CCCCCC" class="bodytext3"><strong>PAYROLL NO</strong></td>
	<td width="276" align="left" bgcolor="#CCCCCC" class="bodytext3"><strong>EMPLOYEE NAME</strong></td>
	<td width="84" align="left" bgcolor="#CCCCCC" class="bodytext3"><strong>ID NO</strong></td>
	<td width="49" align="left" bgcolor="#CCCCCC" class="bodytext3"><strong>NHIF NO</strong></td>
	<td align="right" bgcolor="#CCCCCC" class="bodytext3" width="73"><strong>AMOUNT</strong></td>
	<td align="left" bgcolor="#CCCCCC" class="bodytext3" width="42">&nbsp;</td>
	</tr>
	<?php 
	$totalamount = '0.00';
	...
	<td align="left" class="bodytext3"><?php eval(base64_decode('IGVjaG8gJG5oaWY7IA==')); ?></td>
	<?php 
	...
	$totalamount = $totalamount + $componentamount;
	 ?>
	<td align="right" class="bodytext3" width="73"><?php eval(base64_decode('IGVjaG8gJGNvbXBvbmVudGFtb3VudDsg')); ?></td>
	<td align="right" class="bodytext3" width="42">&nbsp;</td>	
	<?php 
	}
	}
	 ?>
	...
	<td bgcolor="#CCCCCC" align="right" class="bodytext3"><strong><?php eval(base64_decode('IGVjaG8gbnVtYmVyX2Zvcm1hdCgkdG90YWxhbW91bnQsMiwnLicsJywnKTsg')); ?></strong></td>
	<td align="left" bgcolor="#CCCCCC" class="bodytext3" width="42">&nbsp;</td>
	</tr>
	<tr>
