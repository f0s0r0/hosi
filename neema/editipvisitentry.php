...
if ($patientcode != '')
{
	...
	$exec666 = mysql_query($query666) or die(mysql_error());
	$res666 = mysql_fetch_array($exec666);
	...
	if($visitcount == 1 && $overalllimit > 0)
	{
	$availablelimit=$overalllimit ;
	}
	else if($visitcount == 1 && $visitlimit > 0)
	{
        ...
        <tr>
          <td width="860"><table width="1258" height="282" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              ...
              <tr bgcolor="#011E6A">
                <td bgcolor="#CCCCCC" class="bodytext3" colspan="2"><strong>Edit IP Visit Entry </strong></td>
              ...
              <!--<tr>
				...
				<tr>
				  ...
				  <td align="left" valign="middle"  bgcolor="#E0E0E0"><input type="text" name="accountnamename" id="accountnamename"  value="<?php echo $accountname;?>"  readonly="readonly" size="50">
				...
				<tr>
				  ...
				  <td align="left" valign="middle"  bgcolor="#E0E0E0"><input type="text" name="admissiondoctor" id="admissiondoctor" value="<?php echo $opadmissiondoctor; ?>" ></td>
				  <td align="left" valign="middle"  bgcolor="#E0E0E0"><span class="bodytext32">Admission Doctor </span></td>
				  <td align="left" valign="middle"  bgcolor="#E0E0E0"><strong>
				   <input type="text" name="consultingdoctorsearch" id="consultingdoctorsearch" value="<?php echo $doctor; ?>">
                ...
                <td align="left" valign="middle"  bgcolor="#E0E0E0"><input name="admissionfees" id="admissionfees" value="<?php echo $ipadmissionfee; ?>" onFocus="return funcVisitEntryPatientCodeValidation1()" size="20"></td>
                <td colspan="2" align="left" valign="middle"  bgcolor="#E0E0E0">&nbsp;</td>
				 ...
				 <tr id="pack">
				   ...
				   <?php
						...
						{
						?>
                      <option value="<?php echo $packageanum; ?>" selected="selected"><?php echo $res1packagename; ?></option>
                      <?php
						}
						else
						{
				   ...
				   $query66 = "select * from master_ippackage where locationname = '$reslocationname' and status=''";
				   $exec66 = mysql_query($query66) or die(mysql_error());
				   ...
				   <td align="left" valign="middle"  bgcolor="#E0E0E0"><input name="packcharge" id="packcharge"  size="20" value="<?php echo $packagecharge; ?>" readonly/></td>
				   <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">Apply Admn Fee</td>
				   <td align="left" valign="middle"  bgcolor="#E0E0E0"><input type="checkbox" name="packchargeapply" id="packchargeapply" value="1">
				 ...
				 <tr id="nhif">
				   ...
				   <td align="left" valign="middle"  bgcolor="#E0E0E0"><input type="text" name="nhifid" id="nhifid" value="<?php echo $nhifid; ?>"></td>
				   
				   <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">Issue Date </td>
				   <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><input type="text" name="issuedate" id="issuedate" size="10" value="<?php echo $nhifissuedate; ?>"> <strong><span class="bodytext312"> <img src="images2/cal.gif" onClick="javascript:NewCssCal('issuedate')" style="cursor:pointer"/> </span></strong></td>
				   <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">Valid Till</td>
				   <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><input type="text" name="validtill" id="validtill" size="10" value="<?php echo $nhifvaliddate; ?>"> <strong><span class="bodytext312"> <img src="images2/cal.gif" onClick="javascript:NewCssCal('validtill')" style="cursor:pointer"/> </span></strong></td>
				   <td width="8%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">NHIF Rebate</td>
				   <td width="18%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><input type="text" name="nhifrebate" id="nhifrebate" value="<?php echo $nhifrebaterate; ?>"></td>
				 </tr>
<!--				 <tr>
...
-->				 
                 ...
                 <tr>
                <td colspan="8" align="middle"  bgcolor="#E0E0E0"><div align="right"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
                  <input type="hidden" name="frmflag1" value="frmflag1" />
                  <input type="hidden" name="loopcount" value="<?php echo $i - 1; ?>" />
                  <input name="Submit222" type="submit"  value="Save Visit Entry (Alt+S)" accesskey="s" class="button" id="submit" />
