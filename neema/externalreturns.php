...
<tr>
  ...
  $newamount=0;
		   ...
		   $querypaynow="select labitemrate as amount,patientcode,patientvisitcode,patientname,billdate,labitemname from  refund_paynowlab  where patientvisitcode ='walkinvis' and  billdate between '$ADate1' and '$ADate2' ";
