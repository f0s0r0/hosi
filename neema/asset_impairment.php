...
if ($frmflag1 == 'frmflag1')
{
	...
	$impairmentvalue = $_REQUEST['impairmentvalue'];
	$impairmentvalue = str_replace(',','',$impairmentvalue);
	...
	if($row33 > 0)
	{ 
		$query88 = "INSERT INTO `assets_impairment`(`companyanum`, `itemcode`, `itemname`, `rate`, `quantity`, `subtotal`, `totalamount`, `recordstatus`, `assetledger`, `assetledgercode`, `assetledgeranum`, `fxamount`, 
		...
		$query78 = "UPDATE assets_impairment SET impairmentvalue = '$impairmentvalue', impairmentledgercode = '$impairmentledgercode', impairmentledger = '$impairmentledger', entrydate = '$updatedatetime', username = '$username', ipaddress = '$ipaddress' WHERE auto_number = '$insertid'";
...
function addward1process1()
{
	...
	if (document.form1.impairmentvalue.value == "")
	{
		alert ("Please Enter Amount");
		document.form1.impairmentvalue.focus();
		return false;
	}
	if (document.form1.impairmentvalue.value == '0')
	{
		alert ("Please Enter Amount");
		document.form1.impairmentvalue.focus();
		return false;
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="asset_impairment.php" onSubmit="return addward1process1()">
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="" bgcolor="#CCCCCC" class="bodytext3"><strong>Asset Impairment </strong></td>
                  ...
                  <?php
					  ...
					  <tr>
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Impairment Value </div></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
						<input name="impairmentvalue" id="impairmentvalue" value="<?php //echo $totalamount; ?>" style="border: 1px solid #001E6A; text-transform:uppercase" size="40"/></td>
                      </tr>
                      <tr>
