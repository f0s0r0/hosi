...
<?php include("a4pdfpayrollheader1.php"); ?>	
	...
	<td width="5" align="left" bgcolor="#FFFFFF" class="bodytext3"><strong>MEMBERSHIP NO</strong></td>
	<td width="2" align="right" bgcolor="#FFFFFF" class="bodytext3"><strong>EMPLOYEE</strong></td>
	<td width="2" align="right" bgcolor="#FFFFFF" class="bodytext3"><strong>EMPLOYER</strong></td>
...
$dompdf->stream("NSSFReport.pdf", array("Attachment" => 0)); 
?>
