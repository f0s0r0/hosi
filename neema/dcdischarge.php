...
if ($frmflag1 == 'frmflag1')
{
		...
		$paynowbillprefix7 = 'DCDIS-';
$paynowbillprefix17=strlen($paynowbillprefix7);
$query27 = "select * from dc_discharge order by auto_number desc limit 0, 1";
...
else
{
	...
	$billnumbercode7 = $paynowbillprefix7 .$maxanum7;
		...
		$query33 = "select * from dc_discharge where docno='$billnumbercode7'";
		...
		//$readytodischarge = 'completed';
		
		$query67 = "insert into dc_discharge(docno,patientname,patientcode,visitcode,accountname,dischargestatus,recordtime,recorddate,ipaddress,username)values('$billnumbercode7','$patientname','$patientcode','$visitcode','$accname','$readytodischarge','$updatetime','$updatedate','$ipaddress','$username')";
...
$paynowbillprefix = 'DCDIS-';
$paynowbillprefix1=strlen($paynowbillprefix);
$query2 = "select * from dc_discharge order by auto_number desc limit 0, 1";
...
<body>
<form name="form1" id="form1" method="post" action="dcdischarge.php" onSubmit="return validcheck()">	
