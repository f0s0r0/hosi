...
$hostlogin = 'root';
$hostpassword = 'medit';
$databasename = 'neema17';
$databasenameemr = 'neema';
...
$linkemr = mysql_connect($hostname,$hostlogin,$hostpassword,true) or die('Could not connect Table : ' . mysql_error());

mysql_select_db($databasename, $link) or die('Could not select database'. mysql_error());
mysql_select_db($databasenameemr, $linkemr) or die('Could not select database'. mysql_error());
...
$querynw1 = "select * from resultentry_lab where patientcode = '$searchpatientcode' and patientvisitcode ='$searchvisitcode' and patientname ='$searchpatient' and recorddate between '$fromdate' and '$todate' and docnumber = '$docnumber' group by docnumber order by auto_number desc";
			...
			$execnw1 = mysql_query($querynw1, $link) or die ("Error in Query1".mysql_error());
...
{
$querylab1=mysql_query("select * from master_customer where customercode='$patientcode'", $link);
...
<?php
	...
	$exec11 = mysql_query($query11, $link) or die ("Error in Query11".mysql_error());
...
function funcDepartmentChange()
{
	...
	?>
		...
		$exec10 = mysql_query($query10, $link) or die ("error in query10".mysql_error());
...
$('#customer').autocomplete({
	...
	source:'ajaxcustomernewserachemr.php', 
	//alert(source);
	minLength:3,
	delay: 0,
	html: true, 
		  ...
		  <table width="800" height="128" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              ...
              <tr bgcolor="#011E6A">     
                 ...
                 <td colspan="9" bgcolor="#CCCCCC" class="bodytext3" id="ajaxlocation"><!--<strong> Search Sequence : First Name | Middle Name | Last Name | Date of Birth | Location | Mobile Number | National ID | Registration No   (*Use "|" symbol to skip sequence)</strong>-->
                 </td>
                 </tr>
              <tr>
...
<?php
	...
	if (isset($_REQUEST["cbfrmflag1"])) { $cbfrmflag1 = $_REQUEST["cbfrmflag1"]; } else { $cbfrmflag1 = ""; }
			...
			if ($cbfrmflag1 == 'cbfrmflag1')
			{
				...
				$todate=$_POST['ADate2'];
			?>
				<table  bordercolor="#666666" cellspacing="0" cellpadding="4" width="541" 
            align="left" border="0">
                  <tr>
                  ...
                  <tr>
                    <td width="280" bgcolor="#cccccc" class="bodytext3"><strong>Visit Code </strong></td>
                    <td width="160" bgcolor="#cccccc" class="bodytext3"><strong>Date</strong></td>
					<td  width="160" bgcolor="#cccccc">&nbsp;</td>
                  </tr>
				  
				 
				      <?php
  				  $query1emr = "select * from master_ipvisitentry where patientcode = '$searchpatientcode' order by auto_number desc";
				  $exec1emr = mysql_query($query1emr, $linkemr) or die ("Error in Query1emr".mysql_error());
				  while ($res1emr = mysql_fetch_array($exec1emr))
				  {
				  $ipvisitcode = $res1emr['visitcode'];
				  $ipvisitdate = $res1emr['consultationdate'];
				  ...
				  ?>
                    ...
                    <td bgcolor="#ffffff" class="bodytext3"><a target="_blank" href="ipemrviewold.php?patientcode=<?php echo $searchpatientcode; ?>&&visitcode=<?php echo $ipvisitcode; ?>"><strong><?php echo $ipvisitcode; ?></strong></a></td>
				  ...
				  $exec1 = mysql_query($query1, $link) or die ("Error in Query1".mysql_error());
				...
				<tr>
			     ...
			     <tr>
				  ...
				  if($searchpatient!= '') { ?> 
                    ...
                    <td bgcolor="#ffffff" class="bodytext3"><a target="_blank" href="externalemrupload.php?patientcode=<?php echo $searchpatientcode; ?>&&visitcode=<?php echo $visitcode; ?>"><strong>Click To Add</strong></a></td>
                  <?php } ?>
				  </tr>
				  ...
				  $exec2 = mysql_query($query2, $link) or die ("Error in Query2".mysql_error());
			...
			else
			{
			 ...
			 <a href="radiologyresultsview.php?patientcode=<?php echo $searchpatientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&docnumber=<?php echo $radiologydocnumber; ?>" target="_blank"><strong>View</strong></a></div>	</td>
				  ...
				  ?>
				   ...
				   <?php  
				  $query3 = "select * from externalemr_upload where patientvisitcode = '$visitcode' and patientcode = '$searchpatientcode' ";
				  $exec3 = mysql_query($query3, $link) or die ("Error in Query3".mysql_error());
				  while ($res3 = mysql_fetch_array($exec3))
				  {
				   $filename = $res3['filename'];
				   $fileurl = $res3['fileurl'];
			...
			else
			{
				...
				$colorcode = 'bgcolor="#D3EEB7"';
				   ...
				   ?>
                 <tr <?php echo $colorcode; ?>>
                  <td class="bodytext3"><?php echo $filename; ?></td>
				  <td class="bodytext3"><a target="_blank" href="//simacle/externalemr/<?php echo $filename; ?>"><?php echo $fileurl; ?></a></td>
				  <td>&nbsp;</td> 
                </tr>
			   <?php } ?>
			   
			    <?php  
				  $query3 = "select * from tbtemplate where patientvisitcode = '$visitcode' and patientcode = '$searchpatientcode' ";
				  $exec3 = mysql_query($query3, $link) or die ("Error in Query3".mysql_error());
				  while ($res3 = mysql_fetch_array($exec3))
				  {
				   ...
				   ?>
                 <tr <?php echo $colorcode; ?>>
                  <td class="bodytext3"><?php echo 'TB Notes' ; ?></td>
				  <td class="bodytext3"> <a href="tbresultview.php?patientcode=<?php echo $searchpatientcode; ?>&&visitcode=<?php echo $visitcode; ?>" target="_blank"><strong>View</strong></a>	</td>
				  <td>&nbsp;</td> 
                </tr>
			   <?php } ?>
			   <?php 
				  ...
				  $execanc5 = mysql_query($queryanc5, $link) or die ("Error in Queryanc5".mysql_error());
				  $numanc5 = mysql_num_rows($execanc5);
				  $queryanc6 = "select * from ancphysixam where patientcode = '$patientcode' and patientvisitcode = '$visitcode'";
				  $execanc6 = mysql_query($queryanc6, $link) or die ("Error in Queryanc6".mysql_error());
				  $numanc6 = mysql_num_rows($execanc6);
				  $queryanc7 = "select * from ancprespreg where patientcode = '$patientcode' and patientvisitcode = '$visitcode'";
				  $execanc7 = mysql_query($queryanc7, $link) or die ("Error in Queryanc7".mysql_error());
				  $numanc7 = mysql_num_rows($execanc7);
				  $queryanc8 = "select * from ancprevser where patientcode = '$patientcode' and patientvisitcode = '$visitcode'";
				  $execanc8 = mysql_query($queryanc8, $link) or die ("Error in Queryanc8".mysql_error());
				  $numanc8 = mysql_num_rows($execanc8);
				  $numsanc1 = $numanc5 + $numanc6 + $numanc7 + $numanc8;
				  if($numsanc1!=0)
				  {
				   ...
				   ?>
                 <tr <?php echo $colorcode; ?>>
                  <td class="bodytext3"><?php echo 'ANC Notes' ; ?></td>
				  <td class="bodytext3"> <a href="ancresultview.php?patientcode=<?php echo $searchpatientcode; ?>&&visitcode=<?php echo $visitcode; ?>" target="_blank"><strong>View</strong></a>	</td>
				  <td>&nbsp;</td> 
                </tr>
			   <?php } ?>
				  ...
				  <?php
                  $query1 = "select * from master_visitentry where patientcode = '$searchpatientcode' and consultationdate between '$fromdate' and '$todate' order by auto_number desc";
				  $exec1 = mysql_query($query1, $linkemr) or die ("Error in Query1".mysql_error());
				  while ($res1 = mysql_fetch_array($exec1))
				  {
				  $visitcode = $res1['visitcode'];
				  $visitdate = $res1['consultationdate'];
                  ...
                  <tr>
                    <td class="bodytext3"><strong>Case Sheet&nbsp;</strong></td>
                    <td class="bodytext3"><span class="style2"><a target="_blank" href="emrcasesheetold.php?visitcode=<?php echo $visitcode; ?>">View</a>&nbsp;</span></td>
										<td>&nbsp;</td>
                  </tr>
				  <?php
                  $query2 = "select * from resultentry_lab where patientvisitcode = '$visitcode' group by itemname ";
				  $exec2 = mysql_query($query2, $linkemr) or die ("Error in Query2".mysql_error());
				  while ($res2 = mysql_fetch_array($exec2))
				  {
                   $labtestname = $res2['itemname'];
                  $labdocnumber = $res2['docnumber'];
			...
			?>
				     <tr <?php echo $colorcode; ?>>
                    <td class="bodytext3"><?php echo $labtestname; ?>&nbsp;</td>
                    <td class="bodytext3"><span class="style3"><a href="labresultsviewold.php?patientcode=<?php echo $searchpatientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&docnumber=<?php echo $labdocnumber; ?>" target="_blank">View</a>&nbsp;</span></td>
										<td>&nbsp;</td>
                  </tr>
				  <?php
				  }
			...
			else
			{
				...
				<td class="bodytext3">	
				<div align="left">
			 <a href="radiologyresultsviewold.php?patientcode=<?php echo $searchpatientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&docnumber=<?php echo $radiologydocnumber; ?>" target="_blank"><strong>View</strong></a></div>	</td>
			 					<td>&nbsp;</td>
                  </tr>
				  <?php
		           }	 
				  ?>
				   ...
				   <?php  
				  $query3 = "select * from externalemr_upload where patientvisitcode = '$visitcode' and patientcode = '$searchpatientcode' ";
				  $exec3 = mysql_query($query3, $linkemr) or die ("Error in Query3".mysql_error());
				  while ($res3 = mysql_fetch_array($exec3))
				  {
				   $filename = $res3['filename'];
				   $fileurl = $res3['fileurl'];
			...
			else
			{
			   ...
			   <?php 
				  ...
				  $numsanc1 = ''; 
				  $queryanc5 = "select * from ancprevpreg where patientcode = '$patientcode' and patientvisitcode = '$visitcode'";
				  $execanc5 = mysql_query($queryanc5, $linkemr) or die ("Error in Queryanc5".mysql_error());
				  $numanc5 = mysql_num_rows($execanc5);
				  $queryanc6 = "select * from ancphysixam where patientcode = '$patientcode' and patientvisitcode = '$visitcode'";
				  $execanc6 = mysql_query($queryanc6, $linkemr) or die ("Error in Queryanc6".mysql_error());
				  $numanc6 = mysql_num_rows($execanc6);
				  $queryanc7 = "select * from ancprespreg where patientcode = '$patientcode' and patientvisitcode = '$visitcode'";
				  $execanc7 = mysql_query($queryanc7, $linkemr) or die ("Error in Queryanc7".mysql_error());
				  $numanc7 = mysql_num_rows($execanc7);
				  $queryanc8 = "select * from ancprevser where patientcode = '$patientcode' and patientvisitcode = '$visitcode'";
				  $execanc8 = mysql_query($queryanc8, $linkemr) or die ("Error in Queryanc8".mysql_error());
				  $numanc8 = mysql_num_rows($execanc8);
				  $numsanc1 = $numanc5 + $numanc6 + $numanc7 + $numanc8;
				  if($numsanc1!=0)
				  {
