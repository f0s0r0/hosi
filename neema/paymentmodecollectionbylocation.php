    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="777" 
...
&nbsp;				<input  value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />-->
		  ...
		  <tr>
              <td colspan="7" width="8%" bgcolor="#cccccc" class="bodytext31"><strong><?php echo $locationname; ?></strong></td>
            </tr>
            <tr>
			...
			<td>&nbsp; </td>
			 ...
			 <tr bgcolor="#99CC99" <?php //echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="right">
			    ...
			    <div align="right">&nbsp;</div></td>
                <td class="bodytext31" valign="center" bgcolor="#E0E0E0" align="right"> 
                 <a target="_blank" href="print_collectionsummaryallloc.php?ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2; ?>"> <img src="images/pdfdownload.jpg" width="30" height="30"></a> 
                </td>
			<?php
			}
			?>	
