  ...
  foreach($_POST['itemcode1'] as $key => $value)
	...
	//echo "<br>".$itemcode;
	   ...
	   $acknow = $check;
		...
		$query45="update purchase_rfqrequest set grandapprovalstatus='$status',quantity='$reqqty',packagequantity='$pkgqty',amount='$amount' where docno='$docno' and medicinecode='$itemcode'";
		...
		{
		$query46="update purchase_rfqrequest set grandapprovalstatus='rejected' where docno='$docno'";
		...
		{	
			...
			{
		     $query43="insert into purchase_rfqrequest(date,docno,medicinename,medicinecode,quantity,packagequantity,rate,amount,username,approvalstatus,grandapprovalstatus,status,companyanum,location,locationcode,locationname)values
		                 ('$dateonly','$docno','$medicinename','$medicinecode','$reqqty','$pkgqty','$rate','$amount','$username','approved','approved','RFA','$companyanum','$locationname','$locationcode','$locationname')";
...
{
alert("Please either approve/discard items  or click back button on the browser to exit Approve");
return false;
}
return true;
}
...
<form name="form1" id="frmsales" method="post" action="viewapprovedrfp.php" onKeyDown="return disableEnterKey(event)" onSubmit="return acknowledgevalid()">
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="1031" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <td>&nbsp;
			...
			<tr>
              <td bgcolor="#CCCCCC" class="bodytext3" colspan="8"><strong>Approve RFQ</strong></td>
			  ...
			  <tr>
				...
				<input name="docno" id="docno" value="<?php echo $docno; ?>" style="border: 1px solid #001E6A;" size="10" autocomplete="off" readonly/>                  </td>
             ...
             <td width="11%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><strong>Location</strong></td>
				...
				<input name="location" id="location" value="Main Stores" style="border: 1px solid #001E6A" size="18" rsize="20" readonly/>				</td>
			    </tr>
            </tbody>
        </table></td>
      </tr>
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
             <tr>
                       ...
                       <td width="12%"  align="center" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Req Qty</strong></td>
                       <td width="11%"  align="center" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Pack Size</strong></td>
                       <td width="10%"  align="center" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Pkg Qty</strong></td>
                      
                       <td width="10%"  align="center" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Rate</strong></td>
                       <td width="16%"  align="center" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Amount</strong></td>
					   <td width="9%"  align="center" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Approve</strong></td>
                  </tr>
				  		<?php
			$colorloopcount = '';
			$sno = 0;
			$totalamount=0;			
			$query12 = "select * from purchase_rfqrequest where docno='$docno' and approvalstatus='approved'";
		...
		$reqqty = $res12['quantity'];
			...
			$itemcode = $itemcode;
			$query1 = "select sum(batch_quantity) as cum_quantity from transaction_stock where itemcode='$itemcode' and locationcode='$locationcode' and batch_stockstatus='1' and storecode='$storecode' order by auto_number desc";
...
?>
  <tr>
		...
		<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" name="amountold[]" id="amount<?php echo $sno ; ?>" value="<?php echo number_format($amount,'2','.',',');?>" size="10" class="bal" readonly></div></td>
	 ...
	 <td width="66" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">&nbsp;</td>
      ...
      <tr>
		 ...
		 <td width="114" align="right" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><strong>Username</strong></td>
         <td width="62" align="right" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><?php echo $username; ?></td>
         <td width="540" align="right" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">&nbsp;</td>
         <td width="315" align="right" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><input type="hidden" name="frm1submit1" value="frm1submit1" />
