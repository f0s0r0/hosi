...
if (isset($_REQUEST["docno"])) {  $docnumber = $_REQUEST["docno"]; } else { $docnumber = ""; }
if (isset($_REQUEST["vehicleno"])) { $vehicleno = $_REQUEST["vehicleno"]; } else { $vehicleno = ""; }
...
$patientfullname = $_REQUEST["patientname"];
	...
	$chequenumber = $_REQUEST['chequenumber'];
		...
		$docnumber = $_REQUEST['ambulancedocno'];
	...
	$paynowbillprefix = 'EXMB-';
$paynowbillprefix1=strlen($paynowbillprefix);
$query2 = "select * from mortuary_billing_services order by auto_number desc limit 0, 1";
...
else
{
	...
	//echo $companycode;
	 ...
	 $billnumber = $billnumbercode;
		...
		foreach($_POST['servicesitemcode'] as  $key=>$value )
	{
		$servicesitemcode= $_POST['servicesitemcode'][$key];	
		$servicesitemname= $_POST['servicesitemname'][$key];	
		$docnumber2= $_POST['docnumber2'][$key];	
		$recorddate= $_POST['recorddate'][$key];	
		$consultationtime= $_POST['consultationtime'][$key];	
		$servicesitemrate= $_POST['servicesitemrate'][$key];	
		$quantity= $_POST['quantity'][$key];	
		$freestatus= $_POST['freestatus'][$key];	
		$department= $_POST['department'][$key];	
		$username12= $_POST['username12'][$key];	
		
		
		
		 $docno1 = $_POST['docnumber1'];
	

/*	//mysql_query("insert into 	mortuaryexternal_services(patientcode, patientvisitcode,gender,billno,patientname,vehicleno,kms,amount,billdate,recordstatus,username,docno,rate,recordtime,recorddate,ipaddress,description)values('$patientcode','$visitcode','$gender','$billnumber',
	'$patientfullname','$vehicleno','$kms','$amount1','$billdate',
	'completed','$username','$docnumber','$rate','$timeonly','$dateonly','$ipaddress','$description')") or die(mysql_error());
*/			
	
		//echo $ss="update mortuaryexternal_services set paymentstatus='completed' and billno='$billnumber' where mortuarydocno='$docno1' and servicesitemcode='$servicesitemcode'";exit;
	// $ss="insert into mortuaryexternal_services(patientcode,patientname,patientvisitcode,servicesitemcode,servicesitemname,servicesitemrate,consultationdate,paymentstatus,mortuarydocno,consultationtime,freestatus,quantity,username )values('$patientcode','$patientfullname','$visitcode','$servicesitemcode','$servicesitemname','$servicesitemrate','$recorddate','completed','$docnumber2','$consultationtime','$freestatus','$quantity','$username12')"; 
		$servicesquery12=mysql_query("insert into mortuary_billing_services(patientcode,patientname,patientvisitcode,servicesitemcode,servicesitemname,servicesitemrate,consultationdate,paymentstatus,mortuarydocno,consultationtime,freestatus,quantity,username,billno)values('$patientcode','$patientfullname','$visitcode','$servicesitemcode','$servicesitemname','$servicesitemrate','$recorddate','completed','$docnumber2','$consultationtime','$freestatus','$quantity','$username12','$billnumber')") or die(mysql_error());	
		
	mysql_query("update mortuaryexternal_services set paymentstatus='completed', billno='$billnumber' where mortuarydocno='$docno1' and servicesitemcode='$servicesitemcode'") or die(mysql_error());
		...
		transactionmodule,patientname,patientcode,visitcode,billstatus,financialyear,username,transactiontime,cashgivenbycustomer,cashgiventocustomer,cashcode) 
		values ('$billdate', '$particulars', 
		'$transactionmode', '$transactiontype', '$totalamount', '$cashamount', 
		'$billnumber',  '$billanum', '$ipaddress', '$updatedate', '$balanceamount', '$companyanum', '$companyname', '$remarks', 
		'$transactionmodule','$patientfullname','walkin','walkinvis','paid','$financialyear','$username','$timeonly','$cashgivenbycustomer','$cashgiventocustomer','$cashcode')";
		...
		transactionmodule,patientname,patientcode,visitcode,billstatus,financialyear,username,transactiontime,cashgivenbycustomer,cashgiventocustomer,cashcode, bankcode, mpesacode) 
		values ('$billdate', '$particulars', 
		'$transactionmode', '$transactiontype', '$totalamount', '$cashamount', 
		...
		'$chequenumber', '$transactionmodule','$patientfullname','walkin','walkinvis','paid','$financialyear','$username','$timeonly','$cashgivenbycustomer','$cashgiventocustomer','$cashcode', '$bankcode', '$mpesacode')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		...
		transactionmode, transactiontype, transactionamount, cashamount,
		billnumber, billanum, ipaddress, updatedate, balanceamount, companyanum, companyname, remarks, 
		transactionmodule,creditamount,patientname,patientcode,visitcode,billstatus,financialyear,username,transactiontime,cashgivenbycustomer,cashgiventocustomer,mpesacode) 
		values ('$billdate', '$particulars', 
		'$transactionmode', '$transactiontype', '$totalamount', '$cashamount', 
		'$billnumber',  '$billanum', '$ipaddress', '$updatedate', '$balanceamount', '$companyanum', '$companyname', '$remarks', 
		'$transactionmodule','$creditamount','$patientfullname','walkin','walkinvis','paid','$financialyear','$username','$timeonly','$cashgivenbycustomer','$cashgiventocustomer','$mpesacode')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		...
		billnumber, billanum, ipaddress, updatedate, balanceamount, companyanum, companyname, remarks, 
		transactionmodule,patientname,patientcode,visitcode,billstatus,financialyear,username,transactiontime,bankcode) 
		values ('$billdate','$particulars', 
		'$transactionmode', '$transactiontype', '$totalamount', '$onlineamount', 
		'$billnumber',  '$billanum', '$ipaddress', '$updatedate', '$balanceamount', '$companyanum', '$companyname', '$remarks', 
		'$transactionmodule','$patientfullname','walkin','walkinvis','paid','$financialyear','$username','$timeonly','$bankcode')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		...
		billnumber, billanum, ipaddress, updatedate, balanceamount, companyanum, companyname, remarks, 
		transactionmodule,patientname,patientcode,visitcode,billstatus,financialyear,username,transactiontime,creditcardname,creditcardnumber,creditcardbankname,bankcode) 
		values ('$billdate','$particulars', 
		'$transactionmode', '$transactiontype', '$totalamount', '$cardamount', 
		'$billnumber',  '$billanum', '$ipaddress', '$updatedate', '$balanceamount', '$companyanum', '$companyname', '$remarks', 
		'$transactionmodule','$patientfullname','walkin','walkinvis','paid','$financialyear','$username','$timeonly','$card','$cardnumber','$bankname1','$bankcode')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		...
		'$remarks', '$transactionmodule','$patientfullname','walkin','walkinvis','paid','$financialyear','$username','$timeonly','$bankcode')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		...
		if ($paymentmode != '' && $nettamount1 != "0.00") { 	
	 	mysql_query("insert into billing_external(billno,patientname,patientcode,visitcode,totalamount,billdate,age,gender,username,referredfrom)values('$billnumber','$patientfullname','walkin','walkinvis','$totalamount','$billdate','$age','$gender','$username','$referredfrom')") or die(mysql_error());
	                        }
		header("location:patientbillingstatus.php?mainmenuid=MM005&&ambillnumber=$billnumber");
        exit;
...
?>
<?php
/*$query1=mysql_query("select * from external_ambulance where docno='$docnumber'");
$exec1=mysql_fetch_array($query1);
$patientname=$exec1['patientfullname'];
$age=$exec1['age'];
$gender=$exec1['gender'];
$age=$exec1['age'];
...
function printPaynowBill()
 {
var popWin; 
popWin = window.open("print_external_billamb.php?patientcode=<?php echo $patientcode; ?>&&billautonumber=<?php echo $billnumbercode; ?>&&ranum=<?php echo (rand(10,100)); ?>","OriginalWindowA4",'width=400,height=500,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25'); 
 }
</script>
...
<?php
			...
			$query19="select * from mortuaryexternal_services as ms INNER JOIN mortuary_allocation as ma ON ms.mortuarydocno=ma.docno INNER JOIN mortuary_request as mr ON ma.requestno=mr.docno where ms.mortuarydocno='$docnumber'";
			
			$exec19 = mysql_query($query19) or die ("Error in Query1".mysql_error());
			$res19 = mysql_fetch_array($exec19);
			
			 $recorddate=$res19['consultationdate'];
			$patientname = $res19['patientname'];
			 $docnumber=$res19['mortuarydocno'];
			$patientcode=$res19['patientcode'];
			$patientvisitcode=$res19['patientvisitcode'];
			$servicesitemname=$res19['servicesitemname'];
			$servicesitemcode=$res19['servicesitemcode'];
			$quantity=$res19['quantity'];
...
<form name="form1" id="frmsales" method="post" action="extmortuaryservices.php" onKeyDown="return disableEnterKey(event)" onSubmit="return funcSaveBill1()">
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
                <tr bgcolor="#011E6A">
                <td colspan="7" bgcolor="#CCCCCC" class="bodytext32"><strong>Pay Now Patient Details</strong></td>
			 </tr>
			 <?php
			 if (isset($_REQUEST["src"])) { $src = $_REQUEST["src"]; } else { $src = ""; }
			 if (isset($_REQUEST["st"])) { $st = $_REQUEST["st"]; } else { $st = ""; }
		...
		<tr>
			  ...
			  <tr>
                ...
                <td width="17%" align="left" valign="top" class="bodytext3"><?php echo $patientname; ?>
             ...
             <!--   <td width="17%" align="left" valign="top" class="bodytext3"><strong>Gender</strong></td>
                <td width="15%" align="left" valign="top" class="bodytext3"><?php echo $gender; ?></td>
			    ...
			    <td width="14%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><strong>Patientcode</strong></td>
				...
				<!--<textarea name="deliveryaddress" cols="25" rows="3" id="deliveryaddress" style="border: 1px solid #001E6A"><?php //echo $res41deliveryaddress; ?></textarea>--></td>
				    <td align="left" valign="top" class="bodytext3"><strong>Pateint Visitcode</strong></td>
				    <td align="left" valign="top" class="bodytext3"><?php echo $patientvisitcode; ?></td>
				    <td width="15%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><strong></strong></td>
              ...
              <tr>
                <td colspan="7" class="bodytext32"><strong>&nbsp;</strong></td>
				 	...
				 	<input type="hidden" name="visitcode" id="visitcode" value="<?php echo $patientvisitcode; ?>" style="border: 1px solid #001E6A" size="18" rsize="20" readonly/>								<input type="hidden" name="accountname" id="account" value="<?php echo $patientaccount1; ?>" style="border: 1px solid #001E6A" size="18" rsize="20" readonly/>				
                 ...
                 <tr>
			    <td width="14%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><strong>Gender  </strong></td>
                <td width="17%" align="left" valign="top" class="bodytext3"><?php echo $gender; ?>
                <input type="hidden" name="gender" id="gender" value="<?php echo $gender; ?>" style="border: 1px solid #001E6A" size="18" rsize="20" readonly/></td>
                
			    <td width="14%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><strong>Bill No</strong></td>
                <td align="left" valign="top" class="bodytext3"><?php echo $billnumbercode; ?></td>
           ...
           <tr bgcolor="#011E6A">
            ...
            <tr>
              <td width="5%" class="bodytext31" valign="center"  align="left" 
                ...
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Docno</strong></div></td>
                ...
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Requested By</strong></div></td>
                  </tr>

			  <?php 
			  $totalmortuary=0;			  
			 $query19 = "select * from mortuaryexternal_services where mortuarydocno='$docnumber' and paymentstatus<>'completed' and freestatus = '0'";
			$exec19 = mysql_query($query19) or die ("Error in Query1".mysql_error());
			while($res19 = mysql_fetch_array($exec19))
			{
			 $recorddate=$res19['consultationdate'];
			$patientfullname = $res19['patientname'];
			 $docnumber2=$res19['mortuarydocno'];
			$patientcode=$res19['patientcode'];
			$patientvisitcode=$res19['patientvisitcode'];
			$servicesitemname=$res19['servicesitemname'];
			$servicesitemcode=$res19['servicesitemcode'];
			$quantity=$res19['quantity'];
			$rate=$res19['servicesitemrate'];
			$consultationtime=$res19['consultationtime'];
			$freestatus=$res19['freestatus'];
			$department=$res19['department'];
			$username12=$res19['username'];
			...
			$totalmortuary=$totalmortuary+$amount1; 
			
			?>
			 <tr <?php echo $colorcode; ?>>
			 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $sno = $sno + 1; ?></div></td>
			  <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $recorddate; ?></div></td>
			 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $docnumber2; ?></div></td>
			 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $servicesitemname; ?></div></td>
			  <input name="servicesitemcode[]" id="servicesitemcode"  type="hidden" value="<?php echo $servicesitemcode; ?>">
			  <input name="servicesitemname[]" id="servicesitemname"  type="hidden" value="<?php echo $servicesitemname; ?>">
	    	  <input name="docnumber2[]" id="docnumber2"  type="hidden" value="<?php echo $docnumber2; ?>">
			 <input name="recorddate[]" id="recorddate"  type="hidden" value="<?php echo $recorddate; ?>">
		  <input name="consultationtime[]" id="consultationtime"  type="hidden" value="<?php echo $consultationtime; ?>">
		 <input name="servicesitemrate[]" id="servicesitemrate"  type="hidden" value="<?php echo $rate; ?>">
		  <input name="quantity[]" id="quantity"  type="hidden" value="<?php echo $quantity; ?>">
		 <input name="freestatus[]" id="freestatus"  type="hidden" value="<?php echo $freestatus; ?>">
		 	 <input name="department[]" id="department"  type="hidden" value="<?php echo $department; ?>">
		 	 <input name="username12[]" id="username12"  type="hidden" value="<?php echo $username12; ?>">
		 
         

        	 <input name="docnumber1" id="docnumber1" type="hidden" value="<?php echo $docnumber; ?>">
			 ...
			 <td class="bodytext31" valign="center"  align="left"><div align="right"><?php echo $amount1; ?></div></td>
			<td width="4%"  align="left" valign="center" 
               class="bodytext31"><div align="center"><strong><?php echo $usernam; ?></strong></div></td>
             
			  
			  <?php }
			  $overalltotal=number_format($totalmortuary,2,'.','');
...
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong> Card No </strong></div></td>
                <td align="left" valign="center"  
bgcolor="#F3F3F3" class="bodytext31" width="10%"><input name="cardnumber" id="cardnumber" value=""
 style="border: 1px solid #001E6A; text-align:left; text-transform:uppercase" size="8"  /></td>
