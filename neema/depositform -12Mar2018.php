...
else
{
	...
	//echo $companycode;
		...
		'$ipaddress', '$updatedatetime','$companyanum', '$companyname', '$remarks', 
		'Adjustment','$accname','$billnumbercode','$cashamount','$username','$updatetime','".$locationnameget."','".$locationcodeget."','".$comments."')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
	...
	window.location.href="patientbillingstatus.php";
	  } 
        </script>
 ...
 class="bodytext31" colspan="1" bgcolor="#FFF"><input type="text" name="cardname" id="cardname" size="8" style="border: 1px solid #001E6A; text-align:left;">
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            <tr>
			<td colspan="6" bgcolor="#cccccc" class="bodytext311"><strong>Advance Deposits</strong></td>
			<td  bgcolor="#cccccc" class="bodytext311"><strong>Location:&nbsp;&nbsp;<?php echo $patientlocationname ?></strong></td>
				</tr>
			 <tr>
