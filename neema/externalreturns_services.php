...
<tr>
  ...
  $newamount=0;
		  ...
		  $querypaynow="select servicesitemrate as amount,patientcode,patientvisitcode,patientname,billdate,servicesitemname from  refund_paynowservices  where patientvisitcode ='walkinvis' and  billdate between '$ADate1' and '$ADate2' and locationcode='$locationcode1' ";
		  ...
		  while($respaynow = mysql_fetch_array($execpaynow))
		  {
		   ...
		   $accountname= $respaynow['accountname'];
   		   $labitemname=$respaynow['servicesitemname'];
