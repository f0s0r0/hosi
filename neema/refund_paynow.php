...
if ($frm1submit1 == 'frm1submit1')
{
  ...
  $locationcode02=isset($_REQUEST['locationcde'])?$_REQUEST['locationcde']:'';
...
$billnumber = $billnumbercode;
	...
	$locationcode2=$_REQUEST['locationcode'];
	$mpesanumber=$_REQUEST['mpesanumber'];
			...
			mysql_query("update pharmacysalesreturn_details set billstatus='completed' where itemname='$medname' and visitcode='$visitcode'") or die(mysql_error());
			 $query2 = "insert into refund_paynowpharmacy(patientcode,patientname,patientvisitcode,medicinename,quantity,rate,amount,billdate,ipaddress,accountname,medicinecode,billnumber,username,pharmacycoa,locationname,locationcode) 
				values('$patientcode','$patientname','$visitcode','$medname','$pharquantity','$rate','$pharamount','$updatedate','$ipaddress','$accountname','$medicinecode','$billnumber','$username','$pharmacycoa','".$locationnameget."','".$locationcode02."')";
				$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
		...
		'$billnumber',  '$billanum', '$ipaddress', '$updatedate', '$balanceamount', '$companyanum', '$companyname', '$remarks', 
		'$transactionmodule','$patientname','$patientcode','$visitcode','$accountname','$doctorname','paid','$financialyear','$username','$timeonly','$cashgivenbycustomer','$cashgiventocustomer','paynowrefund','".$locationnameget."','".$locationcode02."','$cashcode')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		
		$query37 = "insert into paymentmodecredit(patientname,patientcode,patientvisitcode,accountname,billnumber,billdate,ipaddress,username,cash,cashcoa,source,locationname,locationcode)values('$patientname','$patientcode','$visitcode','$accountname','$billnumber','$billdate','$ipaddress','$username','$totalamount','$cashcoa','paynowrefund','".$locationnameget."','".$locationcode02."')";
		...
		'$transactionmode', '$transactiontype', '$totalamount', '$totalamount', 
		'$billnumber',  '$billanum', '$ipaddress', '$updatedate', '$balanceamount', '$companyanum', '$companyname', '$remarks', 
		'$transactionmodule','$patientname','$patientcode','$visitcode','$accountname','$doctorname','paid','$financialyear','$username','$timeonly','$cashgivenbycustomer','$cashgiventocustomer','paynowrefund','".$locationnameget."','".$locationcode02."','$bankcode')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		
		$query37 = "insert into paymentmodecredit(patientname,patientcode,patientvisitcode,accountname,billnumber,billdate,ipaddress,username,online,onlinecoa,source,locationname,locationcode)values('$patientname','$patientcode','$visitcode','$accountname','$billnumber','$billdate','$ipaddress','$username','$totalamount','$onlinecoa','paynowrefund','".$locationnameget."','".$locationcode02."')";
        $exec37 = mysql_query($query37) or die(mysql_error());
	...
	$transactiontype = 'PAYMENT';
		...
		'$chequedate', '$bankname', '$ipaddress', '$updatedate', '$balanceamount', '$companyanum', '$companyname', 
		'$remarks', '$transactionmodule','$patientname','$patientcode','$visitcode','$accountname','$doctorname','paid','$financialyear','$username','$card','$cardnumber','$bankname1','$timeonly','$cashgivenbycustomer','$cashgiventocustomer','paynowrefund','".$locationnameget."','".$locationcode02."','$bankcode')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		
		$query37 = "insert into paymentmodecredit(patientname,patientcode,patientvisitcode,accountname,billnumber,billdate,ipaddress,username,card,cardcoa,source,locationname,locationcode)values('$patientname','$patientcode','$visitcode','$accountname','$billnumber','$billdate','$ipaddress','$username','$totalamount','$cardcoa','paynowrefund','".$locationnameget."','".$locationcode02."')";
        $exec37 = mysql_query($query37) or die(mysql_error());
...
$query9 = "insert into refund_paynow (transactiondate, particulars,transactionmode, transactiontype, transactionamount, creditamount,billnumber, billanum, ipaddress, updatedate, balanceamount, companyanum, companyname, remarks,
...
values ('$billdate','$particulars', '$transactionmode', '$transactiontype', '$totalamount', '$totalamount', 
		'$billnumber',  '$billanum', '$ipaddress', '$updatedate', '$balanceamount', '$companyanum', '$companyname', '$remarks', 
		'$transactionmodule','$patientname','$patientcode','$visitcode','$accountname','$doctorname','paid','$financialyear','$username','$timeonly','$cashgivenbycustomer','$cashgiventocustomer','paynowrefund','".$locationnameget."','".$locationcode02."','$mpesacode')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		
		$query37 = "insert into paymentmodecredit(patientname,patientcode,patientvisitcode,accountname,billnumber,billdate,ipaddress,username,mpesa,mpesacoa,mpesanumber,source,locationname,locationcode)values('$patientname','$patientcode','$visitcode','$accountname','$billnumber','$billdate','$ipaddress','$username','$totalamount','$mpesacoa','$mpesanumber','paynowrefund','".$locationnameget."','".$locationcode02."')";
        $exec37 = mysql_query($query37) or die(mysql_error());
	...
	mysql_query("update consultation_lab set labrefund='refunded' where patientvisitcode='$visitcode' and labitemname='$labname' and auto_number = '$labanum'");
	$query45 = "insert into refund_paynowlab(patientcode,patientname,patientvisitcode,labitemcode,labitemname,labitemrate,accountname,billdate,billnumber,username,labcoa,locationname,locationcode)values
	           ('$patientcode','$patientname','$visitcode','$labcode','$labname','$labrate','$accountname','$updatedate','$billnumber','$username','$labcoa','".$locationnameget."','".$locationcode02."')";
	$exec45 = mysql_query($query45) or die(mysql_error());		   
	}
	foreach($_POST['rad'] as $key => $value)
		{
		$radname=$_POST['rad'][$key];
		$radanum=$_POST['radanum'][$key];
	...
	mysql_query("update consultation_radiology set radiologyrefund='refunded' where patientvisitcode='$visitcode' and radiologyitemname='$radname' and auto_number = '$radanum'");
	$query46 = "insert into refund_paynowradiology(patientcode,patientname,patientvisitcode,radiologyitemcode,radiologyitemname,radiologyitemrate,accountname,billdate,billnumber,username,radiologycoa,locationname,locationcode)values
	           ('$patientcode','$patientname','$visitcode','$radiologycode','$radname','$radiologyrate','$accountname','$updatedate','$billnumber','$username','$radiologycoa','".$locationnameget."','".$locationcode02."')";
	...
	foreach($_POST['ser'] as $key => $value)
		...
		$servicequantity=$_POST['serqty'][$key];
		$servicetotal=$servicesrate*$servicequantity;
	
	mysql_query("update consultation_services set servicerefund='completed' where patientvisitcode='$visitcode' and servicesitemname='$sername'");
	$query47 = "insert into refund_paynowservices(patientcode,patientname,patientvisitcode,servicesitemcode,servicesitemname,servicesitemrate,accountname,billdate,billnumber,username,servicecoa,locationname,locationcode,servicequantity,servicetotal)values
	           ('$patientcode','$patientname','$visitcode','$servicescode','$sername','$servicesrate','$accountname','$updatedate','$billnumber','$username','$servicecoa','".$locationnameget."','".$locationcode02."','".$servicequantity."','".$servicetotal."')";
	...
	mysql_query("update consultation_departmentreferal set referalrefund='', status = '' where patientvisitcode='$visitcode' and referalname='$referalname'");
	$query47 = "insert into refund_paynowreferal(patientcode,patientname,patientvisitcode,referalcode,referalname,referalrate,accountname,billdate,billnumber,username,referalcoa,locationname,locationcode)values
	           ('$patientcode','$patientname','$visitcode','$referalcode','$referalname','$referalrate','$accountname','$updatedate','$billnumber','$username','$referalcoa','".$locationnameget."','".$locationcode02."')";
	$exec47 = mysql_query($query47) or die(mysql_error());		   
	...
	function openPrint(){
		...
		window.open("print_paynow_refund.php?billnumber=<?php echo $billnumbercode; ?>&&visitcode=<?php echo $visitcode1; ?>&&patientcode=<?php echo $patientcode1; ?>&&locationcode=<?php echo $locationcode02 ?>","OriginalWindowA4",'width=400,height=500,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
...
$query78="select locationcode from master_visitentry where patientcode='$patientcode' and visitcode='$visitcode'";
      ...
      <tr>
        <td><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
                ...
                <input type="hidden" name="locationcde" value="<?php echo $locationcode?>">
          ...
          <tbody id="foo">
           <tr bgcolor="#011E6A">
			...
			?>
			 ...
			 <input type="hidden" name="labanum[]" value="<?php echo $labanum; ?>">
			...
			$query66 = "select rate from billing_paynowpharmacy where patientcode='$patientcode' and patientvisitcode='$visitcode' and medicinename='$phaname'";
			$exec66=mysql_query($query66) or die(mysql_error());
			$res66=mysql_fetch_array($exec66);
			$pharate=$res66['rate'];
			$phaamount=$pharate * $phaquantity;
			...
			?>
			 ...
			 <input type="hidden" name="radanum[]" value="<?php echo $radanum; ?>">
			 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo '1'; ?></div></td>
			...
			$servicesrate = $serrate*$serqty;
			$totalser=$totalser+$servicesrate;
			?>
			 <tr <?php echo $colorcode; ?>>
			 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $sno = $sno + 1; ?></div></td>
			 ...
			 <input type="hidden" name="ser[]" value="<?php echo $sername; ?>">
              <input type="hidden" name="serqty[]" value="<?php echo $serqty; ?>">
			 ...
			 <td class="bodytext31" valign="center"  align="left"><div align="right"><?php echo $servicesrate; ?></div></td>
			 <td width="4%"  align="left" valign="center" 
               class="bodytext31"><div align="right"><strong>&nbsp;</strong></div></td>
			  ...
			  ?>
			   ...
			   {
			   $totalref=0;
			  $query22 = "select * from consultation_departmentreferal where patientvisitcode='$visitcode' and patientcode='$patientcode' and paymentstatus='completed' and approvalstatus = 'approved'";
