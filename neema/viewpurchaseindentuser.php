...
$query1 = "select * from purchase_indent where approvalstatus NOT LIKE '%reject%' and (date between '$fromdate' and '$todate') and docno like '%$docno%' group by docno";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="105%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
        <td width="860">
              <form name="cbform1" method="post" action="viewpurchaseindentuser.php">
                <table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                   <tr bgcolor="#011E6A">
              <td colspan="3" bgcolor="#CCCCCC" class="bodytext3"><strong>Discarded Purchase Indents Approval</strong></td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td width="11%" align="left" valign="center" 
				...
				<td width="17%" align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Export</strong></div></td>
              </tr>
			<?php
			$colorloopcount = '';
			$sno = '';
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left">
			    ...
			    <div align="left"><?php echo $remarks; ?></div></td>
                 <td class="bodytext31" valign="center" align="left">
			    <div align="left"><a href="purchaseindentapprovaluser.php?docno=<?php echo $docno; ?>"><strong> 
				View</strong></a></div></td>
				<td class="bodytext31" valign="center" align="left">
			    <div align="left"><a href="print_generaterpia.php?docnumber=<?php echo $docno; ?>"><strong>Excel</strong></a></div></td>
              </tr>
			<?php
			}    
			?>
