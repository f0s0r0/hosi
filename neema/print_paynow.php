...
if($res2transactionmode == 'CHEQUE')
{
$res2transactionmode = 'Cheque'.' '.'('.$res45chequenumber.' '.$res45bankname.' '.$res45chequedate.')';
}
...
if($res2transactionmode == 'CREDIT CARD')
{
$res2transactionmode = 'CREDIT CARD'.' '.'('.$res46creditcardname.' '.$res46creditcardnumber.' '.$res46creditcardbankname.')';
}

if ($res2transactionmode  == 'CASH')
{
$res2transactionmode = 'CASH';
}
...
<td>&nbsp;</td>
            ...
            <tr>
              ...
              <td colspan="2"  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><strong> Payment Mode: <?php echo $res2transactionmode; ?></strong></td>
              ...
              <td class="bodytext31" valign="center"  align="right" 
                bgcolor="#ffffff"><strong><?php echo number_format($res2transactionamount,2,'.',','); ?></strong></td>
				  ...
				  <?php if ($res2transactionmode == 'CASH')
				  {
				  ?>
				  <tr>
              <td class="bodytext31" valign="center"  align="left" 
...
<table>
	<tr>
	<td><strong>Amount in words:</strong> <?php echo $convertedwords; ?></td>
	</tr>
</table>
