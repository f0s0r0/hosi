    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="ipradiologyresults.php">
...
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
             <tr>
			 <td colspan="7" bgcolor="#cccccc" class="bodytext31"><div align="left"><strong>IP Radiology Results View</strong><label class="number"><<<?php echo $resnw1;?>>></label></div></td>
			 </tr>
            <tr>
	...
	$colorloopcount = $colorloopcount + 1;
          ...
          <tr <?php echo $colorcode; ?>>
			  ...
			  <!--<td class="bodytext31" valign="center"  align="left"><a href="#"><strong>Print</strong></a></td>-->
