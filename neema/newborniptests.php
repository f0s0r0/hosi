...
else
{
	...
	$paymentmode = $_REQUEST['billtype'];
		...
		if(($labname!="")&&($labrate!=''))
		{
		$labquery1=mysql_query("insert into ipconsultation_lab(patientcode,patientname,patientvisitcode,labitemcode,labitemname,labitemrate,consultationdate,paymentstatus,labsamplecoll,resultentry,labrefund,iptestdocno,accountname,billtype,consultationtime,freestatus,locationcode)values('$patientcode','$patientfullname','$visitcode','$labcode','$labname','$labrate','$currentdate','paid','pending','pending','norefund','$billnumbercode','$account','$billtype','$timeonly','$labfree','$locationcode')") or die(mysql_error());
				}
		}
...
<form name="form1" id="frmsales" method="post" action="newborniptests.php" >
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<tr>
			   ...
			   <input type="hidden" name="subtype" id="subtype" value="<?php echo $patientsubtype; ?>">
