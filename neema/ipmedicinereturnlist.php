    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="ipmedicinereturnlist.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Medicine Issue List </strong></td>
...
?>
	...
	//$docnumber=$res1['ipdocno'];
	$salseautonumber=$res1['auto_number'];
	...
	$colorloopcount = $colorloopcount + 1;
          ...
          <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left"><a href="medicinereturnrequest.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&docnumber=<?php echo $docnumber; ?>&&salseautonumber=<?php echo $salseautonumber;?>&&location=<?php echo $locationcode;?>"><strong>Process</strong></a></td>
              </tr>
		   <?php 
		   } 
