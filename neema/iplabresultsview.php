...
$docnumber = $_REQUEST["docnumber"];
	   $query26="update ipresultentry_lab set viewstatus ='$viewstatus' where patientcode='$patientcode' and patientvisitcode='$visitcode' and docnumber='$docnumber' ";
...
$query319="select * from ipresultentry_lab where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and docnumber='$docnumber'";
$exec319=mysql_query($query319) or die(mysql_error());
$res319=mysql_fetch_array($exec319);
$resultdate=$res319['recorddate']; 
?>
    ...
    <td colspan="4" align="left" valign="middle"  bgcolor="<?php if ($errmsg == '') { echo '#E0E0E0'; } else { echo 'red'; } ?>" class="bodytext3"><strong><?php echo $errmsg;?>&nbsp;</strong></td></tr>
	  ...
	  <td width="22%" class="bodytext3" align="left" valign="middle" bgcolor="#E0E0E0">
                ...
                <td width="26%" bgcolor="#E0E0E0" class="bodytext3">
                  ...
                  <input name="ADate" id="ADate" style="border: 1px solid #001E6A" value="<?php echo $resultdate; ?>"  size="8"  readonly="readonly" onKeyDown="return disableEnterKey()" />
     ...
     <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            align="left" border="0">
              <tbody>
			   ...
			   <?php 
			   $subTRsno = 0;
			  $query52="select * from master_labreference where itemname='$labname1' and itemcode='$itemcode2'";
			   ...
			   $labname2=$res52['itemname'];
				...
				$labitemanum = $res52['auto_number'];
				 ...
				 if($labreferencename != '')
				 {
				  $query87 = "select * from ipresultentry_lab where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and docnumber='$docnumber' and referencename = '$labreferencename'";
				 ...
				 $color1 = $res87['color'];
				  ...
				  {
				    $query87 = "select * from ipresultentry_lab where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and docnumber='$docnumber'";
				  $exec87 = mysql_query($query87) or die(mysql_error());
				  $res87 = mysql_fetch_array($exec87);
				  $resultvalue = $res87['resultvalue'];
				  $color1 = $res87['color'];
				...
				<input type="text" readonly name="result[]" id="result<?php echo $sn; ?>" size="8" value="<?php echo $resultvalue;?>" <?php if($color1 == 'orange') {  ?> style="border: 1px solid orange;" <?php } else if($color1 == 'green'){ ?> style="border: 1px solid green;"<?php } else if ($color1 == 'red'){ ?>style="border: 1px solid red;" <?php }?>></div></td>
               ...
               <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="right" width="180"><div align="left"> <?php if($labreferencerange == '')
			   {
      ...
      <tr>
              ...
              <td colspan="7" align="right" valign="top" >
             	  ...
             	  <a href="iplabresultsviewlist.php"><input name="Submit2223" type="button" value="Back" onClick="return acknowledgevalid()"  accesskey="b" class="button" style="border: 1px solid #001E6A"/></a>
               </td>
          </tr>
		  </table>
		  </td>
