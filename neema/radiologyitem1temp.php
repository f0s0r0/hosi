...
if ($st == 'del')
{
	...
	$query3 = "update $radtemplate set status = 'deleted' where auto_number = '$delanum'";
	$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
}
if ($st == 'activate')
{
	$delanum = $_REQUEST["anum"];
	$query3 = "update $radtemplate set status = '' where auto_number = '$delanum'";
	$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
}
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>
                ...
                <table width="900" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="7" bgcolor="#CCCCCC" class="bodytext3"><span class="bodytext32"><strong>Radiology Item Master - Existing List - Latest 100 radiology Items </strong></span></td>
						...
						?>
                         ...
                         <td align="left" valign="center" bgcolor="#E0E0E0" class="bodytext31" ><a target="_blank" href="print_raditemtemp.php?locationcode=<?php echo $locationcode; ?>&&radtemp=<?=$radtemplate?>"><img src="images/excel-xls-icon.png" width="30" height="30"></a></td>
                      </tr>
                      <tr bgcolor="#011E6A">
	  ...
	  if ($searchflag1 == 'searchflag1')
	  {
		...
		$search1 = $_REQUEST["search1"];			  
	    $query1 = "select * from $radtemplate where itemname like '%$search1%' or categoryname like '%$search1%' and status <> 'deleted' group by itemcode order by auto_number desc LIMIT $start , $limit";
	...
	{
	$query1 = "select * from $radtemplate where status <> 'deleted' group by itemcode order by auto_number desc LIMIT $start , $limit";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		while ($res1 = mysql_fetch_array($exec1))
		{
		$itemcode = $res1["itemcode"];
	  ...
	  if ($searchflag2 == 'searchflag2')
	  {
	    ...
	    $query1 = "select * from $radtemplate where itemname like '%$search2%' or categoryname like '%$search1%' and status = 'deleted' group by itemcode order by auto_number desc LIMIT 100";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		while ($res1 = mysql_fetch_array($exec1))
		{
		$itemcode = $res1["itemcode"];
