...
$itemstatus = '';
			...
			$stockquery2 .= "	'$billnumbercode', 'New Batch','1','1', '$locationcode','','$storecode', '', '$username', '$ipaddress','$updatedate','$updatetime','$updatedatetime','$salesprice','$totalamount')";
			...
			manufactureranum, manufacturername,typeofpurchase,suppliername,suppliercode,ponumber,supplierbillnumber,costprice,location,store,coa,categoryname,fifo_code) 
			...
			'$packageanum', '$packagename', '$quantityperpackage', '$allpackagetotalquantity', 
			'$manufactureranum', '$manufacturername','Process','$suppliername','$suppliercode','$ponumber','$supplierbillno','$costprice','$location','$store','$coa','$categoryname','$fifo_code')";
	  ...
	  <td>&nbsp;
			...
			<tr>
			  ...
			  <tr>
				...
				<input name="docno" id="docno" value="<?php echo $billnumbercode; ?>" style="border: 1px solid #001E6A;" size="10" autocomplete="off" readonly type="hidden"/>                  </td>
             ...
             <td width="11%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><strong>MRN Date </strong></td>
				...
				<input name="lpodate" id="lpodate" value="<?php echo $billdate; ?>" style="border: 1px solid #001E6A" size="18" rsize="20" readonly type="hidden"/>				</td>
			    </tr>
				<tr>
				...
				<input name="supplier" id="supplier" value="<?php echo $suppliername; ?>" style="border: 1px solid #001E6A;" size="25" autocomplete="off" readonly type="hidden"/>    
             ...
             <td width="11%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><strong>GRN Date </strong></td>
				...
				<input name="grndate" id="grndate" value="<?php echo $dateonly; ?>" style="border: 1px solid #001E6A" size="18" rsize="20" readonly type="hidden"/>				</td>
			    </tr>
				<tr>
				...
				<input name="address" id="address" value="<?php echo $address; ?>" style="border: 1px solid #001E6A;" size="30" autocomplete="off" readonly type="hidden"/>                  </td>
				...
				<input name="telephone" id="telephone" value="<?php echo $tele; ?>" style="border: 1px solid #001E6A" size="25" rsize="20" readonly type="hidden"/>				</td>
             <td width="11%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><strong>Time </strong></td>
				...
				<input name="time" id="time" value="<?php echo $timeonly; ?>" style="border: 1px solid #001E6A" size="18" rsize="20" readonly type="hidden"/>				</td>
               ...
               <option value=""> Select Store</option>
                 <?php
				echo $query5 = "select * from master_store where location = '$res7locationanum' and recordstatus = ''";
				$exec5 = mysql_query($query5) or die ("Error in Query5".mysql_error());
				while ($res5 = mysql_fetch_array($exec5))
				{
...
?>
  <tr>
		...
		<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" name="receivedquantity[]" id="receivedquantity<?php echo $sno; ?>" size="6" onKeyUp="return totalcalc('<?php echo $sno; ?>');" class="bodytext21" autocomplete="off" value="<?php echo intval($quantity); ?>" readonly></div></td>
		...
		<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" name="batch[]" id="batch<?php echo $sno; ?>" size="6" class="bodytext21" autocomplete="off" value="<?php echo $batchnumber; ?>" readonly></div></td>
		<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" name="expirydate[]" id="expirydate<?php echo $sno; ?>" size="6" autocomplete="off" value="<?php echo $newexpirydate; ?>" readonly></div></td>
		...
		<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" name="free[]" id="free<?php echo $sno; ?>" size="6" onKeyUp="return totalcalc1('<?php echo $sno; ?>');" class="bodytext21" autocomplete="off" value="<?php echo intval($free); ?>" readonly></div></td>
		<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" name="totalquantity[]" id="totalquantity<?php echo $sno; ?>" size="6" class="bodytext21" readonly value="<?php echo intval($totalqty); ?>" readonly="readonly"></div></td>
		<td class="bodytext31" valign="center"  align="right"><?php echo number_format($quotedprice,2,'.',','); ?></td>
		<td class="bodytext31" valign="center"  align="right"><div align="right"><input type="text" name="priceperpack[]" id="priceperpack<?php echo $sno; ?>" size="6" onKeyUp="return totalamount('<?php echo $sno; ?>','<?php echo $number; ?>');" class="bodytext21" autocomplete="off" value="<?php echo $rate; ?>" readonly align="right" style="<?php echo $error_css; ?>"></div></td>
		<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" name="discount[]" id="discount<?php echo $sno; ?>" size="6" onKeyUp="return totalamount5('<?php echo $sno; ?>','<?php echo $number; ?>');" class="bodytext21" autocomplete="off" value="<?php echo $discountpercent; ?>" readonly></div></td>
		<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" name="tax[]" id="tax<?php echo $sno; ?>" size="6" onKeyUp="return totalamount20('<?php echo $sno; ?>','<?php echo $number; ?>');" class="bodytext21" autocomplete="off" value="<?php echo $itemtaxpercentage; ?>" readonly></div></td>
		<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" name="totalamount[]" id="totalamount<?php echo $sno; ?>" size="6" class="bodytext21" readonly value="<?php echo number_format($itemtotalamount,2,'.',','); ?>"></div></td>
		<input type="hidden" name="totalamount1[]" id="totalamount<?php echo $sno; ?>" size="6" class="bodytext21" readonly value="<?php echo $itemtotalamount; ?>">
		<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" name="costprice[]" id="costprice<?php echo $sno; ?>" size="6" class="bodytext21" readonly value="<?php echo number_format($costprice,2,'.',','); ?>"></div></td>
		<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="hidden" name="saleprice1[]" id="saleprice1<?php echo $sno; ?>" size="6" class="bodytext21" readonly value="<?php echo $saleprice; ?>">
		<input type="hidden" name="spmarkup" id="spmarkup<?php echo $sno; ?>" value="<?php echo $spmarkup; ?>"><input type="text" name="saleprice[]" id="saleprice<?php echo $sno; ?>" size="6" class="bodytext21" readonly value="<?php echo number_format($saleprice,2,'.',','); ?>"></div></td>
					</tr>
			<?php 
	  ...
	  <table width="716">
     <tr>
	 <td width="20" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">Total Purchase Cost</td><input type="hidden" name="totalpurchaseamount1" id="totalpurchaseamount" size="10" readonly value="<?php echo $grandtotalamount; ?>">
	   <td width="111" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><input type="text" name="totalpurchaseamount" id="totalpurchaseamount" size="10" readonly value="<?php echo number_format($grandtotalamount,2,'.',','); ?>"></td>
