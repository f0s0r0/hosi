...
<tr>
<td colspan="12" align="center" valign="middle"><strong>IP Debit Reconcile</strong></td>
</tr>
...
<?php 
$query8 = "SELECT visitcode,billnumber as docno,transactionamount,transactiondate,accountname,accountnameid FROM `master_transactionpaylater` WHERE `billnumber` LIKE '%IPDr%' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactiontype` = 'finalize' order by auto_number";
...
$i = 0;
$drresult = array();
$querydr1bnk = "SELECT SUM(`amount`) as income FROM `ip_debitnotebrief` WHERE docno = '$docno' and `accountcode` <> ''
