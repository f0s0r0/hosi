...
include ("autocompletebuild_customeripdeposit.php");
?>
<style type="text/css">
<!--
body {
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="advancepatientslist.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="1" bgcolor="#CCCCCC" class="bodytext3"><strong>Advance Deposit - Edit </strong></td>
	  ...
	  <form name="form11" id="form11" method="post" action="advancepatientslist.php">	
	  <tr>
        <td>
...
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
		   ...
		   $colorloopcount = 0;
		   $sno = 0;
		  $query2 = "select * from master_transactionadvancedeposit where patientname like '%$searchpatient%' and recordstatus <> 'adjusted' and locationcode = '$searchlocation'";
          ...
          <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo number_format($amount,2); ?></div></td>
			  <td class="bodytext31" valign="center"  align="left"><div align="center"><strong><a href="editadvancedeposit.php?docno=<?php echo $docno; ?>"><?php echo 'Edit'; ?></a></strong></div></td>
          </tr>
		   <?php
		   }
		   ?>
