...
?>
<?php
$query764 = "select * from master_financialintegration where field='consultationfee'";
 ...
 <tr>
  ...
  <tr>
    ...
    <td width="97%" valign="top">
		  	  	<form id="form1" name="form1" method="post" action="editconsultationbillcoaintegration.php" onSubmit="return process1login1()">
    ...
    <td>&nbsp;</td>
                 ...
                 <tr bgcolor="#011E6A">
                        <td colspan="10" bgcolor="#CCCCCC" class="bodytext3"><strong>Edit Consultation Bill </strong></td>
                  </tr>
					   <tr>
