...
if (isset($_REQUEST["cbfrmflag1"])) { $cbfrmflag1 = $_REQUEST["cbfrmflag1"]; } else { $cbfrmflag1 = ""; }
			...
			{
			$resutlanums = $_REQUEST['resultanum'];
			foreach ($resutlanums as $key => $value)
			{
				$resultanum = $_REQUEST['resultanum'][$key];
				$resultvalue = $_REQUEST['result'][$key];
				$query112 = "update pending_test_orders set result  = '".$resultvalue."' where auto_number = '$resultanum'";
				mysql_query($query112);
			}
...
$ln=0;
			...
			$labreferencename = $res521['parametercode'];
			   ...
			   $exec52=mysql_query($query64a);
				...
				$labitemanum = $res52['auto_number'];
				 ...
				 $resultanum = $res87['auto_number'];
				  ...
				  $query64 = "select * from master_test_parameter where labcode='$itemcode2' and parametercode = '$parametercode' group by parametername";
...
//echo $query64;
				...
				//echo $labreferencerange1[0];
				 ...
				 $pastresult = $res49['resultvalue'];
				  ...
				  <input type="hidden" name="resultanum[<?php echo $sn; ?>]" value="<?php echo $resultanum; ?>">
				
                  <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="center"><div align="center"> 
				  <textarea name="result[<?php echo $sn; ?>]" id="result<?php echo $sn; ?>" ><?php echo $resultvalue;?></textarea></div></td>
