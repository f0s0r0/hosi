            ...
            <tr bgcolor="#011E6A">
             ...
             <tr>
                ...
                bgcolor="#FFFFFF" class="bodytext31"> Date From </td>
                      <td width="24%" align="left" valign="center"  bgcolor="#FFFFFF" class="bodytext31"><input name="ADate1" id="ADate1" style="border: 1px solid #001E6A" value="<?php echo $ADate1; ?>"  size="10"  readonly="readonly" onKeyDown="return disableEnterKey()" />
       ...
       <tr>
		...
		<table width="600" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
			...
			//echo $ADate2;
			  ...
			  $snocount = "";
			$query1 = "select accountsmain,auto_number,section from master_accountsmain where recordstatus <> 'deleted' and section IN ('I') order by section, auto_number, accountsmain";
			...
			<tr bgcolor="#999999">
			<td width="695" align="left" class="bodytext3" style="color:#000000"><strong>Total :</strong></td>
			<td width="100" align="right" class="bodytext3" style="color:#000000"><strong><?php $groupleft12 = groupleft('0'); echo number_format($groupleft12,2,'.',','); ?></strong>&nbsp;&nbsp;</td>
			</tr>
			<tr>
			<td colspan="2" width="695" align="left" class="bodytext3" style="color:#000000"><strong>&nbsp;</strong></td>
			</tr>
            <?php
			...
			//echo $ADate2;
			  ...
			  $snocount = "";
			$query1 = "select accountsmain,auto_number,section from master_accountsmain where recordstatus <> 'deleted' and section IN ('E') order by section, auto_number desc";
			$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
			while($res1 = mysql_fetch_array($exec1))
			{  
			$accountsmain = $res1['accountsmain'];
			...
			<tr bgcolor="#999999">
			<td width="695" align="left" class="bodytext3" style="color:#000000"><strong>Total :</strong></td>
			<td width="100" align="right" class="bodytext3" style="color:#000000"><strong><?php $groupright12 = groupright(0); echo number_format($groupright12,2,'.',','); ?></strong>&nbsp;&nbsp;</td>
			</tr>
			<tr bgcolor="#CCFF00">
			<td width="695" align="left" class="bodytext3" style="color:#000000"><strong>Net Profit / Loss :</strong></td>
			<td width="100" align="right" class="bodytext3" style="color:#000000"><strong><?php $netpandl = $groupleft12 - $groupright12; echo number_format($netpandl,2,'.',','); ?></strong>&nbsp;&nbsp;</td>
			</tr>
			<tr>
			<td colspan="2" align="right"><a href="incomestatementxl.php?ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2; ?>" target="_blank"><img  width="40" height="40" src="images/excel-xls-icon.png" style="cursor:pointer;"></a></td>
			</tr>
			<?php
			}
			?>
