    ...
    <td width="99%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="790" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Patient Visit Wise Report </strong></td>
           ...
           <tr>
			...
			<tr>
              ...
              <td width="20%" align="left" valign="top"  bgcolor="#FFFFFF"><span class="bodytext31">
			   ...
			   <td align="left" colspan="2" valign="middle"  bgcolor="#FFFFFF" class="bodytext31"></td>
			  </tr>
...
&nbsp;				<input type="hidden" value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" id="resetbutton22"  style="border: 1px solid #001E6A" />
            ...
            <tr>
              <td class="bodytext31" valign="center"  align="left" 
				...
				<td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><strong>Type</strong></td>
			...
			if (isset($_REQUEST["cbfrmflag1"])) { $cbfrmflag1 = $_REQUEST["cbfrmflag1"]; } else { $cbfrmflag1 = ""; }
				...
				if ($cbfrmflag1 == 'cbfrmflag1')
				{
			$query2 = "select * from master_visitentry where locationcode='$locationcode1' and patientfullname like '%$patientfirstname%' and visitcode like '%$visitcode%' and registrationdate between '$transactiondatefrom' and '$transactiondateto' order by patientcode";
			...
			$query78 = "select paymenttype from master_paymenttype where auto_number = '$paymenttype'";
			$exec78 = mysql_query($query78) or die ("Error in Query78".mysql_error());
			$res78 = mysql_fetch_array($exec78);
			$paymenttypename = $res78['paymenttype'];
			...
			{
			$query5 = "select sum(amount) as pharmacyitemrate1 from billing_paylaterpharmacy where locationcode='$locationcode1' and patientcode = '$res2patientcode' and patientvisitcode = '$res2visitcode'";
			}
			else 
			{
			$query5 = "select sum(amount) as pharmacyitemrate1 from billing_paynowpharmacy where locationcode='$locationcode1' and patientcode = '$res2patientcode' and patientvisitcode = '$res2visitcode'";
			}
			...
			if($res2billtype == 'PAY LATER')
			{
			$query6 = "select sum(radiologyitemrate) as radiologyitemrate1 from billing_paylaterradiology where locationcode='$locationcode1' and patientcode = '$res2patientcode' and patientvisitcode = '$res2visitcode'";
			}
			else 
			{
			$query6 = "select sum(radiologyitemrate) as radiologyitemrate1 from billing_paynowradiology where locationcode='$locationcode1' and patientcode = '$res2patientcode' and patientvisitcode = '$res2visitcode'";
			}
			...
			if($res2billtype == 'PAY LATER')
			{
			$query7 = "select sum(labitemrate) as labitemrate1 from billing_paylaterlab where locationcode='$locationcode1' and patientcode = '$res2patientcode' and patientvisitcode = '$res2visitcode'";
			}
			else 
			{
			$query7 = "select sum(labitemrate) as labitemrate1 from billing_paynowlab where locationcode='$locationcode1' and patientcode = '$res2patientcode' and patientvisitcode = '$res2visitcode'";
			}
			...
			if($res2billtype == 'PAY LATER')
			{
			$query8 = "select sum(servicesitemrate) as servicesitemrate1 from billing_paylaterservices where locationcode='$locationcode1' and patientcode = '$res2patientcode' and patientvisitcode = '$res2visitcode'";
			}
			else 
			{
			$query8 = "select sum(servicesitemrate) as servicesitemrate1 from billing_paynowservices where locationcode='$locationcode1' and patientcode = '$res2patientcode' and patientvisitcode = '$res2visitcode'";
			}
            ...
            <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext31" valign="middle" align="left"><?php echo $paymenttypename; ?></td>
			  <td class="bodytext31" valign="center"  align="left">
