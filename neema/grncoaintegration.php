 ...
 <tr>
  ...
  <tr>
    ...
    <td width="97%" valign="top">
		  	  	<form id="form1" name="form1" method="post" action="grncoaintegration.php" onSubmit="return process1login1()">
    ...
    <td>&nbsp;</td>
                 ...
                 <tr bgcolor="#011E6A">
                        <td colspan="10" bgcolor="#CCCCCC" class="bodytext3"><strong>Goods Received Note</strong></td>
                  </tr>
					   <tr>
				  ...
				  <tr>
				  <td width="248" align="left" valign="top"  class="bodytext5">Debit Account <input type="hidden" name="labpaynow" value="grn" /></td>
