...
$patientvisitcode=isset($_REQUEST['patientvisitcode'])?$_REQUEST['patientvisitcode']:'';
...
//get ends here
	$paynowbillprefix = 'AMBOP-';
$paynowbillprefix1=strlen($paynowbillprefix);
$query2 = "select * from op_ambulance order by auto_number desc limit 0, 1";
...
<table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                   <tr bgcolor="#011E6A">
              <td colspan="5" bgcolor="#CCCCCC" class="bodytext3"><strong> Search Patient to OpAmbulance </strong></td>
              <?php
            ...
            <tr>
				  ...
				  <input name="customer" id="customer" size="60" autocomplete="off" value="<?php echo $customer;?>">
 				...
 				<input type="hidden" name="recordstatus" id="recordstatus">
				  <input type="hidden" name="billnumbercode" id="billnumbercode" value="" readonly style="border: 1px solid #001E6A;">	
				  <input name="apnum" id="apnum" value="" type="hidden">
                  <input type="hidden" name="patientvisitcode" id="patientvisitcode"  value="<?php echo $patientvisitcode;?>" >
                  <input type="hidden" name="patientcode" id="patientcode"  value="<?php echo $patientcode;?>" >
                  <input type="hidden" name="accountnamename" id="accountnamename"  value="<?php echo $accountnamename;?>" >
                  <input type="hidden" name="showdetails" id="showdetails"  value="<?php echo $showdetails;?>">
				  			  </td>
                  
                    <input type="hidden" name="location" id="location" value="<?php echo $locationcodeget?>">
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="792">
        <form name="form1" id="frmsales" method="post" action="opambulance.php" onKeyDown="return disableEnterKey(event)">
        <table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
            <?php if($showdetails=='yes'){
	  
	  
					 	$query = "select * from master_visitentry where visitcode='".$patientvisitcode."'";
						$exec = mysql_query($query) or die ("Error in Query1".mysql_error());
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
				        ...
				        <tr>-->
				   <td colspan="11" align="left" valign="middle"  bgcolor="#CCCCCC" class="bodytext3"><span class="bodytext32"><strong> Ambulance </strong> </span></td>
		        </tr>
				<tr id="reffid">
