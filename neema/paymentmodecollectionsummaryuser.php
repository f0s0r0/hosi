    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="paymentmodecollectionsummaryuser.php">
                <table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                    <tr bgcolor="#011E6A">
                      <td colspan="3" bgcolor="#CCCCCC" class="bodytext3"><strong>Collections Summary</strong>&nbsp;&nbsp;&nbsp;<a href="#" onClick="viewReport();"><strong>W</strong></a></td>
           ...
           <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="right">
				...
				<td class="bodytext31" valign="center" bgcolor="#E0E0E0" align="right"> 
                 <a target="_blank" href="print_paymentmodecollectionsummary11.php?cbfrmflag1=cbfrmflag1&&ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2; ?>"> <img src="images/pdfdownload.jpg" width="30" height="30"></a>
                </td>	
				<?php } ?>	 
