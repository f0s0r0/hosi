  ...
  <tr>
    ...
    <td valign="top"><table width="99%" border="0" cellspacing="0" cellpadding="0">
      <tr>
       ...
       <tr>
        <td valign="top"><table width="1072" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            <?php
				...
				<tr bgcolor="#CCC">
				<td width="78" align="left" class="bodytext3"><strong><?php echo 'S.No'; ?></strong></td>
				<td width="78" align="left" class="bodytext3"><strong><?php echo 'Date'; ?></strong></td>
				<td width="78" align="left" class="bodytext3"><strong><?php echo 'Docno'; ?></strong></td>
				<td width="87" align="left" class="bodytext3"><strong><?php echo 'Code'; ?></strong></td>
				<td width="367" align="left" class="bodytext3"><strong><?php echo 'Description'; ?></strong></td>
				<td width="108" align="right" class="bodytext3"><strong><?php echo 'Debit'; ?></strong></td>
				<td width="100" align="right" class="bodytext3"><strong><?php echo 'Credit'; ?></strong></td>
				<td width="112" align="right" class="bodytext3"><strong><?php echo 'Balance'; ?></strong></td>
				</tr>
				<?php
				$colorloopcount = '';
				$orderid1 = '';
				...
				{  
					...
					$querydr1 = "SELECT (`totalamount`) as expenses,`entrydate` as td2,`billnumber` as td3,`itemcode` as td4,`itemname` as td5 FROM `expensepurchase_details` WHERE `expensecode` = '$id' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2' and recordstatus <> 'deleted'
								 ...
								 UNION ALL SELECT (`transactionamount`) as expenses,`transactiondate` as td2,`docnumber` as td3,`expensecoa` as td4, CONCAT(`payee`,' - ',`remarks`) as td5 FROM `expensesub_details` WHERE `expensecoa` = '$id' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2'
								 ...
								 UNION ALL SELECT (transactionamount) as expenses, updatedate as td2, paymonth as td3, accountcode as td4, accountname as td5 FROM master_transactionpayroll WHERE accountcode = '$id' AND transactiontype = 'PROCESS' AND updatedate BETWEEN '$ADate1' AND '$ADate2'
								 UNION ALL SELECT (depreciation) as expenses, entrydate as td2, billnumber as td3, processmonth as td4, itemname as td5 FROM assets_depreciation WHERE depreciationledgercode = '$id' AND entrydate BETWEEN '$ADate1' AND '$ADate2'";
					...
					<tr>
					<td colspan="8" align="right" class="bodytext3">
					<?php 
					$urlpath = "cbfrmflag1=cbfrmflag1&&ADate1=$ADate1&&ADate2=$ADate2&&id=$id";
					?>
             		<a href="detail_accountexpensexl.php?<?php echo $urlpath; ?>"><img  width="40" height="40" src="images/excel-xls-icon.png" style="cursor:pointer;"></a></td>
					</tr>
</tbody>				
</table>
</td>
