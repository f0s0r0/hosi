		...
		while($res1=mysql_fetch_array($exec1))
            ...
            <tr <?php echo $colorcode; ?>>
			  ...
			  <div class="bodytext31" align="center"><?php echo $mrnno; ?></div></td>
			      <td  align="left" valign="center" class="bodytext31"><div class="bodytext31" align="center"><a href="editmaterialreceiptnote.php?ponumber=<?php echo $pono; ?>&&mrnnumber=<?php echo $mrnno; ?>">Edit</a></div></td>
			      <td class="bodytext31" valign="center" align="left" >
			  <div class="bodytext31" align="center"><a target="_blank" href="print_mrn_dmp4inch1.php?billautonumber=<?php echo $mrnno; ?>&&billnum=<?php echo $pono; ?>">Print</a></div></td>
                </tr>
			  <?php
			}
			?>
