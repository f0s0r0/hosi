...
mysql_query($qryparam) or die("Error in qryparam".mysql_error());
   ...
   $exec42=mysql_query($query42) or die("query update ipcons_lab".mysql_error());
...
echo '<script>window.open("print_labsample_label.php?docnumber='.$sampleid1.'","OriginalWindowA4","width=800,height=800,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25");</script>';
  header("location:iplabsamplecollectionlist.php?docnumber=$sampleid1");
  exit();
}
