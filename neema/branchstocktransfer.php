...
else
{
	...
	{	
		...
		$itemcode = $itemcode;
		//include('autocompletestockbatch.php');
		$querybatstock2 = "select batch_quantity from transaction_stock where batch_stockstatus='1' and itemcode='$itemcode' and locationcode='$tolocationcode' and fifo_code='$fifo_code' and storecode ='$store'";
		$execbatstock2 = mysql_query($querybatstock2) or die ("Error in batQuery2".mysql_error());
		$resbatstock2 = mysql_fetch_array($execbatstock2);
		$bat_quantity = $resbatstock2["batch_quantity"];
		$currentstock = $bat_quantity;
		...
		$queryupdatebatstock2 = "update transaction_stock set cum_stockstatus='0' where itemcode='$itemcode' and locationcode='$fromlocationcode'";
		$execupdatebatstock2 = mysql_query($queryupdatebatstock2) or die ("Error in updatebatQuery2".mysql_error());
		...
		$querycumstock2 = "select cum_quantity from transaction_stock where cum_stockstatus='1' and itemcode='$itemcode' and locationcode='$tolocationcode'";
		$execcumstock2 = mysql_query($querycumstock2) or die ("Error in CumQuery2".mysql_error());
		$rescumstock2 = mysql_fetch_array($execcumstock2);
		$cum_quantity = $rescumstock2["cum_quantity"];
		$cum_quantity = $cum_quantity+$tnxquantity;
		
		$querybatstock2 = "select batch_quantity from transaction_stock where batch_stockstatus='1' and itemcode='$itemcode' and locationcode='$tolocationcode' and fifo_code='$fifo_code' and storecode ='$tostore'";
		$execbatstock2 = mysql_query($querybatstock2) or die ("Error in batQuery2".mysql_error());
		$resbatstock2 = mysql_fetch_array($execbatstock2);
		$bat_quantity = $resbatstock2["batch_quantity"];
		$bat_quantity = $bat_quantity+$tnxquantity;
		
		$queryupdatebatstock2 = "update transaction_stock set cum_stockstatus='0' ,batch_stockstatus='0' where itemcode='$itemcode' and locationcode='$tolocationcode' and storecode='$tostore' and fifo_code='$fifo_code'";
		$execupdatebatstock2 = mysql_query($queryupdatebatstock2) or die ("Error in updatebatQuery2".mysql_error());
		
		$queryupdatebatstock2 = "update transaction_stock set cum_stockstatus='0' where itemcode='$itemcode' and locationcode='$tolocationcode'";
		$execupdatebatstock2 = mysql_query($queryupdatebatstock2) or die ("Error in updatebatQuery2".mysql_error());
		...
		$stockquery2="insert into transaction_stock (fifo_code,tablename,itemcode, itemname, transaction_date,transactionfunction,description,
			...
			'$batchnumber', '$bat_quantity', '$tnxquantity', 
			'$cum_quantity', '$billnumbercode1', '','1','1', '$tolocationcode','','$tostore', '', '$username', '$ipaddress','$dateonly','$timeonly','$datetimeonly','$rate','$amount')";
	...
	values('$billnumbercode1','$fromstore','$tostore','$medicinecode','$medicinename','$tnxquantity','$batchname','$fromstorequantitybeforetransfer','$fromstorequantityaftertransfer','$tostorequantitybeforetransfer','$tostorequantityaftertransfer','$rate','$amount','$username','$ipaddress','$companyanum','completed','$updatedatetime','$categoryname','$fromlocationname','$fromlocationcode','$tolocationname','$tolocationcode','$fifo_code')";
...
{ 
	var tolocation= document.getElementsByClassName('tolocation');
	
	var cnt=parseInt(tolocation.length);
	
	for(var i=0; i < cnt; i++)
	{
		tolocation[i].style.display='block';
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="branchstocktransfer.php">
                <table width="1197" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                    <tr bgcolor="#011E6A">
                      <td colspan="8" bgcolor="#E0E0E0" class="bodytext32"><strong>Branch Stock transfer </strong></td>
                    ...
                    <tr>
					  ...
					  <td align="left" class="bodytext3"><select name="location" id="location" onChange="return funcSelectFromStore(this.value)">
			 ...
			 <td align="left" class="bodytext3"><strong>To Location</strong></td>
					  <td align="left" class="bodytext3"><select name="tolocation" id="tolocation" onChange="return funcSelectToStore()">
                  	 <option value="">Select Location</option>
				  <?php
