    ...
    <td valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
			...
			<form name="drugs" action="pharmacysalesbycategory.php" method="post" onKeyDown="return disableEnterKey()">
	<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="700" 
            align="left" border="0">
      <tbody id="foo">
        <tr>
          <td colspan="6" bgcolor="#cccccc" class="bodytext31"><strong>Pharmacy Sales By Category</strong></td>
          </tr>
        <tr>
...
function disableEnterKey()
{
	...
	else
	{
        ...
        <tr>
          ...
          <td width="129" align="left" valign="center"  bgcolor="#ffffff" class="bodytext31"><input name="ADate1" id="ADate1" value="<?php echo $transactiondatefrom; ?>"  size="10"  readonly="readonly" onKeyDown="return disableEnterKey()" />
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			<?php	
				/*$query9 = "select * from master_medicine where status = '' group by categoryname order by categoryname";
				$exec9 = mysql_query($query9) or die(mysql_error());
				while($res9 = mysql_fetch_array($exec9))
				{
				
				$categoryname = $res9['categoryname'];*/
				$query7 = "select * from pharmacysales_details where categoryname like '%$categoryname%' and entrydate between '$ADate1' and '$ADate2' group by categoryname order by entrydate desc";
				...
				$num7 = mysql_num_rows($exec7);
					...
					$categoryname = $res7['categoryname'];
					//$total=$total+$quantity6;
					$query17 = "select sum(quantity) as quantity from pharmacysales_details where categoryname like '%$categoryname%' and entrydate between '$ADate1' and '$ADate2'";
					...
					<td align="left" valign="center"  
					class="bodytext31"><div align="left"><?php echo $categoryname; ?></div></td>
					<td align="left" valign="center"  
