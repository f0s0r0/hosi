...
$a_json = array();
$a_json_row = array();
echo $query1 = "select customercode,customerfullname,nationalidnumber,mobilenumber,accountname,dateofbirth,area from master_customer where $customersearch and status <> 'Deleted'  order by auto_number limit 0, 20";
