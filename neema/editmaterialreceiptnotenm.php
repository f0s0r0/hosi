...
{
echo $billnumber = $_REQUEST['billnum'];
echo $billdate = $_REQUEST['billdate'];
echo $suppliername = $_REQUEST['suppliername'];
echo $suppliercode = $_REQUEST['suppliercode'];
echo $ponumber = $_REQUEST['pono'];
echo $accountssubid = $_REQUEST['accountssubid'];
echo $supplierbillno = $_REQUEST['supplierbillno1'];
echo $amount = $_REQUEST['totalpurchaseamount'];
echo $query23 = "select * from master_employee where username='$username'";
echo $exec23 = mysql_query($query23) or die(mysql_error());
echo $res23 = mysql_fetch_array($exec23);
...
echo $location = $res55['locationname'];
//exit;
...
//print_r($_POST);exit;
			...
			$query4 = "update materialreceiptnote_nmdetails set rate='$rate',priceperpack='$priceperpack',quantity='$quantity',subtotal='$totalamount',free='$free',discountpercentage='$itemdiscountpercent',totalamount='$amount',username='$username',ipaddress='$ipaddress',entrydate='$billdate',itemtaxpercentage='$itemtaxpercent',itemfreequantity='$free',itemtotalquantity='$quantity',
			suppliername='$suppliername',suppliercode='$suppliercode',ponumber='$ponumber',supplierbillnumber='$supplierbillno',location='$location',store='$store',coa='$coa',quotedprice='$quotedprice' where billnumber='$billnumber' and ponumber='$ponumber' and itemname='$itemname'";
...
while ($res5 = mysql_fetch_array($exec5))
{
	...
	$query445 = "select * from materialreceiptnote_nmdetails where ponumber='$billnum'";
...
//alert(totaladjamount);
if(totaladjamount == "")
{
totaladjamount=0;
}
grandtotaladjamt= parseFloat(grandtotaladjamt) + parseFloat(totaladjamount);//alert('hi');
...
-->
  <tr>
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
		 <form name="cbform1" method="post" action="editmaterialreceiptnotenm.php"> 
	  ...
	  <td>&nbsp;
			...
			<tr>
              <td bgcolor="#CCCCCC" class="bodytext3" colspan="8"><strong>NM Edit Material Receipt Note</strong></td>
      ...
      <tr>
        <td>
		<form action="editmaterialreceiptnotenm.php" method="post" name="form">
...
?>
  <tr>
		...
		<!--<td class="bodytext31" valign="center"  align="left"><div align="center">--><input type="hidden" name="free[]" id="free<?php echo $sno; ?>" size="6" onKeyUp="return totalcalc1('<?php echo $sno; ?>');" class="bodytext21" autocomplete="off" value="<?php echo intval($free); ?>"></div><!--</td>-->
