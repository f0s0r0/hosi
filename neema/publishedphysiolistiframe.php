...
<table>
  <tr>
    <td width="99%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="1145"><form name="cbform1" method="post" action="publishedphysiolistiframe.php">
      ...
      <tr>
		...
		$gender = $res43['gender'];
            ...
            <tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left"><div align="left"> <a target="_parent" href="physiotherapyresultscheck.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>"> <strong><?php echo $res1patientname; ?> (<?php echo $patientcode; ?>,<?php echo $visitcode; ?>),<?php echo $gender; ?>,<?php echo $age; ?></strong> </a> </div></td>
