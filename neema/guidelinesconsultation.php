...
$filename=basename($uploadfile);
		...
		header("location:guidelinesentry.php");
		exit();
}
...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
		...
		<td align="left" valign="middle"  bgcolor="#E0E0E0" class="style4">Guidelines List of Files: </td>
			<?php 
  ...
  <tr>
	  <td class="bodytext31" valign="center"  align="left"><a href="" target="_blank"><?php echo $filename; ?></a></td>
  </tr>  
               <?php } ?>
  </table>
