...
{   
	...
	$query21=mysql_query("update master_visitentry set referalbill='completed' where visitcode='$visitcode'");
header("location:billing_pending_opreferal.php");
...
$referalprefix = $res3['referalprefix'];

$query2 = "select * from billing_referal order by auto_number desc limit 0, 1";
$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
$res2 = mysql_fetch_array($exec2);
$billnumber = $res2["billnumber"];
if ($billnumber == '')
{
	$billnumbercode =$referalprefix.'00000001';
	$openingbalance = '0.00';
}
else
{
	...
	$billnumbercode = $referalprefix.$maxanum1;
	$openingbalance = '0.00';
	//echo $companycode;
}
?>
...
<form name="frmsales" id="frmsales" method="post" action="billing_opnew4.php" onKeyDown="return disableEnterKey(event)">
        ...
        <td><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
               ...
               <td bgcolor="#CCCCCC" class="bodytext3"><strong>Referal Bill No. </strong></td>
	 <td bgcolor="#CCCCCC" class="bodytext3"> <input name="billnumber" id="billnumber" value="<?php echo $billnumbercode; ?>" <?php echo $billnumbertextboxvalidation; ?> style="border: 1px solid #001E6A; text-align:right" size="9" readonly="readonly"/> </td>
