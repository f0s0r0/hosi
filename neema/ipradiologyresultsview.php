...
<body>
<form name="frm" id="frmsales" method="post" action="ipradiologyresultsview.php" onKeyDown="return disableEnterKey(event)">
  ...
  <tr>
    ...
    <td colspan="4" align="left" valign="middle"  bgcolor="<?php if ($errmsg == '') { echo '#E0E0E0'; } else { echo 'red'; } ?>" class="bodytext3"><strong><?php echo $errmsg;?>&nbsp;</strong></td></tr>
	  ...
	  <td width="22%" class="bodytext3" align="left" valign="middle" bgcolor="#E0E0E0">
                ...
                <td width="26%" bgcolor="#E0E0E0" class="bodytext3"><?php echo $dateonly1; ?>
		...
		<tr id="idTRMain<?php echo $sno; ?>" <?php echo $colorcode; ?>>
		 ...
		 ?>
              ...
              <td colspan="7" align="right" valign="top" >
             	  ...
             	  <a href="ipradiologyresultsviewlist.php"><input name="Submit2223" type="button" value="Back" onClick="return acknowledgevalid()"  accesskey="b" class="button" style="border: 1px solid #001E6A"/></a>
               </td>
          </tr>
		  </table>
</td>
