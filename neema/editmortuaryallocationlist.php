...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
              <form name="cbform1" method="post" action="editmortuaryallocationlist.php">
                <table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                    <tr bgcolor="#011E6A">
                      <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Edit Allocation List</strong></td>
...
$query34="select * from mortuary_allocation where recordstatus='' and dischargestatus='' and recorddate between '$transactiondatefrom' and '$transactiondateto' order by auto_number asc";
          ...
          <tbody>
            <tr>
              ...
              <td colspan="8" bgcolor="#cccccc" class="bodytext31">
                <div align="left"><strong>Edit Alocation List</strong>
...
$query11 = "select * from mortuary_allocation where recordstatus='' and dischargestatus='' and recorddate between '$transactiondatefrom' and '$transactiondateto' order by auto_number asc";
		...
		// $suppliername = $res11['suppliername'];
			...
			?>
              ...
              <td class="bodytext31" valign="center" width="28"  align="left"><div align="center"><?php echo $sno = $sno + 1; ?></div></td>
			   ...
			   <td class="bodytext31" valign="center" width="61"  align="left">
			    <?php echo $shelf; ?></td>
						<td class="bodytext31" valign="left"  align="left"><a href="editmortuaryshellallocation.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&docno=<?php echo $docno; ?>">Edit</a></td>
