...
<body>
<?php
$query1 = "select * from purchase_rfqrequest where approvalstatus='approved' and grandapprovalstatus='' group by docno";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    <td width="1%">&nbsp;</td>
    <td valign="top"><table width="66%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="876" 
            align="left" border="0">
          <tbody>
            <td colspan="9" bgcolor="#cccccc" class="bodytext31"><script language="javascript">
                ...
                <div align="left"><strong>Approved RFPs</strong><label class="number"><<<?php echo $resnw3;?>>></label></div></td>
              </tr>
            <tr>
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left">
			    <div align="left"><?php echo $status; ?></div></td>
                 <td class="bodytext31" valign="center" align="left">
			    <div align="left"><a href="viewapprovedrfp.php?docno=<?php echo $docno; ?>"><strong>VIEW</strong></a></div></td>
              </tr>
			<?php
			}    
			?>
