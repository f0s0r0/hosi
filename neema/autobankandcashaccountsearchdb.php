...
$query2 = "select * from master_accountname where accountsmain = '7' and accountssub IN ('18','19','20') and accountname like '%$coasearch%' and recordstatus <> 'deleted' order by accountname";
