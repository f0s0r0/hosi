...
//echo $ADate1;
if (isset($_REQUEST["ADate2"])) { $ADate2 = $_REQUEST["ADate2"]; } else { $ADate2 = "2015-12-31"; }
//echo $ADate2;
...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
            ...
            <tr bgcolor="#011E6A">
             ...
             <tr>
                ...
                bgcolor="#FFFFFF" class="bodytext31">From Date </td>
                      <td width="" align="left" valign="center"  bgcolor="#FFFFFF"><span class="bodytext31">
					    <input type="text" name="ADate1" id="ADate1" style="border: 1px solid #001E6A" value="<?php echo $ADate1; ?>"  size="10"  readonly="readonly" onKeyDown="return disableEnterKey()" />
 ...
 <td width="54%" valign="top"><table width="600" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
			...
			<tr bgcolor="#999999">
			<td width="695" align="left" class="bodytext3" style="color:#000000"><strong>Total :</strong></td>
			<td width="100" align="right" class="bodytext3" style="color:#000000"><strong><?php $groupright12 = groupright(0); 
			//echo number_format($groupright12,2,'.',','); 
			if($ADate2 =='2016-08-31') { $groupright12 = $groupright12 + 110000; } ?></strong>
			...
			?>
			<tr>
			<td colspan="2" align="right"><a href="trialbalancexl.php?ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2; ?>" target="_blank"><img  width="40" height="40" src="images/excel-xls-icon.png" style="cursor:pointer;"></a></td>
			</tr>
			<script type="text/javascript">
			totalsum();
			</script>
...
function ledgervalue($parentid,$ADate1,$ADate2,$tbinclude,$tbclosing)
{
	...
	{
		include('accounts/'.$tbinclude);
		return $sumbalance;	
	}
	/*else if($parentid != '' && $tbinclude != '' && $tbclosing != '')
	{
		include('accounts/'.$tbinclude);
		include('accounts/'.$tbclosing);
		$totalsum = $sumbalance + $sumbalance1;
		return $totalsum;	
	}*/
	else
	{
