    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong>Patient Wise Service Bills</strong></td>
              </tr>
            <tr>
  ...
  $accountname=isset($_REQUEST['searchaccountname'])?$_REQUEST['searchaccountname']:'';
    $patienttype1=isset($_REQUEST['patienttype1'])?$_REQUEST['patienttype1']:'';
	 $searchsuppliername=isset($_REQUEST['searchsupplierfullname'])?$_REQUEST['searchsupplierfullname']:'';
		  ...
		  { 
		  $query21 = "select * from billing_paylaterservices where accountname like '%$accountname%' and  patientname like '%$searchsuppliername%' and billdate between '$ADate1' and '$ADate2' group by patientvisitcode";
		  }
		  else if($patienttype == 'cash')
		  {
		  $query21 = "select * from billing_paynowservices where patientname like '%$searchsuppliername%' and billdate between '$ADate1' and '$ADate2' group by patientvisitcode";
		  }
		  ...
		  $resqry="select age,gender from master_visitentry where visitcode='$res21visitcode'";
		  $exqry=mysql_query($resqry) or die("Error in resqry".mysql_error());
		  $resqry1=mysql_fetch_array($exqry);
		  $res21age = $resqry1['age'];
		  $res21gender= $resqry1['gender'];
		    
		  if($patienttype == 'credit')
		  { 
		  $query31 = "select * from billing_paylaterservices where  patientvisitcode = '$res21visitcode' and patientcode = '$res21patientcode' and accountname like '%$accountname%'";
		  }
		  else if($patienttype == 'cash')
		  {
		 $query31 = "select * from billing_paynowservices where  patientvisitcode = '$res21visitcode' and patientcode = '$res21patientcode'";
		  }
		  ...
		  <tr bgcolor="#9999FF">
              <td colspan="7"  align="left" valign="center" bgcolor="#cccccc" class="bodytext31"><strong><?php echo strtoupper($res21patientfullname); ?> (<?php echo $res21patientcode;?>, <?php echo $res21visitcode; ?>, <?php echo $res21age; ?>, <?php echo $res21gender; ?>)</strong></td>
              </tr>
		  ...
		  $res31servicesitemrate = $res31['amount'];
		  ...
		  $snocount = $snocount + 1;
           ...
           <tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left"><?php echo $snocount; ?></td>
               <td class="bodytext31" valign="center"  align="left">
                <div class="bodytext31"><?php echo $res31servicesitemname; ?></div></td>
              
               <td class="bodytext31" valign="center"  align="left">
			    <div align="right"><?php echo number_format($res31servicesitemrate,2,'.',','); ?></div></td>
           </tr>
			<?php
			}
			}
			...
			//<---------------IP------------------>//
				...
				if($patienttype1=='ip' || $patienttype1=='all')
				{
					if($patienttype == 'credit')
					{
					  $query211 = "select * from billing_ipservices where patientname like '%$searchsuppliername%' and billdate between '$ADate1' and '$ADate2' and accountname like '%$accountname%' group by patientvisitcode";	
					}
					if($patienttype == 'cash')
					{
		   $query211 = "select * from billing_ipservices where patientname like '%$searchsuppliername%' and billdate between '$ADate1' and '$ADate2' group by patientvisitcode";
					}
		  ...
		  $res21visitcode1 = $res211['patientvisitcode'];
		    ...
		    $resqry=mysql_query("select billtype,age,gender from master_ipvisitentry where visitcode='$res21visitcode1'")or die("Error in resqry".mysql_error());
		 $exqry=mysql_fetch_array($resqry);
		   $res21billtype1 = $exqry['billtype'];
		   $res21age1 = $exqry['age'];
		  $res21gender1= $exqry['gender'];
		  
		  
		   
		   if($patienttype == 'cash' and $res21billtype1=="PAY NOW")
			{  $query311 = "select * from billing_ipservices where patientname = '$res21patientfullname1' and patientvisitcode = '$res21visitcode1' and patientcode = '$res21patientcode1'";
		  ...
		  <tr bgcolor="#9999FF">
              <td colspan="7"  align="left" valign="center" bgcolor="#cccccc" class="bodytext31"><strong><?php echo strtoupper($res21patientfullname1); ?> (<?php echo $res21patientcode1;?>, <?php echo $res21visitcode1; ?>, <?php echo $res21age1; ?>, <?php echo $res21gender1; ?>)</strong></td>
              </tr>
		  ...
		  {
		  $res31servicesitemname1 = $res311['servicesitemname'];
		  $res31servicesitemrate1= $res311['servicesitemrate'];
		  
		  
		  $total1 = $total1 + $res31servicesitemrate1;
		  ...
		  $snocount = $snocount + 1;
           ...
           <tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left"><?php echo $snocount; ?></td>
               <td class="bodytext31" valign="center"  align="left">
                <div class="bodytext31"><?php echo $res31servicesitemname1; ?></div></td>
              
               <td class="bodytext31" valign="center"  align="left">
			    <div align="right"><?php echo number_format($res31servicesitemrate1,2,'.',','); ?></div></td>
           </tr>
			<?php
			}
			}
