...
<form name="form1" id="frmsales" method="post" action="otcprescription.php" onKeyDown="return disableEnterKey(event)" onSubmit="return validcheck()">
      ...
      <tr>
        <td><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
                ...
                <td colspan="4" bgcolor="#CCCCCC" class="bodytext32"><strong>Location&nbsp;&nbsp;</strong>&nbsp;<?php echo $res1location;?></td>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tr id="pressid">
				...
				?>
				   ...
				   <tr>
				   <td colspan="7" align="right" valign="middle"  bgcolor="#E0E0E0" class="bodytext3" style="display:none"><strong>Dispensing Fee</strong><input type="text" name="dispensingfee" id="dispensingfee" size="7" onKeyUp="return calculate();"></td>
			       <td width="11%" align="right" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><strong>Total</strong>
			         <input name="text" type="text" id="total" size="7" readonly><input type="hidden" name="hidtotal" id="hidtotal"></td>
			      </tr>
			</tbody>
			</table>			</td>
			</tr>
			...
			<td align="center" valign="center" class="bodytext31" colspan="3">
			  <input name="frm1submit1" id="frm1submit1" type="hidden" value="frm1submit1">
                <input name="Submit2223" type="submit" onClick="funcSaveBill1();" value="Save" accesskey="b" class="button" />			</td>
			</tr>
			</tbody>
			</table>			</td>
			</tr>
