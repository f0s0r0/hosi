...
$itemstatus = '';
			...
			$query33 = "select * from materialreceiptnote_nmdetails where billnumber='$ponumber' and itemname='$itemname'";
			...
			discountamount, username, ipaddress, entrydate, itemtaxpercentage, itemtaxamount, itemfreequantity, itemtotalquantity, quantityperpackage, allpackagetotalquantity, typeofpurchase,suppliername,suppliercode,ponumber,supplierbillnumber,location,coa) 
			...
			'$itemtaxpercent', '$itemtaxamount', '$free', '$quantity', '$quantityperpackage', '$allpackagetotalquantity', 'NMProcess','$suppliername','$suppliercode','$ponumber','$supplierbillno','$location','$coa')";
			$exec4 = mysql_query($query4) or die ("Error in Query4".mysql_error());
			
			$query56 = "update materialreceiptnote_nmdetails set itemstatus='$itemstatus' where billnumber='$ponumber' and itemname='$itemname'";
			$exec56 = mysql_query($query56) or die(mysql_error());
		
			

			$query56 = "update master_nmrfqpurchaseorder set goodsstatus='$itemstatus' where billnumber='$purchaseordernumber' and itemname='$itemname'";
			$exec56 = mysql_query($query56) or die(mysql_error());
...
if ($cbfrmflag1 == 'cbfrmflag1')
{
	...
	$len1 = strlen($searchpo);
					...
					if($str1 == 'MRN-')
					{
$query5 = "select * from materialreceiptnote_nmdetails where billnumber = '$searchpo' and itemstatus='' order by billnumber";
}
else
{
$query5 = "select * from materialreceiptnote_nmdetails where billnumber = '$searchpo' and itemstatus='' order by billnumber";
...
$paynowbillprefix = 'NMGRN-';
$paynowbillprefix1=strlen($paynowbillprefix);
$query2 = "select * from purchase_details where typeofpurchase='NMProcess' order by auto_number desc limit 0, 1";
...
<?php
include("autocompletebuild_nmmaterialreceiptnote.php");
...
<?php include ("js/dropdownlist1scriptingnmmrn.php"); ?>
<script type="text/javascript" src="js/autocomplete_nmmrn.js"></script>
<script type="text/javascript" src="js/autosuggestnmmrn.js"></script>
...
-->
  <tr>
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
		 <form name="cbform1" method="post" action="nmrfqgoodsreceivednote.php"> 
	  ...
	  <td>&nbsp;
			...
			<tr>
              <td bgcolor="#CCCCCC" class="bodytext3" colspan="8"><strong>NM Goods Received Note</strong></td>
			  ...
			  <tr>
				...
				<input name="docno" id="docno" value="<?php echo $billnumbercode; ?>" style="border: 1px solid #001E6A;" size="10" autocomplete="off" readonly="readonly" type="hidden"/>                  </td>
                 <td width="11%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><strong>Select MRN</strong></td>
             ...
             <td width="11%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><strong>Time </strong></td>
                ...
                <td width="27%" align="left" valign="middle" class="bodytext3"><!--<select name="store" id="store" onChange="return storeassign()">
      ...
      <tr>
        <td>
		<form action="nmrfqgoodsreceivednote.php" method="post" name="form" onSubmit="return validationcheck()">
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
		 ...
		 <input type="hidden" name="supplierbillno1" id="supplierbillno1" value="<?php echo $supplierbillnumber; ?>">
			...
			$len = strlen($billnum);
					...
					if($str == 'MRN-')
					{
			$query76 = "select * from materialreceiptnote_nmdetails where billnumber='$billnum' and itemstatus=''";
			}
			else
			{
			$query76 = "select * from materialreceiptnote_nmdetails where billnumber='$billnum' and itemstatus=''";
			...
			$orderedquantity = $res761['quantity'];
...
?>
  <tr>
		...
		<td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo intval($orderedquantity); ?></div></td><input type="hidden" name="orderedquantity[]" id="orderedquantity<?php echo $sno; ?>" value="<?php echo intval($orderedquantity); ?>">
		<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" name="receivedquantity[]" id="receivedquantity<?php echo $sno; ?>" size="6" onKeyUp="return totalcalc('<?php echo $sno; ?>');" class="bodytext21" autocomplete="off" value="<?php echo intval($quantity); ?>" readonly="readonly"></div></td>
		...
		<!--<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" name="batch[]" id="batch<?php echo $sno; ?>" size="6" class="bodytext21" autocomplete="off" value="<?php echo $batchnumber; ?>" readonly="readonly"></div></td>
		<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" name="expirydate[]" id="expirydate<?php echo $sno; ?>" size="6" autocomplete="off" value="<?php echo $newexpirydate; ?>" readonly="readonly"></div></td>
		...
		<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" name="free[]" id="free<?php echo $sno; ?>" size="6" onKeyUp="return totalcalc1('<?php echo $sno; ?>');" class="bodytext21" autocomplete="off" value="<?php echo intval($free); ?>" readonly="readonly"></div></td>
		<!--<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" name="totalquantity[]" id="totalquantity<?php echo $sno; ?>" size="6" class="bodytext21" readonly="readonly" value="<?php echo intval($totalqty); ?>" readonly="readonly"></div></td>-->
		<td class="bodytext31" valign="center"  align="right"><?php echo number_format($quotedprice,2,'.',','); ?></td>
		<td class="bodytext31" valign="center"  align="right"><div align="right"><input type="text" name="priceperpack[]" id="priceperpack<?php echo $sno; ?>" size="6" onKeyUp="return totalamount('<?php echo $sno; ?>','<?php echo $number; ?>');" class="bodytext21" autocomplete="off" value="<?php echo $rate; ?>" readonly="readonly" align="right" style="<?php echo $error_css; ?>"></div></td>
		<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" name="discount[]" id="discount<?php echo $sno; ?>" size="6" onKeyUp="return totalamount5('<?php echo $sno; ?>','<?php echo $number; ?>');" class="bodytext21" autocomplete="off" value="<?php echo $discountpercent; ?>" readonly="readonly"></div></td>
		<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" name="tax[]" id="tax<?php echo $sno; ?>" size="6" onKeyUp="return totalamount20('<?php echo $sno; ?>','<?php echo $number; ?>');" class="bodytext21" autocomplete="off" value="<?php echo $itemtaxpercentage; ?>" readonly="readonly"></div></td>
		...
		<!--<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" name="costprice[]" id="costprice<?php echo $sno; ?>" size="6" class="bodytext21" readonly="readonly" value="<?php echo number_format($costprice,2,'.',','); ?>"></div></td>
		<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="hidden" name="saleprice1[]" id="saleprice1<?php echo $sno; ?>" size="6" class="bodytext21" readonly="readonly" value="<?php echo $saleprice; ?>">
		<input type="hidden" name="spmarkup" id="spmarkup<?php echo $sno; ?>" value="<?php echo $spmarkup; ?>"><input type="text" name="saleprice[]" id="saleprice<?php echo $sno; ?>" size="6" class="bodytext21" readonly="readonly" value="<?php echo number_format($saleprice,2,'.',','); ?>"></div></td>-->
					</tr>
			<?php 
	  ...
	  <table width="716">
     <tr>
	 <td width="20" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">Total Purchase Cost</td><input type="hidden" name="totalpurchaseamount1" id="totalpurchaseamount" size="10" readonly="readonly" value="<?php echo $grandtotalamount; ?>">
	   <td width="111" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><input type="text" name="totalpurchaseamount" id="totalpurchaseamount" size="10" readonly="readonly" value="<?php echo number_format($grandtotalamount,2,'.',','); ?>"></td>
