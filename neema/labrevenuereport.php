        ...
        <td width="860">
              ...
              <form name="cbform1" method="post" action="labrevenuereport.php">
                <table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                    <tr bgcolor="#011E6A">
                      <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Lab Revenue</strong></td>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
		  ...
		  <?php
			...
			$paymentreceiveddateto = date("Y-m-d", mktime(0, 0, 0, $dotmonth, $dotday + 1, $dotyear));
					...
					$query02="select sum(labitemrate) as amount from  billing_paynowlab where billdate between '$ADate1' and '$ADate2'";
					$exec02=mysql_query($query02) or die(mysql_error());
					if($res02=mysql_fetch_array($exec02))
						$amount+=$res02['amount'];	

					$query02="select sum(labitemrate) as amount from  billing_paylaterlab where billdate between '$ADate1' and '$ADate2' ";
					$exec02=mysql_query($query02) or die(mysql_error());
					if($res02=mysql_fetch_array($exec02))
		 ...
		 $sumtransactionamount2=0;
		  ...
		  $snocount = $snocount + 1;
           ...
           <tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left"><a href="opsalesdetailed_lab.php?locationcode=<?php echo $locationcode1;?>&&adate1=<?php echo $ADate1;?>&&adate2=<?php echo $ADate2;?>" /><strong>OP Sales</strong></td>
			...
			?>
			<tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left"><a href="ipsalesdetailed_lab.php?locationcode=<?php echo $locationcode1;?>&&adate1=<?php echo $ADate1;?>&&adate2=<?php echo $ADate2;?>" /><strong>IP Sales</strong></td>
               <td class="bodytext31" valign="center"  align="right">
		   ...
		   <?php
			...
			?>
			<tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left"><a href="external_salesdetailed_lab.php?locationcode=<?php echo $locationcode1;?>&&adate1=<?php echo $ADate1;?>&&adate2=<?php echo $ADate2;?>" /><strong>External Sales</strong></td>
               <td class="bodytext31" valign="center"  align="right">
			...
			?>
			<tr <?php echo $colorcode; ?>>
              <td  align="left" valign="center" class="bodytext31"><a href="opreturns.php?locationcode=<?php echo $locationcode1;?>&&adate1=<?php echo $ADate1;?>&&adate2=<?php echo $ADate2;?>" /><strong>OP Returns</strong></td>
               <td class="bodytext31" valign="center"  align="right">
          ...
          <?php
			...
			?>
			<tr <?php echo $colorcode; ?>>
              <td  align="left" valign="center" class="bodytext31"><a href="externalreturns.php?locationcode=<?php echo $locationcode1;?>&&adate1=<?php echo $ADate1;?>&&adate2=<?php echo $ADate2;?>" /><strong>Ext  Returns</strong></td>
               <td class="bodytext31" valign="center"  align="right">
			...
			<tr <?php echo $colorcode; ?>>
              ...
              <td rowspan="2" align="right" valign="center" 
			   bgcolor="#e0e0e0" class="bodytext31"><div align="left"><a target="_blank" href="print_labrevenue.php?locationcode=<?php echo $locationcode1; ?>&&ADate1=<?php echo $transactiondatefrom; ?>&&ADate2=<?php echo $transactiondateto; ?>"><img src="images/excel-xls-icon.png" width="30" height="30"></a></div></td>
               <?php } ?>
