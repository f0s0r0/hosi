			...
			if($num69 > 0)
		{
          ...
          <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext31" valign="center"  align="left">
				...
				<option value="ipmedicinedirectissue.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode;?>&&searchlocation=<?php echo $searchlocation;?>">Medicine Issue</option>
				...
				<option value="ipotbilling.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&searchlocation=<?php echo $searchlocation;?>">OT Billing</option>
                <?php /*?><option value="ipotrequest.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&locationcode=<?php echo $patientlocationcode;?>">OT Request</option> <?php */?>
