...
?>
		...
		<tr>
			<td colspan="8"><div align="center"><?php echo $companyname; ?>
		      <?php
		...
		<tr>
			<td colspan="8"><div align="center"><?php echo $address1; ?>
		      <?php
		...
		<tr>
            ...
            <tr>
              <td colspan="8"  align="left" valign="center" bgcolor="#ffffff" class="bodytext31">&nbsp;</td>
            </tr>
			<?php
			...
			?>
            <tr>
              <td colspan="8"  align="center" valign="center" bgcolor="#ffffff" class="bodytext31"><strong><?php echo $res3username; ?></strong></td>
            </tr>
			 
            <tr>
              <td width="26"  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><strong>No.</strong></td>
				<td width="110" align="right" valign="center"  
              ...
              <td width="112"  align="right" valign="center" 
				...
				<td  width="84"  align="right" valign="center" 
