...
if (isset($_REQUEST["group"])) { $parentid = $_REQUEST["group"]; } else { $parentid = ""; }
       ...
       <tr>
        <td valign="top"><table width="919" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            <?php
				...
				<td width="121" align="left" class="bodytext3"><strong><?php echo 'Month'; ?></strong></td>
				...
				{  
					...
					if($id != '') 
					{
						$i = 0;
						$result = array();
						$querydr1 = "SELECT `transactionamount` as td1, `updatedate` as td2, paymonth as td3, accountcode as td4, componentname as td5 FROM master_transactionpayroll WHERE accountcode = '$id' AND transactiontype = 'PROCESS' AND updatedate BETWEEN '$ADate1' AND '$ADate2'";
						...
						$j = 0;
						$crrresult = array();
						$querycr1 = "SELECT `transactionamount` as td1, `transactiondate` as td2, paymonth as td3, bankcode as td4, CONCAT(particulars,remarks) as td5 FROM master_transactionpayroll WHERE accountcode = '$id' AND transactionmodule = 'PAYMENT' AND recordstatus = 'allocated' AND transactiondate BETWEEN '$ADate1' AND '$ADate2'";
