...
mysql_query("update consultation_radiology set resultentry='$status',radiologyrefund='$status1',docnumber='$docnumber' where patientvisitcode='$visitcode' and radiologyitemname='$radiologyname' and refno='$refno'");
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
			...
			$sno = '';
			$totalamount=0;			
$query61 = "select * from consultation_radiology where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and resultentry='pending' and paymentstatus='completed' and (billtype='PAY NOW' or (billtype='PAY LATER' ))";
...
?>
  ...
  <tr>
        ...
        <input type="checkbox" id="ack<?php echo $sno; ?>" name="ack[]" value="<?php echo $sno; ?>" onClick="return checkboxcheck('<?php echo $sno; ?>'); return makeDisable('<?php echo $sno; ?>');"/></div></td>
