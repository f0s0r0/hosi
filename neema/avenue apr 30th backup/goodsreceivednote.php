...
$itemstatus = '';
			...
			manufactureranum, manufacturername,typeofpurchase,suppliername,suppliercode,ponumber,supplierbillnumber,costprice,locationcode,store,coa,categoryname) 
			...
			'$packageanum', '$packagename', '$quantityperpackage', '$allpackagetotalquantity', 
			'$manufactureranum', '$manufacturername','Process','$suppliername','$suppliercode','$ponumber','$supplierbillno','$costprice','$locationcode','$store1','$coa','$categoryname')";
...
//echo $CURRENTDATE=date('Y-m-d'),',';  echo date('Y-m-d', mktime(0, 0, 0, date('m'), date('d') -7, date('Y')));
...
?>
  <tr>
  		<td class="bodytext31" valign="center"  align="left"><input type="checkbox" name="select[]" id="select"></td>
		<td class="bodytext31" valign="center"  align="right"><div align="center"><?php echo $sno = $sno + 1; ?></div></td>
