...
else
{
	...
	if ($res2 == 0)
	{
		...
		visitcount,department,consultationdate,consultationtime,consultationfees,patientspent,planfixedamount,planpercentage,patientfullname,paymentstatus,triagestatus,age,gender,accountfullname,departmentname,username,complaint,consultationrefund,locationname1,locationcode,memberno)values('$patientcode','$visitcode','$patientfirstname','$patientmiddlename','$patientlastname','$consultationtype','$consultingdoctor','$accountname','$accountexpirydate','$paymenttype','$subtype','$planname','$planexpirydate','$visitlimit','$overalllimit','$billtype',
		'$visitcount','$department','$consultationdate','$consultationtime','$consultationfees','$patientspent','$planfixedamount','$planpercentageamount','$patientfullname','completed','','$age','$gender','$accname','$departmentname','$username','$triag','torefund','$locationname','$location',$memberno)";
	...
	$query56="insert into master_visitentry(patientcode, visitcode, patientfirstname,patientmiddlename, patientlastname,consultationtype,consultingdoctor,accountname,accountexpirydate,paymenttype,subtype,planname,planexpirydate,visitlimit,overalllimit,billtype,
		visitcount,department,consultationdate,consultationtime,consultationfees,patientspent,planfixedamount,planpercentage,patientfullname,paymentstatus,triagestatus,age,gender,accountfullname,departmentname,username,complaint,consultationrefund,locationname,locationcode,memberno)values('$patientcode','$visitcode','$patientfirstname','$patientmiddlename','$patientlastname','$consultationtype','$consultingdoctor','$accountname','$accountexpirydate','$paymenttype','$subtype','$planname','$planexpirydate','$visitlimit','$overalllimit','$billtype',
		'$visitcount','$department','$consultationdate','$consultationtime','$consultationfees','$patientspent','$planfixedamount','$planpercentageamount','$patientfullname','completed','pending','$age','$gender','$accname','$departmentname','$username','$triag','torefund','$locationname1','$location','$memberno')";
		$exec56=mysql_query($query56) or die(mysql_error());
		header("location:visitentry_op1.php");
	exit();
	}
	...
	{
		$query56="insert into master_visitentry(patientcode, visitcode, patientfirstname,patientmiddlename, patientlastname,consultationtype,consultingdoctor,accountname,accountexpirydate,paymenttype,subtype,planname,planexpirydate,visitlimit,overalllimit,billtype,
		visitcount,department,consultationdate,consultationtime,consultationfees,patientspent,planfixedamount,planpercentage,patientfullname,paymentstatus,triagestatus,age,gender,accountfullname,departmentname,username,consultationrefund,complaint,locationname,locationcode,memberno)values('$patientcode','$visitcode','$patientfirstname','$patientmiddlename','$patientlastname','$consultationtype','$consultingdoctor','$accountname','$accountexpirydate','$paymenttype','$subtype','$planname','$planexpirydate','$visitlimit','$overalllimit','$billtype',
		'$visitcount','$department','$consultationdate','$consultationtime','$consultationfees','$patientspent','$planfixedamount','$planpercentageamount','$patientfullname','','','$age','$gender','$accname','$departmentname','$username','torefund','$triag','$locationname1','$location','$memberno')";
		$exec56=mysql_query($query56) or die(mysql_error());
		header("location:visitentry_op1.php");
	exit();
		}
	...
	if ($res2 == 0)
	{
		...
		department,paymenttype,subtype,billtype,accountname,accountexpirydate,planname,planexpirydate,consultationdate,consultationtime,consultationtype,consultationfees,referredby,consultationremarks,complaint,registrationdate,visittype,visitlimit,overalllimit,visitcount,patientspent,planpercentage,planfixedamount,age,gender,accountfullname,itemrefund,departmentname,username,consultationrefund,locationname,locationcode,memberno) 
              ...
              <select name="location" id="location" onChange="locationform(form1,this.value)"  style="border: 1px solid #001E6A;">
				...
				<tr>
				  ...
				  <td align="left" valign="middle"  bgcolor="#E0E0E0"><label>
					...
					<input type="" name="planstatus" id="planstatus"  value="<?php echo $planstatus;?>"   readonly="readonly">
                  </label></td>
