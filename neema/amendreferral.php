...
if ($frm1submit1 == 'frm1submit1')
{
	...
	foreach($_POST['services'] as $key => $value)
		...
		{
		$servicesquery1=mysql_query("insert into consultation_services(consultationid,patientcode,patientname,patientvisitcode,servicesitemcode,servicesitemname,servicesitemrate,billtype,accountname,consultationdate,paymentstatus,refno,process)values('$consultationid','$patientcode','$patientname','$visitcode','$servicescode','$servicesname','$servicesrate','$patientpaymentmode','$accountname','$consultationdate','$status','$serrefnonumber','pending')") or die(mysql_error());
...
$data=mysql_query("select auto_number,patientcode,patientvisitcode,patientname,refno,referalcode,referalname,referalrate from consultation_departmentreferal where auto_number='$auto_number'") or die("Error in data".mysql_error());
$data1=mysql_fetch_array($data);
$patientname=$data1['patientname'];
$patientcode=$data1['patientcode'];
$visitcode=$data1['patientvisitcode'];
$refno=$data1['refno'];
$medicinecode=$data1['referalcode'];
$medicinename=$data1['referalname'];
$rate=$data1['referalrate'];
...
if($medicinecode<>'')
{
 $query="insert into amendment_details (patientcode,visitcode,patientname,refno,itemcode,itemname,rate,amenddate,amendtime,amendfrom,amendby,ipaddress) values ('$patientcode','$visitcode','$patientname','$refno','$medicinecode','$medicinename','$rate','$date','$time','departmentreferal','$username','$ipaddress')";
mysql_query($query)or die("Error in query".mysql_error());
}

mysql_query("delete from consultation_departmentreferal where referalname='$servicename' and auto_number='$auto_number' and patientvisitcode='$visit'");
}
...
<form name="form1" id="frmsales" method="post" action="amendservice.php" onKeyDown="return disableEnterKey(event)">
...
-->
  <tr>
	...
	$status='completed';
			...
			$query17 = "select * from consultation_departmentreferal where patientvisitcode='$visitcode' and patientcode='$patientcode' and paymentstatus='$status' and consultation<>'completed'";
			...
			while ($res17 = mysql_fetch_array($exec17))
			{
				...
				$auto_number = $res17['auto_number'];
				$query18 = "select * from consultation_departmentreferal where patientvisitcode='$visitcode' and patientcode='$patientcode' and consultation='completed' order by auto_number limit 0,1";
				$exec18 = mysql_query($query18) or die ("Error in Query18".mysql_error());
				$num18 = mysql_num_rows($exec18);
				$res18 = mysql_fetch_array($exec18);
				if($num18!=0)
				{
				$deptfrom = $res18['referalname'];
				}
				else
				{
				$query19 = "select * from master_visitentry where visitcode='$visitcode' and patientcode='$patientcode' order by auto_number limit 0,1";
				$exec19 = mysql_query($query19) or die ("Error in Query19".mysql_error());
				$num19 = mysql_num_rows($exec19);
				$res19 = mysql_fetch_array($exec19);
				$deptfrom = $res19['departmentname'];
				}
			...
			?>
			 ...
			 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $sno = $sno + 1; ?></div></td>
			    <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $deptfrom; ?></div></td>
			 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $paharmitemname; ?></div></td>
			    <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $pharmitemrate; ?></div></td>
				 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $pharmitemrate; ?></div></td>
				 <td class="bodytext31" valign="center"  align="left"><div align="center"><a onClick="return deletevalid()" href="amendreferral.php?delete=<?php echo $paharmitemname; ?>&&auto_number=<?php echo $auto_number; ?>&&patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>">Delete</a></div></td>
				
				</tr>
			<?php } ?>
			<?php
			$query17 = "select * from consultation_departmentreferal where patientvisitcode='$visitcode' and patientcode='$patientcode' and referalrate = '0.00' and consultation<>'completed'";
			$exec17 = mysql_query($query17) or die ("Error in Query1".mysql_error());
			while ($res17 = mysql_fetch_array($exec17))
			{
