...
$searchsuppliername1 = $_REQUEST['searchlabname'];
$locationcode = $_REQUEST['locationcode1'];

$stringbuild1 = "";
 $query1 = "select * from master_lab where itemname like '%$searchsuppliername1%' and status <> 'Deleted' AND location = '".$locationcode."' AND rateperunit <> 0 group by itemname order by itemcode limit 0,20";
