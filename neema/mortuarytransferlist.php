...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
              <form name="cbform1" method="post" action="mortuarytransferlist.php">
                <table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                    <tr bgcolor="#011E6A">
                      <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Mortuary Transfer List</strong></td>
...
//$query34="select * from mortuary_allocation where recordstatus='' recorddate between '$transactiondatefrom' and '$transactiondateto' order by auto_number asc";
$query34="select * from mortuary_request where recordstatus='' and paymentstatus <>'' and transferstatus <>'' and allocationstatus='' and recorddate between '$transactiondatefrom' and '$transactiondateto' order by auto_number asc";
          ...
          <tbody>
            <tr>
              ...
              <td colspan="7" bgcolor="#cccccc" class="bodytext31">
                <div align="left"><strong>Mortuary Transfer List</strong>
            ...
            <tr>
              <td class="bodytext31" valign="center"  align="left"  width="28"
				...
				<td   align="left" valign="center" width="274"
                ...
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Visit Code</strong></div></td>
     			<td   align="left" valign="center" width="72" 
			...
			$colorloopcount = '';
			$sno = '';
		  $query11 = "select * from mortuary_request where recordstatus='' and paymentstatus <>'' and transferstatus <>'' and allocationstatus='' and recorddate between '$transactiondatefrom' and '$transactiondateto'  order by auto_number asc";
		  //$query11 = "select * from mortuary_allocation where recordstatus='' recorddate between '$transactiondatefrom' and '$transactiondateto' order by auto_number asc";
		...
		// $suppliername = $res11['suppliername'];
			...
			?>
              ...
              <td class="bodytext31" valign="center" width="28"  align="left"><div align="center"><?php echo $sno = $sno + 1; ?></div></td>
			   <td class="bodytext31" valign="center" width="79"  align="left">
			    <?php echo $recorddate; ?></td>
				<td class="bodytext31" valign="center" width="75"  align="left">
			    <?php echo $docno; ?></td>
			   <td class="bodytext31" valign="left" width="274"  align="left">
			    <?php echo $patientname; ?></td>
				<td class="bodytext31" valign="center" width="76"  align="left">
			    <?php echo $patientcode; ?></td>
			   <td class="bodytext31" valign="center" width="61"  align="left">
			    <?php echo $visitcode; ?></td>
                
						<td class="bodytext31" valign="left"  align="left"><a href="mortuaryshellallocation.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&docno=<?php echo $docno; ?>&&anum=<?php echo $anum; ?>">Process</a></td>
