...
<?php include("a4pdfpayrollheader1.php"); ?>	
	...
	<tr>
	<td width="25" align="center" bgcolor="#FFFFFF" class="bodytext3"><strong>S.No</strong></td>
	...
	<td width="25" align="left" bgcolor="#FFFFFF" class="bodytext3"><strong>ID NO</strong></td>
	<td width="25" align="left" bgcolor="#FFFFFF" class="bodytext3"><strong>PIN NO</strong></td>
	<td align="right" bgcolor="#FFFFFF" class="bodytext3" width="77"><strong>AMOUNT</strong></td>
...
$dompdf->stream("Payereport.pdf", array("Attachment" => 1)); 
?>