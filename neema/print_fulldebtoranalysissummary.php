...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			{
				echo $query221 = "select accountname,auto_number,id from master_accountname where auto_number = '$searchsuppliercode'   and subtype='$searchsubtypeanum1'  and recordstatus <>'DELETED' group by id";
			}
