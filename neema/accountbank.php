            ...
            <?php
				...
				{  
					...
					*/			
					...
					<a href="detail_accountbank.php?id=<?= $id; ?>&&ADate1=<?= $ADate1; ?>&&ADate2=<?= $ADate2; ?>" target="_blank"><?php echo $colorloopcount; ?>. <?php echo $accountsmain2; ?></a></strong></td>
					<td align="right" class="bodytext3"><strong><?php echo number_format($accountbank,2,'.',','); ?></strong></td>
					</tr>
