...
<body>
		<table width="919" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
			...
			<?php
				...
				<td width="87" align="left" class="bodytext3"><strong><?php echo 'Cheque No'; ?></strong></td>
				...
				{  
					...
					$querydr1 = "SELECT (`cashamount`) as bankamount, billdate as td2, billnumber as td3, patientcode as td4, patientname as td5 FROM `billing_consultation` WHERE (`cashcode` = '$id') AND `billdate` BETWEEN '$ADate1' AND '$ADate2'
									...
									UNION ALL SELECT (-1*`cashamount`) as bankamount, recorddate as td2, docno as td3,  patientcode as td4, patientname as td5 FROM `deposit_refund` WHERE (`cashcode` = '$id') AND `recorddate` BETWEEN '$ADate1' AND '$ADate2'
									UNION ALL SELECT (-1*`creditamount`) as bankamount, recorddate as td2, docno as td3,  patientcode as td4, patientname as td5 FROM `deposit_refund` WHERE (`mpesacode` = '$id') AND `recorddate` BETWEEN '$ADate1' AND '$ADate2'
									UNION ALL SELECT (-1*`cardamount`) as bankamount, recorddate as td2, docno as td3,  patientcode as td4, patientname as td5 FROM `deposit_refund` WHERE (`bankcode` = '$id') AND `recorddate` BETWEEN '$ADate1' AND '$ADate2'
									UNION ALL SELECT (-1*`onlineamount`) as bankamount, recorddate as td2, docno as td3,  patientcode as td4, patientname as td5 FROM `deposit_refund` WHERE (`bankcode` = '$id') AND `recorddate` BETWEEN '$ADate1' AND '$ADate2'
									UNION ALL SELECT (-1*`chequeamount`) as bankamount, recorddate as td2, docno as td3,  patientcode as td4, patientname as td5 FROM `deposit_refund` WHERE (`bankcode` = '$id') AND `recorddate` BETWEEN '$ADate1' AND '$ADate2'
