...
if ($frm1submit1 == 'frm1submit1')
{
	...
	if ($delbillst == 'billedit' && $delbillstanum != '' && $delbillnumber != '')
	{
		...
		while ($res19 = mysql_fetch_array($exec19))
		{
			...
			$query16 = "update expensepurchase_details set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
...
include ("expensepurchaseinclude.php"); //handles all the purchase insert operations
...
$paynowbillprefix = 'EXP-';
$paynowbillprefix1=strlen($paynowbillprefix);
$query2 = "select * from master_purchase where companyanum = '$companyanum' and typeofpurchase='Expense' order by auto_number desc";
...
<form name="frmpurchase" id="frmpurchase" method="post" action="expensepurchase.php" onKeyDown="return disableEnterKey(event)">
    ...
    <td width="99%" valign="top"><table width="950" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="100%"><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
		  <tr bgcolor="#011E6A">
		  <td bgcolor="#CCCCCC" class="bodytext3" colspan="10"><strong>Expense Purchase Bill  </strong></td>
		  </tr>
            <tr>
              ...
              <td colspan="2" width="12%" class="bodytext3"><span class="bodytext312">
...
*/            <?php
            ...
            <tr>
              ...
              <td width="10%" align="left" valign="middle" class="bodytext3" >&nbsp;</td>
			...
			<tr>
              <td width="7%" align="left" valign="middle" class="bodytext3"><strong>Account</strong></td>
              <td width="35%" align="left" valign="top" >
			  <input name="account" id="account" size="40" autocomplete="off"/>
                  </td>
              <td align="left" valign="middle" ><div align="left"><span class="style4">Code</span></div></td>
              <td align="left" valign="top" ><span class="bodytext3">
                <input name="accountcode" id="accountcode" readonly="readonly" size="10" rsize="20" />
              </span></td>
              <td width="9%" align="left" valign="middle" class="bodytext3"><strong>Location</strong></td>
                ...
                <td align="left" valign="top" ><span class="bodytext31">
                  <input name="cashamount" id="cashamount" onBlur="return funcbillamountcalc1()" tabindex="1" value="0.00" style="text-align:right" size="8"  readonly="readonly" />
                       ...
                       <input type="hidden" name="cashgivenbysupplier" id="cashgivenbysupplier" onBlur="return funcbillamountcalc1()" onFocus="return cashentryonfocus1()" tabindex="2" value="0.00" style="text-align:right" size="8"  />
                         ...
                         <input type="hidden" name="cashgiventosupplier" id="cashgiventosupplier" onBlur="return funcbillamountcalc1()" value="0.00" style="text-align:right" size="8" readonly="readonly"  />
...
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Online Amount </strong></div></td>
                <td align="left" valign="top" ><span class="bodytext31">
                  <input name="onlineamount" id="onlineamount" onBlur="return funcbillamountcalc1()" value="0.00" style="text-align:right" size="8" readonly="readonly" />
                </span></td>
              </tr>
              <tr id="nettamounttr">
...
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Nett Amount</strong></div></td>
                <td align="left" valign="top" ><span class="bodytext31">
                  <input name="nettamount" id="nettamount" value="0.00" style="text-align:right" size="8" readonly="readonly" />
                </span></td>
              </tr>
              <tr>
                <td colspan="7" align="left" valign="center"  
