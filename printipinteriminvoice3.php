...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<table width="100%" align="center" border="0" cellspacing="4" cellpadding="2">
			...
			<tr>
				...
				<td width=""  align="left" valign="center" style="white-space:normal"
			...
			if($packchargeapply == 1)
		{
			...
			?>
			 ...
			 <td class="bodytext31" valign="top"  align="left"><div align="left"><?php echo 'Admission Charge'; ?></div></td>
			     <td class="bodytext31" valign="top"  align="center"><?php echo '1'; ?></td>
                <td class="bodytext31" valign="top"  align="left"><div align="right"><?php echo number_format($consultationfee,2,'.',','); ?></div></td>
				 <td class="bodytext31" valign="top"  align="left"><div align="right"><?php echo $consultationfee; ?></div></td>
           	</tr>
			<?php
			}
			}
			...
			if($packageanum1 != 0)
	{
	 ...
	 $reqdate = date('Y-m-d',strtotime($packagedate1) + (24*3600*$reqquantity));
					  ...
					  ?>
					   <?php if($rowbedtr == 0) { $totalbedallocationamount=$totalbedallocationamount+$amount; ?>
								<tr>
									...
									<td class="bodytext31" valign="top"  align="center"><?php echo $quantity; ?></td>
			...
			?>
			 ...
			 <td class="bodytext31" valign="top"  align="center"><?php echo $resquantity; ?></td>
		  ...
		  <?php 
			...
			?>
			 ...
			 <td class="bodytext31" valign="top"  align="center"><?php echo $serqty; ?></td>
			...
			while($res62 = mysql_fetch_array($exec62))
		   {
			...
			?>
			 ...
			 <td class="bodytext31" valign="top"  align="center"><?php echo $privatedoctorunit; ?></td>
			...
			while($res63 = mysql_fetch_array($exec63))
		   {
			...
			?>
			 ...
			 <td class="bodytext31" valign="top"  align="center"><?php echo $ambulanceunit; ?></td>
			...
			while($res63 = mysql_fetch_array($exec63))
		   {
			...
			?>
			 ...
			 <td class="bodytext31" valign="top"  align="center"><?php echo $homecareunit; ?></td>
			...
			while($res69 = mysql_fetch_array($exec69))
		   {
			...
			?>
			 ...
			 <td class="bodytext31" valign="top"  align="center"><?php echo $miscbillingunit; ?></td>
			...
			while($res641= mysql_fetch_array($exec641))
		   {
			...
			?>
			 ...
			 <td class="bodytext31" valign="top"  align="left"><div align="left"> <?php echo 'NHIF'; ?></div></td>
				 <td class="bodytext31" valign="top" align="center"><?php echo $nhifqty; ?></td>
        ...
        <tr>
            ...
            <tr>
                ...
                <td width="90" align="left" ><strong>Admission Charges:</strong></td>
            ...
            <tr>
                <td colspan="2" align="center"></td>
                <td width="90" align="left" ><strong>Package Charges:</strong></td>
            ...
            <tr>
                <td colspan="2" align="center"></td>
                <td width="90" align="left" ><strong>Bed Charges:</strong></td>
            ...
            <tr>
                <td colspan="2" align="center"></td>
                <td width="90" align="left" ><strong>Misc Charges:</strong></td>
            ...
            <tr>
                <td colspan="2" align="center"></td>
                <td width="90" align="left" ><strong>Ambulance Charges:</strong></td>
            ...
            <tr>
                <td colspan="2" align="center"></td>
                <td width="90" align="left" ><strong>Homecare Charges:</strong></td>
                <td align="right" ><?php echo number_format($totalhomecareamount,2,'.',','); ?></td>
            </tr>
			<?php } ?>
            <tr>
                <td colspan="2" align="center"></td>
                <td width="90" align="left" ><strong>Discount Amount:</strong></td>
                <td align="right" ><?php echo number_format($totaldiscountamount,2,'.',','); ?></td>
            </tr>
             <tr>
                <td colspan="2" align="center"></td>
                <td width="90" align="left" ><strong>Deposit Amount:</strong></td>
                <td align="right" ><?php echo number_format($totaldepositamount,2,'.',','); ?></td>
            </tr>
            <tr>
                <td colspan="2" align="center"></td>
                <td width="90" align="left" ><strong>NHIF amount:</strong></td>
                <td align="right" ><?php echo number_format($totalnhifamount,2,'.',','); ?></td>
            </tr>
            <tr>
                <td colspan="2" align="center"></td>
                <td width="90" align="left" ><strong>Deposit Refund:</strong></td>
                <td align="right" ><?php echo number_format($totaldepositrefundamount,2,'.',','); ?></td>
            </tr>
            <tr>
                <td colspan="2" align="center"></td>
                <td width="90" align="left" ><strong>Advance Deposit:</strong></td>
