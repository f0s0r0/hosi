    ...
    <td colspan="2" valign="top"><table width="99%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="1202" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong> Trial Balance OP Ext</strong></td>
              </tr>
             <tr>
	...
	if($parentid != '' && $tbinclude != '')
	{
		...
		{  
			...
			if($id == '01-1006')
			{
				...
				$j = 0;
				$crresult = array();  
				$querycr1in = "SELECT SUM(`totalamount`) as income FROM `billing_paylaterconsultation` WHERE `billdate` BETWEEN '$ADate1' AND '$ADate2'
