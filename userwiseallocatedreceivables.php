    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="userwiseallocatedreceivables.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong>Userwise Allocated Receivables</strong></td>
              </tr>
            <!--<tr>
      ...
      <tr>
       ...
       <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="872" 
            align="left" border="0">
          <tbody>
            <tr>
...
&nbsp;				<input  value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />-->
            ...
            <tr>
              ...
              <td width="11%" align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Bill Amt </strong></div></td>
				 <td width="10%" align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Adj Amt </strong></div></td>
				 <td width="12%" align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Adjusted By </strong></div></td>
            ...
            {
			$totalreceivedamount = 0;
			$query21 = "select * from master_transactionpaylater where transactiontype = 'finalize' and  accountname like '%$searchsuppliername%' and transactiondate between '$ADate1' and '$ADate2' group by accountname order by accountname desc  ";
		  ...
		  $query414 = "select * from master_transactionpaylater where accountname = '$res21accountname' and transactiontype = 'PAYMENT' and transactionstatus <> 'onaccount' and recordstatus <> 'deallocated'";
		  $exec414 = mysql_query($query414) or die ("Error in query3".mysql_error());
		  $num414 = mysql_num_rows($exec414);
		  ...
		  $query2 = "select * from master_transactionpaylater where transactiontype = 'finalize' and accountname like '%$res21accountname%' and transactiondate between '$ADate1' and '$ADate2' order by transactiondate desc";
		  $exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
		  while ($res2 = mysql_fetch_array($exec2))
		  {
     	  $res2billnumber = $res2['billnumber'];
		  $res2billdate = $res2['transactiondate'];
		  $res2patientcode = $res2['patientcode'];
		  $res2visitcode = $res2['visitcode'];
		  $res2patientname = $res2['patientname'];
		  $res2totalamount = $res2['transactionamount'];
		  ...
		  $query4 = "select * from master_transactionpaylater where billnumber = '$res2billnumber' and patientcode = '$res2patientcode' and visitcode = '$res2visitcode' and transactiontype = 'PAYMENT' and transactionstatus <> 'onaccount' and recordstatus <> 'deallocated' group by username";
		  $exec4 = mysql_query($query4) or die ("Error in query3".mysql_error());
		  while($res4 = mysql_fetch_array($exec4))
		  {

		  $res2user = $res4['username'];
		  
		  $query41 = "select sum(transactionamount) as receivedamount from master_transactionpaylater where billnumber = '$res2billnumber' and patientcode = '$res2patientcode' and visitcode = '$res2visitcode' and username = '$res2user' and transactiontype = 'PAYMENT' and transactionstatus <> 'onaccount' and recordstatus <> 'deallocated'";
		  $exec41 = mysql_query($query41) or die ("Error in query3".mysql_error());
		  $res41 = mysql_fetch_array($exec41);
		  $receivedamount = $res41['receivedamount'];
 ...
 <td class="bodytext31" valign="center"  align="left">
			  <div align="right"><?php echo number_format($receivedamount,2,'.',','); ?></div></td>
			  	<td class="bodytext31" valign="center"  align="left">
			    <div align="center"><?php echo $res2user; ?></div></td>
           ...
           <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#cccccc"><div align="right"><strong><?php echo number_format($totalreceivedamount,2,'.',','); ?></strong></div></td>
				 <td class="bodytext31" valign="center"  align="left" 
