...
if ($frmflag1 == 'frmflag1')
{
 ...
 $query3 = "select * from master_location as ml LEFT JOIN login_locationdetails as ll ON ml.locationcode=ll.locationcode";
...
//echo $customercode;
	...
	$query29 = "select * from master_customer where customercode = '$customercode'";
	$exec29 = mysql_query($query29) or die ("Error in Query29".mysql_error());
	$res29 = mysql_num_rows($exec29);
	if ($res29 > 0)
	{
		$status = 'failedcode';
...
else if ($st == 'failedcode')
{
		$errmsg = "Failed. Patientcode Already Exists.";
		$bgcolorcode = 'failed';
}
...
$query3 = "select * from login_locationdetails where  username = '$username' order by locationname";
$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
$res3 = mysql_fetch_array($exec3);
...
<td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">National ID 				   </td>
				   <td align="left" valign="middle"  bgcolor="#E0E0E0">
				   <input name="nationalidnumber" id="nationalidnumber" value="" maxlength="11"  onBlur="return funcNationalIDValidation1()" style="text-transform:uppercase;" size="20" tabindex="11"/>				   </td>
				</tr>
				<tr>
