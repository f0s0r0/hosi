...
AutoSuggestControlmed.prototype.autosuggest = function (aSuggestions /*:Array*/,
	...
	if (xmlHttp==null)
	{
  	...
  	var searchsuppliername = document.getElementById("suppliername").value;
	//alert(searchmedicinename1);
	
	//alert(drugallergy);
    if (searchsuppliername.length < 2) 
	{
		var searchsuppliername = 'xyzxyzxyzxyz'; //To hide the already populated drop list automatically.
		//return false;
	}

	
	var url = "";
	var url="ajaxcustomer2newborn.php?searchsuppliername="+searchsuppliername+"&&RandomKey="+Math.random()+"";
    //alert(url);
	///*
	xmlHttp.onreadystatechange=function()
	{
		...
		{ 
			...
			//alert("Inside"+t);
			document.getElementById("searchsuppliername").value = t;
	...
	var varCompleteStringReturned = document.getElementById("searchsuppliername").value;
...
AutoSuggestControlmed.prototype.createDropDown = function () {
    ...
    this.layer.onmouseover = function (oEvent) {
        ...
        if (oEvent.type == "mousedown") {
			...
			var varSupplierName = document.getElementById("suppliername").value;
			...
			var varcustomervisitcode = arrSupplierName[2];
			var varaccountname = arrSupplierName[3];
			
			//alert (vargenericname);
			document.getElementById("suppliername").value = varsuppliername;
			document.getElementById("varSupplierCode").value = varsuppliercode;
			document.getElementById("varSuppliervisitCode").value = varcustomervisitcode;
			document.getElementById("accountname").value = varaccountname;			//funcmedicinesearch4();
...
function suppliernamelostfocus()
{
	...
	else
	{
		...
		document.getElementById("varSupplierCode").value = "";
			document.getElementById("varSuppliervisitCode").value = "";
			document.getElementById("accountname").value = "";			//funcmedicinesearch4();
	}
