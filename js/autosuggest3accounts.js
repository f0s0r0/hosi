...
function suppliernamelostfocus()
{
	...
	var varSupplierAnum = arrSupplierName[2];
	document.getElementById("accountnamenew").value = varSupplierName2;
	document.getElementById("accountcode").value = varSupplierCode;
	document.getElementById("accountname").value = varSupplierName2;
	document.getElementById("accountanum").value = varSupplierAnum;
