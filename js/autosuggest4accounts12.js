...
AutoSuggestControl.prototype.autosuggest = function (aSuggestions /*:Array*/,
	...
	if (xmlHttp==null)
	{
  	...
  	var searchmedicinename1 = document.getElementById("searchsuppliername").value;
	...
	//alert(storecode);
	var url = "";
	var url="autocompletebuild_account12.php?searchmedicinename1="+searchmedicinename1+"";
    //alert(url);
	///*
...
AutoSuggestControl.prototype.createDropDown = function () {
    ...
    this.layer.onmouseover = function (oEvent) {
		...
		//	var availablestock = arrSupplierName[2];
			...
			document.getElementById("searchsuppliername").value = varmedicineAnum;
