...
function ajaxprocess()
{
	...
	//alert(customercode);
	var url = "";
	var url="autocoasearch.php?RandomKey="+Math.random()+"&&coasearch="+coasearch;
    //alert(url);
...
{ 
	...
	for (m=0;m<=varNewLineLength;m++)
	{
		...
		//{
			...
			//alert (varCustomerName1);
			var varGroup = varNewRecordValue[3];
			...
			text4.id = "customeraddress"+k+"";
			text4.name = "customeraddress"+k+"";
			text4.type = "text";
			text4.size = "15";
			text4.value = varType;
			...
			text5.id = "customergroup"+k+"";
			text5.name = "customergroup"+k+"";
			text5.type = "text";
			text5.size = "15";
			text5.value = varGroup;
