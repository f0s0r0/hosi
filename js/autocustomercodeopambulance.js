...
function funcCustomerSearch2()
{
	...
	{
		var varCustomerSearch = document.getElementById("customer").value;
...
function ajaxprocessACCS2()
{
	...
	if (xmlHttp==null)
	{
  	...
  	var customersearch=document.getElementById("customer").value;
	//alert(customersearch);
	var location=document.getElementById("location").value;
	alert(location);
	var url = "";
	
	var url="autocustomercodeopambulance.php?RandomKey="+Math.random()+"&&customersearch="+customersearch+"&&location="+location;
   //alert(url);
