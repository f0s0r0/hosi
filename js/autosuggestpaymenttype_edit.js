...
AutoSuggestControl.prototype.handleKeyUp = function (oEvent /*:Event*/) {
    ...
    //make sure not to interfere with non-character keys
		...
		//alert ("Meow...");
		var varPaymentType = document.getElementById("searchpaymenttype").value;
		//alert (varPaymentType);
		var varPaymentType = varPaymentType.toUpperCase();
		//alert (varPaymentType);
		document.getElementById("searchpaymenttype").value = varPaymentType;
		//code end by prem.
...
function suppliernamelostfocus() 
{
	...
	var varPaymentType = document.getElementById("searchpaymenttype").value;
	//alert (varPaymentType);
	var arrSupplierName = varPaymentType.split('#'); 
	...
	if (varSupplierCode != undefined)
	{
		...
		document.getElementById("searchpaymenttype").value = varSupplierCode;
		document.getElementById("searchpaymentcode").value = varSupplierName2;
		
		var searchpaymentcode = document.getElementById("searchpaymentcode").value;
  	var searchsubtype = document.getElementById("searchpaymenttype").value;
	...
	//	alert('ok');
					...
					xmlhttp.onreadystatechange=function()
					  ...
					  if (xmlhttp.readyState==4 && xmlhttp.status==200)
						{
						document.getElementById("accountexpirydate").value=xmlhttp.responseText;
						}
					  }
					xmlhttp.open("GET","ajax/ajaxexpirydate1.php?accname="+searchsubtype,true);
					xmlhttp.send();
		...
		document.getElementById("searchaccountname").value='CASH IN HAND';
		document.getElementById("searchaccountcode").value=1;
