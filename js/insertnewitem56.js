...
//alert('h');
	...
	//alert(varRate);
	var z = varSerialNumber24;
	
	var i = varSerialNumber24;
	...
	grandtotal= parseFloat(totalamount)+parseFloat(totalamount1)+parseFloat(totalamount2)+parseFloat(totalamount3)+parseFloat(totalamount4);
