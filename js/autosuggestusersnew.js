...
AutoSuggestControl.prototype.autosuggest = function (aSuggestions /*:Array*/,
 ...
 //alert('hi');
	...
	if (xmlHttp==null)
	{
  	...
  	var searchsuppliername1 = document.getElementById("cbcustomername").value;
	...
	var url = "";
	var url="autocompletebuild_usersnew.php?searchsuppliername="+searchsuppliername1+"&&RandomKey="+Math.random()+"";
    //alert(url);
	///*
...
AutoSuggestControl.prototype.createDropDown = function () {
    ...
    this.layer.onmouseover = function (oEvent) {
        ...
        if (oEvent.type == "mousedown") {
			...
			var varSupplierName = document.getElementById("cbcustomername").value;
...
function suppliernamelostfocus()
{
	...
	if (varSupplierName != undefined)
	{
		...
		document.getElementById("cbcustomername").value = varSubtypeName;
		document.getElementById("searchdescription").value = varDescription;
		//document.getElementById("searchvisitcode").value = varVisitCode;
