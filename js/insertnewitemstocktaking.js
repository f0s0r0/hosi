function insertitem10()
{
	...
	text5.id = "batchnumber"+i+"";
	text5.name = "batchnumber"+i+"";
	text5.type = "text";
	text5.size = "8";
	...
	//get location and storecode
	//alert(locationcode);
	var text11 = document.createElement ('input');
	text11.id = "batchnumber"+i+"";
	text11.name = "locationcode"+i+"";
	text11.type = "hidden";
	text11.size = "8";
	text11.value = locationcode;
	text11.readOnly = "readonly";
	text11.style.backgroundColor = "#FFFFFF";
	text11.style.border = "0px solid #001E6A";
	text11.style.textAlign = "left";
	td5.appendChild (text11);
	//tr.appendChild (td5);
	
	var text12 = document.createElement ('input');
	text12.id = "batchnumber"+i+"";
	text12.name = "storecode"+i+"";
	text12.type = "hidden";
	text12.size = "8";
	text12.value = storecode;
