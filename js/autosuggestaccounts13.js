...
AutoSuggestControl3.prototype.createDropDown = function () {
    ...
    this.layer.onmouseover = function (oEvent) {
        ...
        if (oEvent.type == "mousedown") {
			...
			//Code by Prem Kumar.
			//alert ("Mouse Down."); 
			suppliernamelostfocus3() //Function located at the bottom of this file.
...
AutoSuggestControl3.prototype.handleKeyUp = function (oEvent /*:Event*/) {
    ...
    //make sure not to interfere with non-character keys
		...
		//alert ("Meow...");
		var varSupplierName3 = document.getElementById("accountname3").value;
		//alert (varSupplierName3);
		var varSupplierName3 = varSupplierName3.toUpperCase();
		//alert (varSupplierName3);
		document.getElementById("accountname3").value = varSupplierName3;
		//code end by prem.
...
function suppliernamelostfocus3()
{
	//alert ("you pressed a key.");
	var varSupplierName3 = document.getElementById("accountname3").value;
	//alert (varSupplierName3);
	var arrSupplierName2 = varSupplierName3.split('||'); 
	var varSupplierName32 = arrSupplierName2[0];
	var varSupplierCode2 = arrSupplierName2[1];
	document.getElementById("accountnamenew3").value = varSupplierName32;
	document.getElementById("accountcode3").value = varSupplierCode2;
	document.getElementById("accountname3").value = varSupplierName32;
