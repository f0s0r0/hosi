...
function ajaxprocessACCS25()
{
	...
	var url = "";
	var url="autolabcodesearch2.php?RandomKey="+Math.random()+"&&labsearch="+labsearch+"&&patienttypesearch="+varpatienttype+"&&varpaymenttype="+varpaymenttype+"&&locationcode="+locationcode+"&&subtype="+subtype;
    //alert(url);
