...
function customernamelostfocus1()
{
	...
	//alert (arritemname);
	var varitemcode = arritemname[1];
	//alert(varitemcode);
	var varitemname = arritemname[2];
	if (varitemname != undefined)
	{
		//alert (varitemcode);
		document.getElementById("id").value = varitemcode;
		
		document.getElementById("itemname").value = varitemname;
		//alert(varitemname);
		funcitemsearch5(); //autocustomercodesearch2.js
