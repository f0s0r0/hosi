...
AutoSuggestControlmed.prototype.autosuggest = function (aSuggestions /*:Array*/,
	...
	var url="ajaxmedicinebuildipmedicineissue.php?searchmedicinename1="+searchmedicinename1+"&&searchlocation="+locationcode+"&&searchstore="+storecode+"&&RandomKey="+Math.random()+"";
    //alert(url);
	///*
...
AutoSuggestControlmed.prototype.createDropDown = function () {
    ...
    this.layer.onmouseover = function (oEvent) {
        ...
        if (oEvent.type == "mousedown") {
			...
			var varCurrentstock = arrSupplierName[2];
			//var varSupplierName1 = arrSupplierName[1];
			var varRate=arrSupplierName[4];
