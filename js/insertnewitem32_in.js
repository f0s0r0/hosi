...
/*
	...
	*/
	...
	tr.id = "idTR"+i+"";
	tr.style.border = "0px solid #001E6A";
	...
	var text11it = document.createElement ('input');
	text11it.id = "itemcode"+i+"";
	text11it.name = "itemcodear[]";
	text11it.type = "hidden";
	text11it.align = "left";
	text11it.size = "25";
	text11it.value = varMedicineCode;
	text11it.readOnly = "readonly";
	text11it.style.backgroundColor = "#FFFFFF";
	text11it.style.border = "0px solid #001E6A";
	text11it.style.textAlign = "left";

	td1.appendChild (text1);
	td1.appendChild (text11);
	td1.appendChild (text11it);
	tr.appendChild (td1);
	...
	var text81c = document.createElement ('input');
	text81c.id = "appar"+i+"";
	text81c.name = "appar[]";
	text81c.type = "checkbox";
	text81c.value = varMedicineCode;
	text81c.style.display = 'none';
	text81c.style.backgroundColor = "#FFFFFF";
	text81c.style.border = "0px solid #001E6A";
	td81.appendChild (text81c);
