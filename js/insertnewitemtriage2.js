...
function insertitem2()
{
	...
	if(document.getElementById("laburgent").checked)
	{
	var varurgent = 1;
	}
	else
	...
	text84.id = "laburgent"+j+"";
	text84.name = "laburgent[]"+j+"";
	text84.type = "hidden";
	text84.value = varurgent;
	
	td8.appendChild (text84);
	tr.appendChild (td8);
	...
	grandtotal= parseInt(totalamount1)+parseInt(totalamount3);
	
	
	
	var varLab = document.getElementById("lab").value = "";
	var varRate = document.getElementById("rate5").value = "";
	document.getElementById("laburgent").checked = false;
