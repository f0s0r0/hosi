...
function ajaxprocessACCS26()
{
	...
	var url = "";
	var url="autoradiologycodesearchexternal.php?RandomKey="+Math.random()+"&&radiologysearch="+radiologysearch;
    //alert(url);
...
{ 
	...
	//{
		...
		document.getElementById("radrate8").value = varradiologyRate;
		...
		//document.getElementById("radiology").value = Varradiologyname1;
