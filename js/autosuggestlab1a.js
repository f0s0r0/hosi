...
AutoSuggestControl1.prototype.autosuggest = function (aSuggestions /*:Array*/,
 ...
 //alert('hi');
	...
	if (xmlHttp==null)
	{
  	...
  	var searchlabname1 = document.getElementById("lab").value;
	...
	//alert(lab1);
    if (searchlabname1.length < 2) 
	{
		var searchlabname1 = 'xyzxyzxyzxyz'; //To hide the already populated drop list automatically.
		//return false;
	}

	
	var url = "";
	var url="ajaxlabbuild1a.php?searchlabname="+searchlabname1+"&&RandomKey="+Math.random()+"&&locationcode1="+locationcode+"";
    //alert(url);
	///*
	xmlHttp.onreadystatechange=function()
	{
		...
		{ 
			...
			//alert("Inside"+t);
			document.getElementById("labname1hiddentextbox").value = t;
	...
	var varCompleteStringReturned = document.getElementById("labname1hiddentextbox").value;
...
AutoSuggestControl1.prototype.createDropDown = function () {
    ...
    this.layer.onmouseover = function (oEvent) {
        ...
        if (oEvent.type == "mousedown") {
			...
			var varLabName = document.getElementById("lab").value;
			var arrLabName = varLabName.split('||'); 
		    var varLabCode = arrLabName[0];
		  var varLabName = arrLabName[1];
			
			//alert (varLabName);
		//	var varDescription = arrLabName[1];
//var varEmployeeCode = arrLabName[2];
			//alert (varEmployeeCode);
			//var varVisitCode = arrLabName[2];
			//alert (varVisitCode);
...
AutoSuggestControl1.prototype.handleKeyUp = function (oEvent /*:Event*/) {
    ...
    //make sure not to interfere with non-character keys
		...
		var varLabName = varLabName.toUpperCase();
		//alert (varLabName);
		document.getElementById("lab").value = varLabName;
		//code end by prem.
