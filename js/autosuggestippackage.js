...
AutoSuggestControl.prototype.handleKeyUp = function (oEvent /*:Event*/) {
    ...
    //make sure not to interfere with non-character keys
		...
		//alert ("Meow...");
		var varSupplierName = document.getElementById("packagename").value;
		//alert (varSupplierName);
		var varSupplierName = varSupplierName.toUpperCase();
		//alert (varSupplierName);
		document.getElementById("packagename").value = varSupplierName;
		//code end by prem.
...
function suppliernamelostfocus()
{
	...
	if (varSupplierCode != undefined)
	{
		...
		document.getElementById("packagecode").value = varSupplierCode;
