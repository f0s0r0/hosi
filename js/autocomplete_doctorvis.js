...
*/
function StateSuggestionsdoctorvis() {
 ...
 */
StateSuggestionsdoctorvis.prototype.requestSuggestions = function (AutoSuggestControldoctor /*:AutoSuggestControlmed*/,
                                                          bTypeAhead /*:boolean*/) {
	//alert('h');
    var aSuggestions = [];
    var sTextboxValue = AutoSuggestControldoctor.textbox.value;
    //alert(sTextboxValue);
 	var loopLength = 0;
    ...
    AutoSuggestControldoctor.autosuggest(aSuggestions, bTypeAhead);
};