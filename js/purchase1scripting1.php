...
function itemtotalamountupdate1()
{
		...
		document.getElementById("costprice").value = varItemMRP;
		
		
		var salespriceamt = (varItemMRP * spmarkup)/100;
		
		var salesprice = parseFloat(varItemMRP) + parseFloat(salespriceamt);
