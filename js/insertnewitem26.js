function insertitem26()
{

	
	var presserialnumber1 = document.getElementById("presserialnumber1").value;
	...
	var urine = document.getElementById("urine").value;
	var weight = document.getElementById("presweight").value;
	var bp = document.getElementById("bp").value;
	var hp = document.getElementById("hp").value;
	var pallor = document.getElementById("pallor").value;
	var maturity = document.getElementById("presmaturity").value;
	//alert(varpharmRate);
	var lie = document.getElementById("lie").value;
	var fundalweight = document.getElementById("fundalweight").value;
	var present = document.getElementById("present").value;
	var foetalheart = document.getElementById("foetalheart").value;
 	var nextvisit = document.getElementById("nextvisit").value;

	
	var i = presserialnumber1;
	...
	text1.id = "presserialnumber1"+i+"";
	text1.name = "presserialnumber1"+i+"";
	text1.type = "hidden";
	text1.size = "25";
	text1.value = presserialnumber1;
	...
	text5.id = "presweight"+i+"";
	text5.name = "presweight"+i+"";
	text5.type = "text";
	text5.size = "8";
	text5.value = weight;
	...
	text8.id = "presmaturity"+i+"";
	text8.name = "presmaturity"+i+"";
	text8.type = "text";
	text8.size = "8";
	text8.value = maturity;
	...
	text81.id = "fundalweight"+i+"";
	text81.name = "fundalweight"+i+"";
	text81.type = "text";
	text81.size = "8";
	text81.value = fundalweight;
	...
	text82.id = "present"+i+"";
	text82.name = "present"+i+"";
	text82.type = "text";
	text82.size = "8";
	text82.value = present;
	...
	td86.id = "foetalheart"+i+"";
	td86.align = "left";
	td86.valign = "top";
	td86.style.backgroundColor = "#FFFFFF";
	td86.style.border = "0px solid #001E6A";
	//var text81 = document.createElement ('<input name="taxpercent'+i+'" value="'+varItemTaxPercent+'" id="discountrupees'+i+'" readonly="readonly" style="border: 0px solid #001E6A; text-align:right" size="3" />');
	var text86 = document.createElement ('input');
	text86.id = "foetalheart"+i+"";
	text86.name = "foetalheart"+i+"";
	text86.type = "text";
	text86.size = "8";
	text86.value = foetalheart;
	...
	td87.align = "left";
	td87.valign = "top";
	td87.style.backgroundColor = "#FFFFFF";
	td87.style.border = "0px solid #001E6A";
	//var text81 = document.createElement ('<input name="taxpercent'+i+'" value="'+varItemTaxPercent+'" id="discountrupees'+i+'" readonly="readonly" style="border: 0px solid #001E6A; text-align:right" size="3" />');
	var text87 = document.createElement ('input');
	text87.id = "nextvisit"+i+"";
	text87.name = "nextvisit"+i+"";
	text87.type = "text";
	text87.size = "8";
	text87.value = nextvisit;
	...
	text11.onclick = function() { return btnDeleteClick26(i); }
	//td10.appendChild (text10);
	td10.appendChild (text11);
	tr.appendChild (td10);
	var cal = document.getElementById ('presimgdate').style.top;
	//document.getElementById ('presimgdate').style.top=(parseInt(cal)+33);
    document.getElementById ('preinsertrow1').appendChild (tr);
//alert("hio");	
	...
	document.getElementById("presserialnumber1").value = parseInt(i) + 1;
