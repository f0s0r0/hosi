...
function customernamelostfocus3()
{
	...
	var varitemname = document.getElementById("accdepreciationledger").value;
	//alert(varitemname);
	...
	if (varitemname != undefined)
	{
		...
		document.getElementById("accdepreciationledgerid").value = varitemcode;
		
		document.getElementById("accdepreciationledger").value = varitemname;
