...
if($delkey==1)
{
	...
	$query1 = "UPDATE master_copayaccount SET recordstatus = 'DELETED' WHERE auto_number = '".$planid."'";
...
{
	$planid = isset($_REQUEST['planid'])?$_REQUEST['planid']:'';
	$query1 = "UPDATE master_copayaccount SET recordstatus = 'ACTIVE' WHERE auto_number = '".$planid."'";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
	//	$errmsg = "Success. New Plan Name Updated.";
	//	$bgcolorcode = 'success';
...
if ($frmflag1 == 'frmflag1')
{
	...
	$accountnamecodeanum = $_REQUEST["accountnamecode"];
...
//	$forall = isset($_REQUEST['forall'])?$_REQUEST['forall']:'';
	...
	$query7 = mysql_query("select id from master_accountname where auto_number = '$accountnamecodeanum'");
	$res7 = mysql_fetch_array($query7);
	$accountnamecode = $res7['id'];
	
	$query2 = "select * from master_copayaccount where id = '$accountnamecode'";
	...
	if($res2==0)
	{
		...
		$query1 = "INSERT INTO  master_copayaccount SET ipaddress = '".$ipaddress."',recorddate = '".$updatedatetime."',username = '".$username."',lab_copay = '".$lab_copay."',radiology_copay = '".$radiology_copay."',service_copay = '".$service_copay."',pharmacy_copay = '".$pharmacy_copay."' , id = '".$accountnamecode."' , accountnameano = '".$accountnamecodeanum."', accountname = '".$accountname."'    , bed_copay = '".$bed_copay."', nursing_copay = '".$nursing_copay."', rmo_copay = '".$rmo_copay."', package_copay = '".$package_copay."', misc_copay = '".$misc_copay."', ambulance_copay = '".$ambulance_copay."', mortuary_copay = '".$mortuary_copay."'";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
	//	$errmsg = "Success. New Plan Name Updated.";
	//	$bgcolorcode = 'success';
	...
	{
		$errmsg = "Account Name Already Exist";
		$bgcolorcode = 'failed';
	}
...
/*	function checking(){
	...
	function dropplan(planid)
	{
		...
		if(con == false)
		{
			...
			//alert(planid);
			form1.method="post"
			form1.action="addcopayplan.php?planid="+planid+"&&delkey=1";
			form1.submit();
		}
	...
	function activeplan(planid)
	{
		...
		if(con == false)
		{
			...
			//alert(planid);
			form1.method="post"
			form1.action="addcopayplan.php?planid="+planid+"&&actkey=1";
			form1.submit();
		}
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="addcopayplan.php" onSubmit="return addplanname1process1()">
                ...
                <tbody>
                  <tr>
                    <td align="left" colspan="3" valign="top"  bgcolor="#FFFFFF"><table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber" style="border-collapse: collapse">
                      <tbody>
                        <tr bgcolor="#011E6A">
                          <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong>Add Copay </strong></td>
                        </tr>
                        <tr>
...
-->
                        <tr>
                          ...
                          <td align="left" valign="top"   bgcolor="#FFFFFF"><input name="lab_copay" id="lab_copay" style="text-transform:uppercase;" size="10"  onKeyDown="return numbervaild(event)" onFocus="return copay(this.id)"/></td>						<!--<td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Smart Applicable </div></td>-->
                         
                        </tr>
                        <tr>
                          <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Radiology </div></td>
                          <td align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3"><input name="radiology_copay" id="radiology_copay" style="text-transform:uppercase;" size="10"  onKeyDown="return numbervaild(event)" onFocus="return copay(this.id)"/></td>
                        ...
                        <tr>
                          ...
                          <td align="left" valign="top"  bgcolor="#FFFFFF"><label>
                            <input name="service_copay" type="text" id="service_copay" style="text-transform:uppercase;" size="10" onKeyDown="return numbervaild(event)">
                          </label></td>
                        ...
                        <tr>
                          ...
                          <td align="left" valign="top"   bgcolor="#FFFFFF"><label>
                            <input name="pharmacy_copay" type="text" id="pharmacy_copay" style="text-transform:uppercase;" size="10"  onKeyDown="return numbervaild(event)">
                          </label></td>
                         ...
                         <tr>
                          ...
                          <td align="left" valign="top"   bgcolor="#FFFFFF"><label>
                            <input name="bed_copay" type="text" id="bed_copay" style="text-transform:uppercase;" size="10"  onKeyDown="return numbervaild(event)">
                          </label></td>
                          <!--<td align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3"><div align="right" >Visit IP Limit </div></td>-->
                          <td align="left" valign="top"   bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                         <tr>
                          ...
                          <td align="left" valign="top"   bgcolor="#FFFFFF"><label>
                            <input name="nursing_copay" type="text" id="nursing_copay" style="text-transform:uppercase;" size="10"  onKeyDown="return numbervaild(event)">
                          </label></td>
                          <!--<td align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3"><div align="right" >Visit IP Limit </div></td>-->
                          <td align="left" valign="top"   bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                         <tr>
                          ...
                          <td align="left" valign="top"   bgcolor="#FFFFFF"><label>
                            <input name="rmo_copay" type="text" id="rmo_copay" style="text-transform:uppercase;" size="10"  onKeyDown="return numbervaild(event)">
                          </label></td>
                          <!--<td align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3"><div align="right" >Visit IP Limit </div></td>-->
                          <td align="left" valign="top"   bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td align="left" valign="top"   bgcolor="#FFFFFF"><label>
                            <input name="package_copay" type="text" id="package_copay" style="text-transform:uppercase;" size="10"  onKeyDown="return numbervaild(event)">
                          </label></td>
                          <!--<td align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3"><div align="right" >Visit IP Limit </div></td>-->
                          <td align="left" valign="top"   bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                         ...
                         <tr>
                          ...
                          <td align="left" valign="top"   bgcolor="#FFFFFF"><label>
                            <input name="misc_copay" type="text" id="misc_copay" style="text-transform:uppercase;" size="10"  onKeyDown="return numbervaild(event)">
                          </label></td>
                          <!--<td align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3"><div align="right" >Visit IP Limit </div></td>-->
                          <td align="left" valign="top"   bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                         <tr>
                          ...
                          <td align="left" valign="top"   bgcolor="#FFFFFF"><label>
                            <input name="ambulance_copay" type="text" id="ambulance_copay" style="text-transform:uppercase;" size="10"  onKeyDown="return numbervaild(event)">
                          </label></td>
                          <!--<td align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3"><div align="right" >Visit IP Limit </div></td>-->
                          <td align="left" valign="top"   bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                         <tr>
                          ...
                          <td align="left" valign="top"   bgcolor="#FFFFFF"><label>
                            <input name="mortuary_copay" type="text" id="mortuary_copay" style="text-transform:uppercase;" size="10"  onKeyDown="return numbervaild(event)">
                          </label></td>
                          <!--<td align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3"><div align="right" >Visit IP Limit </div></td>-->
                          <td align="left" valign="top"   bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                ...
                <table width="800" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td width="45%"  bgcolor="#CCCCCC" class="bodytext3"><strong>Account </strong></td>
                        <td  bgcolor="#CCCCCC" class="bodytext3"><strong>Lab</strong></td>
                        <td bgcolor="#CCCCCC" class="bodytext3"><strong>Radiology</strong></td>
                        <td  bgcolor="#CCCCCC" class="bodytext3"><strong>Service</strong></td>
                        <td bgcolor="#CCCCCC" class="bodytext3"><strong>Pharmacy</strong></td>
                        
                        <td bgcolor="#CCCCCC" class="bodytext3"><strong>Bed</strong></td>
                        <td bgcolor="#CCCCCC" class="bodytext3"><strong>Nursing</strong></td>
                        <td bgcolor="#CCCCCC" class="bodytext3"><strong>RMO</strong></td>
                        <td bgcolor="#CCCCCC" class="bodytext3"><strong>Package</strong></td>
                        
                        <td bgcolor="#CCCCCC" class="bodytext3"><strong>Misc</strong></td>
                        <td bgcolor="#CCCCCC" class="bodytext3"><strong>Ambulance</strong></td>
                        <td bgcolor="#CCCCCC" class="bodytext3"><strong>Mortuary</strong></td>
                        
                        <td bgcolor="#CCCCCC" class="bodytext3"><strong>Edit</strong></td>
                        <td bgcolor="#CCCCCC" class="bodytext3"><strong>Delete</strong></td>
                      </tr>
                      <?php
	    $query1 = "select * from master_copayaccount where recordstatus <> 'DELETED' order by accountname ";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
        ...
        <tr <?php echo $colorcode; ?>>
                       ...
                       <?php /*?> <input type="hidden" name="maintypeplan" id="maintypeplan" value="<?php echo $accountname; ?>" >
                         <input type="hidden" name="subtypeplan" id="subtypeplan" value="<?php echo $subtypeplan; ?>" >
                          <input type="hidden" name="accountnameanum" id="accountnameanum" value="<?php echo $maintypeplan; ?>" ><?php */?>
                        <td align="left" valign="top"  class="bodytext3"><?php echo $accountname; ?></td>
                        <td align="left" valign="top"  class="bodytext3"><?php echo $lab_copay; ?></td>
                        <td align="left" valign="top"  class="bodytext3"><?php echo $radiology_copay; ?></td>
                        <td align="left" valign="top"  class="bodytext3"><?php echo $service_copay; ?> </td>
                        <td align="left" valign="top"  class="bodytext3"><?php echo $pharmacy_copay; ?> </td>
                        
                        <td align="left" valign="top"  class="bodytext3"><?php echo $bed_copay; ?> </td>
                        <td align="left" valign="top"  class="bodytext3"><?php echo $nursing_copay; ?> </td>
                        <td align="left" valign="top"  class="bodytext3"><?php echo $rmo_copay; ?> </td>
                        <td align="left" valign="top"  class="bodytext3"><?php echo $package_copay; ?> </td>
                        
                        <td align="left" valign="top"  class="bodytext3"><?php echo $misc_copay; ?> </td>
                        <td align="left" valign="top"  class="bodytext3"><?php echo $ambulance_copay; ?> </td>
                        <td align="left" valign="top"  class="bodytext3"><?php echo $mortuary_copay; ?> </td>
                        
                        <td align="left" valign="top"  class="bodytext3"> <a href="editcopayplan.php?planid=<?php echo $auto_number; ?>" style="text-decoration:none">Edit</a></td>
                         <td align="left" valign="top"  class="bodytext3"> <a href="#" style="text-decoration:none" onClick="dropplan(<?php echo $auto_number; ?>);"><img src="images/b_drop.png" width="16" height="16"></a></td>
        </tr>
                      <?php
		}
		?>
                  ...
                  <table width="800" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      ...
                      <tr bgcolor="#011E6A">
                        <td width="45%"  bgcolor="#CCCCCC" class="bodytext3"><strong>Account Deleted</strong></td>
                        <td  bgcolor="#CCCCCC" class="bodytext3"><strong>Lab</strong></td>
                        <td bgcolor="#CCCCCC" class="bodytext3"><strong>Radiology</strong></td>
                        <td  bgcolor="#CCCCCC" class="bodytext3"><strong>Service</strong></td>
                        <td bgcolor="#CCCCCC" class="bodytext3"><strong>Pharmacy</strong></td>
        ...
        <tr <?php echo $colorcode; ?>>
                       ...
                       <?php /*?> <input type="hidden" name="maintypeplan" id="maintypeplan" value="<?php echo $accountname; ?>" >
                        ...
                        <td align="left" valign="top"  class="bodytext3"> <a href="#" style="text-decoration:none" onClick="activeplan(<?php echo $auto_number; ?>);">Active</a></td>
        </tr>
                      <?php
		}
		?>
