...
<body>
<?php $querynw1 = "select * from consultation_lab where labsamplecoll='completed' and resultentry='pending' and labrefund <> 'refund' and patientcode <> 'walkin' group by docnumber order by auto_number desc";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
          ...
          <tbody>
            <tr>
              ...
              <td colspan="7" bgcolor="#cccccc" class="bodytext31">
                ...
                <div align="left"><strong>Lab Result Entry</strong><label class="number"><<<?php echo $resnw1;?>>></label></div></td>
              </tr>
            <tr>
			...
			$query1 = "select * from consultation_lab where labsamplecoll='completed' and resultentry='pending' and labrefund <> 'refund' group by docnumber order by consultationdate desc";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center" align="left">
			    <div align="left"><a href="labresultentry.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&docnumber=<?php echo $docnumber; ?>"><strong>Enter</strong></a></div></td>
              </tr>
			<?php
			}    
			?>
