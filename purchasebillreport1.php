...
if ($cbfrmflag1 == 'cbfrmflag1')
{
	...
	$supplierbillnumber = $_REQUEST['cbbillnumber'];
            ...
            <tr>
              ...
              <td colspan="3" align="left" valign="center" bgcolor="#ffffff" class="bodytext31">
				...
				if ($cbfrmflag1 == 'cbfrmflag1')
				{
					...
					$urlpath = "cbsuppliername=$cbsuppliername&&cbbillnumber=$cbbillnumber&&approvalstatus=$approvalstatus&&paymenttype=$paymenttype&&ADate1=$transactiondatefrom&&ADate2=$transactiondateto&&username=$username&&companyanum=$companyanum";//&&companyname=$companyname";
				}
				else
				{
					$urlpath = "cbsuppliername=$cbsuppliername&&cbbillnumber=$cbbillnumber&&approvalstatus=APPROVED&&ADate1=$transactiondatefrom&&ADate2=$transactiondateto&&username=$username&&companyanum=$companyanum";//&&companyname=$companyname";
				}
				?>
 				<?php
...
-->
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center" align="left" 
                bgcolor="#ffffff"><div align="left"><strong>Invoice</strong></div></td>
              <td class="bodytext31" valign="center" align="left" 
			...
			supplierbillnumber like '%$supplierbillnumber' and $billstatusquery1 and billtype like '%$paymenttype%' and 
            ...
            <tr <?php echo $colorcode; ?>>
			  ...
			  <?php echo $supplierbillnumber; ?></div></td>
              <td class="bodytext31" valign="center" align="left"><div align="left">
                  <?php 
				/*
				//echo $billdate; 
			...
			?>
			  ...
			  {
			  ?>
                  <a href="purchase1.php?delbillst=billedit&&delbillautonumber=<?php echo $billautonumber; ?>&&delbillnumber=<?php echo $billnumber; ?>&&delsupplierbillnumber=<?php echo $supplierbillnumber; ?>" class="bodytext3" target="_blank">
             ...
             <?php
			  ...
			  ?>
			  <div align="center"> 
			  <a href="purchasedelete1.php?task=delete&&anum=<?php echo $billautonumber; ?>&&delsupplierbillnumber=<?php echo $supplierbillnumber; ?>" 
			  class="bodytext3" onClick="return funcDeleteRecord1(<?php echo $supplierbillnumber;?>)"> 
