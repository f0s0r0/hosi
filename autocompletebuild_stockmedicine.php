...
$stringbuild1 = "";
$querymed = "select * from master_medicine where status <> 'Deleted' order by itemcode";
...
while ($resmed = mysql_fetch_array($execmed))
{
	...
	$res1itemcode = mysql_real_escape_string(trim($res1itemcode));
	$res1itemname = mysql_real_escape_string($resmed['itemname']);
...
$filefolder = 'js';
$filename = 'autocomplete_stockmedicine.'.'js';
