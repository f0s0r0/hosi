	...
	*/
	$drresult = array();
					$querydr1bnk = "SELECT SUM(`cashamount`) as bankamount FROM `billing_consultation` WHERE (`cashcode` = '$id') AND `billdate` BETWEEN '$ADate1' AND '$ADate2'
									...
									UNION ALL SELECT SUM(`cashamount`) as bankamount FROM `master_mortuaryexternaldeposit` WHERE `cashcode` = '$id' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactionmodule` = 'PAYMENT'
									UNION ALL SELECT SUM(`creditamount`) as bankamount FROM `master_mortuaryexternaldeposit` WHERE `mpesacode` = '$id' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactionmodule` = 'PAYMENT'
									UNION ALL SELECT SUM(`chequeamount`) as bankamount FROM `master_mortuaryexternaldeposit` WHERE `bankcode` = '$id' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactionmodule` = 'PAYMENT'
									UNION ALL SELECT SUM(`onlineamount`) as bankamount FROM `master_mortuaryexternaldeposit` WHERE `bankcode` = '$id' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactionmodule` = 'PAYMENT'
									UNION ALL SELECT SUM(`cardamount`) as bankamount FROM `master_mortuaryexternaldeposit` WHERE `bankcode` = '$id' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactionmodule` = 'PAYMENT'
					...
					*/			
					...
					$querycr1bnk = "SELECT SUM(transactionamount) as bankcredit FROM `master_transactionpaylater` WHERE `accountnameid` = '$id' AND `docno` LIKE '%IPCr%' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactiontype` = 'paylatercredit'
									...
									UNION ALL SELECT SUM(`transactionamount`) as bankcredit FROM `master_transactionpayroll` WHERE `bankcode` = '$id' AND `transactionmodule` = 'PAYMENT' AND `recordstatus` = 'allocated' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2'
									...
									UNION ALL SELECT SUM(`cashamount`) as bankcredit FROM `deposit_refund` WHERE (`cashcode` = '$id') AND `recorddate` BETWEEN '$ADate1' AND '$ADate2'
									UNION ALL SELECT SUM(`creditamount`) as bankcredit FROM `deposit_refund` WHERE (`mpesacode` = '$id') AND `recorddate` BETWEEN '$ADate1' AND '$ADate2'
									UNION ALL SELECT SUM(`cardamount`) as bankcredit FROM `deposit_refund` WHERE (`bankcode` = '$id') AND `recorddate` BETWEEN '$ADate1' AND '$ADate2'
									UNION ALL SELECT SUM(`onlineamount`) as bankcredit FROM `deposit_refund` WHERE (`bankcode` = '$id') AND `recorddate` BETWEEN '$ADate1' AND '$ADate2'
									UNION ALL SELECT SUM(`chequeamount`) as bankcredit FROM `deposit_refund` WHERE (`bankcode` = '$id') AND `recorddate` BETWEEN '$ADate1' AND '$ADate2'
