    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="registeredbyreceptionist.php">
		<table width="658" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong>Registered By Receptionist</strong></td>
              </tr>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <?php
			...
			$cbcustomername=trim($cbcustomername);
		  		  ...
		  		  $query7 = "select username from master_customer where username like '$cbcustomername' and registrationdate between '$ADate1' and '$ADate2'"; 
		  $exec7 = mysql_query($query7) or die ("Error in Query7".mysql_error());
		  $numcount=mysql_num_rows($exec7);

		  ?>
            <tr>
              <td colspan='5' bgcolor="#cccccc" class="bodytext31"><?php echo 'Total No of Registered by '.$cbcustomername?>(<?php echo $numcount;?>)</td>
            </tr>
            <tr>
