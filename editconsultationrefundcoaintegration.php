...
?>
<?php
$query764 = "select * from master_financialintegration where field='consultationfeerefund'";
$exec764 = mysql_query($query764) or die(mysql_error());
$res764 = mysql_fetch_array($exec764);

$consultationcoa = $res764['code'];
$consultationcoaname = $res764['coa'];
$consultationtype = $res764['type'];
$consultationselect = $res764['selectstatus'];
 ...
 <tr>
  ...
  <tr>
    ...
    <td width="97%" valign="top">
		  	  	<form id="form1" name="form1" method="post" action="editconsultationrefundcoaintegration.php" onSubmit="return process1login1()">
    ...
    <td>&nbsp;</td>
                 ...
                 <tr bgcolor="#011E6A">
                        <td colspan="10" bgcolor="#CCCCCC" class="bodytext3"><strong>Edit Consultation Refund </strong></td>
                  </tr>
					   <tr>
				  ...
				  <td width="248" align="left" valign="top"  class="bodytext5">Consultation Fee <input type="hidden" name="labpaynow5" value="consultationfeerefund" /></td>
                        <td width="332" align="left" valign="top"  class="bodytext3"><input type="text" name="paynowlabcoa5" id="paynowreferalcoa" size="40" value="<?php echo $consultationcoaname; ?>"/>
						...
						{
						if($consultationselect == 'dr')		
						{
						$consultationselect1 = 'Dr';
						}	
						else
						{
						$consultationselect1 = 'Cr';
						}	
						?>
						<option value="<?php echo $pharmacyselect; ?>"><?php echo $consultationselect1; ?></option>
						<?php
						}
						?>
                        ...
                        <td width="110" align="left" valign="top"  class="bodytext3"><input type="text" name="paynowlabtype5" id="paynowreferaltype" size="10" value="<?php echo $consultationtype; ?>"/></td>
                        <td width="103" align="left" valign="top"  class="bodytext3"><input type="text" name="paynowlabcode5" id="paynowreferalcode" size="10" value="<?php echo $consultationcoa; ?>"/></td>
				  </tr>
