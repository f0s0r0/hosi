        ...
        <td valign="top"><table width="919" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            <?php
				...
				{  
					...
					/*$querydr1 = "SELECT `openbalanceamount` as td1,`entrydate` as td2,`docno` as td3,`accountcode` as td4,`accountname` as td5 FROM `openingbalanceaccount` WHERE `accountcode` = '$id'";
					...
					$querycr1 = "SELECT `openbalanceamount` as td1,`entrydate` as td2,`docno` as td3,`accountcode` as td4,`accountname` as td5 FROM `openingbalancesupplier` WHERE `accountcode` = '$id'";
