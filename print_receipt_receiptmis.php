...
$query1 = "select * from receiptsub_details where docnumber LIKE '%MSE%' AND  recordstatus <> 'DELETED' and companyanum = '$companyanum' order by auto_number desc";
...
if ($receiptanum != '')
{
	$query21 = "select * from receiptsub_details where docnumber like '%MSE%' AND  auto_number = '$receiptanum'";
}
else
{
	$query21 = "select * from receiptsub_details where docnumber like '%MSE%' AND recordstatus <> 'DELETED' and companyanum = '$companyanum' order by auto_number desc";
}
...
<table width="660" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>Paid To </td>
    <td><?php echo $receiptfullname; ?>&nbsp;</td>
    <td width="4">&nbsp;</td>
  </tr>
  <tr>
    <td>Amount Paid </td>
