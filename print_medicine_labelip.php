...
?> 
<style type="text/css">
.bodytext3 {	FONT-WEIGHT: normal; FONT-SIZE: 15px; COLOR: #000000; 
}
.bodytext31 {FONT-WEIGHT: normal; FONT-SIZE: 15px; COLOR: #000000; 
}
.bodytext41 {FONT-WEIGHT: normal; FONT-SIZE: 15px; COLOR: #000000; 
}
.bodytext311 {FONT-WEIGHT: normal; FONT-SIZE: 15px; COLOR: #000000;  text-decoration:none
}
.bodytext365 {FONT-WEIGHT: normal; FONT-SIZE: 15px; COLOR: #000000;  text-decoration:none
}
.bodytext366 {FONT-WEIGHT: normal; FONT-SIZE: 15px; COLOR: #000000;  text-decoration:none
}
.bodytext311 {FONT-WEIGHT: normal; FONT-SIZE: 15px; COLOR: #000000; 
}
.bodytext32 {FONT-WEIGHT: normal; FONT-SIZE: 15px; COLOR: #000000; 
}
.bodytext312 {FONT-WEIGHT: normal; FONT-SIZE: 15px; COLOR: #000000; 
}
body {
	margin-left: 0px;
	margin-top: 0px;
...
$query7 = "select * from master_ipvisitentry where patientcode='$patientcode'";
...
$res8formula = trim($res8formula);
  ...
  <tr>
    ...
    <td colspan="3"  align="left" valign="center"
				...
				echo "TAKE"."&nbsp;".$res2dose."&nbsp;"."TAB"."&nbsp;"."TIMES A DAY FOR"."&nbsp;".$res2days."&nbsp;"."DAYS"."&nbsp;"."&nbsp;"."BY"."&nbsp;".$res2route."&nbsp;";
				}
				?>
 ...
 <tr>
    <td class="bodytext31"  valign="center"  align="left" 
                bgcolor="#ffffff">&nbsp;</td>
    <td colspan="2" class="bodytext41" valign="center"  align="left" 
                bgcolor="#ffffff" nowrap="nowrap">&nbsp;</td>
  </tr>
  <tr>
    <td class="bodytext31"  valign="center"  align="left" 
                bgcolor="#ffffff">&nbsp;</td>
...
<?php	
    ...
    {	
        ...
        $html2pdf->Output('IPMedicineLabel.pdf');
