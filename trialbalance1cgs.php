	...
	if($parentid != '')
	{
		...
		{  
			...
			{				
				$i = 0;
				$drresult = array();
				$querydr1inv = "SELECT SUM(`totalcp`) as stock FROM `pharmacysalesreturn_details` WHERE `entrydate` BETWEEN '$ADate1' AND '$ADate2'";
				...
				$j = 0;
				$crresult = array();
				$querycr1inv = "SELECT SUM(`totalcp`) as stockcredit FROM `pharmacysales_details` WHERE `entrydate` BETWEEN '$ADate1' AND '$ADate2'";
