...
<?php //include("a4pdfheader1.php"); ?>	
	...
	<td colspan="10" align="left" class="bodytext3"><strong>NSSF CONTRIBUTION</strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	<td width="50" align="center" bgcolor="#FFFFFF" class="bodytext3"><strong>&nbsp;</strong></td>
	<td colspan="10" align="left" class="bodytext3"><strong>EMPLOYER'S CODE : <?php echo $companycode; ?></strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	<td width="50" align="center" bgcolor="#FFFFFF" class="bodytext3"><strong>&nbsp;</strong></td>
	<td colspan="10" align="left" class="bodytext3"><strong>EMPLOYER'S NAME : <?php echo $companyname; ?></strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	<td width="50" align="center" bgcolor="#FFFFFF" class="bodytext3"><strong>&nbsp;</strong></td>
	...
	<td width="70" align="left" bgcolor="#FFFFFF" class="bodytext3"><strong>PAYROLL NO</strong></td>
	<td width="100" align="left" bgcolor="#FFFFFF" class="bodytext3"><strong>EMPLOYEE'S NAME</strong></td>
	<td width="85" align="left" bgcolor="#FFFFFF" class="bodytext3"><strong>NSSF NO</strong></td>
	<td width="85" align="right" bgcolor="#FFFFFF" class="bodytext3"><strong>STD.AMT</strong></td>
	<td width="85" align="right" bgcolor="#FFFFFF" class="bodytext3"><strong>EMP Contribution</strong></td>
	<td width="85" align="right" bgcolor="#FFFFFF" class="bodytext3"><strong>TOTAL AMT</strong></td>
	<td width="20" align="left" bgcolor="#FFFFFF" class="bodytext3">&nbsp;</td>
