        ...
        <td valign="top"><table width="919" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            <?php
				...
				{  
					...
					$querydr1 = "SELECT (amount) as deposit, recorddate as td2, docno as td3, patientcode as td4, patientname as td5 FROM `deposit_refund` WHERE visitcode IN (select visitcode FROM `master_transactionip` WHERE transactiondate BETWEEN '$ADate1' AND '$ADate2')
									 UNION ALL SELECT (`transactionamount`) as deposit, transactiondate as td2, docno as td3, patientcode as td4, patientname as td5 FROM `master_transactionadvancedeposit` WHERE `transactiondate` BETWEEN '$ADate1' AND '$ADate2'
									 ...
									 UNION ALL SELECT (`transactionamount`) as deposit, transactiondate as td2, docno as td3, patientcode as td4, patientname as td5 FROM `master_mortuaryexternaldeposit` WHERE `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactionmodule` = 'PAYMENT'
									 ...
									 UNION ALL SELECT (-1*ABS(amount)) as deposit, recorddate as td2, docno as td3, patientcode as td4, patientname as td5 FROM `deposit_refund` WHERE visitcode IN (select visitcode FROM `master_transactionip` WHERE transactiondate BETWEEN '$ADate1' AND '$ADate2')
