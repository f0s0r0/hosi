...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr><!--maintable5throwstart  -->
          ...
          <td width="860"><!--2ndtable-1sttd start here  -->
            ...
            <form name="cbform1" method="post" action="">
              ...
              <table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                ...
                <!--3rd table tbody end here -->
              </table>
              <!--3rd table end here -->
            </form>
            <!--3rd table form end here --></td>
          <!--2ndtable-1sttd end here  --> 
        </tr>
        <!--2ndtable-1st tr end here  -->
	...
	$fromdate=isset($_REQUEST['ADate1'])?$_REQUEST['ADate1']:$transactiondatefrom;
            ...
            <table width="116%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr><!--3rdtable 1st tr start here  -->
                <td><!--3rdtable 1st td start here  --> 
                  <!--4rth table   start here  -->
                  <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
												bordercolor="#666666" cellspacing="0" cellpadding="4" width="900" align="left" border="0">
                    <tbody>
                      <!--4rth table tbody  start here  -->
                      <tr><!--4rth table 1st tr  start here  -->
                        <td colspan="6" bgcolor="#cccccc" class="bodytext31"><!--<input onClick="javascript:printbillreport1()" name="resetbutton2" type="submit" id="resetbutton2"  style="border: 1px solid #001E6A" value="Print Report" />-->
                          
                          <div align="left"><strong> Approval List</strong>
                      ...
                      <?php
														...
														$sql1 = "select * from master_consultation where patientname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and approval = '1' and approvalstatus <> 'completed' and consolidateapproval = '1' and recorddate between '$fromdate' and '$todate' and locationcode='$locationcode' order by auto_number desc ";
														$result = mysql_query($sql1);
														while ($row = mysql_fetch_array($result))
														{
															$billtype = $row['billtype'];
															$patientcode = $row['patientcode'];
															$visitcode = $row['patientvisitcode'];
															$patientname = $row['patientname'];
															$data = 'patientcode='.$patientcode.'&&visitcode='.$visitcode;
															if($billtype == 'PAY NOW'){
																$url = 'billing_paynow.php?';
															}else{
																$url = 'billing_paylater.php?';
															}
                    ...
                    <!--4rth table tbody end here  -->
                    <?php
							}//ifendhere
						?>
                  </table>
                  <!--4rth table   end here  --></td>
                <!--3rdtable 1st td end here  --> 
              </tr>
              <!--3rdtable 1st tr end here  -->
              
            </table>
            <!--3rdtable end here  --></td>
          <!--2ndtable-3rd tr 1st td end here  --> 
        </tr>
        <!--2ndtable-3rd tr end here  -->
      </table>
      <!--2ndtable  end here  --></td>
    <!--maintable2td end here  --> 
  </tr>
  <!--maintable5throwstarthere  -->
</table>
<!--maintableendhere  -->
