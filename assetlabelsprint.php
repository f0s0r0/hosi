...
?>
<script>
//window.open("print_asset_lable.php?assetanum="+<?= $assetanum;?>+"","Window",'width=500,height=300,toolbar=0,scrollbars=1,location=0,bar=0,menubar=1,resizable=1,left=25,top=25');
</script>
<?php
}
?>
...
{
varcheckboxes = document.getElementsByName('asset[]');
for(i=0;i<varcheckboxes.length;i++)
{
varcheckboxes[i].checked = document.getElementById('checkall').checked;
}
}
}
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="assetlabelsprint.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="1" bgcolor="#CCCCCC" class="bodytext3"><strong>Assets Register </strong></td>
	  ...
	  <form name="form11" id="form11" method="post" action="assetlabels_print.php">	
	  <tr>
        <td>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <tr>
			 ...
			 <td width="8%"  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Select</strong><input type="checkbox" id="checkall" onClick="funcheckall();"></div></td>
              </tr>
           <?php
		 
           $query34 = "select * from assets_register where itemname like '%$searchitem%' and asset_id <> ''";
          ...
          <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext31" valign="center"  align="left">
			    <div align="center"><?php echo $itemname; ?></div></td>
				  ...
				  <td class="bodytext31" valign="center"  align="left">
			    <div align="center"><?php echo $totalamount; ?></div></td>
			   ...
			   <input type="checkbox" name="asset[]" value="<?= $anum;?>"
				</td>
				</tr>
		  <?php
		  }
           ?>
            <tr>
              <td colspan="11" class="bodytext311" valign="center" bordercolor="#f3f3f3" align="right" 
                bgcolor="#cccccc"><input type="hidden" name="frmprntflg" value="frmprntflg"><input type="submit" name="print_btn" value="Print All"></td>
			</tr>
        </table>
<?php
}
