...
include ("autocompletebuild_expenseaccount_1.php");
...
if ($frm1submit1 == 'frm1submit1')
{
	...
	if ($delbillst == 'billedit' && $delbillstanum != '' && $delbillnumber != '')
	{
		...
		while ($res19 = mysql_fetch_array($exec19))
		{
			...
			$query16 = "update assetpurchase_details set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
...
include ("assetpurchaseinclude.php"); //handles all the purchase insert operations
...
$paynowbillprefix = 'FAP-';
$paynowbillprefix1=strlen($paynowbillprefix);
$query2 = "select * from master_purchase where companyanum = '$companyanum' and typeofpurchase='Asset' order by auto_number desc";
...
<script type="text/javascript" src="js/autocomplete_12accounts_1.js"></script>
...
<form name="frmpurchase" id="frmpurchase" method="post" action="assetpurchase.php" onKeyDown="return disableEnterKey(event)">
    ...
    <td width="99%" valign="top"><table width="950" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="100%"><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
		  <tr bgcolor="#011E6A">
		  <td bgcolor="#CCCCCC" class="bodytext3" colspan="10"><strong>Asset Purchase Bill  </strong></td>
		  </tr>
            <tr>
