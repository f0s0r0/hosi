...
$totalquantity = $totalquantity + $quantity;
	...
	if($itemname !='')
	{
		...
		username,credit,cash,subtotaldiscountamountonlyapply1,subtotaldiscountamountonlyapply2,locationcode, locationname)values('$companyanum','$billnumber','$updatedatetime','$suppliercode', '$suppliername','$amount','$totalquantity','$ipaddress','$supplierbillno','Expense',
