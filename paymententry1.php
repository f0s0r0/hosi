...
else
{
	...
	//echo $companycode;
		...
		transactionmodule, approvalstatus,docno,suppliercode,recordstatus,transactionstatus,bankcode,bankname) 
		...
		'$ipaddress', '$updatedate', '$balanceamount', '$companyanum', '$companyname', '$remarks', 
		'$transactionmodule', '$approvalstatus','$billnumbercode','$suppliercode','','onaccount','$bankcode','$bankname')";
	...
	if ($paymentmode == 'ONLINE')
		...
		'$remarks', '$transactionmodule', '$approvalstatus','$billnumbercode','$suppliercode','','onaccount','$bankcode')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		...
		transactionmodule, approvalstatus,docno,suppliercode,recordstatus,bankcode,bankname) 
		...
		'$transactionmodule', '$approvalstatus','$billnumbercode','$suppliercode','allocated','$bankcode','$bankname')";
		$exec9 = mysql_query($query9) or die ("Error in Query10".mysql_error());
		...
		chequedate, bankname, bankbranch, ipaddress, updatedate, balanceamount, companyanum, companyname, remarks, 
		transactionmodule, approvalstatus,docno,suppliercode,recordstatus,bankcode) 
		values ('$transactioncode', '$transactiondate', '$particulars', '$accountssubid', '$suppliername', 
		...
		'$remarks', '$transactionmodule', '$approvalstatus','$billnumbercode','$suppliercode','allocated','$bankcode')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		...
		billnumber, billanum, ipaddress, updatedate, balanceamount, companyanum, companyname, remarks, 
		transactionmodule, approvalstatus,suppliercode,recordstatus,bankcode,bankname) 
		values ('$transactioncode', '$transactiondate', '$particulars', '$accountssubid', '$suppliername', 
		'$transactionmode', '$transactiontype', '$adjamount', '$adjamount', '$taxamount',
		'$billnum2',  '$billanum', '$ipaddress', '$updatedate', '$balamount', '$companyanum', '$companyname', '$remarks', 
		'$transactionmodule', '$approvalstatus','$suppliercode','allocated','$bankcode','$bankname')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		}
		}
		}
        ...
        <td>
			  ...
			  <table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
				...
				<input type="hidden" name="suppliercode" value="<?php echo $suppliercode; ?>">
					...
					<input name="paymententrydate" id="paymententrydate" style="border: 1px solid #001E6A" value="<?php echo $updatedatetime; ?>"  readonly="readonly" onKeyDown="return disableEnterKey()" size="20" /> <img src="images2/cal.gif" onClick="javascript:NewCssCal('paymententrydate')" style="cursor:pointer"/></td>
                  </tr>
                  <tr>
         ...
         <td width="8%" bgcolor="#cccccc" class="bodytext311">&nbsp;</td>
          <td width="8%" bgcolor="#cccccc" class="bodytext311">&nbsp;</td>
			...
			while ($res2 = mysql_fetch_array($exec2))
			{
				...
				$totalreturn = 0;
				$query38 = "select totalamount from purchasereturn_details where grnbillnumber = '$billnumber' and suppliercode = '$arraysuppliercode'";
