...
<script type="text/javascript" src="js/autobankandcashaccountsearch.js"></script>
...
function escapekeypressed(e)
{
	...
	if(key == '13') //up arrow key press
	{
		...
		if (!isNaN(varActiveElementNumber)) //to prevent losing focus to submit2.
		{
			...
			//alert (varCustomerNameCatch);
			window.opener.document.getElementById("bankname").value = varCoaCatch;
			
			window.opener.document.getElementById("bankcode").value = varIdCatch;
				window.opener.document.getElementById("bankname").focus();
				<?php
			}
...
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
    <tbody>
      <tr bgcolor="#011E6A">
        <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Search Account</strong></td>
      </tr>
      <tr>
