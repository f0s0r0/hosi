...
header('Content-Disposition: attachment;filename="bedoccupancyaccount-detailed.xls"');
...
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse; float:none" 
            bordercolor="#666666" cellspacing="0" cellpadding="0" width="1250" 
            align="left" border="0">
          <tbody>
             <tr>
			 <td colspan="13" class="bodytext31"><div align="left"><strong>Bed Occupancy Account Detailed</strong>
...
<?php	
		...
		$dob = $res751['dateofbirth'];
			...
			?>
          <tr>
              <td  width="" class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $sno = $sno + 1; ?></div></td>
			  ...
			  <td  width="" class="bodytext31" valign="center"  align="left">
				...
				<td  width="" class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $fromdate; ?></div></td>
                 <td  width="" class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $admissiondate; ?></div></td>
                 <td  width="" class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $dischargedate; ?></div></td>
				 <td  width="" class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $todate; ?></div></td>
				<td  width="" class="bodytext31" valign="center"  align="left">
        ...
        <td>&nbsp;</td>
         ...
         <tr>
             <?php if($sno > 0) { $avgstay= $totalbedday/$sno ; } else { $avgstay = '0.00'; } ?>
			  <td width=""  align="left" valign="center" class="bodytext31">
			  <div class="bodytext31" align="left"><strong></strong></div></td>
               <td width=""  align="left" valign="center" class="bodytext31"><div align="left"><strong>Total Patients:</strong></div></td>
               <td width=""  align="left" valign="center" class="bodytext31"><div align="left"><?php echo $sno ?></div></td>
			  <td width=""  align="left" valign="center" class="bodytext31">
			    <div align="left"><strong>Total Days</strong></div></td>
                 <td width=""  align="left" valign="center" class="bodytext31"><div align="left"><?php echo $totalday ?></div></td>
				  <td width=""  align="left" valign="center" class="bodytext31">
			    <div align="left"><strong>Total Bed Days</strong></div></td>
                 <td width=""  align="left" valign="center" class="bodytext31"><div align="left"><?php echo $totalbedday ?></div></td>
				 <td width=""  align="left" valign="center" class="bodytext31">
			    <div align="left"><strong>Average Length of Stay</strong></div></td>
				 <td width=""  align="left" valign="center" class="bodytext31"><div align="left"><?php echo number_format($avgstay); ?></div></td>
      </tr> 
