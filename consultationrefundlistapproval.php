          ...
          <tbody>
       	<tr>
			<td width="860">
              ...
              <form name="cbform1" method="post" action="consultationrefundlistapproval.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong>Consultation Refund </strong></td>
              </tr>
            <tr>
...
if ($cbfrmflag1 == 'cbfrmflag1')
{
	...
	<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
             <tr>
			 <td colspan="8" bgcolor="#cccccc" class="bodytext31"><div align="left"><strong>Consultation Refund</strong></div></td>
			 </tr>
            <tr>
			...
			$query76 = "select * from master_visitentry where paymentstatus='completed' and consultationrefund='torefund' and consultationrefundapproval = 'pending' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and patientfullname like '%$searchpatient%' and consultationdate between '$fromdate' and '$todate' and locationcode='$locationcode' group by visitcode order by consultationdate desc";
			...
			<tr <?php echo $colorcode; ?>>
             ...
             <td class="bodytext31" valign="center"  align="left"><a href="consultationrefund1approved.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $patientvisitcode; ?>&&locationcode=<?php echo $locationcode2?>"><strong>Approve</strong></a>			  </td>
              </tr>
			<?php
			}
			}
