...
if ($cbfrmflag1 == 'cbfrmflag1')
{
	...
	<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			$query76 = "select * from master_visitentry where paymentstatus='completed' and consultationrefund='torefund' and consultationrefundapproval = '' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and patientfullname like '%$searchpatient%' and consultationdate between '$fromdate' and '$todate' and locationcode='$locationcode' group by visitcode order by consultationdate desc";
			...
			<tr <?php echo $colorcode; ?>>
             ...
             <td class="bodytext31" valign="center"  align="left"><a href="consultationrefund1approve.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $patientvisitcode; ?>&&locationcode=<?php echo $locationcode2?>"><strong>Refund</strong></a>			  </td>
              </tr>
			<?php
			}
			}
