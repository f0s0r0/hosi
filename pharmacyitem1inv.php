...
if ($frmflag1 == 'frmflag1')
{
	...
	{  
		...
		header("location:pharmacyitem1inv.php?st=1");
		exit();
	}
	...
	$query4 = "select * from master_tax where auto_number = '$taxanum'";// and cstid='$custid' and cstname='$custname'";
		...
		if ($res2 == 0)
		{
			$query1 = "insert into master_medicine (itemcode, itemname, categoryname, unitname_abbreviation,packagename,rateperunit, expiryperiod, taxanum, taxname, ipaddress, updatetime, description, purchaseprice,pkg,genericname,exclude,minimumstock,maximumstock,rol,roq,ipmarkup,spmarkup,formula,disease,transfertype,type) 
			values ('$itemcode', '$itemname', '$categoryname', '$res4packagename','$res4packagename', '$rateperunit', '$expiryperiod', '$taxanum', '$res4taxname', '$ipaddress', '$updatedatetime','$description', '$purchaseprice','$pkg','$genericname','$exclude','$minimumstock','$maximumstock','$rol','$roq','$ipmarkup','$spmarkup','$formula','$disease','$transfertype','$medtype')";
			$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
	
	        $query2 = "insert into master_itempharmacy (itemcode, itemname, categoryname, unitname_abbreviation, packagename,rateperunit, expiryperiod, taxanum, taxname, ipaddress, updatetime, description, purchaseprice, pkg, genericname,exclude,minimumstock,maximumstock,rol,roq,ipmarkup,spmarkup,formula,disease) 
			values ('$itemcode', '$itemname', '$categoryname', '$res4packagename','$res4packagename', '$rateperunit', '$expiryperiod', '$taxanum', '$res4taxname', '$ipaddress', '$updatedatetime','$description', '$purchaseprice','$pkg','$genericname','$exclude','$minimumstock','$maximumstock','$rol','$roq','$ipmarkup','$spmarkup','$formula','$disease')";
			$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
...
function fixed2(){
	...
	if(formula.value=='FIXED'){
		...
		packageanum.onchange = function(){if(packageanum.value !='14' && formula.value=='FIXED'){
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="pharmacyitem1inv.php" onSubmit="return additem1process1()">
                  <table width="1072" border="0" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#E0E0E0"><input name="itemcode" value="<?php echo $itemcode; ?>" id="itemcode" onKeyDown="return process1backkeypress1()" style="border: 1px solid #001E6A; background-color:#CCCCCC" size="20" maxlength="100" readonly />
...
-->					  
					  <tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#E0E0E0"><select id="formula" name="formula" onChange="fixed2()">
                      ...
                      <tr>
					   ...
					   <tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#E0E0E0"><input type="checkbox" name="pkg" value="yes"></td>
                      </tr>
                      <tr>
      ...
      <tr>
	   <td width="9%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">&nbsp;</td>
        ...
        &nbsp;<span style="width:100px;float:left;line-height:20px"><?php echo $locationname;?></span>&nbsp;<input type="text" name="locrate<?php echo $incr;?>" style="width:90px;"></td>
	  </tr> 
                    ...
                    <tbody>
                      <tr bgcolor="#011E6A">
						...
						if($searchflag1 != 'searchflag1'){
							...
							*/
							$query111 = "select * from $tbl_name where status <> 'deleted' and categoryname IN ('LABORATORY','PHYSIOTHERAPY')";
							$exec111 = mysql_query($query111) or die ("Error in Query111".mysql_error());
	  ...
	  if ($searchflag1 == 'searchflag1')
	  {
	    ...
	    $query1 = "select * from master_medicine where itemname like '%$search1%' and categoryname IN ('LABORATORY','PHYSIOTHERAPY') and status <> 'deleted' order by auto_number desc ";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		while ($res1 = mysql_fetch_array($exec1))
		{
	 ...
	 /*?>	
        ...
        <tr <?php echo $colorcode; ?>>
                        <td align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3"><div align="center"><a href="pharmacyitem1inv.php?st=del&&anum=<?php echo $auto_number; ?>"><img src="images/b_drop.png" width="16" height="16" border="0" /></a></div></td>
                        <td align="left" valign="top"  class="bodytext3"><a href="editpharmacyiteminv.php?itemcode=<?php echo $itemcode; ?>">Edit</a></td>
	...
	{
	$query1 = "select * from master_medicine where status <> 'deleted' and categoryname IN ('LABORATORY','PHYSIOTHERAPY') order by auto_number desc LIMIT $start, $limit";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		while ($res1 = mysql_fetch_array($exec1))
		{
		$itemcode = $res1["itemcode"];
	  ...
	  if ($searchflag2 == 'searchflag2')
	  {
	    ...
	    $query1 = "select * from master_medicine where itemname like '%$search2%' and categoryname IN ('LABORATORY','PHYSIOTHERAPY') and status = 'deleted' order by auto_number desc LIMIT 100";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		while ($res1 = mysql_fetch_array($exec1))
		{
		$itemcode = $res1["itemcode"];
        ...
        <tr <?php echo $colorcode; ?>>
						...
						<a href="pharmacyitem1inv.php?st=activate&&anum=<?php echo $auto_number; ?>" class="bodytext3">
	...
	else
	{
	    ...
	    $query1 = "select * from master_medicine where status = 'deleted' and categoryname IN ('LABORATORY','PHYSIOTHERAPY') order by auto_number desc LIMIT 100";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		while ($res1 = mysql_fetch_array($exec1))
		{
		$itemcode = $res1["itemcode"];
