    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="658" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong>Doctor Activity Report</strong></td>
              </tr>
      ...
      <tr>
	   ...
	   <?php if($cbfrmflag2 == 'cbfrmflag1'){?>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
		  ...
		  $query4 = "select username,locationname,count(username) as totalpatients,visitcode from master_consultationlist where locationcode like '%$slocation' and date between '$ADate1' and '$ADate2' and username <>'' group by username order by auto_number ASC"; 
		...
		$query1002 = "select count(username) as totalpatients1 from master_consultationlist where locationcode like '%$slocation' and username='$username' and date between '$ADate1' and '$ADate2' group by visitcode order by auto_number ASC"; 
		  ...
		  $exec1002 = mysql_query($query1002) or die ("Error in Query002".mysql_error());
		 $numt1=mysql_num_rows($exec1002);
			...
			?>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                ...
                bgcolor="#cccccc">&nbsp;</td>
				 ...
				 <tr>
               <?php  $url = "ADate1=$ADate1&&ADate2=$ADate2&slocation=$slocation" ?>
