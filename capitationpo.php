...
include ("capitationpoinclude.php"); //handles all the purchase insert operations
...
$paynowbillprefix = 'CPO-';
$paynowbillprefix1=strlen($paynowbillprefix);
$query2 = "select * from capitation_po where companyanum = '$companyanum' order by auto_number desc";
...
<?php include ("nmpurchasescripting1.php"); ?>
...
?>
	...
	if(otcbillnumberr != "") 
	{
		window.open("print_capitationpurchaseorder.php?billnumber="+otcbillnumberr,"OriginalWindowA25",'width=400,height=500,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25'); 
	}	
</script>
...
<form name="frmpurchase" id="frmpurchase" method="post" action="capitationpo.php" onKeyDown="return disableEnterKey(event)">
...
-->
  <tr>
    <td width="1%">&nbsp;</td>
    <td width="99%" valign="top"><table width="1008" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="100%"><table width="101%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
		  <tr bgcolor="#011E6A">
		  <td bgcolor="#CCCCCC" class="bodytext3" colspan="7"><strong>Capitation PO  </strong></td>
...
*/            <?php
            ...
            <?php
			  ...
			  ?>
            <tr>
              <td width="5%" align="left" valign="middle" class="bodytext3"><strong>Supplier   </strong></td>
...
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Nett Amount</strong></div></td>
                <td align="left" valign="top" ><span class="bodytext31">
                  ...
                  <input type="hidden" name="supplierbillnumber" id="supplierbillnumber" value="1">
...
bgcolor="#F3F3F3" class="bodytext31"><span class="bodytext32"><strong><?php //echo $f18;?></strong></span>
				  ...
				  <input type="hidden" name="footerline2" id="footerline2" size="10" /></td>
                <td colspan="2" align="left" valign="center"  
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Remarks</strong></div></td>
                <td align="left" valign="top" ><span class="bodytext31">
              ...
              <tr>
                ...
                bgcolor="#CCCCCC" class="bodytext31"><div align="right"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
				  ...
				  <input name="Submit2223" id="Submit2223" type="submit" onClick="return funcSaveBill1()" value="Save Bill" accesskey="b" class="button" />
