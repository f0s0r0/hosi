  ...
  <tr>
                ...
                <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      ...
                      <tr bgcolor="#011E6A">
						...
						<td bgcolor="#CCCCCC" class="bodytext3"><strong>Description </strong> 
					                         
						  <td bgcolor="#CCCCCC" class="bodytext3"><strong>Edit                      </strong>              
                                                   
						  <td width="19%" bgcolor="#CCCCCC" class="bodytext3"><strong>Delete                      </strong>           </tr>
                      <?php
	     $query1 = "select * from equipment_details where recordstatus <> 'deleted'";
		//$query1 = "select * from master_vehicle where recordstatus <> 'deleted' order by paymenttype ";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
	...
	*/
		...
		?>
          ...
          <td width="23%" align="left" valign="top"  class="bodytext3"><?php echo $vehiclenumber; ?></td>
 
          <td width="38%" align="left" valign="top"  class="bodytext3"><?php echo $description; ?></td>
		  
          <td width="20%" align="left" valign="top"  class="bodytext3">
		  <a href="equipmentdetailedit.php?st=edit&&anum=<?php echo $auto_number; ?>" style="text-decoration:none">Edit</a>		  </td> 
