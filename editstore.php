...
{  
	...
	if ($res2 != 0)
	{
	    $query1 = "update master_store set type='".$type."',location = '$location',store = '$store',storecode = '$storenumber',locationcode = '$locationcode',locationname = '$locationname' where auto_number = '$storeanum'";
            ...
            <tr>
              <td><form name="form1" id="form1" method="post" action="editstore.php" onSubmit="return addward1process1()">
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Store Master - Edit </strong></td>
                      </tr>
					  <tr>
                      ...
                      <tr>
                       ...
                       <tr>
						...
						<select name="type" style="border: 1px solid #001E6A;">
                          ...
                          <option value="Billing" <?php if($type=='Billing'){echo "selected";}?>>Billing</option>
                      ...
                      <tr>
					   ...
					   <tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
						<input name="storeno" id="storeno"  value="<?php echo $res1storeno;?>" readonly style="border: 1px solid #001E6A; text-transform:uppercase" size="40" /></td>
                      </tr>
                      <tr>
