...
//ends here
			...
			$totalcp = $purchaseprice * $returnquantity;
	...
	{// echo 'in';
		...
		$query43="insert into pharmacysalesreturn_details(patientcode,visitcode,companyanum,billnumber,itemcode,itemname,rate,quantity,totalamount,username,ipaddress,entrydate,batchnumber,billstatus,pharmacycoa,location,categoryname,locationname,locationcode,store,docnumber,salseautonumber,comments,costprice,totalcp)values('$patientcode','$visitcode','$companyanum','$billnumber','$itemcode','$medicinename','$rate','$returnquantity','$amount','$username','$ipaddress','$dateonly','$batchnumber','completed','$pharmacycoa','$location1','$categoryname','".$getlocationname."','".$getlocationcode."','".$getstorecode."','".$docnumber."','".$salseautonumber."','$comments','$purchaseprice','totalcp')";
		$exec43=mysql_query($query43) or die(mysql_error());
