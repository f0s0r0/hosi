...
<body>
<form name="frmsales" id="frmsales" method="post" action="sales1dischargesummary.php" >
  ...
  <tr>
            ...
            <tbody>
              <tr bgcolor="#011E6A">
                ...
                <td bgcolor="#CCCCCC" class="bodytext3"><strong>
                  ...
                  Bill No. 
                  <input name="summarynumber" id="summarynumber" value="<?php echo $summarynumber; ?>" style="border: 1px solid #001E6A; text-align:right" size="8" /> 
	...
	//$delBillSt = $_REQUEST["delbillst"];
			  ...
			  <tr>
                ...
                <td width="22%" align="left" valign="middle" class="bodytext3"><?php echo $patientname; ?>
...
<input name="patientgender" type="hidden" value="<?php echo $patientgender; ?>" id="patientgender" size="10"></td>
			  ...
			  <tr>
			    ...
			    <td align="left" valign="middle" class="bodytext3"><?php echo $address1; ?><input name="address1" type="hidden" id="address1" style="border: 1px solid #001E6A;" value="<?php echo $address1; ?>" size="40" autocomplete="off"></td>
 ...
 <?php echo $bedname; ?> <input name="bednumber" type="hidden" value="<?php echo $bednumber; ?>" id="bednumber" size="10"></td>
			  ...
			  <tr>
			    ...
			    <td align="left" valign="middle" class="bodytext3"><?php echo $address2; ?><input name="address2" type="hidden" id="address2" style="border: 1px solid #001E6A;" value="<?php echo $address2; ?>" size="40" autocomplete="off"></td>
			  ...
			  <tr>
			    ...
			    <td align="left" valign="middle" ><span class="bodytext3"><strong>
