 ...
 <tr>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
                 ...
                 <tr bgcolor="#011E6A">
                        <td colspan="10" bgcolor="#CCCCCC" class="bodytext3"><strong>Account Opening Balance</strong></td>
                  </tr>
					   <tr>
				  ...
				  <tr>
				  <td width="248" align="left" valign="top"  class="bodytext5">Credit Account <input type="hidden" name="labpaynow" value="openingbalanceaccount" /></td>
