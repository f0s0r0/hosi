...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="105%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
        <td width="860">
              <form name="cbform1" method="post" action="viewpurchaseindent.php">
  ...
  <tr>    
	...
	$query1 = "select * from purchase_indent where approvalstatus='' and pogeneration <> 'completed' and (date between '$fromdate' and '$todate') and docno like '%$docno%' and username in (select username from master_employee where departmentname like '$dpt') group by docno";
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left">
			    ...
			    <div align="left"><?php echo $remarks."<br>-By ".$user; ?></div></td>
                 <td class="bodytext31" valign="center" align="left">
			    <div align="left"><a href="purchaseindentapproval.php?docno=<?php echo $docno1; ?>"><strong> <?php if($approvalstatus=='')
				{
                 echo 'VIEW';
				}
				else
