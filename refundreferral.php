...
{		
	...
	if($refund == $auto_number)
	{
		...
		$query29=mysql_query("update consultation_departmentreferal set referalrefund='$status1',status='$status1', refundrequestby = '$username', approvalstatus = 'pending' where auto_number='$auto_number' and referalname='$referalname' and patientvisitcode='$visitcode'");
		$query29=mysql_query("update consultation_referal set referalrefund='$status1',status='$status1', refundrequestby = '$username', approvalstatus = 'pending' where auto_number='$auto_number' and referalname='$referalname' and patientvisitcode='$visitcode'");
