...
if (isset($_REQUEST["billno"])) {  $billno1 = $_REQUEST["billno"]; } else { $billno1 = ""; }
...
$paynowbillprefix = 'EXRE-';
$paynowbillprefix1=strlen($paynowbillprefix);
$query2 = "select * from refund_paynow where source = 'externalrefund' order by auto_number desc limit 0, 1";
...
$billnumber = $billnumbercode;
	...
	$mpesanumber=$_REQUEST['mpesanumber']; 
		...
		transactionmodule,patientname,patientcode,visitcode,accountname,doctorname,billstatus,financialyear,username,transactiontime,cashgivenbycustomer,cashgiventocustomer,source,locationname,locationcode,cashcode) 
		values ('$billdate', '$particulars', 
		'$transactionmode', '$transactiontype', '$totalamount', '$totalamount', 
		'$billnumber','$billanum', '$ipaddress', '$updatedate', '$balanceamount', '$companyanum', '$companyname', '$remarks', 
		'$transactionmodule','$patientname','$patientcode','$visitcode','$accountname','$doctorname','paid','$financialyear','$username','$timeonly','$cashgivenbycustomer','$cashgiventocustomer','externalrefund','".$locationnameget."','".$locationcodeget."','$cashcode')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		
		$query37 = "insert into paymentmodecredit(patientname,patientcode,patientvisitcode,accountname,billnumber,billdate,ipaddress,username,cash,cashcoa,source,locationname,locationcode)values('$patientname','$patientcode','$visitcode','$accountname','$billnumber','$billdate','$ipaddress','$username','$totalamount','$cashcoa','externalrefund','".$locationnameget."','".$locationcodeget."')";
		...
		billnumber, billanum, ipaddress, updatedate, balanceamount, companyanum, companyname, remarks, 
		transactionmodule,patientname,patientcode,visitcode,accountname,doctorname,billstatus,financialyear,username,transactiontime,cashgivenbycustomer,cashgiventocustomer,source,locationname,locationcode,bankcode) 
		values ('$billdate','$particulars', 
		'$transactionmode', '$transactiontype', '$totalamount', '$totalamount', 
		'$billnumber',  '$billanum', '$ipaddress', '$updatedate', '$balanceamount', '$companyanum', '$companyname', '$remarks', 
		'$transactionmodule','$patientname','$patientcode','$visitcode','$accountname','$doctorname','paid','$financialyear','$username','$timeonly','$cashgivenbycustomer','$cashgiventocustomer','externalrefund','".$locationnameget."','".$locationcodeget."','$bankcode')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		
		$query37 = "insert into paymentmodecredit(patientname,patientcode,patientvisitcode,accountname,billnumber,billdate,ipaddress,username,online,onlinecoa,source,locationname,locationcode)values('$patientname','$patientcode','$visitcode','$accountname','$billnumber','$billdate','$ipaddress','$username','$totalamount','$onlinecoa','externalrefund','".$locationnameget."','".$locationcodeget."')";
        $exec37 = mysql_query($query37) or die(mysql_error());
		...
		'$remarks', '$transactionmodule','$patientname','$patientcode','$visitcode','$accountname','$doctorname','paid','$financialyear','$username','$timeonly','$cashgivenbycustomer','$cashgiventocustomer','externalrefund','".$locationnameget."','".$locationcodeget."','$bankcode')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		
		$query37 = "insert into paymentmodecredit(patientname,patientcode,patientvisitcode,accountname,billnumber,billdate,ipaddress,username,cheque,chequecoa,source,locationname,locationcode)values('$patientname','$patientcode','$visitcode','$accountname','$billnumber','$billdate','$ipaddress','$username','$totalamount','$chequecoa','externalrefund','".$locationnameget."','".$locationcodeget."')";
        $exec37 = mysql_query($query37) or die(mysql_error());
	...
	$transactiontype = 'PAYMENT';
		...
		chequedate, bankname, ipaddress, updatedate, balanceamount, companyanum, companyname, remarks, 
		transactionmodule,patientname,patientcode,visitcode,accountname,doctorname,billstatus,financialyear,username,creditcardname,creditcardnumber,creditcardbankname,transactiontime,cashgivenbycustomer,cashgiventocustomer,source,locationname,locationcode,bankcode) 
		values ('$billdate', '$particulars', 
		'$transactionmode', '$transactiontype', '$totalamount',
		'$totalamount',  '$billnumber',  '$billanum', 
		'$chequedate', '$bankname', '$ipaddress', '$updatedate', '$balanceamount', '$companyanum', '$companyname', 
		'$remarks', '$transactionmodule','$patientname','$patientcode','$visitcode','$accountname','$doctorname','paid','$financialyear','$username','$card','$cardnumber','$bankname1','$timeonly','$cashgivenbycustomer','$cashgiventocustomer','externalrefund','".$locationnameget."','".$locationcodeget."','$bankcode')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		
		$query37 = "insert into paymentmodecredit(patientname,patientcode,patientvisitcode,accountname,billnumber,billdate,ipaddress,username,card,cardcoa,source,locationname,locationcode)values('$patientname','$patientcode','$visitcode','$accountname','$billnumber','$billdate','$ipaddress','$username','$totalamount','$cardcoa','externalrefund','".$locationnameget."','".$locationcodeget."')";
        $exec37 = mysql_query($query37) or die(mysql_error());
	...
	$transactiontype = 'PAYMENT';
		...
		billnumber, billanum, ipaddress, updatedate, balanceamount, companyanum, companyname, remarks, 
		transactionmodule,patientname,patientcode,visitcode,accountname,doctorname,billstatus,financialyear,username,transactiontime,cashgivenbycustomer,cashgiventocustomer,source,locationname,locationcode,mpesacode) 
		values ('$billdate','$particulars', 
		'$transactionmode', '$transactiontype', '$totalamount', '$totalamount', 
		'$billnumber',  '$billanum', '$ipaddress', '$updatedate', '$balanceamount', '$companyanum', '$companyname', '$remarks', 
		'$transactionmodule','$patientname','$patientcode','$visitcode','$accountname','$doctorname','paid','$financialyear','$username','$timeonly','$cashgivenbycustomer','$cashgiventocustomer','externalrefund','".$locationnameget."','".$locationcodeget."','$mpesacode')";
		$exec9 = mysql_query($query9) or die ("Error in Query9".mysql_error());
		
		$query37 = "insert into paymentmodecredit(patientname,patientcode,patientvisitcode,accountname,billnumber,billdate,ipaddress,username,mpesa,mpesacoa,mpesanumber,source,locationname,locationcode)values('$patientname','$patientcode','$visitcode','$accountname','$billnumber','$billdate','$ipaddress','$username','$totalamount','$mpesacoa','$mpesanumber','externalrefund','".$locationnameget."','".$locationcodeget."')";
        $exec37 = mysql_query($query37) or die(mysql_error());
	...
	foreach($_POST['lab'] as $key => $value)
	    ...
	    $labautonumber=$_POST['labautono'][$key];
...
{
	mysql_query("update consultation_lab set labrefund='' where patientvisitcode='$visitcode' and labitemname='$labname' and billnumber='$billno' and auto_number='$labautonumber'");
}
else
{
	mysql_query("update consultation_lab set labrefund='' where patientvisitcode='$visitcode' and labitemname='$labname' and docnumber='$billno' and auto_number='$labautonumber'");
	}
	...
	foreach($_POST['rad'] as $key => $value)
		...
		$radautonumber=trim($_POST['radautono'][$key]);
if($patientcode=='walkin')
{
	mysql_query("update consultation_radiology set radiologyrefund='' where patientvisitcode='$visitcode' and radiologyitemname='$radname' and billnumber='$billno' and auto_number='$radautonumber'");
}
else
{
	mysql_query("update consultation_radiology set radiologyrefund='' where patientvisitcode='$visitcode' and radiologyitemname='$radname' and docnumber='$billno' and auto_number='$radautonumber'");
	}
	...
	foreach($_POST['ser'] as $key => $value)
		...
		$serautonumber=trim($_POST['serautono'][$key]);
		if($patientcode=='walkin')
{
	mysql_query("update consultation_services set servicerefund='' where patientvisitcode='$visitcode' and servicesitemname='$sername' and billnumber='$billno' and auto_number='$serautonumber'");
}
else
{
	mysql_query("update consultation_services set servicerefund='' where patientvisitcode='$visitcode' and servicesitemname='$sername' and docnumber='$billno' and auto_number='$serautonumber'");
	}
	$query47 = "insert into refund_paynowservices(patientcode,patientname,patientvisitcode,servicesitemcode,servicesitemname,servicesitemrate,accountname,billdate,billnumber,username,servicecoa,locationname,locationcode)values
	           ('$patientcode','$patientname','$visitcode','$servicescode','$sername','$servicesrate','$accountname','$updatedate','$billnumber','$username','$servicecoa','".$locationnameget."','".$locationcodeget."')";
	...
	header("location:patientbillingstatus.php?refundbillnumber=$billnumber&&patientcode=$patientcode&&visitcode=$visitcode&&mainmenuid=MM005&&locationcode=$locationcodeget");
	exit();
...
$query69="select * from paylaterpharmareturns where billnumber='$billno1'";
...
if($patientname=='')
{
$querylab1=mysql_query("select * from consultation_radiology where billnumber='$billno1'");
...
if($patientname=='')
{
$querylab1=mysql_query("select * from consultation_lab where billnumber='$billno1'");
$execlab1=mysql_fetch_array($querylab1);
$patientname=$execlab1['patientname'];
$patientaccount=$execlab1['accountname'];
}
if($patientname=='')
{
$querylab1=mysql_query("select * from consultation_services where billnumber='$billno1'");
$execlab1=mysql_fetch_array($querylab1);
$patientname=$execlab1['patientname'];
$patientaccount=$execlab1['accountname'];
}
...
{
$query3 = "select patientfullname,accountname from master_visitentry where visitcode = '".$visitcode1."'";
$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
$res3 = mysql_fetch_array($exec3);
 $patientname = $res3['patientfullname'];
 $patientaccount1 = $res3['accountname'];
}
?>
...
/*var popWin; 
popWin = window.open("print_paynow_refund.php?billnumber=<?php echo $billnumbercode; ?>&&visitcode=<?php echo $visitcode1; ?>&&patientcode=<?php echo $patientcode1;?>"
,"OriginalWindowA4",'width=400,height=500,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');*/
}
...
<form name="form1" id="frmsales" method="post" action="refund_external.php">
      ...
      <tr>
        <td><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
             <?php
                ...
                <td colspan="3" bgcolor="#CCCCCC" class="bodytext32"><strong>Location : <?php echo $res1location;?> </strong></td>
              	  <input type="hidden" name="locationcodeget" value="<?php echo $res1locationanum?>">
				<input type="hidden" name="locationnameget" value="<?php echo $res1location?>">
		...
		<tr>
			  ...
			  <tr>
				...
				<input type="hidden" name="billnumber" value="<?php echo $billno1; ?>">
          ...
          <tbody id="foo">
           <tr bgcolor="#011E6A">
            ...
            <tr>
			  ...
			  <?php  
  $query11 = "select * from refund_paynowlab where  patientvisitcode = '$visitcode1' and billnumber='$billno1' and patientcode = '$patientcode' ";
			  ...
			  $query19 = "select * from consultation_lab where patientvisitcode='$visitcode1' and patientcode='$patientcode1' and billnumber='$billno1' and labrefund='refund'";
			...
			$labautonumber=$res19['auto_number'];
			...
			?>
			 ...
			 <input type="hidden" name="labautono[]" value="<?php echo $labautonumber; ?>">
			...
			<td width="4%"  align="left" valign="center" 
			  ...
			  $query23 = "select * from pharmacysalesreturn_details where visitcode='$visitcode' and patientcode='$patientcode' and billnumber='$billno1' and billstatus='pending'";
			...
			?>
			 ...
			 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo intval($phaquantity); ?></div></td>
			...
			<td width="4%"  align="left" valign="center" 
			  ...
			  $query20 = "select * from consultation_radiology where patientvisitcode='$visitcode' and patientcode='$patientcode' and billnumber='$billno1' and radiologyrefund='refund'";
			...
			$radautonumber=$res20['auto_number'];
			$radref=$res20['refno'];
			$colorloopcount = $colorloopcount + 1;
			$showcolor = ($colorloopcount & 1); 
			if ($showcolor == 0)
			...
			?>
			 ...
			 <input type="hidden" name="radautono[]" value="<?php echo $radautonumber; ?>">
			 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo '1'; ?></div></td>
			 ...
			 <td width="4%"  align="left" valign="center" 
			  ...
			  $query21 = "select * from consultation_services where patientvisitcode='$visitcode' and patientcode='$patientcode' and billnumber='$billno1' and servicerefund='refund'";
			...
			$serautonumber=$res21['auto_number'];
			$serref=$res21['refno'];
			$colorloopcount = $colorloopcount + 1;
			$showcolor = ($colorloopcount & 1); 
			if ($showcolor == 0)
			...
			?>
			 ...
			 <input type="hidden" name="serautono[]" value="<?php echo $serautonumber; ?>">
			 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo '1'; ?></div></td>
			 ...
			 <td width="4%"  align="left" valign="center" 
			  ...
			  ?>
			   <?php 
			   $totalref=0;
			  $query22 = "select * from consultation_departmentreferal where patientvisitcode='$visitcode' and patientcode='$patientcode' and paymentstatus='completed' and referalrefund='refund'";
